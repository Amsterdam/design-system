import{j as e,b as c}from"./iframe-AVaY1VGI.js";import{l as m}from"./ExampleLogo-BJuWIU_t.js";import{m as g,P as r,a as u}from"./PageHeader.stories-BVqOzyt-.js";import"./preload-helper-PPVm8Dsz.js";import"./useViewportHasMinWidth-nPo3gQiz.js";import"./Grid-gptNCx6a.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-CweuOKKs.js";const{expect:d}=__STORYBOOK_MODULE_TEST__,B={...g,title:"Components/Containers/Page Header"},l=u,n={args:{brandName:"Data Amsterdam",children:e.jsx("p",{children:"test"}),menuItems:[e.jsx(r.MenuLink,{href:"#",lang:"en",children:"English"},"1"),e.jsx(r.MenuLink,{fixed:!0,href:"#",children:"Zoeken"},"2")]},play:async({canvas:a,userEvent:t})=>{const i=(await a.findByTestId("interaction-test")).querySelector("button"),o=await a.findByTestId("children");i&&(await t.click(i),d(o).toBeVisible(),await t.click(i),d(o).not.toBeVisible())},render:a=>e.jsxs(e.Fragment,{children:[e.jsx(r,{"data-testid":"interaction-test",...a,children:e.jsx("ul",{children:e.jsx("li",{"data-testid":"children",children:"English"})})}),Object.keys(l).filter(t=>t!=="__namedExportsOrder").sort().map(t=>{const s=l[t];return s?e.jsx(r,{...s.args},t):null}),m.map(t=>e.jsx(r,{brandName:"Voorbeeld",logoBrand:t,menuItems:e.jsx(r.MenuLink,{fixed:!0,href:"#",icon:c,children:"Inloggen"})},t))]}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
