...
`,(0,E.jsx)(r.p,{children:`An item can offer one or more actions on its value, such as a link to the step of a form where that value is entered or a button that opens a dialog to edit the value directly.
...
`,(0,E.jsx)(r.p,{children:`A value takes rich content: several lines of text, an address, a paragraph, a link, or an image.
...
`,(0,E.jsxs)(r.p,{children:[`Introduce a Data List with a Data List Header, which draws a line below its content and sets the space to the list.
Place a `,(0,E.jsx)(r.a,{href:`/docs/components-text-heading--docs`,children:`Heading`}),` in it, at the level that fits the document outline.
Add at most one action next to it, and use a `,(0,E.jsx)(r.a,{href:`/docs/components-layout-row--docs`,children:`Row`}),` to place the two side by side.`]}),`
`,(0,E.jsx)(a,{of:p}),`
...
`,(0,E.jsx)(r.p,{children:`Group data about several people or subjects by placing a Data List Header above each Data List.
...
`,(0,E.jsx)(r.p,{children:`Items are separated by a line, which runs the full width of the list.
The whitespace above and below that line is the same, so the line sits between two items rather than belonging to one.`}),`
`,(0,E.jsx)(r.p,{children:`Several actions sit next to each other, with a thin line between each pair.
They do not wrap onto a new line, so a line never starts a row; in a narrow column their labels wrap instead.`}),`
`,(0,E.jsx)(r.p,{children:`A Data List Header draws a thicker, darker line below its content, and adds space below itself when a Data List follows.`}),`
...
`,(0,E.jsxs)(r.p,{children:[`By default the column for the labels is at most `,(0,E.jsx)(r.code,{children:`15rem`}),` wide.
...
Labels and values sit next to each other when their `,(0,E.jsx)(r.a,{href:`/docs/utilities-css-query-container--docs`,children:`query container`}),` is wide enough (at least `,(0,E.jsx)(r.code,{children:`32rem`}),`).`]}),`
...
These tie each label to its value in the markup instead of only through the layout, which is the kind of relationship `,(0,E.jsx)(r.a,{href:`https://www.w3.org/TR/WCAG22/#info-and-relationships`,rel:`nofollow`,children:`WCAG 1.3.1`}),` asks to be made available.
An Item renders a `,(0,E.jsx)(r.code,{children:`div`}),` around one pair, which HTML permits inside a `,(0,E.jsx)(r.code,{children:`dl`}),`.`]}),`
...
Give repeated actions a unique accessible name with the `,(0,E.jsx)(r.code,{children:`ams-visually-hidden`}),` helper, as `,(0,E.jsx)(r.a,{href:`https://www.w3.org/TR/WCAG22/#link-purpose-in-context`,rel:`nofollow`,children:`WCAG 2.4.4`}),` asks.
...
`,(0,E.jsxs)(r.p,{children:[`A Data List Header renders a `,(0,E.jsx)(r.code,{children:`div`}),`, so it adds no landmark and its Heading stays part of the page outline.
