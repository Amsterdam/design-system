...
`,(0,k.jsx)(r.p,{children:`An item can offer one or more actions on its value, such as a link to the step of a form where that value is entered or a button that opens a dialog to edit the value directly.
The text, the icon, and the type of each action are yours to choose: pass Standalone Links, Links, or Buttons.
A line separates each action from the one before it.`}),`
...
`,(0,k.jsx)(r.p,{children:`A value takes rich content: several lines of text, an address, a paragraph, a link, or an image.
