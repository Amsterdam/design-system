import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{h as t,u as n}from"./blocks-DDIQjgnz.js";import{t as r}from"./jsx-runtime-Bq1bXGty.js";import{i}from"./react-BnCtKaSV.js";import{n as a,t as o}from"./PageAnatomy-CD3Va-3z.js";import{t as s}from"./mdx-react-shim-9RzcSRdq.js";import{n as c,t as l}from"./LoadingPage.stories-Dgi-Tnii.js";var u,d=e((()=>{u=[[{height:56,label:`Page title`},{height:48,label:`Search field`}],[{height:320,label:`Search results`}]]}));function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[`
`,`
`,`
`,`
`,(0,m.jsx)(n,{of:l}),`
...
`,(0,m.jsxs)(t.li,{children:[`The page has two Grids in one landmark, so a plain `,(0,m.jsx)(t.code,{children:`main`}),` wraps them both.
A page that is a single section can put `,(0,m.jsx)(t.code,{children:`as="main"`}),` on the Grid itself instead.`]}),`
`,(0,m.jsxs)(t.li,{children:[`The first Grid holds the `,(0,m.jsx)(t.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),` instead of a breadcrumb, so it still takes the `,(0,m.jsx)(t.code,{children:`large`}),` top padding.`]}),`
`,(0,m.jsxs)(t.li,{children:[`Search is not a content page, so the title spans the full width rather than the `,(0,m.jsx)(t.a,{href:`/docs/pages-public-introduction--docs#content-page-header`,children:`header Cell`}),` other page types use.`]}),`
`,(0,m.jsx)(t.li,{children:`The Search Field spans half the grid on wide screens, so the input does not stretch to an unusable length.
...
`,(0,m.jsxs)(t.li,{children:[`The Search Field is not a breadcrumb, so the Grid that follows it keeps the regular `,(0,m.jsx)(t.code,{children:`x-large`}),` top padding.`]}),`
