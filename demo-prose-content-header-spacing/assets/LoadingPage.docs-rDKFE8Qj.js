...
The `,(0,m.jsx)(t.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),` is no part of the Content Header, so it takes a Grid Cell of its own below the title.`]}),`
`,(0,m.jsxs)(t.li,{children:[`Search is not a content page, so the title spans the full width rather than the `,(0,m.jsx)(t.a,{href:`/docs/pages-public-introduction--docs#content-header`,children:`Content Header Cell`}),` other page types use.`]}),`
...
`,(0,m.jsxs)(t.li,{children:[`The results sit on the regular background below the Content Header, so their Grid takes a `,(0,m.jsx)(t.code,{children:`paddingTop`}),` of `,(0,m.jsx)(t.code,{children:`2x-large`}),`.`]}),`
