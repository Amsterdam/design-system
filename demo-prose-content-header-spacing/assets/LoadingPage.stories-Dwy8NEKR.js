import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{F as i,V as a,Z as o,b as s,l as c,y as l,z as u}from"./index.esm-Bu5eCpkJ.js";import{n as d,t as f}from"./commonMeta-d_QmIhGL.js";var p=t({Default:()=>w,Loaded:()=>E,Loading:()=>T,__namedExportsOrder:()=>D,default:()=>y}),m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{o(),m=n(),d(),h=r(),g=`woningbouw`,_=[{description:`Een levendige, groene en duurzame woonbuurt tussen de Gooiseweg en het Nelson Mandelapark.`,heading:`Nederlands eerste houten woonwijk komt in Zuidoost`,imageSrc:`https://picsum.photos/id/1015/640/360`},{description:`De komende jaren bouwt de gemeente duizenden nieuwe woningen in stadsdeel Noord.`,heading:`Meer betaalbare woningen in Noord`,imageSrc:`https://picsum.photos/id/1016/640/360`},{description:`Havenstad groeit uit tot een gemengd stadsgebied met ruimte om te wonen en te werken.`,heading:`Woningbouwplannen Havenstad`,imageSrc:`https://picsum.photos/id/1029/640/360`},{description:`Bekijk hoe u zich inschrijft en wat de wachttijden zijn voor een sociale huurwoning.`,heading:`Sneller een sociale huurwoning`,imageSrc:`https://picsum.photos/id/1039/640/360`},{description:`Subsidies en advies om uw huis te isoleren en van het gas af te gaan.`,heading:`Verduurzaam uw woning`,imageSrc:`https://picsum.photos/id/1043/640/360`},{description:`Op het Zeeburgereiland verrijst een hoogstedelijke buurt met hoge woontorens.`,heading:`Nieuwbouw in de Sluisbuurt`,imageSrc:`https://picsum.photos/id/1044/640/360`}],v={narrow:4,medium:4,wide:4},y={...f,title:`Pages/Public/Loading Page`,args:{initialPhase:`idle`},argTypes:{initialPhase:{table:{disable:!0}}},render:({initialPhase:e})=>{let[t,n]=(0,m.useState)(e),[r,o]=(0,m.useState)(g),d=(0,m.useRef)(null);(0,m.useEffect)(()=>()=>{d.current&&clearTimeout(d.current)},[]);let f=e=>{e.preventDefault();let t=new FormData(e.currentTarget).get(`search`);typeof t==`string`&&t.trim()&&o(t.trim()),d.current&&clearTimeout(d.current),n(`loading`),d.current=setTimeout(()=>n(`loaded`),3e3)},p=t===`loading`?`Zoekresultaten voor ‘${r}’ worden geladen`:t===`loaded`?`${_.length} resultaten voor ‘${r}’ gevonden`:``;return(0,h.jsxs)(`main`,{id:`inhoud`,children:[(0,h.jsxs)(l,{paddingTop:`large`,children:[(0,h.jsx)(l.Cell,{span:`all`,children:(0,h.jsx)(s,{level:1,children:`Zoeken op amsterdam.nl`})}),(0,h.jsx)(l.Cell,{span:{narrow:4,medium:6,wide:6},children:(0,h.jsxs)(u,{onSubmit:f,children:[(0,h.jsx)(u.Input,{defaultValue:g,label:`Zoek op de website`,name:`search`}),(0,h.jsx)(u.Button,{})]})})]}),(0,h.jsxs)(l,{"aria-busy":t===`loading`,paddingBottom:`2x-large`,paddingTop:`2x-large`,children:[(0,h.jsxs)(l.Cell,{span:`all`,children:[(0,h.jsx)(`p`,{className:`ams-visually-hidden`,role:`status`,children:p}),t===`idle`&&(0,h.jsx)(i,{children:`Klik op de zoekknop om de resultaten te laden.`}),t===`loaded`&&(0,h.jsx)(s,{level:2,size:`level-3`,children:`${_.length} resultaten voor ‘${r}’`})]}),t===`loading`&&_.map((e,t)=>(0,h.jsx)(l.Cell,{span:v,children:(0,h.jsxs)(a,{children:[(0,h.jsx)(a.Image,{}),(0,h.jsx)(a.Heading,{}),(0,h.jsx)(a.Paragraph,{lines:2})]})},t)),t===`loaded`&&_.map(e=>(0,h.jsx)(l.Cell,{span:v,children:(0,h.jsxs)(c,{children:[(0,h.jsx)(c.Image,{alt:``,aspectRatio:`16:9`,src:e.imageSrc}),(0,h.jsx)(c.Heading,{level:3,children:(0,h.jsx)(c.Link,{href:`#`,children:e.heading})}),(0,h.jsx)(i,{children:e.description})]})},e.heading))]})]})}},b=({busy:e,extraCells:t=``,status:n,statusCell:r=``})=>`// The Skip Link in the Page Layout targets this id, so the next Tab press lands in the main content.
