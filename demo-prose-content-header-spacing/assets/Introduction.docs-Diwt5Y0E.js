...
`,(0,c.jsxs)(t.p,{children:[`Its `,(0,c.jsx)(t.code,{children:`paddingBottom`}),` depends on the section below it.
A section on the regular background of the page takes `,(0,c.jsx)(t.code,{children:`2x-large`}),`, which sets the Content Header apart from the body that follows.
A coloured section takes `,(0,c.jsx)(t.code,{children:`x-large`}),`, because the edge of the colour marks that boundary already.
A Spotlight and an Image are the two that occur in these templates.`]}),`
`,(0,c.jsxs)(t.p,{children:[`Anything else in the Content Header Grid — a Search Field, an Image Slider — takes a Grid Cell of its own.
The row gap of `,(0,c.jsx)(t.code,{children:`x-large`}),` then sets it apart from the title above it.`]}),`
