import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,u as n}from"./blocks-zzQRermb.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{i,r as a}from"./react-Dyi61YEg.js";import{n as o,t as s}from"./PageAnatomy-MXPRDTMn.js";import{n as c,t as l}from"./SearchResultsPage.stories-DrIXToGL.js";var u;function d(){return(d=e((()=>{u=[[{height:32,label:`Breadcrumb`}],[{height:64,label:`Page title`},{height:56,label:`Search`}],[{height:240,label:`Filters`},{height:32,label:`Result count`},...Array.from({length:6},()=>({height:120,label:`Search result`})),{height:44,label:`Pagination`}]]})))()}function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[`
`,`
`,`
`,`
`,(0,m.jsx)(n,{of:l}),`
...
`,(0,m.jsxs)(t.p,{children:[`The breadcrumb sits in its own Grid above `,(0,m.jsx)(t.code,{children:`main`}),`, and the Grid below it carries the Content Header and the search field.`]}),`
...
`,(0,m.jsx)(t.p,{children:`A page of results with the term still in the search field.`}),`
`,(0,m.jsx)(t.h2,{id:`no-results`,children:`No results`}),`
`,(0,m.jsx)(t.p,{children:`An empty result set is a normal outcome, not an error, so the page says so plainly and offers a way on.
The count is still announced, so a visitor using a screen reader hears that the search ran and returned nothing.
Suggest what to change — a shorter term, a different word, or fewer filters — and give a way to clear the filters in one action.`})]})}function p(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(f,{...e})}):f(e)}var m;function h(){return(h=e((()=>{m=r(),a(),t(),o(),d(),c()})))()}h();export{p as default};