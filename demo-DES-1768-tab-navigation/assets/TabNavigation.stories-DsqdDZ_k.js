import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{At as r,Nt as i,_t as a,et as o,gn as s,ht as c,it as l}from"./iframe-B830195d.js";import{s as u,t as d}from"./src-BX1RXqZf.js";var f=n({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=e((()=>{r(),d(),p=t(s()),m=i(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}},decorators:[(e,t)=>(0,m.jsx)(`div`,{style:{maxWidth:t.args.orientation===`vertical`?`16rem`:void 0},children:e()})]},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(_);return(0,m.jsx)(u,{...e,children:(0,m.jsx)(u.List,{children:_.map(e=>(0,m.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},b=[{icon:a,label:`Gegevens`},{icon:l,label:`Aanslagen`},{icon:o,label:`Documenten`},{icon:c,label:`Acties`}],x={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
