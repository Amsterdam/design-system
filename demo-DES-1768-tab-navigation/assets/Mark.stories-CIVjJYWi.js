import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{K as r,P as i,R as a,Vt as o,b as s,l as c,q as l,wn as u,y as d}from"./iframe-COv4ELOd.js";import{j as f,t as p}from"./src-CICJgien.js";var m=n({Default:()=>v,SearchResults:()=>S,__namedExportsOrder:()=>C,default:()=>_}),h,g,_,v,y,b,x,S,C,w=e((()=>{l(),p(),h=t(u()),g=o(),_={title:`Components/Text/Mark`,component:f},v={args:{children:`Wat vinden Amsterdammers belangrijk?`},argTypes:{children:{description:`The text to mark.`,table:{disable:!1}}},render:({children:e})=>(0,g.jsxs)(i,{children:[`Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. `,(0,g.jsx)(f,{children:e}),` Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren.`]})},y=[{category:`Kansspelen`,date:new Date(`2025-10-27`),fragment:`Op dit moment zijn alle vergunning voor speelautomatenhallen verleend. Als u kansspelautomaten wilt plaatsen in uw horecabedrijf dan heeft u de …`,heading:`Vergunning speelautomatenhal of kansspelautomaten aanvragen`},{category:`Veelgevraagd`,date:new Date(`2024-09-15`),fragment:`U heeft een ontheffing nodig als u de geldende geluidsgrenzen van uw horecagelegenheid wil overschrijden. Kijk hier hoe het werkt en hoe u de …`,heading:`Ontheffing geluidsvoorschriften`},{category:`Vergunningen`,date:new Date(`2023-08-03`),fragment:`Voor de organisatie van grootschalige vechtsportgala’s in Amsterdam moet u een vergunning aanvragen bij de gemeente. Vooraf moet u een Bibobformulier …`,heading:`Vergunning vechtsportevenementen`}],b=new Intl.DateTimeFormat(`nl`,{day:`numeric`,month:`long`,year:`numeric`}),x=(e,t,n)=>{if(!t)return e;let r=t.split(/\s+/).filter(Boolean).map(e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`));if(r.length===0)return e;let i=RegExp(`(${r.join(`|`)})`,`gi`);return e.split(i).map(e=>e.match(i)?(0,g.jsx)(f,{...n,children:e},e):e)},S={render:e=>{let[t,n]=(0,h.useState)(`horeca vergunning`),o=y.filter(({fragment:e,heading:n})=>[e,n].some(e=>t.split(/\s+/).filter(Boolean).some(t=>e.toLowerCase().includes(t.toLowerCase()))));return(0,g.jsx)(d,{children:(0,g.jsxs)(d.Cell,{span:{narrow:4,medium:6,wide:7},start:{narrow:1,medium:2,wide:3},children:[(0,g.jsxs)(a,{className:`ams-mb-m`,children:[(0,g.jsx)(a.Input,{label:`Zoeken`,onChange:e=>n(e.target.value),value:t}),(0,g.jsx)(a.Button,{})]}),(0,g.jsxs)(i,{className:`ams-mb-xl`,children:[(0,g.jsx)(`strong`,{children:o.length}),` artikelen gaan over ‘`,t,`’.`]}),(0,g.jsx)(r,{className:`ams-gap-xl`,markers:!1,children:o.map(({category:n,date:a,fragment:o,heading:l})=>(0,g.jsx)(r.Item,{children:(0,g.jsxs)(c,{children:[(0,g.jsx)(c.HeadingGroup,{tagline:n,children:(0,g.jsx)(s,{level:2,size:`level-4`,children:(0,g.jsx)(c.Link,{href:`#`,children:x(l,t,e)})})}),(0,g.jsx)(i,{className:`ams-mb-xs`,children:x(o,t,e)}),(0,g.jsx)(i,{size:`small`,children:(0,g.jsx)(`time`,{dateTime:a.toISOString(),children:b.format(a)})})]})},l))})]})})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
