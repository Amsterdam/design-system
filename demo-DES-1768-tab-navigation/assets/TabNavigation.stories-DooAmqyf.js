import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{Ct as r,Rt as i,Tt as a,Vt as o,at as s,dt as c,wn as l}from"./iframe-C1K9Nvqi.js";import{s as u,t as d}from"./src-DIWUthZP.js";import{m as f,t as p}from"./exampleContent-BwA2seBs.js";var m=n({Default:()=>b,Vertical:()=>x,WithIcons:()=>C,WithManyLinks:()=>w,__namedExportsOrder:()=>T,default:()=>v});function h(e,t){let[n,r]=(0,g.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}}var g,_,v,y,b,x,S,C,w,T,E=e((()=>{i(),d(),g=t(l()),f(),_=o(),v={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}},decorators:[(e,t)=>(0,_.jsx)(`div`,{style:{maxWidth:t.args.orientation===`vertical`?`16rem`:void 0},children:e()})]},y=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],b={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(y);return(0,_.jsx)(u,{...e,children:(0,_.jsx)(u.List,{children:y.map(e=>(0,_.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},S=[{icon:a,label:`Gegevens`},{icon:c,label:`Aanslagen`},{icon:s,label:`Documenten`},{icon:r,label:`Acties`}],C={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
