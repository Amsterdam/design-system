import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{At as r,Nt as i,_t as a,et as o,gn as s,ht as c,it as l}from"./iframe-BpKv-bii.js";import{s as u,t as d}from"./src-ByO7eYZM.js";import{m as f,t as p}from"./exampleContent-BwA2seBs.js";var m=n({Default:()=>b,Vertical:()=>x,WithIcons:()=>C,WithManyLinks:()=>w,__namedExportsOrder:()=>T,default:()=>v});function h(e,t){let[n,r]=(0,g.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}}var g,_,v,y,b,x,S,C,w,T,E=e((()=>{r(),d(),g=t(s()),f(),_=i(),v={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}},decorators:[(e,t)=>(0,_.jsx)(`div`,{style:{maxWidth:t.args.orientation===`vertical`?`16rem`:void 0},children:e()})]},y=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],b={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(y);return(0,_.jsx)(u,{...e,children:(0,_.jsx)(u.List,{children:y.map(e=>(0,_.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},S=[{icon:a,label:`Gegevens`},{icon:l,label:`Aanslagen`},{icon:o,label:`Documenten`},{icon:c,label:`Acties`}],C={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
