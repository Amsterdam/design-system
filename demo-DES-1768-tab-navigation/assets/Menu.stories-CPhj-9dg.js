import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{t as r}from"./react-Wx6hiPly.js";import{t as i}from"./jsx-runtime-GmyBfqKJ.js";import{M as a,R as o,h as s,k as c,n as l,u,z as d}from"./index.esm-B_OH5ZB5.js";import{C as f,k as p,t as m,w as h}from"./src-CVUNfj4B.js";var g=n({Default:()=>w,Link:()=>T,__namedExportsOrder:()=>E,default:()=>C}),_,v,y,b,x,S,C,w,T,E,D=e((()=>{d(),m(),h(),_=t(r()),v=i(),y=t(r()),{useArgs:b}=__STORYBOOK_MODULE_PREVIEW_API__,x=[{href:`#`,icon:(0,v.jsx)(c,{}),text:`Dashboard`},{href:`#`,icon:(0,v.jsx)(s,{}),text:`Projecten`},{href:`#`,icon:(0,v.jsx)(u,{}),text:`Rapportages`},{href:`#`,icon:(0,v.jsx)(l,{}),text:`Analyses`},{href:`#`,icon:(0,v.jsx)(a,{}),text:`Instellingen`}],S=e=>{let[,t]=b();return(0,_.useEffect)(()=>{if(typeof window>`u`||!window.matchMedia)return;let e=window.matchMedia(`(min-width: ${f.wide})`);t({inWideWindow:e.matches});let n=e=>t({inWideWindow:e.matches});return e.addEventListener(`change`,n),()=>e.removeEventListener(`change`,n)},[t]),(0,v.jsx)(e,{})},C={title:`Components/Navigation/Menu`,component:p,args:{inWideWindow:!1},argTypes:{inWideWindow:{control:{disable:!0},description:`This props gets automatically updated in Storybook. Is \`true\` when the viewport is wider than ${f.wide}.`,table:{category:`Derived`}}},decorators:[S],parameters:{themes:{themeOverride:`Compact`}}},p.Link,w={args:{children:x.map(({text:e,...t})=>(0,y.createElement)(p.Link,{...t,key:e},e))}},T={args:{children:x[0].text,href:`#`,icon:`PieChartFillIcon`},argTypes:{accessibleName:{table:{disable:!0}},children:{control:`text`,table:{disable:!1}},icon:{control:{labels:{undefined:`none`},type:`select`},mapping:o,options:[void 0,...Object.keys(o)]},inWideWindow:{table:{disable:!0}}},decorators:[e=>(0,v.jsx)(p,{inWideWindow:!0,style:{display:`inline-flex`,margin:0,paddingBlock:`var(--ams-menu-padding-block)`,paddingInline:`var(--ams-menu-padding-block)`},children:(0,v.jsx)(e,{})})],render:({children:e,...t})=>{let{accessibleName:n,inWideWindow:r,...i}=t;return(0,v.jsx)(p.Link,{...i,children:e})}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
