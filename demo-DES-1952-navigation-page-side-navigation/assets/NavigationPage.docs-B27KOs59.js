import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,u as n}from"./blocks-zzQRermb.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{i,r as a}from"./react-Dyi61YEg.js";import{n as o,t as s}from"./PageAnatomy-BE2UcTvl.js";import{n as c,t as l}from"./NavigationPage.stories-DsxT3wMh.js";var u;function d(){return(d=e((()=>{u=[[{height:32,label:`Breadcrumb`}],[{height:132,label:`Page title`},...Array.from({length:10},()=>({height:152,label:`Link section`}))]]})))()}function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[`
`,`
`,`
`,`
`,(0,m.jsx)(n,{of:l}),`
...
`,(0,m.jsxs)(t.p,{children:[`The navigation is usually longer than the entry beside it.
Give its Grid Cell a `,(0,m.jsx)(t.code,{children:`rowSpan`}),` for the number of rows that entry occupies, or it takes a row of its own and pushes everything below it.
`,(0,m.jsx)(t.code,{children:`rowSpan`}),` accepts at most 4, so plan the entry for at most that many rows on the wide grid, or place the navigation above the content instead.
Set `,(0,m.jsx)(t.code,{children:`rowSpan`}),` per grid variant: on narrower grids the navigation stacks above the content and spans a single row.`]}),`
`,(0,m.jsx)(t.p,{children:`Because the entry’s parts each sit in their own Grid Cell, the space between them is the Grid’s row gap.
