import{j as e}from"./iframe-OW4oVQ-T.js";import{useMDXComponents as o}from"./index-C7hp3sF6.js";import{M as r}from"./blocks-QfDEKDwc.js";import{F as t}from"./FormFlow.stories-i2_eDiCY.js";import"./index-H_NnBPq2.js";import"./Layout-Cvc3KM3X.js";import"./PageFooter.stories-Q7M1uD31.js";import"./Hint-Dyl6f6iB.js";/*@license CC0-1.0*/function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(r,{of:t}),`
...
`,e.jsxs(n.p,{children:[`On a form page with one question, the questions label or legend is the level 1 heading of the page.
...
`,e.jsxs(n.p,{children:["When a form page has multiple questions, define an ",e.jsx(n.code,{children:"h1"})," outside the ",e.jsx(n.code,{children:"form"}),`-tag,
...
`,e.jsxs(n.li,{children:["add ‘(X invoerfouten) ’ to the beginning of the page ",e.jsx(n.code,{children:"<title>"})," so screen readers read it out as soon as possible (Invalid Form Alert does this automatically)"]}),`
