...
To control it yourself – for example to close the menu when the route changes – pass `,(0,k.jsx)(t.code,{children:`open`}),` and update it from the `,(0,k.jsx)(t.code,{children:`onOpenChange`}),` callback.`]}),`
