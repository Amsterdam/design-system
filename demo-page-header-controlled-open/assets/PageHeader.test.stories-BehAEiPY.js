import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-BTu_umhU.js";import{t as r}from"./jsx-runtime-BCDDjCIb.js";import{G as i,T as a}from"./index.esm-Cyk4q9Yv.js";import{V as o,at as s,it as c,t as l}from"./src-Dgx2oxNo.js";import u,{n as d,t as f}from"./PageHeader.stories-BfdKIjyA.js";var p,m,h,g,_,v,y;e((()=>{i(),l(),c(),p=t(n()),d(),m=r(),{expect:h}=__STORYBOOK_MODULE_TEST__,g={...u,title:`Components/Containers/Page Header`},_=f,v={args:{brandName:`Data Amsterdam`,children:(0,m.jsx)(`p`,{children:`test`}),menuItems:[(0,m.jsx)(o.MenuLink,{href:`#`,lang:`en`,children:`English`},`1`),(0,m.jsx)(o.MenuLink,{fixed:!0,href:`#`,children:`Zoeken`},`2`)]},play:async({canvas:e,userEvent:t})=>{let n=(await e.findByTestId(`interaction-test`)).querySelector(`button`),r=await e.findByTestId(`children`);n&&(await t.click(n),h(r).toBeVisible(),await t.click(n),h(r).not.toBeVisible(),await t.click(n),h(r).toBeVisible(),await t.click(e.getByTestId(`mega-menu-link`)),h(r).not.toBeVisible())},render:e=>{let[t,n]=(0,p.useState)(!1);return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(o,{"data-testid":`interaction-test`,...e,onClick:e=>{e.target.closest(`.ams-page-header__mega-menu a`)&&(e.preventDefault(),n(!1))},onOpenChange:n,open:t,children:(0,m.jsx)(`ul`,{children:(0,m.jsx)(`li`,{"data-testid":`children`,children:(0,m.jsx)(`a`,{"data-testid":`mega-menu-link`,href:`#/should-not-navigate`,children:`English`})})})}),Object.keys(_).filter(e=>e!==`__namedExportsOrder`).sort().map(e=>{let t=_[e];return t?(0,m.jsx)(o,{...t.args},e):null}),s.map(e=>(0,m.jsx)(o,{brandName:`Voorbeeld`,logoBrand:e,menuItems:(0,m.jsx)(o.MenuLink,{fixed:!0,href:`#`,icon:a,children:`Inloggen`})},e))]})},tags:[`!dev`,`!autodocs`]},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
