import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,d as n,h as r,i,n as a,p as o,u as s}from"./blocks-msKSRvUz.js";import{t as c}from"./jsx-runtime-ATHzeHXA.js";import{i as l,r as u}from"./react-Dyi61YEg.js";import{n as d,t as f}from"./DesignTokensTable-PJfg6Snp.js";import{i as p,n as m,r as h,t as g}from"./CharacterCount.stories-BFI2kGGX.js";var _,v;function y(){return(y=e((()=>{_={"character-count":{color:{$value:`{ams.color.text.default}`,$extensions:{"nl.amsterdam.type":`color`}},"font-family":{$value:`{ams.typography.font-family}`,$extensions:{"nl.amsterdam.type":`fontFamily`}},"font-size":{$value:`{ams.typography.body-text.small.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.font-weight}`,$extensions:{"nl.amsterdam.type":`fontWeight`}},"line-height":{$value:`{ams.typography.body-text.small.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`,"nl.amsterdam.type":`number`}},error:{color:{$value:`{ams.color.feedback.error}`,$extensions:{"nl.amsterdam.type":`color`}}}}},v={ams:_}})))()}function b(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(s,{of:g}),`
...
`,(0,S.jsxs)(r.p,{children:[`Pass a formatter to `,(0,S.jsx)(r.code,{children:`formatText`}),` to render the count in another language, as ‘Translated text’ below shows.
Set `,(0,S.jsx)(r.code,{children:`lang`}),` on the component, or on an element containing it, when that language differs from the language of the page around it.
Screen readers choose a pronunciation from `,(0,S.jsx)(r.code,{children:`lang`}),`, so without it an English count is read aloud by a Dutch voice.`]}),`
...
`,(0,S.jsx)(r.p,{children:`The count is text the component writes itself rather than content passed in, so it inherits the page language whether or not that is the language it is written in.
