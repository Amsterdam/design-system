...
`,(0,S.jsxs)(r.p,{children:[`The text is Dutch by default, and the `,(0,S.jsx)(r.code,{children:`formatText`}),` prop replaces it with a function of your own.
...
Set `,(0,S.jsx)(r.code,{children:`lang`}),` to the same language, on the component or on an element containing it, so screen readers pronounce the text correctly.`]}),`
