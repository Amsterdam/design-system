...
`,(0,w.jsxs)(r.p,{children:[`We use a smaller font size for text in a Figure Caption.
For a date or a category, reach for `,(0,w.jsx)(r.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`}),` instead.`]}),`
`,(0,w.jsx)(a,{of:m}),`
...
The browser decides where to split them, so the `,(0,w.jsx)(r.a,{href:`/docs/docs-guidelines-localisation--docs#specify-the-language-for-the-entire-document`,children:`language of the document`}),` must be set correctly.`]}),`
...
`,(0,w.jsxs)(r.li,{children:[(0,w.jsx)(r.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`}),` – for the date and the categories of a piece of content.`]}),`
