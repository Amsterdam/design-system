...
`,e.jsx(n.p,{children:"In andere gevallen installeer je Amsterdam Sans op 1 van deze 2 manieren:"}),`
`,e.jsxs(n.ol,{children:[`
`,e.jsxs(n.li,{children:["Kopieer ",e.jsx(n.a,{href:"https://amsterdam.nl/publish/pages/1007152/amsterdam_sans_v_0_9.css",target:"_blank",rel:"nofollow noopener noreferrer",children:"deze regels CSS"}),` naar je applicatie.
Het maakt gebruik van ons snelle CDN.
Dit levert korte laadtijden voor bezoekers.`]}),`
...
`]}),`
`,e.jsx(n.p,{children:"Als het niet mogelijk is Amsterdam Sans te gebruiken pas je het lettertype Arial toe, of het generieke sans-serif lettertype van het apparaat."}),`
...
//# sourceMappingURL=typography.stories-ee388cdf.js.map
