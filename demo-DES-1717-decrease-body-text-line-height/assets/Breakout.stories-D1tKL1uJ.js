import{r as g,j as e,c as h,m as w,P as p,a as f}from"./iframe-D84rDQ4m.js";import{g as C}from"./Grid.argTypes-CfqFMx79.js";import{a as i,p as b}from"./gridCellClasses-DKw8XbSK.js";const _=(r,t,l,o)=>[...i("ams-breakout__cell--col-span-",r),...i("ams-breakout__cell--col-start-",t),...i("ams-breakout__cell--row-span-",l),...i("ams-breakout__cell--row-start-",o)],v=g.forwardRef(({as:r="div",children:t,className:l,colSpan:o,colStart:d,has:u,rowSpan:c,rowStart:m,...k},y)=>e.jsx(r,{...k,className:h("ams-breakout__cell",_(o,d,c,m),u&&`ams-breakout__cell--has-${u}`,l),ref:y,children:t}));v.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:{value:"div"},description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},rowSpan:{defaultValue:null,description:"The amount of grid rows the cell spans.",name:"rowSpan",required:!1,type:{name:"BreakoutRowNumber | BreakoutRowNumbers"}},rowStart:{defaultValue:null,description:"The index of the grid row the cell starts at.",name:"rowStart",required:!1,type:{name:"BreakoutRowNumber | BreakoutRowNumbers"}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...s.parameters?.docs?.source}}};const B=["Default","VerticalLayout"],N=Object.freeze(Object.defineProperty({__proto__:null,Default:n,VerticalLayout:s,__namedExportsOrder:B,default:x},Symbol.toStringTag,{value:"Module"}));export{a as B,s as V,N as a,x as m};
