...
`,e.jsx(n.h3,{id:"twee-varianten-voor-witruimte",children:"Twee varianten voor witruimte"}),`
...
`]})]})}function s(i={}){const{wrapper:n}=Object.assign({},d(),i.components);return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}const a=()=>{throw new Error("Docs-only story")};a.parameters={docsOnly:!0};const r={title:"Docs/Designrichtlijnen/Grid",tags:["stories-mdx"],includeStories:["__page"]};r.parameters=r.parameters||{};r.parameters.docs={...r.parameters.docs||{},page:s};const b=["__page"];export{b as __namedExportsOrder,a as __page,r as default};
//# sourceMappingURL=grid.stories-1ba2774d.js.map
