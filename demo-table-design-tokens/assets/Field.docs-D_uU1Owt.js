import{j as e}from"./iframe-DxFJ3SCQ.js";import{useMDXComponents as r}from"./index-CdbzGJT0.js";import{M as o,f as a,P as d,h as c,i as s}from"./blocks-DPfOuimJ.js";import{a as l,W as h,b as p,I as m}from"./Field.stories-CXg_zUOv.js";import{D as x}from"./DesignTokensTable-CKsYRah6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CnyXa-QK.js";import"./exampleContent-Du2yH2Fl.js";const u=`<!-- @license CC0-1.0 -->
...
`,j={field:{gap:{value:"{ams.space.s}"},invalid:{"border-inline-start":{value:"{ams.border.width.l} solid {ams.color.feedback.error}"},"padding-inline-start":{value:"{ams.space.m}"}}}},f={ams:j};function t(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...r(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(x,{tokens:f})]})}function D(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{D as default};
