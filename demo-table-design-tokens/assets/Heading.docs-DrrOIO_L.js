import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as o}from"./index-CUuWwI6L.js";import{M as i,f as r,P as h,h as l,i as t}from"./blocks-C1WmRPMp.js";import{H as c,L as d,a as g,b as p,c as u,S as m,I as f,W as v}from"./Heading.stories-BRu9HbGb.js";import{D as y}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-CL8U14h_.js";const w=`<!-- @license CC0-1.0 -->
...
`,x={heading:{1:{"font-size":{value:"{ams.typography.heading.1.font-size}"},"line-height":{value:"{ams.typography.heading.1.line-height}"}},2:{"font-size":{value:"{ams.typography.heading.2.font-size}"},"line-height":{value:"{ams.typography.heading.2.line-height}"}},3:{"font-size":{value:"{ams.typography.heading.3.font-size}"},"line-height":{value:"{ams.typography.heading.3.line-height}"}},4:{"font-size":{value:"{ams.typography.heading.4.font-size}"},"line-height":{value:"{ams.typography.heading.4.line-height}"}},5:{"font-size":{value:"{ams.typography.heading.5.font-size}"},"line-height":{value:"{ams.typography.heading.5.line-height}"}},6:{"font-size":{value:"{ams.typography.heading.6.font-size}"},"line-height":{value:"{ams.typography.heading.6.line-height}"}},color:{value:"{ams.color.text.default}"},"font-family":{value:"{ams.typography.font-family}"},"font-weight":{value:"{ams.typography.heading.font-weight}"},"text-wrap":{value:"{ams.typography.heading.text-wrap}"},inverse:{color:{value:"{ams.color.text.inverse}"}}}},j={ams:x};function a(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...o(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(y,{tokens:j})]})}function L(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{L as default};
