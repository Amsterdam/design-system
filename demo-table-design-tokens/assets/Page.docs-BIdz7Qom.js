import{j as e}from"./iframe-BiErRGvs.js";import{useMDXComponents as a}from"./index-BVfInj7M.js";import{M as o,f as i,P as r,h as m,i as l}from"./blocks-BzC5Qy9m.js";import{a as p,W as d}from"./Page.stories-BNlmB7qA.js";import{D as c}from"./DesignTokensTable-6Gsg3hI7.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bdsl2Juj.js";const h=`<!-- @license CC0-1.0 -->
...
`,u={page:{"background-color":{value:"{ams.color.background}"},"max-inline-size":{value:"90rem"},"with-menu":{"max-inline-size":{value:"120rem"},"area-skip-link":{"margin-inline-end":{value:"{ams.grid.padding-inline}",comment:"Must be the Grid inline padding, to make sure Skip Link and Grid line up"}}}}},g={ams:u};function t(s){const n={a:"a",h2:"h2",h3:"h3",p:"p",...a(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:p}),`
...
`,e.jsx(c,{tokens:g})]})}function y(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{y as default};
