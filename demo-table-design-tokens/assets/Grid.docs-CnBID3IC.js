import{j as e}from"./iframe-BiErRGvs.js";import{useMDXComponents as i}from"./index-BVfInj7M.js";import{M as a,f as l,P as r,h as c,i as s}from"./blocks-BzC5Qy9m.js";import{G as d,V as h,a as p,S as m,b as u,c as x,d as g,I as w}from"./Grid.stories-ehjTaZRG.js";import{D as f}from"./DesignTokensTable-6Gsg3hI7.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bdsl2Juj.js";import"./common-HRWYXPjp.js";import"./Grid-DQhGUupf.js";import"./gridCellClasses-DKw8XbSK.js";const j=`<!-- @license CC0-1.0 -->
...
`,v={grid:{"column-count":{value:"4"},"column-gap":{value:"{ams.space.xl}"},"padding-block":{l:{value:"{ams.space.l}"},xl:{value:"{ams.space.xl}"},"2xl":{value:"{ams.space.2xl}"}},"padding-inline":{value:"{ams.space.l}"},"row-gap":{l:{value:"{ams.space.l}"},xl:{value:"{ams.space.xl}"},"2xl":{value:"{ams.space.2xl}"}},medium:{"column-count":{value:"8"},"padding-inline":{value:"{ams.space.xl}"}},wide:{"column-count":{value:"12"},"padding-inline":{value:"{ams.space.2xl}"}}}},y={ams:v};function t(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
