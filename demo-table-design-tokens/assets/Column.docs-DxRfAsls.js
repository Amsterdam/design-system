import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as l}from"./index-CUuWwI6L.js";import{M as a,f as o,P as r,h,i as t}from"./blocks-C1WmRPMp.js";import{a as c,A as d,H as m,I as x}from"./Column.stories-CMvtwX1S.js";import{D as p}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";import"./types-CjGn4A4T.js";const u=`<!-- @license CC0-1.0 -->

# Column

Stacks its children vertically with gaps between them and offers alignment options.
`,j={column:{gap:{"x-small":{value:"{ams.space.xs}"},small:{value:"{ams.space.s}"},medium:{value:"{ams.space.m}"},large:{value:"{ams.space.l}"},"x-large":{value:"{ams.space.xl}"}}}},g={ams:j};function i(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(p,{tokens:g})]})}function M(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{M as default};
