import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as r}from"./index-CUuWwI6L.js";import{M as i,f as a,P as h,h as m,i as s}from"./blocks-C1WmRPMp.js";import{a as c,C as d,W as l}from"./ErrorMessage.stories-Lz0BzmO_.js";import{D as f}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";import"./Icon-B0BHIoDG.js";const p=`<!-- @license CC0-1.0 -->
...
`,u={"error-message":{color:{value:"{ams.color.feedback.error}"},"font-family":{value:"{ams.typography.font-family}"},"font-size":{value:"{ams.typography.body-text.font-size}"},"font-weight":{value:"{ams.typography.body-text.font-weight}"},gap:{value:"{ams.space.xs}"},"line-height":{value:"{ams.typography.body-text.line-height}"}}},x={ams:u};function t(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...r(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(f,{tokens:x})]})}function D(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{D as default};
