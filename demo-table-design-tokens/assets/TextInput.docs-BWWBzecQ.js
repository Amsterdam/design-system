import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as t}from"./index-CUuWwI6L.js";import{M as r,f as l,P as a,h as d,i as s}from"./blocks-C1WmRPMp.js";import{a as h,E as c,W as p,P as u,b as m,D as f,S as x,I as b,c as j,d as y,e as g}from"./TextInput.stories-ndYUfsFz.js";import{D as v}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";const w=`<!-- @license CC0-1.0 -->
...
`,k={"text-input":{"background-color":{value:"{ams.inputs.background-color}"},"border-color":{value:"{ams.inputs.border-color}"},"border-style":{value:"{ams.inputs.border-style}"},"border-width":{value:"{ams.inputs.border-width}"},color:{value:"{ams.inputs.color}"},"font-family":{value:"{ams.inputs.font-family}"},"font-size":{value:"{ams.inputs.font-size}"},"font-weight":{value:"{ams.inputs.font-weight}"},"line-height":{value:"{ams.inputs.line-height}"},"outline-offset":{value:"{ams.inputs.outline-offset}"},"padding-block":{value:"{ams.inputs.padding-block}"},"padding-inline":{value:"{ams.inputs.padding-inline}"},disabled:{color:{value:"{ams.inputs.disabled.color}"},cursor:{value:"{ams.cursor.disabled}"}},hover:{"box-shadow":{value:"{ams.inputs.hover.box-shadow}"}},invalid:{"border-color":{value:"{ams.inputs.invalid.border-color}"},hover:{"border-color":{value:"{ams.inputs.invalid.hover.border-color}"},"box-shadow":{value:"{ams.inputs.invalid.hover.box-shadow}"}}},placeholder:{color:{value:"{ams.inputs.placeholder.color}"}}}},T={ams:k};function o(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:h}),`
...
`,e.jsx(v,{tokens:T})]})}function F(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{F as default};
