import{j as e}from"./iframe-DxFJ3SCQ.js";import{useMDXComponents as o}from"./index-CdbzGJT0.js";import{M as a,f as r,P as d,h as l,i}from"./blocks-DPfOuimJ.js";import{a as h,M as c,b as m,c as p,I as u,d as v,e as f,f as x}from"./DateInput.stories-mzBhL8dP.js";import{D as b}from"./DesignTokensTable-CKsYRah6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CnyXa-QK.js";const g=`<!-- @license CC0-1.0 -->
...
`,j={"date-input":{"background-color":{value:"{ams.inputs.background-color}"},"border-color":{value:"{ams.inputs.border-color}"},"border-style":{value:"{ams.inputs.border-style}"},"border-width":{value:"{ams.inputs.border-width}"},color:{value:"{ams.inputs.color}"},"font-family":{value:"{ams.inputs.font-family}"},"font-size":{value:"{ams.inputs.font-size}"},"font-weight":{value:"{ams.inputs.font-weight}"},"line-height":{value:"{ams.inputs.line-height}"},"outline-offset":{value:"{ams.inputs.outline-offset}"},"padding-block":{value:"{ams.inputs.padding-block}"},"padding-inline":{value:"{ams.inputs.padding-inline}"},disabled:{color:{value:"{ams.inputs.disabled.color}"},cursor:{value:"{ams.cursor.disabled}"},"calendar-picker-indicator":{"background-image":{value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 36 36' fill='%23767676'><path d='M28 6V2h-4v4H12V2H8v4H2v28h32V6zm2 24H6V14h24z'/><path d='M10 17h4v4h-4zm6 0h4v4h-4zm6 0h4v4h-4zm-12 6h4v4h-4zm6 0h4v4h-4z'/></svg>")`}}},hover:{"box-shadow":{value:"{ams.inputs.hover.box-shadow}"},"calendar-picker-indicator":{"background-image":{value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 36 36' fill='%23003677'><path d='M28 6V2h-4v4H12V2H8v4H2v28h32V6zm2 24H6V14h24z'/><path d='M10 17h4v4h-4zm6 0h4v4h-4zm6 0h4v4h-4zm-12 6h4v4h-4zm6 0h4v4h-4z'/></svg>")`}}},invalid:{"border-color":{value:"{ams.inputs.invalid.border-color}"},hover:{"border-color":{value:"{ams.inputs.invalid.hover.border-color}"},"box-shadow":{value:"{ams.inputs.invalid.hover.box-shadow}"}}},"calendar-picker-indicator":{"background-image":{value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 36 36' fill='%23004699'><path d='M28 6V2h-4v4H12V2H8v4H2v28h32V6zm2 24H6V14h24z'/><path d='M10 17h4v4h-4zm6 0h4v4h-4zm6 0h4v4h-4zm-12 6h4v4h-4zm6 0h4v4h-4z'/></svg>")`},cursor:{value:"{ams.cursor.interactive}"}}}},w={ams:j};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",...o(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:h}),`
...
`,e.jsx(b,{tokens:w})]})}function V(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{V as default};
