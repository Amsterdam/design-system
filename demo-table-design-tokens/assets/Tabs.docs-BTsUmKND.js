import{j as e}from"./iframe-BiErRGvs.js";import{useMDXComponents as s}from"./index-BVfInj7M.js";import{M as i,f as r,P as h,h as l,i as a}from"./blocks-BzC5Qy9m.js";import{a as c,W as d,b,P as u}from"./Tabs.stories-DZpNBfg_.js";import{D as m}from"./DesignTokensTable-6Gsg3hI7.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bdsl2Juj.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";const p=`<!-- @license CC0-1.0 -->
...
`,f={tabs:{gap:{value:"{ams.space.m}"},list:{"box-shadow":{value:"inset 0 calc({ams.border.width.m} * -1) {ams.color.separator}"}},button:{color:{value:"{ams.color.interactive.default}"},cursor:{value:"{ams.cursor.interactive}"},"font-family":{value:"{ams.typography.font-family}"},"font-size":{value:"{ams.typography.body-text.font-size}"},"font-weight":{value:"{ams.typography.body-text.font-weight}"},"line-height":{value:"{ams.typography.body-text.line-height}"},"outline-offset":{value:"calc({ams.focus.outline-offset} * -1)"},"padding-block":{value:"{ams.space.s}"},"padding-inline":{value:"{ams.space.m}"},hover:{"box-shadow":{value:"inset 0 calc({ams.border.width.m} * -1)"},color:{value:"{ams.color.interactive.hover}"}},selected:{"box-shadow":{value:"inset 0 calc({ams.border.width.xl} * -1)"},"font-weight":{value:"{ams.typography.body-text.bold.font-weight}"}},disabled:{color:{value:"{ams.color.interactive.disabled}"},cursor:{value:"{ams.cursor.disabled}"}}}}},v={ams:f};function o(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(m,{tokens:v})]})}function A(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{A as default};
