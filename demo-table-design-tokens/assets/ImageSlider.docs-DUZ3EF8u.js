import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as o}from"./index-CUuWwI6L.js";import{M as a,f as i,P as r,h as l,i as m}from"./blocks-C1WmRPMp.js";import{a as c,R as d}from"./ImageSlider.stories-jaOcDIZ3.js";import{D as u}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";import"./Image-BhsgFmEh.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./Button-BEfb-lkL.js";import"./Icon-B0BHIoDG.js";const h=`<!-- @license CC0-1.0 -->
...
`,p={"image-slider":{gap:{value:"{ams.space.xs}"},scroller:{gap:{value:"{ams.space.xs}"},"outline-offset":{value:"{ams.focus.outline-offset}"}},thumbnails:{gap:{value:"{ams.space.xs}"},thumbnail:{"background-color":{value:"transparent"},cursor:{value:"{ams.cursor.interactive}"},opacity:{value:"40%"},"outline-offset":{value:"{ams.focus.outline-offset}"},"in-view":{opacity:{value:"100%"}},hover:{opacity:{value:"100%"}}}}}},g={ams:p};function t(n){const s={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...o(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(u,{tokens:g})]})}function S(n={}){const{wrapper:s}={...o(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{S as default};
