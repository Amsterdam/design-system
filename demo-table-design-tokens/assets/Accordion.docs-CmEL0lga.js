import{j as e}from"./iframe-w94ru4Ue.js";import{useMDXComponents as a}from"./index-Bq7Cfrvq.js";import{M as i,f as c,P as r,h as d,i as o}from"./blocks-BYunJLRK.js";import{a as h,L as l,E as u,R as m}from"./Accordion.stories-cFJYOd-h.js";import{D as p}from"./DesignTokensTable-BQOGlbBZ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BDwRgOZS.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./Icon-Dxk4cTZn.js";import"./Heading-CmBW4yg6.js";const f=`<!-- @license CC0-1.0 -->
...
`,g={accordion:{gap:{value:"{ams.space.s}"},button:{color:{value:"{ams.color.interactive.default}"},cursor:{value:"{ams.cursor.interactive}"},gap:{value:"{ams.space.s}"},"outline-offset":{value:"{ams.focus.outline-offset}"},"padding-block":{value:"{ams.space.s}"},"padding-inline":{value:"0"},hover:{color:{value:"{ams.color.interactive.hover}"}}}}},x={ams:g};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:h}),`
