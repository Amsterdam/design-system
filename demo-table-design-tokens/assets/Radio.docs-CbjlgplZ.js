import{j as e}from"./iframe-BRapv6FB.js";import{useMDXComponents as t}from"./index-1afWrQwj.js";import{M as s,f as r,P as l,h as d,i as a}from"./blocks-Cl_LkDV9.js";import{a as c,I as h,b as u,W as m}from"./Radio.stories-BwsfPddd.js";import{D as v}from"./DesignTokensTable-CI3e1M8Z.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DleYxqVB.js";const f=`<!-- @license CC0-1.0 -->
...
`,p={radio:{color:{value:"{ams.color.text.default}"},cursor:{value:"{ams.cursor.interactive}"},"font-family":{value:"{ams.typography.font-family}"},"font-size":{value:"{ams.typography.body-text.font-size}"},"font-weight":{value:"{ams.typography.body-text.font-weight}"},gap:{value:"{ams.space.s}"},"line-height":{value:"{ams.typography.body-text.line-height}"},"outline-offset":{value:"{ams.focus.outline-offset}"},"text-decoration-thickness":{value:"{ams.links.text-decoration-thickness}"},"text-underline-offset":{value:"{ams.links.text-underline-offset}"},"checked-indicator":{fill:{value:"{ams.color.interactive.default}"},disabled:{fill:{value:"{ams.color.interactive.disabled}"}},"disabled-invalid":{fill:{value:"{ams.color.interactive.disabled}"},hover:{fill:{value:"{ams.color.interactive.disabled}"}}},hover:{fill:{value:"{ams.color.interactive.hover}"}},invalid:{fill:{value:"{ams.color.interactive.invalid.default}"},hover:{fill:{value:"{ams.color.interactive.invalid.hover}"}}}},"hover-indicator":{hover:{stroke:{value:"{ams.color.interactive.hover}"}},invalid:{hover:{stroke:{value:"{ams.color.interactive.invalid.hover}"}}}},circle:{fill:{value:"{ams.color.background}"},stroke:{value:"{ams.color.interactive.default}"},disabled:{stroke:{value:"{ams.color.interactive.disabled}"}},"disabled-invalid":{stroke:{value:"{ams.color.interactive.disabled}"},hover:{stroke:{value:"{ams.color.interactive.disabled}"}}},hover:{stroke:{value:"{ams.color.interactive.hover}"}},invalid:{stroke:{value:"{ams.color.interactive.invalid.default}"},hover:{stroke:{value:"{ams.color.interactive.invalid.hover}"}}}},disabled:{color:{value:"{ams.color.interactive.disabled}"},cursor:{value:"{ams.cursor.disabled}"}},hover:{color:{value:"{ams.color.interactive.hover}"},"text-decoration-line":{value:"{ams.links.subtle.hover.text-decoration-line}"}},"icon-container":{"block-size":{value:"calc({ams.radio.font-size} * {ams.radio.line-height})"},"inline-size":{value:"{ams.radio.font-size}"}}}},x={ams:p};function n(i){const o={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...t(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(s,{of:c}),`
...
`,e.jsx(v,{tokens:x})]})}function S(i={}){const{wrapper:o}={...t(),...i.components};return o?e.jsx(o,{...i,children:e.jsx(n,{...i})}):n(i)}export{S as default};
