import{j as e}from"./iframe-Dha-7zTR.js";import{useMDXComponents as t}from"./index-CUuWwI6L.js";import{M as i,f as r,P as l,h,i as o}from"./blocks-C1WmRPMp.js";import{L as d,G as m,S as g,a as c,V as u,M as p}from"./Logo.stories-KQmUhd6E.js";import{D as f}from"./DesignTokensTable-DH0a8p0G.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fiaxSpfT.js";import"./Logo-B-BMH_ZW.js";const b=`<!-- @license CC0-1.0 -->
...
`,x={logo:{"block-size":{value:"{ams.space.xl}"},"min-block-size":{value:"2.5rem"},emblem:{color:{value:"#ec0000"}},subsite:{color:{value:"{ams.color.text.default}"}},title:{color:{value:"#ec0000"}}}},w={ams:x};function a(s){const n={h2:"h2",h3:"h3",...t(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:d}),`
...
`,e.jsx(f,{tokens:w})]})}function C(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{C as default};
