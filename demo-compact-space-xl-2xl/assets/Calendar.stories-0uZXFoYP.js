import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./jsx-runtime-Bq1bXGty.js";import{t as r,un as i}from"./src-DRT3jm3H.js";import{c as a,n as o,r as s,s as c,t as l}from"./locale-DkMmhiQY.js";var u=t({DatesWithoutLinks:()=>g,Default:()=>h,__namedExportsOrder:()=>_,default:()=>m}),d,f,p,m,h,g,_,v=e((()=>{r(),c(),d=n(),f=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,p=({onClick:e,...t})=>(0,d.jsx)(`a`,{...t,onClick:t=>{t.preventDefault(),e?.(t)}}),m={title:`Components/Navigation/Calendar`,component:i,args:{linkComponent:p,linkTemplate:e=>`?date=${f(e)}`},argTypes:{...o,defaultMonth:{control:!1},linkComponent:{control:!1},linkTemplate:{control:!1},nextMonthButtonIcon:{control:!1},nextYearButtonIcon:{control:!1},previousMonthButtonIcon:{control:!1},previousYearButtonIcon:{control:!1}},decorators:[l],parameters:{localeVariant:`calendar`},render:e=>(0,d.jsx)(i,{...e,...s(e.locale)})},h={parameters:{docs:{source:{transform:a(`Calendar`,`calendar`,["linkTemplate={(date: Date): string | undefined => `?date=${formatDate(date)}`}"])}}}},g={args:{linkTemplate:e=>e.getDay()===0||e.getDay()===6?void 0:`?date=${f(e)}`},parameters:{docs:{source:{transform:a(`Calendar`,`calendar`,["linkTemplate={(date: Date) =>\n    date.getDay() === 0 || date.getDay() === 6 ? undefined : `?date=${formatDate(date)}`\n  }"])}}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
