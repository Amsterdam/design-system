...
`,(0,k.jsx)(t.h4,{id:`controlling-the-menu`,children:`Controlling the menu`}),`
`,(0,k.jsxs)(t.p,{children:[`By default the Page Header keeps track of whether the collapsible menu is open.
Set `,(0,k.jsx)(t.code,{children:`defaultOpen`}),` to have it open on the first render.`]}),`
`,(0,k.jsxs)(t.p,{children:[`To control the menu yourself, pass `,(0,k.jsx)(t.code,{children:`open`}),` and update it from the `,(0,k.jsx)(t.code,{children:`onOpenChange`}),` callback.
...
`,`
`,(0,k.jsx)(t.pre,{children:(0,k.jsx)(t.code,{className:`language-tsx`,children:`function Header() {
