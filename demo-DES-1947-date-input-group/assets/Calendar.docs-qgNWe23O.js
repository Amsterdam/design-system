...
`,(0,x.jsxs)(r.li,{children:[(0,x.jsx)(r.a,{href:`/docs/components-forms-date-input-group--docs`,children:`Date Input Group`}),` – lets the user type a date they know by heart, one part per field.`]}),`
`]}),`
