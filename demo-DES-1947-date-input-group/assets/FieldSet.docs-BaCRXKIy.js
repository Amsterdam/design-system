...
`,(0,E.jsxs)(r.li,{children:[(0,E.jsx)(r.a,{href:`/docs/components-forms-date-input-group--docs`,children:`Date Input Group`}),` – a set of fields for one date, which a Field Set gathers under a single question.`]}),`
`]}),`
