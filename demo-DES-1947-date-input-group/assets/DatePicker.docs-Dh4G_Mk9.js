...
`,(0,w.jsxs)(r.li,{children:[`Use a `,(0,w.jsx)(r.a,{href:`/docs/components-forms-date-input-group--docs`,children:`Date Input Group`}),` when the user knows the exact date, such as a date of birth, and no calendar is needed.`]}),`
...
`,(0,w.jsxs)(r.li,{children:[(0,w.jsx)(r.a,{href:`/docs/components-forms-date-input-group--docs`,children:`Date Input Group`}),` – lets the user type a date they know by heart, one part per field.`]}),`
