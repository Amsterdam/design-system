import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,d as n,h as r,i,n as a,p as o,u as s}from"./blocks-BFa-eblR.js";import{t as c}from"./jsx-runtime-ATHzeHXA.js";import{i as l,r as u}from"./react-Dyi61YEg.js";import{n as d,t as f}from"./DesignTokensTable-z9GjcalU.js";import{i as p,n as m,r as h,t as g}from"./KnownDateInput.stories-BOPfgSro.js";var _,v;function y(){return(y=e((()=>{_={"known-date-input":{"column-gap":{$value:`{ams.space.m}`,$description:`The space between the fields of the group.`,$extensions:{"nl.amsterdam.hint":`Must be a single value: it sets a longhand property, which takes only one.`,"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"row-gap":{$value:`{ams.space.s}`,$description:`The space between rows of fields, once the group wraps at narrow widths or large text sizes.`,$extensions:{"nl.amsterdam.hint":`Must be a single value: it sets a longhand property, which takes only one.`,"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},field:{"inline-size":{$value:`calc(3ch + (2 * {ams.inputs.padding-inline}) + (2 * {ams.inputs.border-width}))`,$description:"Fits a two-digit value such as a day or a month, with a character to spare for the caret. Includes the padding and border of the input, which sizes itself with `border-box`.",$extensions:{"nl.amsterdam.hint":`Must be a single value: it sets a longhand property, which takes only one.`,"nl.amsterdam.type":`dimension`}},"row-gap":{$value:`{ams.space.s}`,$description:`The space between the label of a field and its input.`,$extensions:{"nl.amsterdam.hint":`Must be a single value: it sets a longhand property, which takes only one.`,"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},wide:{"inline-size":{$value:`calc(5ch + (2 * {ams.inputs.padding-inline}) + (2 * {ams.inputs.border-width}))`,$description:"Fits a four-digit value such as a year, with a character to spare for the caret. Includes the padding and border of the input, which sizes itself with `border-box`.",$extensions:{"nl.amsterdam.hint":`Must be a single value: it sets a longhand property, which takes only one.`,"nl.amsterdam.type":`dimension`}}}}}},v={ams:_}})))()}function b(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(s,{of:g}),`
...
`,(0,S.jsxs)(r.p,{children:[`Compose a Known Date Input from Known Date Input Fields, one for each part of the date.
...
`,(0,S.jsx)(r.p,{children:`Use a Known Date Input for a date the user already knows or can copy from a document in front of them: a date of birth, the expiry date of a passport, the day something happened.
...
`,(0,S.jsxs)(r.p,{children:[`Wrap a Known Date Input in a `,(0,S.jsx)(r.a,{href:`/docs/components-forms-field-set--docs`,children:`Field Set`}),` whose legend asks for the date as a question.
