...
`,(0,A.jsxs)(r.li,{children:[(0,A.jsx)(r.a,{href:`/docs/components-forms-date-input-group--docs`,children:`Date Input Group`}),` – for a date the user knows by heart, in a Text Input per part.`]}),`
