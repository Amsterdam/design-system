...
`,(0,S.jsxs)(r.p,{children:[`Use a `,(0,S.jsx)(r.a,{href:`/docs/components-forms-date-picker--docs`,children:`Date Picker`}),` when the user has to choose a date or a date range from a calendar they can see, such as when booking an appointment.`]}),`
...
`,(0,S.jsxs)(r.li,{children:[(0,S.jsx)(r.a,{href:`/docs/components-forms-date-picker--docs`,children:`Date Picker`}),` – lets the user choose a date from a visible calendar.`]}),`
`,(0,S.jsxs)(r.li,{children:[(0,S.jsx)(r.a,{href:`/docs/components-navigation-calendar--docs`,children:`Calendar`}),` – displays content organised by date in a month view.`]}),`
`]}),`
