...
`,(0,w.jsxs)(r.p,{children:[`Set `,(0,w.jsx)(r.code,{children:`autoComplete`}),` to `,(0,w.jsx)(r.code,{children:`birth-date`}),` for a date of birth, or to `,(0,w.jsx)(r.code,{children:`credit-card-expiry-date`}),` for the expiry date of a payment card, so the browser can fill in a date it already knows.`]}),`
