import{j as e}from"./iframe-BEzdxRAd.js";import{useMDXComponents as i}from"./index-BCW09akW.js";import{M as a,e as l,f as r,h as d,i as o}from"./blocks-mDkjOfhw.js";import{a as m,W as p,b as h,c,d as u,e as g,f}from"./PageHeader.stories-BeSOzQfk.js";import{D as y}from"./DesignTokensTable-Dj9rmPkn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B8ZFiJKu.js";import"./ExampleLogo-DzrvV1XA.js";import"./useIsAfterBreakpoint-DhgLnryU.js";import"./Grid-EqcCrWY7.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-BiV7_6OH.js";import"./BorderSample-C2sdYmsF.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CEB8Ig7T.js";import"./ColorSample-CCmSu4aO.js";import"./SpaceSample-CnxYPU65.js";import"./TypographySample-BvbTVgci.js";const x=`<!-- @license CC0-1.0 -->
...
`,b={"page-header":{"background-color":{$value:"{ams.color.background.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"padding-block":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline":{$value:"{ams.grid.padding-inline}",$type:"dimension",$extensions:{"nl.amsterdam.hint":"Must be the Grid inline padding, to make sure Header and Grid line up.","nl.amsterdam.subtype":"space"}},medium:{"padding-inline":{$value:"{ams.grid.medium.padding-inline}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},wide:{"padding-inline":{$value:"{ams.grid.wide.padding-inline}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},"logo-link":{"column-gap":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},"brand-name":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"}},"mega-menu":{"padding-block":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},button:{cursor:{$value:"{ams.cursor.interactive}"},label:{open:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}}}}},menu:{"column-gap":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"row-gap":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},item:{color:{$value:"{ams.links.color}",$type:"color"},"column-gap":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"}}},link:{gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}}},navigation:{"column-gap":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"row-gap":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}}},w={ams:b};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",strong:"strong",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:m}),`
...
`,e.jsx(y,{tokens:w})]})}function E(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{E as default};
