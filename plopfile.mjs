  ...
  plop.setGenerator('component', {
    ...
    actions: [
      ...
      },
      {
        type: 'add',
        data: { curlyBefore: '{' },
        path: 'storybook/storybook-react/src/react-components/{{pascalCase name}}/{{pascalCase name}}.docs.mdx',
        templateFile: 'plop-templates/storybook.docs.mdx.hbs',
      },
      {
        type: 'add',
        path: 'storybook/storybook-react/src/react-components/{{pascalCase name}}/{{pascalCase name}}.stories.tsx',
