import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{H as r,P as i,U as a,X as o,c as s,k as c,v as l,y as u}from"./index.esm-DcdAjKyb.js";import{r as d,t as f}from"./Overlap.stories-CR6A1EdX.js";import{m as p,s as m}from"./exampleContent-DsZ2XVq0.js";import{n as h,t as g}from"./commonMeta-DIyg6bfx.js";var _,v,y;function b(){return(b=e((()=>{p(),_={title:`Direct naar`,tasks:[{title:`Gemeentebelastingen`,description:`Bekijk welke belastingen en heffingen er zijn, hoe u bezwaar maakt of een betalingsregeling treft.`},{title:`Parkeren + Reizen (P+R)`,description:`U kunt met uw auto goedkoop parkeren bij een P+R-locatie aan de rand van de stad.`},{title:`Paspoort, ID-kaart en rijbewijs`,description:`Vraag deze bewijzen aan of verleng ze. Geef een vermissing aan.`},{title:`Onderwijs`,description:`Meld een kind aan voor basisschool, middelbare school of kinderopvang. Bekijk het kindtegoed op uw Stadspas.`},{title:`Meldingen openbare ruimte en overlast`,description:`Ziet u op straat of in een park iets waarvan u wilt dat het gemaakt of opgeruimd wordt, dan kunt u dat bij de gemeente melden.`},{title:`Verhuizing doorgeven`,description:`Geef uw nieuwe adres door als u binnen Amsterdam of naar Amsterdam verhuist.`},{title:`Grof afval`,description:`Grof afval zijn spullen die niet in een vuilniszak passen.`},{title:`Kennisgevingen en bekendmakingen`,description:`Kennisgevingen en bekendmakingen van de gemeente Amsterdam van de laatste 8 weken.`}]},v=[{title:`Ontheffing of vergunning`,description:`Check welke ontheffing of vergunning u nodig heeft. Bijvoorbeeld een RVV, TVM, objectvergunning, nachtwerkontheffing, e-RVV, e-TVM of filmmelding. Dat regelt u allemaal met 1 formulier.`,link:`Eenvoudig regelen`},{title:`Werkzaamheden`,description:`Lees waar en wanneer we werken aan nieuwbouw, groot onderhoud, herinrichting van straten en wegen, aanpak van parken of ontwikkeling van hele gebieden.`,link:`Alle bouw- en verkeerswerkzaamheden`}],y={title:`Nieuws`,items:[{title:`Waarom we op zoek zijn naar vleermuizen`,description:`U kunt ’s avonds ecologen in oranje hesjes tegenkomen. Zij zijn op zoek naar vleermuizen. Dat heeft te maken met het verduurzamen van woningen.`,image:m(640,360,0)},{title:`Meer aandacht voor voetgangers, een jaar lang`,description:`We gaan de veiligheid voor voetgangers verbeteren, meer ruimte maken, en lopen en wandelen stimuleren.`,image:m(640,360,1)},{title:`Nieuwe manieren om afval op te halen`,description:`Afvalboten, bakfietsen en ondergrondse containers. We experimenteren met nieuwe manieren om afval op te halen in het centrum.`,image:m(640,360,2)}]}})))()}var x=t({Default:()=>w,__namedExportsOrder:()=>T,default:()=>C}),S,C,w,T;function E(){return(E=e((()=>{o(),d(),h(),b(),S=n(),C={...g,title:`Pages/Public/Home Page`,render:e=>(0,S.jsxs)(`main`,{id:`inhoud`,children:[(0,S.jsx)(`h1`,{className:`ams-visually-hidden`,children:`Homepage van de gemeente Amsterdam`}),(0,S.jsx)(c,{children:f.args?.children}),(0,S.jsxs)(l,{paddingVertical:`x-large`,children:[(0,S.jsx)(l.Cell,{span:`all`,children:(0,S.jsx)(u,{level:2,size:`level-1`,children:_.title})}),_.tasks.map(({title:e,description:t})=>(0,S.jsx)(l.Cell,{span:{narrow:4,medium:4,wide:3},children:(0,S.jsxs)(s,{children:[(0,S.jsx)(s.Heading,{level:3,children:(0,S.jsx)(s.Link,{href:`#`,children:e})}),(0,S.jsx)(i,{children:t})]})},e))]}),(0,S.jsx)(r,{children:(0,S.jsx)(l,{paddingVertical:`x-large`,children:v.map(({title:e,description:t,link:n})=>(0,S.jsxs)(l.Cell,{className:`ams-prose`,span:{narrow:4,medium:4,wide:6},children:[(0,S.jsx)(u,{color:`inverse`,level:2,size:`level-3`,children:e}),(0,S.jsx)(i,{color:`inverse`,children:t}),(0,S.jsx)(a,{color:`inverse`,href:`#`,children:n})]},e))})}),(0,S.jsxs)(l,{paddingBottom:`2x-large`,paddingTop:`x-large`,children:[(0,S.jsx)(l.Cell,{span:`all`,children:(0,S.jsx)(u,{level:2,size:`level-1`,children:y.title})}),y.items.map(({title:e,description:t,image:n})=>(0,S.jsx)(l.Cell,{span:4,children:(0,S.jsxs)(s,{children:[(0,S.jsx)(s.Image,{alt:``,src:n}),(0,S.jsx)(s.HeadingGroup,{tagline:`Nieuws`,children:(0,S.jsx)(s.Heading,{level:3,children:(0,S.jsx)(s.Link,{href:`#`,children:e})})}),(0,S.jsx)(i,{children:t})]})},e))]})]})},w={parameters:{docs:{source:{code:`// The Skip Link in the Page Layout targets this id, so the next Tab press lands in the main content.
<main id="inhoud">
  {/*
...
}`,...w.parameters?.docs?.source}}},T=[`Default`]})))()}export{E as n,x as t};