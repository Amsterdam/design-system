import{n as e}from"./chunk-zsgVPwQN.js";import{t}from"./jsx-runtime-GmyBfqKJ.js";import{I as n,y as r}from"./index.esm-6Mm6hKCe.js";import{M as i,j as a,t as o,x as s}from"./src-DVAS6rfi.js";import c,{n as l,t as u}from"./PageHeader.stories-BWmEhpBJ.js";var d,f,p,m,h,g;e((()=>{n(),o(),a(),l(),d=t(),{expect:f}=__STORYBOOK_MODULE_TEST__,p={...c,title:`Components/Containers/Page Header`},m=u,h={args:{brandName:`Data Amsterdam`,children:(0,d.jsx)(`p`,{children:`test`}),menuItems:[(0,d.jsx)(s.MenuLink,{href:`#`,lang:`en`,children:`English`},`1`),(0,d.jsx)(s.MenuLink,{fixed:!0,href:`#`,children:`Zoeken`},`2`)]},play:async({canvas:e,userEvent:t})=>{let n=(await e.findByTestId(`interaction-test`)).querySelector(`button`),r=await e.findByTestId(`children`);n&&(await t.click(n),f(r).toBeVisible(),await t.click(n),f(r).not.toBeVisible())},render:e=>(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(s,{"data-testid":`interaction-test`,...e,children:(0,d.jsx)(`ul`,{children:(0,d.jsx)(`li`,{"data-testid":`children`,children:`English`})})}),Object.keys(m).filter(e=>e!==`__namedExportsOrder`).sort().map(e=>{let t=m[e];return t?(0,d.jsx)(s,{...t.args},e):null}),i.map(e=>(0,d.jsx)(s,{brandName:`Voorbeeld`,logoBrand:e,menuItems:(0,d.jsx)(s.MenuLink,{fixed:!0,href:`#`,icon:r,children:`Inloggen`})},e))]}),tags:[`!dev`,`!autodocs`]},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
