import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-BrayXyei.js";import{r as n}from"./react-oCAR5XSR.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-DaShEQua.js";import{n as l,t as u}from"./DesignTokensTable-CJgajNVN.js";import{t as d}from"./mdx-react-shim-9Tyt82po.js";import{Confirmation as f,n as p,t as m}from"./Dialog.stories-CoSaM00l.js";var h,g=e((()=>{h=`<!-- @license CC0-1.0 -->
...
`})),_,v,y=e((()=>{_={dialog:{"background-color":{$value:`{ams.color.background}`,$type:`color`},"border-color":{$value:`{ams.dialog.background-color}`,$type:`color`},"border-radius":{$value:`initial`},"border-style":{$value:`solid`,$extensions:{"nl.amsterdam.type":`borderStyle`}},"border-width":{$value:`{ams.border.width.m}`,$extensions:{"nl.amsterdam.type":`borderWidth`}},"box-shadow":{$value:`initial`},gap:{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"inline-size":{$value:`calc(100% - 2 * {ams.space.l})`,$type:`dimension`},"max-block-size":{$value:`calc(100dvh - 2 * {ams.space.l})`,$type:`dimension`},"max-inline-size":{$value:{value:48,unit:`rem`},$type:`dimension`},medium:{"inline-size":{$deprecated:"Use `ams.dialog.vi-medium.inline-size` instead. Will be removed in release 6.0.0.",$value:`calc(100% - 2 * {ams.space.xl})`,$type:`dimension`},"max-block-size":{$deprecated:"Use `ams.dialog.vi-medium.max-block-size` instead. Will be removed in release 6.0.0.",$value:`calc(100dvh - 2 * {ams.space.xl})`,$type:`dimension`}},"vi-medium":{"inline-size":{$value:`calc(100% - 2 * {ams.space.xl})`,$type:`dimension`},"max-block-size":{$value:`calc(100dvh - 2 * {ams.space.xl})`,$type:`dimension`}},backdrop:{"background-color":{$value:`rgb(24 24 24 / 62.5%)`,$type:`color`}},header:{gap:{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.space.l} 0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},medium:{"padding-block":{$deprecated:"Use `ams.dialog.header.vi-medium.padding-block` instead. Will be removed in release 6.0.0.",$value:`{ams.space.xl} 0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$deprecated:"Use `ams.dialog.header.vi-medium.padding-inline` instead. Will be removed in release 6.0.0.",$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},"vi-medium":{"padding-block":{$value:`{ams.space.xl} 0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}},body:{"padding-block":{$value:`0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},medium:{"padding-inline":{$deprecated:"Use `ams.dialog.body.vi-medium.padding-inline` instead. Will be removed in release 6.0.0.",$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},"vi-medium":{"padding-inline":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}},footer:{"padding-block":{$value:`0 {ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},medium:{"padding-block":{$deprecated:"Use `ams.dialog.footer.vi-medium.padding-block` instead. Will be removed in release 6.0.0.",$value:`0 {ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$deprecated:"Use `ams.dialog.footer.vi-medium.padding-inline` instead. Will be removed in release 6.0.0.",$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},"vi-medium":{"padding-block":{$value:`0 {ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}}}},v={ams:_}}));function b(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(r,{of:m}),`
