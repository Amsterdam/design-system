import{j as e}from"./iframe-CQ8Fim-Q.js";import{useMDXComponents as i}from"./index-B88p3tdP.js";import{M as s}from"./blocks-QfNyGfHm.js";import{H as t}from"./HomePage.stories-NGbtFVyh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bn3K6qHB.js";/*@license CC0-1.0*/function o(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(s,{of:t}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`<Page hasMenu>
...
`,e.jsxs(n.p,{children:[`One instance, for narrow and medium windows, sits in the Page Header.
The user can access it through the menu button.
Hide the menu button on wide windows through the `,e.jsx(n.code,{children:"GridCellNarrowWindowOnly"})," subcomponent."]}),`
`,e.jsxs(n.p,{children:[`A second Menu should go between the Page Header and the main content.
