import{r as l,j as e,c as d,F as u,t as m,P as g}from"./iframe-DG_xAW1O.js";const i=l.forwardRef(({className:p,...c},n)=>e.jsx("input",{...c,className:d("ams-file-input",p),ref:n,type:"file"}));i.displayName="FileInput";try{i.displayName="FileInput",i.__docgenInfo={description:"",displayName:"FileInput",props:{}}}catch{}const F={title:"Components/Forms/File Input",component:i,args:{accept:void 0,disabled:!1,multiple:!1},argTypes:{accept:{control:{type:"text"}},disabled:{control:{type:"boolean"}},multiple:{control:{type:"boolean"}}}},r={},a={args:{multiple:!0}},s={args:{accept:"application/pdf"}},t={args:{disabled:!0}},o={render:p=>e.jsxs(u,{children:[e.jsx(m,{htmlFor:"input1",children:"Label"}),e.jsx(g,{id:"description1",children:"Omschrijving."}),e.jsx(i,{"aria-describedby":"description1",id:"input1",...p})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:"{}",...r.parameters?.docs?.source}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    multiple: true
  }
