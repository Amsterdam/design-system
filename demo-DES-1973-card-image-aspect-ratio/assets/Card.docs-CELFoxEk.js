...
Set `,(0,M.jsx)(r.code,{children:`objectFit`}),` to `,(0,M.jsx)(r.code,{children:`cover`}),` to fill the area instead, which crops the image.
...
`,(0,M.jsxs)(r.p,{children:[`The image fits inside that area by default and keeps all of it in view, against the same background colour it shows while it loads.
Cropping an image is a decision, so it is asked for rather than assumed.
A set of Cards whose images should reach the edges is what `,(0,M.jsx)(r.code,{children:`objectFit`}),` is for.`]}),`
