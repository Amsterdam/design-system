...
Its `,(0,M.jsx)(r.code,{children:`aspectRatio`}),` sets the shape of the image itself.
A Card defaults that shape to 16 by 9 through a Card-specific token.
Give every Card in the same set the same value, so they all end up the same size.
Set `,(0,M.jsx)(r.code,{children:`objectFit`}),` to `,(0,M.jsx)(r.code,{children:`contain`}),` to keep the full source in view instead of the default cover fit.
...
`,(0,M.jsxs)(r.p,{children:[`A source whose proportions differ from the shape the Card gives its image fills that shape by default, losing whatever falls outside it.
Set `,(0,M.jsx)(r.code,{children:`objectFit`}),` to `,(0,M.jsx)(r.code,{children:`contain`}),` to keep all of it in view instead.
...
`,(0,M.jsxs)(r.p,{children:[`A Card gives its image a default aspect ratio of 16 by 9 through a Card-specific token.
That default keeps a row of Cards visually consistent without extra configuration.
The image fills and crops to that shape by default, so cards in one set keep the same visual rhythm.
Use `,(0,M.jsx)(r.code,{children:`objectFit="contain"`}),` when keeping all of the source in view is the intended visual choice.`]}),`
