...
Set `,(0,M.jsx)(r.code,{children:`objectFit`}),` to `,(0,M.jsx)(r.code,{children:`contain`}),` to keep the full image in view instead of the default cover fit.
...
`,(0,M.jsxs)(r.p,{children:[`An image whose proportions differ from the shape the Card gives its image fills that shape by default, losing whatever falls outside it.
...
Use `,(0,M.jsx)(r.code,{children:`objectFit="contain"`}),` when keeping all of the image in view is the intended visual choice.`]}),`
