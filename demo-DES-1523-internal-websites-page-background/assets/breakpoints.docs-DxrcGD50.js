import{j as e}from"./iframe-Xd7uzhxY.js";import{useMDXComponents as t}from"./index-B82-zH9j.js";import{M as i}from"./blocks-7dCo0Pcy.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DXlc6_cV.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
To complement, the `,e.jsx(n.a,{href:"/docs/components-containers-page--docs",children:"Page"}),` container component sets a maximum width of 90rem, which is 1.440 pixels = 40 + 5 × 280.
...
`,e.jsxs(n.p,{children:["We leave out the ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@media#media_types",rel:"nofollow",children:"media type"}),` so that our media queries work for both screens and paged media.
