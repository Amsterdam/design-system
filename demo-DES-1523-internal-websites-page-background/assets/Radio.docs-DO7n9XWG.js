import{j as e}from"./iframe-B0iA3o5g.js";import{useMDXComponents as s}from"./index-B7MVSzpL.js";import{M as a,e as r,f as l,h as d,i as t}from"./blocks-BtklZZUV.js";import{a as c,I as h,b as m,W as u}from"./Radio.stories-LBJhRhUn.js";import{D as p}from"./DesignTokensTable-Cao_Fdqw.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CQ-FHSDw.js";import"./BorderSample-4crMMrJP.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CVRCR9av.js";import"./ColorSample-DeFYHeFm.js";import"./SpaceSample-DGMjMrid.js";import"./TypographySample-I9tadZwi.js";const v=`<!-- @license CC0-1.0 -->
...
`,f={radio:{color:{$value:"{ams.color.text.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"checked-indicator":{fill:{$value:"{ams.color.interactive.default}",$type:"color"},disabled:{fill:{$value:"{ams.color.interactive.disabled}",$type:"color"}},"disabled-invalid":{fill:{$value:"{ams.color.interactive.disabled}",$type:"color"},hover:{fill:{$value:"{ams.color.interactive.disabled}",$type:"color"}}},hover:{fill:{$value:"{ams.color.interactive.hover}",$type:"color"}},invalid:{fill:{$value:"{ams.color.interactive.invalid.default}",$type:"color"},hover:{fill:{$value:"{ams.color.interactive.invalid.hover}",$type:"color"}}}},"hover-indicator":{hover:{stroke:{$value:"{ams.color.interactive.hover}",$type:"color"}},invalid:{hover:{stroke:{$value:"{ams.color.interactive.invalid.hover}",$type:"color"}}}},circle:{fill:{$value:"{ams.color.background.default}",$type:"color"},stroke:{$value:"{ams.color.interactive.default}",$type:"color"},disabled:{stroke:{$value:"{ams.color.interactive.disabled}",$type:"color"}},"disabled-invalid":{stroke:{$value:"{ams.color.interactive.disabled}",$type:"color"},hover:{stroke:{$value:"{ams.color.interactive.disabled}",$type:"color"}}},hover:{stroke:{$value:"{ams.color.interactive.hover}",$type:"color"}},invalid:{stroke:{$value:"{ams.color.interactive.invalid.default}",$type:"color"},hover:{stroke:{$value:"{ams.color.interactive.invalid.hover}",$type:"color"}}}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}},hover:{color:{$value:"{ams.color.interactive.hover}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}},"icon-container":{"block-size":{$value:"calc({ams.radio.font-size} * {ams.radio.line-height})",$type:"dimension"},"inline-size":{$value:"{ams.radio.font-size}",$type:"dimension"}}}},x={ams:f};function n(i){const o={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...s(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(p,{tokens:x})]})}function D(i={}){const{wrapper:o}={...s(),...i.components};return o?e.jsx(o,{...i,children:e.jsx(n,{...i})}):n(i)}export{D as default};
