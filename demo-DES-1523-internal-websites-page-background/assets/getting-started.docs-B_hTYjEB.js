import{j as e}from"./iframe-SiuXPIqw.js";import{useMDXComponents as o}from"./index-BUv9YYhy.js";import{M as r}from"./blocks-DbJTd1aB.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CvJO4BBo.js";function n(t){const s={a:"a",code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
export default App
`})}),`
`,e.jsx(s.h2,{id:"body-class",children:"Body class"}),`
`,e.jsxs(s.p,{children:["Add the ",e.jsx(s.code,{children:"ams-body"})," ",e.jsx(s.a,{href:"/docs/utilities-css-body--docs",children:"class name"})," to your document’s ",e.jsx(s.code,{children:"<body>"}),` tag.
...
Check our `,e.jsx(s.a,{href:"https://github.com/Amsterdam/design-system/blob/develop/CONTRIBUTING.md",rel:"nofollow",children:"Contributing guidelines"})," when you start."]})]})}function h(t={}){const{wrapper:s}={...o(),...t.components};return s?e.jsx(s,{...t,children:e.jsx(n,{...t})}):n(t)}export{h as default};
