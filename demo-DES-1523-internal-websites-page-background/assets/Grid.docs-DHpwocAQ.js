import{j as e}from"./iframe-B2pI3tXX.js";import{useMDXComponents as i}from"./index-Bz4wP8ro.js";import{M as a,e as l,f as r,h as d,i as s}from"./blocks-BCJZ_QlI.js";import{G as c,V as h,a as p,S as m,b as u,c as g,d as x,B as w,I as j}from"./Grid.stories-ChcS3EKD.js";import{D as f}from"./DesignTokensTable-BEHEMpIi.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CFgaUZn4.js";import"./GridColumnsGuide-CZNDt_VS.js";import"./Grid-C6djv56R.js";import"./gridCellClasses-DKw8XbSK.js";import"./Grid.argTypes-CfqFMx79.js";import"./Paragraph-DnIAup9A.js";import"./BorderSample-D3ssNGnS.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-0lGLLW2u.js";import"./ColorSample-D6fUxzqH.js";import"./SpaceSample-2TaQ9ckL.js";import"./TypographySample-Cc6i3FZp.js";const y=`<!-- @license CC0-1.0 -->
...
`,e.jsx(n.p,{children:`In Compact Mode, the page background is light grey.
...
`,e.jsxs(n.p,{children:["Use the ",e.jsx(n.code,{children:"transparent"}),` appearance to let a cell blend into the page background instead.
This also removes the padding.`]}),`
`,e.jsxs(n.p,{children:[`In Spacious Mode, the large spacing between cells is enough to tell them apart, so cells are always transparent and without padding.
The `,e.jsx(n.code,{children:"appearance"})," prop has no effect there."]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note"}),": that’s why this example appears best with the ‘Compact theme’ turned on in the toolbar above."]}),`
`,e.jsx(s,{of:w}),`
...
`,e.jsx(f,{tokens:b})]})}function R(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{R as default};
