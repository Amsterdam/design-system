import{j as e}from"./iframe-XFXYebUe.js";import{useMDXComponents as i}from"./index-B7pSibrX.js";import{M as a,e as l,f as d,h as r,i as s}from"./blocks-BirhGbbr.js";import{G as c,V as h,a as p,S as m,b as u,c as g,d as x,B as w,I as f}from"./Grid.stories-D2WUFaYY.js";import{D as j}from"./DesignTokensTable-CJ-X9ke2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CeJtUUqq.js";import"./common-HRWYXPjp.js";import"./Grid-Dsk1u_sp.js";import"./gridCellClasses-DKw8XbSK.js";import"./Paragraph-CzfuHYwD.js";import"./BorderSample-BqcmwheG.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-XHFmJhNL.js";import"./ColorSample-X3qn83dq.js";import"./SpaceSample-CGGTppNx.js";import"./TypographySample-B66kc5fV.js";const v=`<!-- @license CC0-1.0 -->
...
`,y={grid:{"column-count":{$value:"4"},"column-gap":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},"padding-inline":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"row-gap":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},medium:{"column-count":{$value:"8"},"padding-inline":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},wide:{"column-count":{$value:"12"},"padding-inline":{$value:"{ams.space.2xl}",$type:"dimension","background-color":{value:"initial"},$extensions:{"nl.amsterdam.subtype":"space"}}},cell:{"background-color":{$value:"initial"},"padding-block":{$value:"initial"},"padding-inline":{$value:"initial"}}}},b={ams:y};function o(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(s,{of:x}),`
`,e.jsx(n.h3,{id:"background-in-compact-mode",children:"Background in Compact Mode"}),`
`,e.jsx(n.p,{children:`In Compact Mode, cells have a white background and padding to clearly set them apart.
This is because the limited white space makes it more difficult to distinguish cells from each other.`}),`
`,e.jsx(n.p,{children:`Cells can be made transparent, such as the one with the the Breadcrumb and Heading.
This removes the padding as well.`}),`
`,e.jsx(n.p,{children:`The ‘flush’ appearance only removes the padding, keeping the white background.
This is useful for components that need to fit edge-to-edge inside the cell but do benefit from the white background, like a Table.`}),`
`,e.jsx(n.p,{children:"In Spacious Mode, cells are always transparent and without padding; this prop has no effect."}),`
`,e.jsx(s,{of:w}),`
...
`,e.jsx(j,{tokens:b})]})}function L(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{L as default};
