import{j as e}from"./iframe-B0iA3o5g.js";import{useMDXComponents as a}from"./index-B7MVSzpL.js";import{M as i,e as o,f as r,h as m}from"./blocks-BtklZZUV.js";import{a as p}from"./Page.stories-BIHTPWT-.js";import{D as l}from"./DesignTokensTable-Cao_Fdqw.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CQ-FHSDw.js";import"./BorderSample-4crMMrJP.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CVRCR9av.js";import"./ColorSample-DeFYHeFm.js";import"./SpaceSample-DGMjMrid.js";import"./TypographySample-I9tadZwi.js";const d=`<!-- @license CC0-1.0 -->
...
`,c={page:{"background-color":{$value:"{ams.color.background.body}",$type:"color"},"max-inline-size":{$value:{value:90,unit:"rem"},$type:"dimension"},"with-menu":{"max-inline-size":{$value:{value:120,unit:"rem"},$type:"dimension"},"area-skip-link":{"margin-inline-end":{$value:"{ams.grid.padding-inline}",$type:"dimension",$extensions:{"nl.amsterdam.hint":"Must be the Grid inline padding, to make sure Skip Link and Grid line up.","nl.amsterdam.subtype":"space"}}}}}},h={ams:c};function s(t){const n={a:"a",h2:"h2",h3:"h3",p:"p",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:p}),`
