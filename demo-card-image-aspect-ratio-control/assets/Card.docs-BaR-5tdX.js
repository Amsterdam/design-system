import{j as e}from"./iframe-Ct2azXav.js";import{useMDXComponents as i}from"./index-BBJVCPmA.js";import{M as o,e as r,f as d,i as t}from"./blocks-BXMRX2jg.js";import{a as l,W as c,b as p,T as m}from"./Card.stories-CbH8nbqZ.js";import{D as h}from"./DesignTokensTable-C1lVB0jY.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ChznUZH3.js";import"./types-CjGn4A4T.js";import"./exampleContent-D2tKGi5u.js";import"./formatDate-HeD_AkCg.js";import"./Heading-83CX3dEJ.js";import"./getHeadingTag-Dv1eMqvl.js";import"./Paragraph-3WZzKEl8.js";import"./Image-CEMc6DKB.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./BorderSample-BuyIAZuu.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-DCGvgaP2.js";import"./ColorSample-BfU4Ycvl.js";import"./SpaceSample-DX5_9qk4.js";import"./TypographySample-BGjMmFLq.js";const g=`<!-- @license CC0-1.0 -->
...
`,u={card:{heading:{"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},"heading-group":{gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},image:{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},link:{color:{$value:"{ams.links.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}},x={ams:u};function s(a){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...i(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(h,{tokens:x})]})}function U(a={}){const{wrapper:n}={...i(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(s,{...a})}):s(a)}export{U as default};
