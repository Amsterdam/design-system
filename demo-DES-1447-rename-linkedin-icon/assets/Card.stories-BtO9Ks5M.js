import{r as g,j as e,c as m,P as d,C as _,G as l}from"./iframe-DhKSZybA.js";import{f as w}from"./common-DrnyCu3t.js";import{k as x}from"./exampleContent-DRope23M.js";import{H as y}from"./Heading-Bmcs1GT3.js";import{P as H}from"./Paragraph-D6ekePPG.js";import{I as b}from"./Image-BhlHAFr6.js";const C=g.forwardRef(({children:r,className:n,size:i="level-3",...s},h)=>e.jsx(y,{...s,className:m("ams-card__heading",n),ref:h,size:i,children:r}));C.displayName="Card.Heading";try{Card.Heading.displayName="Card.Heading",Card.Heading.__docgenInfo={description:"",displayName:"Card.Heading",props:{level:{defaultValue:null,description:"The hierarchical level within the document.",name:"level",required:!0,type:{name:"enum",value:[{value:"1"},{value:"3"},{value:"4"},{value:"2"}]}},size:{defaultValue:{value:"level-3"},description:`Uses larger or smaller text without changing its position in the heading hierarchy.
