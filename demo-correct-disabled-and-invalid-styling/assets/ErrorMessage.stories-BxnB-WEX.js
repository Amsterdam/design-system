import{r as d,j as o,c as p,x as u,y as g}from"./iframe-CL47HroO.js";import{I as f}from"./Icon-DeIcakc5.js";const s=d.forwardRef(({children:n,className:c,icon:t,prefix:i="Invoerfout",...l},m)=>o.jsxs("p",{...l,className:p("ams-error-message",c),ref:m,children:[o.jsx(f,{svg:t||u}),o.jsxs("span",{className:"ams-visually-hidden",children:[i,": "]}),n]}));s.displayName="ErrorMessage";try{s.displayName="ErrorMessage",s.__docgenInfo={description:"",displayName:"ErrorMessage",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"Function"}},prefix:{defaultValue:{value:"Invoerfout"},description:"An accessible phrase that screen readers announce before the error message. Should translate to something like ‘input error’.",name:"prefix",required:!1,type:{name:"string"}}}}}catch{}/**
 * @license EUPL-1.2+
