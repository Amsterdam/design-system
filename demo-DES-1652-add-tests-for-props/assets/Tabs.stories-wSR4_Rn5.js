import{r as n,j as a,c as g,H as P,P as I,aq as l}from"./iframe-Pj6X5Xd2.js";import{l as w,c as _}from"./exampleContent-D2tKGi5u.js";import{u as k}from"./useKeyboardFocus-CO72QOjh.js";const S={activeTabId:void 0,updateTab:()=>{}},C=n.createContext(S),N=n.forwardRef(({"aria-controls":e,children:s,className:t,onClick:i,...r},d)=>{const{activeTabId:h,updateTab:c}=n.useContext(C),b=f=>{i?.(f),!f.defaultPrevented&&n.startTransition(()=>{c(e)})};return a.jsxs("button",{"aria-controls":e,"aria-selected":h===e,className:g("ams-tabs__button",t),id:`button-${e}`,onClick:b,ref:d,role:"tab",tabIndex:h===e?0:-1,type:"button",...r,children:[a.jsx("span",{"aria-hidden":"true",className:"ams-tabs__button-label-hidden",children:s}),a.jsx("span",{className:"ams-tabs__button-label",children:s})]})});N.displayName="Tabs.Button";try{Tabs.Button.displayName="Tabs.Button",Tabs.Button.__docgenInfo={description:"",displayName:"Tabs.Button",props:{"aria-controls":{defaultValue:null,description:`The identifier of the corresponding tab panel.
