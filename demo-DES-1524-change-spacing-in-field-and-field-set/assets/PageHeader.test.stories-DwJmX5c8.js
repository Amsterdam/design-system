import{j as e}from"./iframe-G1BLKbqC.js";import{r as o}from"./renderComponentVariants-DIbGwndY.js";import{m as c,P as a}from"./PageHeader.stories-BVe56o_T.js";import"./preload-helper-PPVm8Dsz.js";import"./useIsAfterBreakpoint-C_T_fL_Y.js";import"./Grid-Ck3OuF-L.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-DHVA4SPM.js";import"./Logo-5g63y6Fn.js";const{expect:d}=__STORYBOOK_MODULE_TEST__,H={...c,title:"Components/Containers/Page Header"},n={args:{brandName:"Data Amsterdam",children:e.jsx("p",{children:"test"}),menuItems:[e.jsx(a.MenuLink,{href:"#",lang:"en",children:"English"},"1"),e.jsx(a.MenuLink,{fixed:!0,href:"#",children:"Zoeken"},"2")]},play:async({canvas:t,userEvent:i})=>{const r=(await t.findByTestId("interaction-test")).querySelector("button"),s=await t.findByTestId("children");r&&(await i.click(r),d(s).toBeVisible(),await i.click(r),d(s).not.toBeVisible())},render:t=>e.jsxs(e.Fragment,{children:[e.jsx(a,{"data-testid":"interaction-test",...t,children:e.jsx("ul",{children:e.jsx("li",{"data-testid":"children",children:"English"})})}),o(a,{args:t})]}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
