...
}`,...(u=(g=m.parameters)==null?void 0:g.docs)==null?void 0:u.source}}};var x,C,f;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    children: [<Footer.Top key="footer-top">
        <Heading className="ams-visually-hidden" inverseColor>
          Colofon
...
}`,...(f=(C=d.parameters)==null?void 0:C.docs)==null?void 0:f.source}}};const T=["Default","Onderzoek"],J=Object.freeze(Object.defineProperty({__proto__:null,Default:m,Onderzoek:d,__namedExportsOrder:T,default:O},Symbol.toStringTag,{value:"Module"}));export{m as D,J as F,d as O};
