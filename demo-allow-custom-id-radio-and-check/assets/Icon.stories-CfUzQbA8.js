import{j as a}from"./jsx-runtime-Cf8x2fCZ.js";import{b as m,H as z}from"./index.esm-CMapxPh_.js";import{i as g,I as c}from"./Icon-Pril9caF.js";import{I as d,e as h}from"./index.esm-D3RaMjqb.js";import{R as p}from"./Row-JeNeYdOs.js";import{P as S}from"./Paragraph-BDLeQ91t.js";const f={title:"Components/Media/Icon",component:c,args:{svg:h},argTypes:{color:{control:{labels:{undefined:"default"},type:"radio"},options:[void 0,"inverse"]},size:{control:{labels:{undefined:"default"},type:"select"},options:[void 0,...g]},svg:{control:{type:"select"},mapping:d,options:Object.keys(d)}}},s={},o={argTypes:{size:{control:{labels:{undefined:"medium (default)"}},options:["small",void 0,"large"]}},render:e=>{const r=e.size,u=l=>l===void 0?"Regular":l.charAt(0).toUpperCase()+l.slice(1);return a.jsxs(p,{gap:"small",children:[a.jsx(c,{...e}),a.jsxs(S,{color:e.color,size:r,children:[u(r)," body text"]})]})}},n={args:{size:"heading-3"},argTypes:{size:{options:[...g.filter(e=>e.startsWith("heading-"))]}},render:e=>{const r=e.size?e.size.slice(-1):"3";return a.jsxs(p,{gap:"small",children:[a.jsx(c,{...e}),r==="0"?a.jsxs(m,{color:e.color,children:["Heading ",r," text"]}):a.jsxs(z,{color:e.color,level:1,size:`level-${r}`,children:["Heading ",r," text"]})]})}},i={args:{square:!0}},t={args:{color:"inverse"}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{}",...s.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  argTypes: {
    size: {
      control: {
        labels: {
...
}`,...t.parameters?.docs?.source}}};const x=["Default","WithBodyText","WithAHeading","Square","InverseColour"],R=Object.freeze(Object.defineProperty({__proto__:null,Default:s,InverseColour:t,Square:i,WithAHeading:n,WithBodyText:o,__namedExportsOrder:x,default:f},Symbol.toStringTag,{value:"Module"}));export{R as I,i as S,o as W,n as a,t as b};
