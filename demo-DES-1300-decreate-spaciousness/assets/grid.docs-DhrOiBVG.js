...
`,e.jsxs(t.p,{children:["The gap between columns uses our ",e.jsx(t.code,{children:"xl"})," space token, which grows from 36 to 56 pixels in windows between 320 and 1440 pixels wide."]}),`
...
`,e.jsx(t.p,{children:`For websites, the maximum width of the grid is 1248 pixels.
