...
`,(0,x.jsxs)(t.p,{children:[`Different navigation icons can be used through the `,(0,x.jsx)(t.code,{children:`*ButtonIcon`}),` props, which each take the same value as the `,(0,x.jsx)(t.a,{href:`/docs/components-media-icon--docs`,children:`Icon`}),` component’s `,(0,x.jsx)(t.code,{children:`svg`}),` prop.
