import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./jsx-runtime-BCDDjCIb.js";import{H as r,P as i,Y as a,i as o,v as s,y as c}from"./index.esm-CuM8JI5w.js";import{C as l,S as u,T as d,t as f,w as p}from"./src-DyZenj6c.js";import{d as m,i as h,t as g}from"./argTypes-CX0Ca9AC.js";import{m as _,u as v}from"./exampleContent-CFoxZuYq.js";import{i as y,t as b}from"./decorators-D2PgmKKc.js";var x=e({Default:()=>T,HighlightContent:()=>E,__namedExportsOrder:()=>D,default:()=>w}),S,C,w,T,E,D,O=t((()=>{a(),f(),l(),m(),b(),_(),S=n(),C=v(),w={title:`Components/Containers/Spotlight`,component:u,argTypes:{as:g(d),color:h(p,`purple`)},decorators:[y]},T={render:({as:e,color:t})=>(0,S.jsx)(u,{as:e,color:t,children:(0,S.jsx)(s,{paddingVertical:`x-large`,children:(0,S.jsx)(s.Cell,{span:`all`,children:(0,S.jsx)(o,{color:!t||[`azure`,`green`,`magenta`].includes(t)?`inverse`:void 0,children:C})})})})},E={args:{color:`green`},render:({color:e})=>{let t=[`lime`,`orange`,`yellow`],n=t.includes(e)?void 0:`inverse`,a=t.includes(e)?`contrast`:`inverse`;return(0,S.jsx)(u,{color:e,children:(0,S.jsx)(s,{paddingVertical:`x-large`,children:(0,S.jsxs)(s.Cell,{span:{narrow:4,medium:5,wide:7},children:[(0,S.jsx)(c,{className:`ams-mb-s`,color:n,level:2,size:`level-3`,children:`Steun geven aan een partij`}),(0,S.jsx)(i,{className:`ams-mb-m`,color:n,children:`Van 19 januari tot en met 2 februari kunt u uw steun geven aan een partij voor de gemeenteraad of een stadsdeel- of bestuurscommissie. Dit doet u met een ondersteuningsverklaring.`}),(0,S.jsx)(r,{color:a,href:`#`,children:`Ondersteuningsverklaring inleveren`})]})})})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: ({
    as,
    color
