import{r as k,j as r,c as B,F as w,s as D,P as $,E as H}from"./iframe-C5QqADL7.js";import{b as G}from"./exampleContent-r-zRGsZY.js";const a=k.forwardRef(({className:e,dir:W,invalid:q,resize:p,...u},C)=>r.jsx("textarea",{...u,"aria-invalid":q||void 0,className:B("ams-text-area",p&&`ams-text-area--resize-${p}`,u.cols&&"ams-text-area--cols",e),dir:W??"auto",ref:C}));a.displayName="TextArea";try{a.displayName="TextArea",a.__docgenInfo={description:"",displayName:"TextArea",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}},resize:{defaultValue:null,description:"Allows the user to resize the text box. The default is resizing in both directions.",name:"resize",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"horizontal"'},{value:'"vertical"'}]}}}}}catch{}const J=G(),K={title:"Components/Forms/Text Area",component:a,args:{defaultValue:J,disabled:!1,invalid:!1},argTypes:{cols:{control:{type:"number"},description:"The width, expressed in the average number of characters."},defaultValue:{table:{disable:!0}},disabled:{description:"Prevents interaction. Avoid if possible."},resize:{control:{labels:{horizontal:"horizontal",none:"none",undefined:"default",vertical:"vertical"},type:"radio"},options:[void 0,"none","horizontal","vertical"]},rows:{control:{type:"number"},description:"The number of lines to show"}}},i={},s={args:{resize:"vertical"}},o={args:{resize:"horizontal"}},t={args:{resize:"none"}},n={args:{invalid:!0}},l={args:{disabled:!0}},d={render:e=>r.jsxs(w,{invalid:e.invalid,children:[r.jsx(D,{htmlFor:"input1",children:"Label"}),r.jsx($,{id:"description1",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(H,{id:"error1",children:"Foutmelding."}),r.jsx(a,{"aria-describedby":`description1${e.invalid?" error1":""}`,id:"input1",...e})]})},c={args:{invalid:!0},render:e=>r.jsxs(w,{invalid:e.invalid,children:[r.jsx(D,{htmlFor:"input2",children:"Label"}),r.jsx($,{id:"description2",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(H,{id:"error2",children:"Foutmelding."}),r.jsx(a,{"aria-describedby":`description2${e.invalid?" error2":""}`,id:"input2",...e})]})};var m,g,v;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:"{}",...(v=(g=i.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,b,x;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    resize: 'vertical'
  }
...
}`,...(M=(O=c.parameters)==null?void 0:O.docs)==null?void 0:M.source}}};const Q=["Default","VerticalResize","HorizontalResize","NoResize","Invalid","Disabled","InAField","InAFieldWithValidation"],Y=Object.freeze(Object.defineProperty({__proto__:null,Default:i,Disabled:l,HorizontalResize:o,InAField:d,InAFieldWithValidation:c,Invalid:n,NoResize:t,VerticalResize:s,__namedExportsOrder:Q,default:K},Symbol.toStringTag,{value:"Module"}));export{l as D,o as H,n as I,t as N,Y as T,s as V,d as a,c as b};
