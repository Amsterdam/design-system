import{r as c,j as e,c as f}from"./iframe-C5QqADL7.js";import{H as C}from"./Heading-D5rILqqr.js";const m=c.forwardRef(({children:t,className:a,label:s,...l},r)=>e.jsxs("li",{className:"ams-table-of-contents__item",children:[e.jsx("a",{...l,className:f("ams-table-of-contents__link",a),ref:r,children:s}),t]}));m.displayName="TableOfContents.Link";try{TableOfContents.Link.displayName="TableOfContents.Link",TableOfContents.Link.__docgenInfo={description:"",displayName:"TableOfContents.Link",props:{label:{defaultValue:null,description:"The text for the link.",name:"label",required:!0,type:{name:"string"}}}}}catch{}const T=c.forwardRef(({children:t,className:a,...s},l)=>e.jsx("ul",{...s,className:f("ams-table-of-contents__list",a),ref:l,children:t}));T.displayName="TableOfContents.List";try{TableOfContents.List.displayName="TableOfContents.List",TableOfContents.List.__docgenInfo={description:"",displayName:"TableOfContents.List",props:{}}}catch{}const u=c.forwardRef(({children:t,className:a,heading:s,headingLevel:l=2,...r},O)=>e.jsxs("nav",{...r,className:f("ams-table-of-contents",a),ref:O,children:[s&&e.jsx(C,{className:"ams-table-of-contents__heading",level:l,size:"level-4",children:s}),t]}));u.displayName="TableOfContents";const n=Object.assign(u,{Link:m,List:T});try{n.displayName="TableOfContents",n.__docgenInfo={description:"",displayName:"TableOfContents",props:{heading:{defaultValue:null,description:"The text for the Heading.",name:"heading",required:!1,type:{name:"string"}},headingLevel:{defaultValue:{value:"2"},description:`The hierarchical level of the Heading within the document.
...
}`,...(L=(k=o.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};const j=["Default","MultipleLevels"],v=Object.freeze(Object.defineProperty({__proto__:null,Default:i,MultipleLevels:o,__namedExportsOrder:j,default:g},Symbol.toStringTag,{value:"Module"}));export{o as M,v as T};
