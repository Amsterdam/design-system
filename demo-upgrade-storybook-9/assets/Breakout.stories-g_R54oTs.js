import{r as k,j as e,c as y,$ as T,a0 as C,P as p,a as b}from"./iframe-CmHy-vHF.js";import{g as V}from"./common-DYX7ZGrz.js";import{a as i,p as N}from"./paddingClasses-BhwbQ8nP.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const q=(a,t,l,o)=>[...i("ams-breakout__cell--col-span-",a),...i("ams-breakout__cell--col-start-",t),...i("ams-breakout__cell--row-span-",l),...i("ams-breakout__cell--row-start-",o)],x=k.forwardRef(({as:a="div",children:t,className:l,colSpan:o,colStart:d,has:u,rowSpan:c,rowStart:m,...B},j)=>e.jsx(a,{...B,className:y("ams-breakout__cell",q(o,d,c,m),u&&`ams-breakout__cell--has-${u}`,l),ref:j,children:t}));x.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(S=(v=s.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};const z=["Default","VerticalLayout"],L=Object.freeze(Object.defineProperty({__proto__:null,Default:n,VerticalLayout:s,__namedExportsOrder:z,default:P},Symbol.toStringTag,{value:"Module"}));export{L as B,s as V};
