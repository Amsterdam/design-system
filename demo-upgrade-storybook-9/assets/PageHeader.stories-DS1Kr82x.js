import{r as o,j as e,c as t,G as d,a3 as r,H as x}from"./iframe-De3IwJlC.js";import{G as re}from"./Grid-BL7BTFhA.js";import{I as ie}from"./Icon-Y2wn-Sy7.js";import{L as se}from"./Logo-CKvP_GaJ.js";const F=o.forwardRef(({children:a,className:n,...l},s)=>e.jsx(re.Cell,{...l,className:t("ams-page-header__grid-cell-narrow-window-only",n),ref:s,children:a}));F.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(K=($=f.parameters)==null?void 0:$.docs)==null?void 0:K.source}}};const de=["Default","WithMovingLinks","WithoutMenuButtonOnWideWindow","WithoutMenuButton","WithCustomLogoLink","WithCustomTexts"],he=Object.freeze(Object.defineProperty({__proto__:null,Default:c,WithCustomLogoLink:L,WithCustomTexts:f,WithMovingLinks:h,WithoutMenuButton:p,WithoutMenuButtonOnWideWindow:g,__namedExportsOrder:de,default:te},Symbol.toStringTag,{value:"Module"}));export{he as P,h as W,g as a,p as b,L as c,f as d};
