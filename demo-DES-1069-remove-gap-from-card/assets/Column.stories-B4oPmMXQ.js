import{j as e}from"./jsx-runtime-j_jdvEMj.js";import{H as i,d as l,P as d}from"./index.esm-D8PFa1_D.js";import{m as A,c as S}from"./types-B5YJ6HHW.js";import{c as L}from"./clsx-B-dksMZM.js";import{r as T}from"./index-B-o1Wr-g.js";const o=T.forwardRef(({align:t,alignHorizontal:m,as:N="div",children:H,className:_,gap:c,...w},z)=>e.jsx(N,{...w,ref:z,className:L("ams-column",t&&`ams-column--align-${t}`,m&&`ams-column--align-horizontal-${m}`,c&&`ams-column--gap-${c}`,_),children:H}));o.displayName="Column";try{o.displayName="Column",o.__docgenInfo={description:"",displayName:"Column",props:{align:{defaultValue:{value:"start"},description:"The vertical alignment of the items in the column.",name:"align",required:!1,type:{name:"enum",value:[{value:'"center"'},{value:'"end"'},{value:'"between"'},{value:'"around"'},{value:'"evenly"'}]}},alignHorizontal:{defaultValue:{value:"stretch"},description:"The horizontal alignment of the items in the column.",name:"alignHorizontal",required:!1,type:{name:"enum",value:[{value:'"center"'},{value:'"end"'},{value:'"start"'}]}},as:{defaultValue:{value:"div"},description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},gap:{defaultValue:{value:"medium"},description:"The amount of space between items.",name:"gap",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"small"'},{value:'"large"'},{value:'"extra-small"'},{value:'"extra-large"'}]}}}}}catch{}const P=[e.jsx("div",{className:"ams-docs-item"},0),e.jsx("div",{className:"ams-docs-item"},1),e.jsx("div",{className:"ams-docs-item"},2)],V={title:"Components/Layout/Column",component:o,args:{children:P,className:"ams-docs-column"},argTypes:{align:{control:{type:"radio",labels:{undefined:"start"}},options:[void 0,...A]},alignHorizontal:{control:{type:"radio",labels:{undefined:"stretch"}},options:[void 0,...S]},className:{table:{disable:!0}},gap:{control:{type:"radio",labels:{undefined:"medium"}},options:["none","extra-small","small",void 0,"large","extra-large"]}}},a={},n={args:{align:"center"}},r={args:{alignHorizontal:"center"}},s={args:{as:"section",children:[e.jsx(i,{level:3,children:"Zoekresultaten"}),e.jsxs(l,{children:[e.jsx(i,{className:"ams-mb--sm",level:4,children:e.jsx(l.Link,{href:"#",children:"Nieuwe manieren om afval op te halen"})}),e.jsx(d,{children:"Afvalboten, bakfietsen en ondergrondse containers. We experimenteren met nieuwe manieren om afval op te halen in het centrum."})]},1),e.jsxs(l,{children:[e.jsx(i,{className:"ams-mb--sm",level:4,children:e.jsx(l.Link,{href:"#",children:"Verlenging proef ophalen afval per boot"})}),e.jsx(d,{children:"Een proef met het anders ophalen van afval. We halen vuilniszakken hier op met kleine wagentjes, kleine vuilniswagens en een afvalboot."})]},2)],className:void 0}};var u,p,g;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:"{}",...(g=(p=a.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var v,h,f;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    align: 'center'
  }
}`,...(f=(h=n.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var x,b,k;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    alignHorizontal: 'center'
  }
}`,...(k=(b=r.parameters)==null?void 0:b.docs)==null?void 0:k.source}}};var j,y,C;s.parameters={...s.parameters,docs:{...(j=s.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    as: 'section',
...
}`,...(C=(y=s.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};const E=["Default","Alignment","HorizontalAlignment","ImproveSemantics"],D=Object.freeze(Object.defineProperty({__proto__:null,Alignment:n,Default:a,HorizontalAlignment:r,ImproveSemantics:s,__namedExportsOrder:E,default:V},Symbol.toStringTag,{value:"Module"}));export{n as A,D as C,r as H,s as I};
