import{j as e}from"./iframe-RMwqzCzd.js";import{useMDXComponents as t}from"./index-g2PnwlIS.js";import{M as r,f as l,P as a,h as d,i as s}from"./blocks-DJIONqt2.js";import{a as h,E as c,W as p,P as u,b as m,D as f,S as x,I as b,c as y,d as j,e as g}from"./TextInput.stories-DPoJc-iE.js";import{D as v}from"./DesignTokensTable-DTNttNzm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D3qruZMH.js";import"./FontDesignToken-fiDH8YNd.js";import"./ColorSample-BFMKLB7P.js";const w=`<!-- @license CC0-1.0 -->
...
`,k={"text-input":{"background-color":{$value:"{ams.inputs.background-color}",$type:"color"},"border-color":{$value:"{ams.inputs.border-color}",$type:"color"},"border-style":{$value:"{ams.inputs.border-style}",$extensions:{"ams.type":"borderStyle"}},"border-width":{$value:"{ams.inputs.border-width}",$extensions:{"ams.type":"borderWidth"}},color:{$value:"{ams.inputs.color}",$type:"color"},"font-family":{$value:"{ams.inputs.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.inputs.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.inputs.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$type:"number"},"outline-offset":{$value:"{ams.inputs.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.inputs.padding-block}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.inputs.padding-inline}",$extensions:{"ams.type":"paddingInline"}},disabled:{color:{$value:"{ams.inputs.disabled.color}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}",$extensions:{"ams.type":"cursor"}}},hover:{"box-shadow":{$value:"{ams.inputs.hover.box-shadow}",$extensions:{"ams.type":"boxShadow"}}},invalid:{"border-color":{$value:"{ams.inputs.invalid.border-color}",$type:"color"},hover:{"border-color":{$value:"{ams.inputs.invalid.hover.border-color}",$type:"color"},"box-shadow":{$value:"{ams.inputs.invalid.hover.box-shadow}",$extensions:{"ams.type":"boxShadow"}}}},placeholder:{color:{$value:"{ams.inputs.placeholder.color}",$type:"color"}}}},T={ams:k};function o(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:h}),`
...
`,e.jsx(v,{tokens:T})]})}function W(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{W as default};
