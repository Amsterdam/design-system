import{j as e}from"./iframe-Cqm9YVuc.js";import{useMDXComponents as i}from"./index-D77Bi88w.js";import{M as l,f as a,P as r,h as d,i as n}from"./blocks-ywNNy8rQ.js";import{a as c,M as p,R as u,D as m,I as h}from"./FileInput.stories-BeH2fwLk.js";import{D as b}from"./DesignTokensTable-B2rM_yD9.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ck7w4tC1.js";import"./FontDesignToken-DXxbLhxP.js";import"./ColorSample-BV1MJyw7.js";const f=`<!-- @license CC0-1.0 -->
...
`,x={"file-input":{"background-color":{$value:"{ams.inputs.background-color}",$type:"color"},"border-color":{$value:"{ams.inputs.border-color}",$type:"color"},"border-style":{$value:"dashed",$extensions:{"ams.type":"borderStyle"}},"border-width":{$value:"{ams.inputs.border-width}",$extensions:{"ams.type":"borderWidth"}},color:{$value:"{ams.inputs.color}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},"font-family":{$value:"{ams.inputs.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.inputs.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.inputs.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$extensions:{"ams.type":"lineHeight"}},"outline-offset":{$value:"{ams.inputs.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.space.m}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.space.m}",$extensions:{"ams.type":"paddingInline"}},disabled:{color:{$value:"{ams.inputs.disabled.color}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}",$extensions:{"ams.type":"cursor"}}},"file-selector-button":{"background-color":{$value:"{ams.button.secondary.background-color}",$type:"color"},"border-color":{$value:"{ams.button.secondary.border-color}",$type:"color"},"border-style":{$value:"{ams.button.border-style}",$extensions:{"ams.type":"borderStyle"}},"border-width":{$value:"{ams.button.border-width}",$extensions:{"ams.type":"borderWidth"}},color:{$value:"{ams.button.secondary.color}",$type:"color"},cursor:{$value:"{ams.button.cursor}",$extensions:{"ams.type":"cursor"}},"line-height":{$value:"{ams.button.line-height}",$extensions:{"ams.type":"lineHeight"}},"margin-inline-end":{$value:"{ams.space.m}",$extensions:{"ams.type":"marginInline"}},"padding-block":{$value:"{ams.button.padding-block}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.button.padding-inline}",$extensions:{"ams.type":"paddingInline"}},disabled:{color:{$value:"{ams.button.secondary.disabled.color}",$type:"color"},cursor:{$value:"{ams.button.disabled.cursor}",$extensions:{"ams.type":"cursor"}}},hover:{"box-shadow":{$value:"{ams.button.secondary.hover.box-shadow}",$extensions:{"ams.type":"boxShadow"}},color:{$value:"{ams.button.secondary.hover.color}",$type:"color"}}}}},y={ams:x};function t(s){const o={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(l,{of:c}),`
...
`,e.jsx(b,{tokens:y})]})}function D(s={}){const{wrapper:o}={...i(),...s.components};return o?e.jsx(o,{...s,children:e.jsx(t,{...s})}):t(s)}export{D as default};
