import{j as o}from"./iframe-BALby5yE.js";import{useMDXComponents as a}from"./index-DigZJdeW.js";import{M as s,f as c,P as l,h as i,i as t}from"./blocks-DGMKRjY7.js";import{I as u,C as d,a as m}from"./IconButton.stories-DZzm9PXp.js";import{D as h}from"./DesignTokensTable-BjYYN-kx.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wx_JZNvQ.js";import"./Icon-9kUVvs9h.js";import"./IconButton-CMH-1WpS.js";import"./BorderSample-BnihSK68.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-bHEagSZ7.js";import"./TypographySample-BIQDxljR.js";const p=`<!-- @license CC0-1.0 -->
...
`,v={"icon-button":{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},hover:{"background-color":{$value:"rgb(0 70 153 / 12.5%)",$type:"color"},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}},contrast:{color:{$value:"{ams.color.interactive.contrast}",$type:"color"},hover:{"background-color":{$value:"rgb(0 0 0 / 12.5%)",$type:"color"},color:{$value:"{ams.color.interactive.contrast}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"}}},inverse:{"background-color":{$value:"{ams.color.interactive.default}",$type:"color"},color:{$value:"{ams.color.interactive.inverse}",$type:"color"},hover:{"background-color":{$value:"{ams.color.interactive.hover}",$type:"color"},color:{$value:"{ams.color.interactive.inverse}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.inverse}",$type:"color"},"background-color":{$value:"{ams.color.interactive.disabled}",$type:"color"}}}}},b={ams:v};function r(n){const e={a:"a",h2:"h2",h3:"h3",h4:"h4",p:"p",...a(),...n.components};return o.jsxs(o.Fragment,{children:[`
`,`
`,`
`,`
`,o.jsx(s,{of:u}),`
...
`,o.jsx(h,{tokens:b})]})}function A(n={}){const{wrapper:e}={...a(),...n.components};return e?o.jsx(e,{...n,children:o.jsx(r,{...n})}):r(n)}export{A as default};
