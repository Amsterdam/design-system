import{j as e}from"./iframe-Cqm9YVuc.js";import{useMDXComponents as a}from"./index-D77Bi88w.js";import{M as i,f as o,P as r,h as m,i as l}from"./blocks-ywNNy8rQ.js";import{a as p,W as d}from"./Page.stories-B54rlBU9.js";import{D as c}from"./DesignTokensTable-B2rM_yD9.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ck7w4tC1.js";import"./FontDesignToken-DXxbLhxP.js";import"./ColorSample-BV1MJyw7.js";const h=`<!-- @license CC0-1.0 -->
...
`,u={page:{"background-color":{$value:"{ams.color.background}",$type:"color"},"max-inline-size":{$value:{value:90,unit:"rem"},$type:"dimension"},"with-menu":{"max-inline-size":{$value:{value:120,unit:"rem"},$type:"dimension"},"area-skip-link":{"margin-inline-end":{$value:"{ams.grid.padding-inline}",comment:"Must be the Grid inline padding, to make sure Skip Link and Grid line up",$extensions:{"ams.type":"marginInline"}}}}}},g={ams:u};function s(t){const n={a:"a",h2:"h2",h3:"h3",p:"p",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:p}),`
...
`,e.jsx(c,{tokens:g})]})}function C(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{C as default};
