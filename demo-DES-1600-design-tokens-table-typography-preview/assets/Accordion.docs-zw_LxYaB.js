import{j as e}from"./iframe-Cqm9YVuc.js";import{useMDXComponents as a}from"./index-D77Bi88w.js";import{M as i,f as c,P as r,h as d,i as o}from"./blocks-ywNNy8rQ.js";import{a as h,L as l,E as m,R as u}from"./Accordion.stories-DQm9h3Yi.js";import{D as p}from"./DesignTokensTable-B2rM_yD9.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ck7w4tC1.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./Icon-DvBpLhwU.js";import"./Heading-D1i2tzNh.js";import"./FontDesignToken-DXxbLhxP.js";import"./ColorSample-BV1MJyw7.js";const f=`<!-- @license CC0-1.0 -->
...
`,g={accordion:{gap:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},gap:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.space.s}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"0",$type:"number"},hover:{color:{$value:"{ams.color.interactive.hover}",$type:"color"}}}}},x={ams:g};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:h}),`
...
`,e.jsx(p,{tokens:x})]})}function R(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{R as default};
