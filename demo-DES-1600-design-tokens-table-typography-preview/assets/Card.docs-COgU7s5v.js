import{j as e}from"./iframe-BALby5yE.js";import{useMDXComponents as s}from"./index-DigZJdeW.js";import{M as o,f as r,P as d,i as t}from"./blocks-DGMKRjY7.js";import{a as l,W as c,b as h,T as p}from"./Card.stories-lKUVk93q.js";import{D as m}from"./DesignTokensTable-BjYYN-kx.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wx_JZNvQ.js";import"./common-HRWYXPjp.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-Nurfx4xZ.js";import"./Paragraph-LaX8xUi3.js";import"./Image-C4jXPk27.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./BorderSample-BnihSK68.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-bHEagSZ7.js";import"./TypographySample-BIQDxljR.js";const g=`<!-- @license CC0-1.0 -->
...
`,u={card:{heading:{"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension"}},"heading-group":{gap:{$value:"{ams.space.xs}",$type:"dimension"},"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension"}},image:{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension"}},link:{color:{$value:"{ams.links.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension"},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"}}},x={ams:u};function i(a){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...s(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(m,{tokens:x})]})}function S(a={}){const{wrapper:n}={...s(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(i,{...a})}):i(a)}export{S as default};
