import{j as e}from"./iframe-Cqm9YVuc.js";import{useMDXComponents as a}from"./index-D77Bi88w.js";import{M as i,f as r,P as l,h as c,i as o}from"./blocks-ywNNy8rQ.js";import{a as u,W as h,C as d}from"./SearchField.stories-DxxUK7hN.js";import{D as p}from"./DesignTokensTable-B2rM_yD9.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ck7w4tC1.js";import"./Button-DiUyCb3h.js";import"./Icon-DvBpLhwU.js";import"./FontDesignToken-DXxbLhxP.js";import"./ColorSample-BV1MJyw7.js";const m=`<!-- @license CC0-1.0 -->
...
`,f={"search-field":{input:{"background-color":{$value:"{ams.inputs.background-color}",$type:"color"},"border-color":{$value:"{ams.inputs.border-color}",$type:"color"},"border-style":{$value:"{ams.inputs.border-style}",$extensions:{"ams.type":"borderStyle"}},"border-width":{$value:"{ams.inputs.border-width}",$extensions:{"ams.type":"borderWidth"}},color:{$value:"{ams.inputs.color}",$type:"color"},"font-family":{$value:"{ams.inputs.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.inputs.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.inputs.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$extensions:{"ams.type":"lineHeight"}},"outline-offset":{$value:"{ams.inputs.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.inputs.padding-block}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.inputs.padding-inline}",$extensions:{"ams.type":"paddingInline"}},hover:{"box-shadow":{$value:"{ams.inputs.hover.box-shadow}",$extensions:{"ams.type":"boxShadow"}}},invalid:{"border-color":{$value:"{ams.inputs.invalid.border-color}",$type:"color"},hover:{"border-color":{$value:"{ams.inputs.invalid.hover.border-color}",$type:"color"},"box-shadow":{$value:"{ams.inputs.invalid.hover.box-shadow}",$extensions:{"ams.type":"boxShadow"}}}},"cancel-button":{"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23004699' fill-rule='evenodd' d='M29.333 5.47 26.53 2.668 16 13.187 5.47 2.666 2.668 5.47 13.187 16 2.666 26.53l2.804 2.803L16 18.813l10.53 10.52 2.803-2.804L18.813 16z'/></svg>")`,$extensions:{"ams.type":"background"}},"block-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"blockSize"}},color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},"inline-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"inlineSize"}}},placeholder:{color:{$value:"{ams.inputs.placeholder.color}",$type:"color"}}}}},y={ams:f};function s(n){const t={h2:"h2",h3:"h3",p:"p",...a(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:u}),`
...
`,e.jsx(p,{tokens:y})]})}function S(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{S as default};
