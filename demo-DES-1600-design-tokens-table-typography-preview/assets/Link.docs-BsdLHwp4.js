import{j as e}from"./iframe-B-hL_0Ik.js";import{useMDXComponents as s}from"./index-wwsLrtBb.js";import{M as r,f as a,P as l,h as c,i as t}from"./blocks-D50KQJvQ.js";import{a as h,C as d,I as u}from"./Link.stories-CDVQpbWV.js";import{D as p}from"./DesignTokensTable-D8sl-jCk.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dz7aTctx.js";import"./BorderSample-MMWi1tqo.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-_eJkxoIo.js";import"./TypographySample-B8VxI2pN.js";const m=`<!-- @license CC0-1.0 -->
...
`,k={link:{color:{$value:"{ams.links.color}",$type:"color"},"font-family":{$value:"inherit",$type:"color"},"font-size":{$value:"inherit",$type:"color"},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"inherit",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension"},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-thickness":{$value:"{ams.links.hover.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.hover.text-underline-offset}",$type:"dimension"}},contrast:{color:{$value:"{ams.links.contrast.color}",$type:"color"},hover:{color:{$value:"{ams.links.contrast.hover.color}",$type:"color"}}},inverse:{color:{$value:"{ams.links.inverse.color}",$type:"color"},hover:{color:{$value:"{ams.links.inverse.hover.color}",$type:"color"}}}}},g={ams:k};function i(o){const n={a:"a",h2:"h2",h3:"h3",h4:"h4",p:"p",...s(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:h}),`
...
`,e.jsx(p,{tokens:g})]})}function W(o={}){const{wrapper:n}={...s(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{W as default};
