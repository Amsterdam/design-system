import{j as e}from"./iframe-BALby5yE.js";import{useMDXComponents as t}from"./index-DigZJdeW.js";import{M as a,f as l,P as r,h as d,i as s}from"./blocks-DGMKRjY7.js";import{G as c,V as h,a as p,S as m,b as u,c as x,d as g,I as w}from"./Grid.stories-C6pOZVBS.js";import{D as f}from"./DesignTokensTable-BjYYN-kx.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Wx_JZNvQ.js";import"./common-HRWYXPjp.js";import"./Grid-BhfTbfTA.js";import"./gridCellClasses-DKw8XbSK.js";import"./BorderSample-BnihSK68.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-bHEagSZ7.js";import"./TypographySample-BIQDxljR.js";const j=`<!-- @license CC0-1.0 -->
...
`,v={grid:{"column-count":{$value:"4"},"column-gap":{$value:"{ams.space.xl}",$type:"dimension"},"padding-block":{l:{$value:"{ams.space.l}",$type:"dimension"},xl:{$value:"{ams.space.xl}",$type:"dimension"},"2xl":{$value:"{ams.space.2xl}",$type:"dimension"}},"padding-inline":{$value:"{ams.space.l}",$type:"dimension"},"row-gap":{l:{$value:"{ams.space.l}",$type:"dimension"},xl:{$value:"{ams.space.xl}",$type:"dimension"},"2xl":{$value:"{ams.space.2xl}",$type:"dimension"}},medium:{"column-count":{$value:"8"},"padding-inline":{$value:"{ams.space.xl}",$type:"dimension"}},wide:{"column-count":{$value:"12"},"padding-inline":{$value:"{ams.space.2xl}",$type:"dimension"}}}},y={ams:v};function i(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...t(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(f,{tokens:y})]})}function V(o={}){const{wrapper:n}={...t(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{V as default};
