import{j as e}from"./iframe-B-hL_0Ik.js";import{useMDXComponents as s}from"./index-wwsLrtBb.js";import{M as a,f as l,P as d,h as r,i as o}from"./blocks-D50KQJvQ.js";import{a as m,W as h,b as p,c,d as u,e as g}from"./PageHeader.stories-BTPdUP-A.js";import{D as f}from"./DesignTokensTable-D8sl-jCk.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dz7aTctx.js";import"./useIsAfterBreakpoint-DiczGdcX.js";import"./Grid-DyBFYQq_.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-BapNMd1v.js";import"./Logo-B2hvVVQq.js";import"./BorderSample-MMWi1tqo.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-_eJkxoIo.js";import"./TypographySample-B8VxI2pN.js";const y=`<!-- @license CC0-1.0 -->
...
`,x={"page-header":{"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"padding-block":{$value:"{ams.space.l}",$type:"dimension"},"padding-inline":{$value:"{ams.grid.padding-inline}",$type:"dimension",$extension:{"amsterdam.designsystem.hint":"Must be the Grid inline padding, to make sure Header and Grid line up."}},medium:{"padding-inline":{$value:"{ams.grid.medium.padding-inline}",$type:"dimension"}},wide:{"padding-inline":{$value:"{ams.grid.wide.padding-inline}",$type:"dimension"}},"logo-link":{"column-gap":{$value:"{ams.space.m}",$type:"dimension"},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"}},"brand-name":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"}},"mega-menu":{"padding-block":{$value:"{ams.space.l}",$type:"dimension"},button:{cursor:{$value:"{ams.cursor.interactive}"},label:{open:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}}}}},menu:{"column-gap":{$value:"{ams.space.l}",$type:"dimension"},"row-gap":{$value:"{ams.space.xs}",$type:"dimension"},item:{color:{$value:"{ams.links.color}",$type:"color"},"column-gap":{$value:"{ams.space.xs}",$type:"dimension"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},"padding-block":{$value:"{ams.space.xs}",$type:"dimension"},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"}}},link:{gap:{$value:"{ams.space.xs}",$type:"dimension"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension"},hover:{"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}}},navigation:{"column-gap":{$value:"{ams.space.l}",$type:"dimension"},"row-gap":{$value:"{ams.space.l}",$type:"dimension"}}}},w={ams:x};function i(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:m}),`
...
`,e.jsx(f,{tokens:w})]})}function N(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{N as default};
