import{j as e}from"./iframe-Cqm9YVuc.js";import{useMDXComponents as r}from"./index-D77Bi88w.js";import{M as o,f as a,P as d,h as c,i as s}from"./blocks-ywNNy8rQ.js";import{a as l,W as h,b as p,I as m}from"./Field.stories-vBxJ5oAx.js";import{D as x}from"./DesignTokensTable-B2rM_yD9.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ck7w4tC1.js";import"./exampleContent-Du2yH2Fl.js";import"./FontDesignToken-DXxbLhxP.js";import"./ColorSample-BV1MJyw7.js";const u=`<!-- @license CC0-1.0 -->
...
`,j={field:{gap:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}",$type:"color"},"padding-inline-start":{$value:"{ams.space.m}",$extensions:{"ams.type":"paddingInline"}}}}},f={ams:j};function t(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...r(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(x,{tokens:f})]})}function S(i={}){const{wrapper:n}={...r(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{S as default};
