import{j as e}from"./iframe-DtVPNwUD.js";import{useMDXComponents as s}from"./index-BK9GSsbI.js";import{M as l}from"./blocks-rPTaCQg3.js";import"./index-0Oe5E7MT.js";/*@license CC0-1.0*/function n(i){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
From that point and beyond, it has 12 columns.`}),`
`,e.jsx(t.p,{children:"We refer to these 3 variants as the narrow, medium, and wide grid."}),`
`,e.jsx(t.p,{children:`The columns get narrower or wider around these breakpoints.
This affects the size of the elements placed on them.
The width and height of rows and columns, as well as white space around them, change linearly.`}),`
...
`,e.jsx(t.p,{children:`For websites, the maximum width of the grid is 1260 pixels.
The grid has this width in windows of at least 1440 pixels wide – the margins are 90 pixels here.`}),`
...
`]})]})}function c(i={}){const{wrapper:t}={...s(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(n,{...i})}):n(i)}export{c as default};
