import{j as e}from"./jsx-runtime-CKrituN3.js";import{R as d,n as m}from"./index.esm-CoBoxnIb.js";const p={title:"Components/Forms/Switch",component:d,args:{disabled:!1},argTypes:{disabled:{control:"boolean"}}},r={args:{"aria-label":"Default"}},a={decorators:[t=>e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"5rem"},children:e.jsx(t,{})})],render:t=>e.jsxs(e.Fragment,{children:[e.jsx(m,{htmlFor:"switch-with-label",children:"Label"}),e.jsx(d,{...t,id:"switch-with-label"})]})};var s,o,l;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    'aria-label': 'Default'
  }
