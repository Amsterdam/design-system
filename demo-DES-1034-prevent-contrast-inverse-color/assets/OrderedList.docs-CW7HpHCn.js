...
Therefore, it does not define typography for the items and the `,e.jsx(n.code,{children:"color"})," prop to ",e.jsx(n.code,{children:"inverse"})," has no effect."]}),`
