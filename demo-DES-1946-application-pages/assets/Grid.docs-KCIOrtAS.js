...
`,(0,N.jsx)(r.h4,{id:`sizing-and-placement`,children:`Sizing and placement`}),`
...
`,(0,N.jsx)(r.h4,{id:`meaningful-elements`,children:`Meaningful elements`}),`
...
A Grid or a Cell can be an `,(0,N.jsx)(r.code,{children:`article`}),` or a `,(0,N.jsx)(r.code,{children:`section`}),` too, among the other tags `,(0,N.jsx)(r.code,{children:`as`}),` offers.`]}),`
...
`,(0,N.jsxs)(r.p,{children:[`Give a Grid or a Subgrid `,(0,N.jsx)(r.code,{children:`as="ul"`}),` and the Cells inside it `,(0,N.jsx)(r.code,{children:`as="li"`}),` where those Cells hold the same kind of thing, such as a set of Cards.
‘Semantic list of cards’ below shows how.`]}),`
`,(0,N.jsx)(r.h4,{id:`reading-order`,children:`Reading order`}),`
...
`,(0,N.jsx)(a,{of:v}),`
`,(0,N.jsx)(r.h3,{id:`semantic-list-of-cards`,children:`Semantic list of cards`}),`
`,(0,N.jsxs)(r.p,{children:[`A set of Cells that hold the same kind of thing is a list: news items, search results, a row of Cards.
Render the Grid or the Subgrid around them as an `,(0,N.jsx)(r.code,{children:`ol`}),` or a `,(0,N.jsx)(r.code,{children:`ul`}),`, and every Cell inside it as an `,(0,N.jsx)(r.code,{children:`li`}),`.`]}),`
`,(0,N.jsxs)(r.p,{children:[`That element then holds those items and nothing else.
A heading above the set or a `,(0,N.jsx)(r.a,{href:`/docs/components-navigation-pagination--docs`,children:`Pagination`}),` below it is not one of them, so each goes in a Cell of its own outside the list.
A Subgrid is usually the one to reach for, since a Grid tends to carry that heading as well.`]}),`
`,(0,N.jsx)(r.p,{children:`Where the set is only part of a wider region, give it a Subgrid of its own inside that region’s Subgrid.
A Subgrid inside a Subgrid still hands down the columns of the page, and takes the same row gap.`}),`
`,(0,N.jsxs)(r.p,{children:[`A list looks exactly like a `,(0,N.jsx)(r.code,{children:`div`}),`: it drops the marker, the indent and the margin a browser gives a list.
...
`,(0,N.jsx)(r.a,{href:`/docs/docs-guidelines-getting-started--docs`,children:`Getting started`}),` explains how.`]}),`
...
`,(0,N.jsxs)(r.p,{children:[`A Grid or a Subgrid that renders an `,(0,N.jsx)(r.code,{children:`ol`}),` or a `,(0,N.jsx)(r.code,{children:`ul`}),` reaches assistive technology as a list, and the Cells inside it need `,(0,N.jsx)(r.code,{children:`as="li"`}),` to be its items.
...
`,(0,N.jsxs)(r.li,{children:[(0,N.jsx)(r.a,{href:`/docs/docs-guidelines-spacing--docs`,children:`Spacing`}),` – which tools to use for white space and when.`]}),`
`]}),`
`,(0,N.jsx)(r.h2,{id:`design-tokens`,children:`Design tokens`}),`
`,(0,N.jsx)(f,{tokens:k})]})}function M(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,N.jsx)(t,{...e,children:(0,N.jsx)(j,{...e})}):j(e)}var N;function P(){return(P=e((()=>{N=c(),u(),r(),d(),A(),g(),C(),T()})))()}P();export{M as default};