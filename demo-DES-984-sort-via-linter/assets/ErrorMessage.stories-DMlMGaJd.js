import{a as y,j as v}from"./index.esm-DfRxjY0e.js";import{j as o}from"./jsx-runtime-z8MfsBtr.js";import{c as b}from"./clsx-B-dksMZM.js";import{r as j}from"./index-D7uoVdV3.js";import{I as S}from"./Icon-BoBhPfLP.js";const a=j.forwardRef(({children:n,className:h,icon:t,prefix:x="Invoerfout",...E},_)=>o.jsxs("p",{...E,ref:_,className:b("ams-error-message",h),children:[o.jsx(S,{size:"level-6",svg:t||y}),o.jsxs("span",{className:"ams-visually-hidden",children:[x,": "]}),n]}));a.displayName="ErrorMessage";try{a.displayName="ErrorMessage",a.__docgenInfo={description:"",displayName:"ErrorMessage",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"Function"}},prefix:{defaultValue:{value:"Invoerfout"},description:"An accessible phrase that screen readers announce before the error message. Should translate to something like ‘input error’.",name:"prefix",required:!1,type:{name:"string"}}}}}catch{}/**
 * @license EUPL-1.2+
