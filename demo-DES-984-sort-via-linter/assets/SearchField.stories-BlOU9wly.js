  ...
  render: function Component({
    ...
    return <SearchField onSubmit={e => {
      ...
      if (value) {
        ...
        <SearchField.Input name="search-box" invalid={invalid} label={label} placeholder={placeholder} value={args['value']} onChange={onValueChange} />
        <SearchField.Button />
      </SearchField>;
  }
