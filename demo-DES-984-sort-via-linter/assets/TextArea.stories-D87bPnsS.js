import{j as r}from"./jsx-runtime-z8MfsBtr.js";import{b as w,c as D,P as $,E as H}from"./index.esm-BfFJbanl.js";import{b as k}from"./exampleContent-fW-Djhm4.js";import{c as B}from"./clsx-B-dksMZM.js";import{r as G}from"./index-D7uoVdV3.js";const a=G.forwardRef(({className:e,dir:W,invalid:q,resize:p,...m},C)=>r.jsx("textarea",{...m,ref:C,"aria-invalid":q||void 0,className:B("ams-text-area",p&&`ams-text-area--resize-${p}`,m.cols&&"ams-text-area--cols",e),dir:W??"auto"}));a.displayName="TextArea";try{a.displayName="TextArea",a.__docgenInfo={description:"",displayName:"TextArea",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}},resize:{defaultValue:null,description:"Allows the user to resize the text box. The default is resizing in both directions.",name:"resize",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"horizontal"'},{value:'"vertical"'}]}}}}}catch{}const J=k(),K={title:"Components/Forms/Text Area",component:a,args:{defaultValue:J,disabled:!1,invalid:!1},argTypes:{cols:{control:{type:"number"},description:"The width, expressed in the average number of characters."},defaultValue:{table:{disable:!0}},disabled:{description:"Prevents interaction. Avoid if possible."},resize:{control:{labels:{horizontal:"horizontal",none:"none",undefined:"default",vertical:"vertical"},type:"radio"},options:[void 0,"none","horizontal","vertical"]},rows:{control:{type:"number"},description:"The number of lines to show"}}},i={},s={args:{resize:"vertical"}},o={args:{resize:"horizontal"}},t={args:{resize:"none"}},n={args:{invalid:!0}},l={args:{disabled:!0}},d={render:e=>r.jsxs(w,{invalid:e.invalid,children:[r.jsx(D,{htmlFor:"input1",children:"Label"}),r.jsx($,{id:"description1",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(H,{id:"error1",children:"Foutmelding."}),r.jsx(a,{id:"input1","aria-describedby":`description1${e.invalid?" error1":""}`,...e})]})},c={args:{invalid:!0},render:e=>r.jsxs(w,{invalid:e.invalid,children:[r.jsx(D,{htmlFor:"input2",children:"Label"}),r.jsx($,{id:"description2",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(H,{id:"error2",children:"Foutmelding."}),r.jsx(a,{id:"input2","aria-describedby":`description2${e.invalid?" error2":""}`,...e})]})};var u,g,v;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:"{}",...(v=(g=i.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,b,x;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    resize: 'vertical'
  }
