import{j as r}from"./jsx-runtime-z8MfsBtr.js";import{b as L,c as S,P,E as O}from"./index.esm-BfFJbanl.js";import{c as N}from"./clsx-B-dksMZM.js";import{r as V}from"./index-D7uoVdV3.js";const a=V.forwardRef(({className:e,invalid:M,type:z="date",...A},T)=>r.jsx("input",{...A,ref:T,"aria-invalid":M||void 0,className:N("ams-date-input",e),type:z}));a.displayName="DateInput";try{a.displayName="DateInput",a.__docgenInfo={description:"",displayName:"DateInput",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}},type:{defaultValue:{value:"date"},description:"The kind of data that the user should provide.",name:"type",required:!1,type:{name:"enum",value:[{value:'"date"'},{value:'"datetime-local"'}]}}}}}catch{}const $={title:"Components/Forms/Date Input",component:a,args:{disabled:!1,invalid:!1},argTypes:{disabled:{description:"Prevents interaction. Avoid if possible."}}},i={},s={args:{type:"datetime-local"}},t={args:{invalid:!0}},d={args:{disabled:!0}},n={render:e=>r.jsxs(L,{invalid:e.invalid,children:[r.jsx(S,{htmlFor:"input1",children:"Label"}),r.jsx(P,{id:"description1",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(O,{id:"error1",children:"Foutmelding."}),r.jsx(a,{id:"input1","aria-describedby":`description1${e.invalid?" error1":""}`,...e})]})},o={args:{invalid:!0},render:e=>r.jsxs(L,{invalid:e.invalid,children:[r.jsx(S,{htmlFor:"input2",children:"Label"}),r.jsx(P,{id:"description2",size:"small",children:"Omschrijving."}),e.invalid&&r.jsx(O,{id:"error2",children:"Foutmelding."}),r.jsx(a,{id:"input2","aria-describedby":`description2${e.invalid?" error2":""}`,...e})]})};var l,c,p;i.parameters={...i.parameters,docs:{...(l=i.parameters)==null?void 0:l.docs,source:{originalSource:"{}",...(p=(c=i.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var m,u,g;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    type: 'datetime-local'
  }
  ...
  render: args => <Field invalid={args.invalid}>
      ...
      <DateInput id="input1" aria-describedby={\`description1\${args.invalid ? ' error1' : ''}\`} {...args} />
    </Field>
  ...
  render: args => <Field invalid={args.invalid}>
      ...
      <DateInput id="input2" aria-describedby={\`description2\${args.invalid ? ' error2' : ''}\`} {...args} />
    </Field>
