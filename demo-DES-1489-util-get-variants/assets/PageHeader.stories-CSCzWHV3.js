import{r as m,j as e,c as d,G as l,_ as r,H as x}from"./iframe-g5f0W2Mq.js";import{G as S}from"./Grid-Bz-60yo9.js";import{I as q}from"./Icon-CeqWPD4m.js";import{L as z}from"./Logo-DYmvMuCN.js";/**
 * @license EUPL-1.2+
...
The amount of grid columns the cell spans.`,name:"span",required:!1,type:{name:'"all" | GridColumnNumber | GridColumnNumbers'}},start:{defaultValue:null,description:"The index of the grid column the cell starts at.",name:"start",required:!1,type:{name:"GridColumnNumber | GridColumnNumbers"}},as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"aside"'},{value:'"div"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'},{value:'"section"'}]}}}}}catch{}/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
