...
`,e.jsxs(o.p,{children:[`The Radio button can display a different icon.
This allows reusing this component with a different visual identity.
Make sure to set the `,e.jsx(o.code,{children:"ams-radio__circle"})," and ",e.jsx(o.code,{children:"ams-radio__checked-indicator"}),` classes in the SVG markup.
This is not to be used within the City of Amsterdam.`]}),`
