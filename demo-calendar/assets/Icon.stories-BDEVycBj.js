import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{Bt as n,Ut as r,Y as i,b as a,xt as o,zt as s}from"./iframe-BviSAJKP.js";import{At as c,Ot as l,St as u,ct as d,kt as f,t as p}from"./src-X5vktuxR.js";var m=t({Default:()=>v,InverseColour:()=>S,Square:()=>x,WithAHeading:()=>b,WithBodyText:()=>y,__namedExportsOrder:()=>C,default:()=>_}),h,g,_,v,y,b,x,S,C,w=e((()=>{i(),n(),p(),c(),h=r(),g=[`heading-0`,`heading-6`],_={title:`Components/Media/Icon`,component:l,args:{svg:o},argTypes:{color:{control:{labels:{undefined:`default`},type:`radio`},options:[void 0,`inverse`]},size:{control:{labels:{undefined:`default`},type:`select`},options:[void 0,...f]},svg:{control:{type:`select`},mapping:s,options:Object.keys(s)}}},v={},y={argTypes:{size:{control:{labels:{undefined:`medium (default)`}},options:[`small`,void 0,`large`]}},render:e=>{let t=e.size,n=e=>e===void 0?`Regular`:e.charAt(0).toUpperCase()+e.slice(1);return(0,h.jsxs)(u,{gap:`small`,children:[(0,h.jsx)(l,{...e}),(0,h.jsxs)(d,{color:e.color,size:t,children:[n(t),` body text`]})]})}},b={args:{size:`heading-3`},argTypes:{size:{options:[...f.filter(e=>e.startsWith(`heading-`)&&!g.includes(e))]}},render:e=>{let t=e.size?e.size.slice(-1):`3`;return(0,h.jsxs)(u,{gap:`small`,children:[(0,h.jsx)(l,{...e}),(0,h.jsxs)(a,{color:e.color,level:1,size:`level-${t}`,children:[`Heading `,t,` text`]})]})}},x={args:{square:!0}},S={args:{color:`inverse`}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{}`,...v.parameters?.docs?.source}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  argTypes: {
    size: {
      control: {
        labels: {
