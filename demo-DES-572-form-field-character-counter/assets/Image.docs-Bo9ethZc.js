import{j as e}from"./jsx-runtime-CKrituN3.js";import{M as r,d as a,P as l,e as c,f as o}from"./index-BbiwHj4E.js";import{I as d,M as h,L as m}from"./Image.stories-DVReLa00.js";import{useMDXComponents as i}from"./index-DI5IigMn.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-Dg9KGpa_.js";import"../sb-preview/runtime.js";import"./index-BtM5VmRH.js";import"./index-Bw8VTzHM.js";import"./index-Cmc67Rxs.js";import"./index-DrFu-skq.js";import"./index.esm-DlatE2JW.js";const p=`<!-- @license CC0-1.0 -->
...
`;function s(n){const t=Object.assign({h2:"h2",p:"p",a:"a",code:"code"},i(),n.components);return e.jsxs(e.Fragment,{children:[e.jsx(r,{of:d}),`
`,e.jsx(a,{children:p}),`
`,e.jsx(t.h2,{id:"examples",children:"Examples"}),`
`,e.jsx(l,{}),`
`,e.jsx(c,{}),`
`,e.jsx(t.h2,{id:"provide-multiple-sources",children:"Provide multiple sources"}),`
`,e.jsxs(t.p,{children:["Use the srcSet prop, which controls the corresponding HTML attribute (see ",e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#srcset",target:"_blank",rel:"nofollow noopener noreferrer",children:"MDN"}),`), to let the browser select the optimal source file for the image.
...
`,e.jsxs(t.p,{children:["Set the ",e.jsx(t.code,{children:"loading"})," attribute (see ",e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#loading",target:"_blank",rel:"nofollow noopener noreferrer",children:"MDN"}),") to ",e.jsx(t.code,{children:"lazy"}),` and the browser will wait to load the image until it is close to the viewport.
Consider setting this for images below the top area of the page.`]}),`
`,e.jsx(o,{of:m})]})}function D(n={}){const{wrapper:t}=Object.assign({},i(),n.components);return t?e.jsx(t,Object.assign({},n,{children:e.jsx(s,n)})):s(n)}export{D as default};
