import{r as L,j as e,c as d,a2 as j,G as l,a3 as r,H as b,ab as q}from"./iframe-CbZbKm2I.js";import{u as z}from"./useIsAfterBreakpoint-CnJhTkRj.js";import{G as R}from"./Grid-PDBYCUuG.js";import{I as W}from"./Icon-fceS35hk.js";import{L as D}from"./Logo-HHF4yzvo.js";const P=L.forwardRef(({children:a,className:n,...s},t)=>e.jsx(R.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),hidden:!0,ref:t,children:a}));P.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"aside"'},{value:'"div"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'},{value:'"section"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
