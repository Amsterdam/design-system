import{j as e}from"./iframe-BRx-oxUX.js";import{useMDXComponents as s}from"./index-i6nCN9l3.js";import{M as i,e as r,f as l,h,i as a}from"./blocks-nGR42pmi.js";import{a as c,W as d,b as p,P as m}from"./Tabs.stories-CdD0PqlV.js";import{D as b}from"./DesignTokensTable-93Xi9nPg.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BmJJ4XMB.js";import"./exampleContent-B8t5xvDp.js";import"./useKeyboardFocus-CO72QOjh.js";import"./BorderSample-KlgxvXio.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-DWSeW_hR.js";import"./ColorSample-CYY0qtpi.js";import"./SpaceSample-DrF440lF.js";import"./TypographySample-B7oQC-iw.js";const u=`<!-- @license CC0-1.0 -->
...
`,f={tabs:{gap:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},list:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1) {ams.color.separator}"}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"outline-offset":{$value:"calc({ams.focus.outline-offset} * -1)",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1)"},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},selected:{"box-shadow":{$value:"inset 0 calc({ams.border.width.xl} * -1)"},"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}}}}},v={ams:f};function o(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(b,{tokens:v})]})}function R(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{R as default};
