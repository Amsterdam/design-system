import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{$ as i,H as a,R as o,S as s,et as c,u as l}from"./index.esm-C1gIk5t6.js";import{n as u,t as d}from"./Mark-CtLfP02X.js";import{n as f,t as p}from"./decorators-6i9XI7i9.js";import{d as m,r as h}from"./argTypes-CTYEle7b.js";var g=t({Default:()=>b,SearchResults:()=>w,__namedExportsOrder:()=>T,default:()=>y}),_,v,y,b,x,S,C,w,T;function E(){return(E=e((()=>{c(),u(),_=n(),m(),p(),v=r(),y={title:`Components/Text/Mark`,component:d},b={args:{children:`Wat vinden Amsterdammers belangrijk?`},argTypes:{children:h(`The text to mark.`)},render:({children:e})=>(0,v.jsxs)(o,{children:[`Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. `,(0,v.jsx)(d,{children:e}),` Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren.`]})},x=[{category:`Kansspelen`,date:new Date(`2025-10-27`),fragment:`Op dit moment zijn alle vergunning voor speelautomatenhallen verleend. Als u kansspelautomaten wilt plaatsen in uw horecabedrijf dan heeft u de …`,heading:`Vergunning speelautomatenhal of kansspelautomaten aanvragen`},{category:`Veelgevraagd`,date:new Date(`2024-09-15`),fragment:`U heeft een ontheffing nodig als u de geldende geluidsgrenzen van uw horecagelegenheid wil overschrijden. Kijk hier hoe het werkt en hoe u de …`,heading:`Ontheffing geluidsvoorschriften`},{category:`Vergunningen`,date:new Date(`2023-08-03`),fragment:`Voor de organisatie van grootschalige vechtsportgala’s in Amsterdam moet u een vergunning aanvragen bij de gemeente. Vooraf moet u een Bibobformulier …`,heading:`Vergunning vechtsportevenementen`}],S=new Intl.DateTimeFormat(`nl`,{day:`numeric`,month:`long`,year:`numeric`}),C=(e,t,n)=>{if(!t)return e;let r=t.split(/\s+/).filter(Boolean).map(e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`));if(r.length===0)return e;let i=RegExp(`(${r.join(`|`)})`,`gi`);return e.split(i).map(e=>e.match(i)?(0,v.jsx)(d,{...n,children:e},e):e)},w={decorators:[f(`7-of-12-columns`)],render:e=>{let[t,n]=(0,_.useState)(`horeca vergunning`),r=x.filter(({fragment:e,heading:n})=>[e,n].some(e=>t.split(/\s+/).filter(Boolean).some(t=>e.toLowerCase().includes(t.toLowerCase()))));return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsxs)(a,{className:`ams-mb-m`,children:[(0,v.jsx)(a.Input,{label:`Zoeken`,onChange:e=>n(e.target.value),value:t}),(0,v.jsx)(a.Button,{})]}),(0,v.jsxs)(o,{className:`ams-mb-xl`,children:[(0,v.jsx)(`strong`,{children:r.length}),` artikelen gaan over ‘`,t,`’.`]}),(0,v.jsx)(i,{className:`ams-gap-xl`,markers:!1,children:r.map(({category:n,date:r,fragment:a,heading:c})=>(0,v.jsx)(i.Item,{children:(0,v.jsxs)(l,{children:[(0,v.jsx)(l.HeadingGroup,{tagline:n,children:(0,v.jsx)(s,{level:2,size:`level-4`,children:(0,v.jsx)(l.Link,{href:`#`,children:C(c,t,e)})})}),(0,v.jsx)(o,{className:`ams-mb-xs`,children:C(a,t,e)}),(0,v.jsx)(o,{size:`small`,children:(0,v.jsx)(`time`,{dateTime:r.toISOString(),children:S.format(r)})})]})},c))})]})}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...w.parameters?.docs?.source}}},T=[`Default`,`SearchResults`]})))()}export{w as n,E as r,g as t};