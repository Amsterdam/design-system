import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-_y5vc8cl.js";import{r as n}from"./react-iLE801Ux.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-EqW2BeXU.js";import{n as l,t as u}from"./DesignTokensTable-DuD4Da25.js";import{t as d}from"./mdx-react-shim-CCxsI6ba.js";import{ExpandedByDefault as f,Level as p,ReduceLandmarks as m,n as h,t as g}from"./Accordion.stories-Dme_73aA.js";var _,v=e((()=>{_=`<!-- @license CC0-1.0 -->
...
`})),y,b,x=e((()=>{y={accordion:{gap:{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},button:{color:{$value:`{ams.color.interactive.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`},gap:{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},hover:{color:{$value:`{ams.color.interactive.hover}`,$type:`color`}}}}},b={ams:y}}));function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:g}),`
