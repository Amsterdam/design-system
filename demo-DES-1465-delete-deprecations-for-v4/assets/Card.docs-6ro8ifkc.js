import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-CdRvrppO.js";import{r as n}from"./react-ClmAn0sn.js";import{c as r,f as i,l as a,n as o,s}from"./blocks-B3L6VStt.js";import{n as c,t as l}from"./DesignTokensTable-BXhurWpF.js";import{t as u}from"./mdx-react-shim-DwH0Jo1b.js";import{TopTasks as d,WithImage as f,WithTagline as p,n as m,t as h}from"./Card.stories-CpXazyv7.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={card:{heading:{"margin-block-end":{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},"heading-group":{gap:{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"margin-block-end":{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},image:{"margin-block-end":{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},link:{color:{$value:`{ams.links.color}`,$type:`color`},"text-decoration-line":{$value:`{ams.links.subtle.text-decoration-line}`},"text-decoration-thickness":{$value:`{ams.links.text-decoration-thickness}`,$type:`dimension`},"text-underline-offset":{$value:`{ams.links.text-underline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},hover:{color:{$value:`{ams.links.hover.color}`,$type:`color`},"text-decoration-line":{$value:`{ams.links.subtle.hover.text-decoration-line}`}}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}},y={ams:v}}));function x(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
