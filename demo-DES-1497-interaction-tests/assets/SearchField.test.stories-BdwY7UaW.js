import{j as e}from"./iframe-OfInhUsD.js";import{m as l,S as t}from"./SearchField.stories-Bp0cOZ0r.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-BuArMkIt.js";import"./Icon-Dqci5sL8.js";const{expect:o,fn:d}=__STORYBOOK_MODULE_TEST__,x={...l,title:"Components/Forms/Search Field"},c=d(),s={args:{onSubmit:a=>{a.preventDefault();const n=a.target.querySelector('input[type="search"]')?.value;c(n)}},play:async({canvas:a,userEvent:r})=>{await r.type(a.getByTestId("searchbox"),"Amsterdam"),await r.click(a.getByTestId("button")),o(c).toHaveBeenCalledWith("Amsterdam")},render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--ams-space-s)"},children:[e.jsxs(t,{...a,children:[e.jsx(t.Input,{"data-testid":"searchbox",name:"search",placeholder:"Waar ben je naar opzoek?"}),e.jsx(t.Button,{"data-testid":"button"})]}),e.jsxs(t,{...a,children:[e.jsx(t.Input,{}),e.jsx(t.Button,{})]}),e.jsxs(t,{children:[e.jsx(t.Input,{invalid:!0}),e.jsx(t.Button,{})]}),e.jsxs(t,{children:[e.jsx(t.Input,{className:"hover",invalid:!0}),e.jsx(t.Button,{className:"hover"})]}),e.jsxs(t,{...a,children:[e.jsx(t.Input,{className:"hover"}),e.jsx(t.Button,{className:"hover"})]}),e.jsxs(t,{...a,children:[e.jsx(t.Input,{disabled:!0}),e.jsx(t.Button,{disabled:!0})]})]}),tags:["!dev","!autodocs"]};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    onSubmit: event => {
  ...
  tags: ['!dev', '!autodocs']
}`,...s.parameters?.docs?.source}}};const v=["Test"];export{s as Test,v as __namedExportsOrder,x as default};
