import{m}from"./ImageSlider.stories-D-WQ_X9A.js";import"./iframe-DkHWFf1c.js";import"./preload-helper-PPVm8Dsz.js";import"./Image-CyBWH7vQ.js";import"./generateAspectRatioClass-CefTNpDa.js";import"./Button-YneAlbV9.js";import"./Icon-Dp_rxceE.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const{expect:t}=__STORYBOOK_MODULE_TEST__,y={...m,title:"Components/Media/Image Slider"},n={play:async({canvas:a,userEvent:r})=>{const c=a.queryAllByRole("group")?.at(0)?.children,s=Array.from(c??[]),d=a.queryAllByRole("button"),l=d?.at(0),u=d?.at(1);if(!(!u||!l)){for(const[i,e]of s.entries())i===0||(await r.click(u),await new Promise(o=>setTimeout(o,500))),t(e).not.toHaveAttribute("aria-hidden");for(const[i,e]of s.reverse().entries())i===0||(await r.click(l),await new Promise(o=>setTimeout(o,500))),t(e).not.toHaveAttribute("aria-hidden")}},tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvas,
    userEvent
  }) => {
