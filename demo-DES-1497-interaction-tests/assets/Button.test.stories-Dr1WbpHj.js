import{j as t,e as o}from"./iframe-CfScnC1S.js";import{b as d,B as i}from"./Button-GfCV3q42.js";import{m as c}from"./Button.stories-Cm2pr2p6.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-7rI7OGwk.js";const h={...c,title:"Components/Buttons/Button"},m=["default","disabled","hover","icon"],a={parameters:{pseudo:{hover:[".hover"]}},render:s=>t.jsx("table",{children:t.jsx("tbody",{children:d.map(n=>t.jsx("tr",{children:m.map(e=>{const r=`${n}-${e}`;return t.jsx("td",{children:t.jsx(i,{...s,className:e==="hover"?"hover":void 0,disabled:e==="disabled",icon:e==="icon"?t.jsx(o,{}):void 0,variant:n,children:r})},r)})},n))})}),tags:["!dev","!autodocs"]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      hover: ['.hover']
    }
