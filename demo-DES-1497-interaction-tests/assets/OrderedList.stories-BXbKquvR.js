import{r as I,j as e,c as L,p as t,P as a}from"./iframe-BwLXUFRs.js";import{h as v}from"./exampleContent-DRope23M.js";const O=I.forwardRef(({children:s,className:h,...u},p)=>e.jsx("li",{className:L("ams-ordered-list__item",h),ref:p,...u,children:s}));O.displayName="OrderedList.Item";try{OrderedList.Item.displayName="OrderedList.Item",OrderedList.Item.__docgenInfo={description:"",displayName:"OrderedList.Item",props:{}}}catch{}const j=I.forwardRef(({children:s,className:h,color:u,markers:p=!0,size:g,...x},k)=>e.jsx("ol",{className:L("ams-ordered-list",u&&`ams-ordered-list--${u}`,!p&&"ams-ordered-list--no-markers",g&&`ams-ordered-list--${g}`,h),ref:k,...x,children:s}));j.displayName="OrderedList";const r=Object.assign(j,{Item:O});try{r.displayName="OrderedList",r.__docgenInfo={description:"",displayName:"OrderedList",props:{color:{defaultValue:null,description:"Changes the text colour for readability on a dark background.",name:"color",required:!1,type:{name:"enum",value:[{value:'"inverse"'}]}},markers:{defaultValue:{value:"true"},description:"Whether the list items show a marker.",name:"markers",required:!1,type:{name:"boolean"}},size:{defaultValue:null,description:"The size of the text.",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'}]}}}}}catch{}const f=v().map(s=>e.jsx(r.Item,{children:s},s)),S={title:"Components/Text/Ordered List",component:r,args:{children:f,markers:void 0,reversed:void 0,start:void 0},argTypes:{color:{control:{labels:{undefined:"default"},type:"radio"},options:[void 0,"inverse"]},reversed:{control:"boolean",description:"Numbers the items from the highest value down."},size:{control:{labels:{small:"small",undefined:"medium"},type:"radio"},options:["small",void 0]},start:{control:"number",description:"The value for the first list item’s marker."}}},d={},n={render:s=>e.jsxs(r,{...s,children:[e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]}),e.jsxs(r.Item,{children:["Stadsdeel Nieuw-West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"De Aker, Sloten en Nieuw Sloten"}),e.jsx(r.Item,{children:"Geuzenveld, Slotermeer en Sloterdijken"}),e.jsx(r.Item,{children:"Osdorp"}),e.jsx(r.Item,{children:"Slotervaart"})]})]})]})},i={args:{children:[e.jsx(r.Item,{children:"Zes"},6),e.jsx(r.Item,{children:"Zeven"},7),e.jsx(r.Item,{children:"Acht"},8)],start:6}},l={args:{children:[e.jsx(r.Item,{children:"Drie"},3),e.jsx(r.Item,{children:"Twee"},2),e.jsx(r.Item,{children:"Eén"},1)],reversed:!0,start:3}},o={args:{children:[e.jsx(r.Item,{children:e.jsxs(t,{children:[e.jsx(t.Heading,{level:2,children:e.jsx(t.Link,{href:"#",children:"Weg met steen, hallo extra groen en koelte"})}),e.jsx(a,{children:"Sinds 2021 kwamen er maar liefst 60 nieuwe groene plekken bij in de stad. Groen is fijn en het verkoelt de stad in de zomer. Een paar voorbeelden."}),e.jsx(a,{size:"small",children:"16 augustus 2023"})]})},1),e.jsx(r.Item,{children:e.jsxs(t,{children:[e.jsx(t.Heading,{level:2,children:e.jsx(t.Link,{href:"#",children:"Amsterdam bindt de strijd aan met lawaaierige voertuigen"})}),e.jsx(a,{children:"Deze zomer testen we of digitale borden langs de weg kunnen helpen om geluidsoverlast van voertuigen zoals motoren en auto’s tegen te gaan."}),e.jsx(a,{size:"small",children:"10 augustus 2023"})]})},2),e.jsx(r.Item,{children:e.jsxs(t,{children:[e.jsx(t.Heading,{level:2,children:e.jsx(t.Link,{href:"#",children:"Een prachtroute door de wonderlijke Baarsjes"})}),e.jsx(a,{children:"In de Baarsjes zijn kunst en cultuur met elkaar vervlochten. We zetten een prachtige wandelroute voor u uit en laten zien hoe het was en hoe het nu is."}),e.jsx(a,{size:"small",children:"8 augustus 2023"})]})},3)],className:"ams-gap-xl",markers:!1,style:{maxInlineSize:"32rem"}},argTypes:{style:{table:{disable:!0}}}},m={args:{color:"inverse"},render:s=>e.jsx(r,{...s,children:e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]})})},c={args:{size:"small"}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"{}",...d.parameters?.docs?.source}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...c.parameters?.docs?.source}}};const y=["Default","TwoLevels","StartingNumber","DescendingNumbers","WithoutMarkers","InverseColor","SmallText"],w=Object.freeze(Object.defineProperty({__proto__:null,Default:d,DescendingNumbers:l,InverseColor:m,SmallText:c,StartingNumber:i,TwoLevels:n,WithoutMarkers:o,__namedExportsOrder:y,default:S},Symbol.toStringTag,{value:"Module"}));export{l as D,m as I,r as O,i as S,n as T,o as W,w as a,c as b,S as m};
