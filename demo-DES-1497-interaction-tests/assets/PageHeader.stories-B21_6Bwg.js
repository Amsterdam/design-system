import{r as L,j as e,c as d,G as l,Z as r,H as x}from"./iframe-Dw88OR9M.js";import{u as S}from"./useIsAfterBreakpoint-DQxeAO6Z.js";import{G as E}from"./Grid-CWuBPxRP.js";import{I as q}from"./Icon-BZYXeehT.js";import{L as z}from"./Logo-DYvjp2bd.js";const G=L.forwardRef(({children:a,className:n,...s},o)=>e.jsx(E.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:o,children:a}));G.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
