import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,d as n,h as r,i,n as a,p as o,u as s}from"./blocks-DXSisYNI.js";import{t as c}from"./jsx-runtime-ATHzeHXA.js";import{i as l,r as u}from"./react-Dyi61YEg.js";import{n as d,t as f}from"./DesignTokensTable-50E7IdH_.js";import{i as p,n as m,r as h,t as g}from"./Image.stories-VJNpGDOH.js";var _,v;function y(){return(y=e((()=>{_={image:{"aspect-ratio":{$value:`{ams.aspect-ratio.16-9}`,$extensions:{"nl.amsterdam.type":`aspectRatio`}},"background-color":{$value:`#e8e8e8`,$description:`A neutral tint that marks the reserved space until the image has loaded. Set as a literal because the brand layer has no matching grey yet.`,$extensions:{"nl.amsterdam.type":`color`}},"background-image":{$value:`none`,$extensions:{"nl.amsterdam.type":`backgroundImage`}},"object-position":{$value:`50% 50%`,$extensions:{"nl.amsterdam.type":`objectPosition`}}}},v={ams:_}})))()}function b(e){let r={a:`a`,code:`code`,em:`em`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(s,{of:g}),`
...
Leave `,(0,S.jsx)(r.code,{children:`fit`}),` unset to keep the default of `,(0,S.jsx)(r.code,{children:`cover`}),` unless important objects in the image disappear or the cropping does not look right.
Setting `,(0,S.jsx)(r.code,{children:`fit`}),` to `,(0,S.jsx)(r.code,{children:`contain`}),` keeps the whole image in view at the cost of empty space beside or above it.
...
The default is 16:9.
If the intrinsic dimensions of the source do not match an aspect ratio, the image is cropped to cover the intended area by default.
The crop is taken from the centre, so the middle of a photograph is what survives a ratio it was not made for.
Setting `,(0,S.jsx)(r.code,{children:`fit`}),` to `,(0,S.jsx)(r.code,{children:`contain`}),` keeps the whole source in view inside that same area instead.`]}),`
