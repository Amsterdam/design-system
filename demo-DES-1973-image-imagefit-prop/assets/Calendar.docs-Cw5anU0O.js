...
`,(0,x.jsxs)(r.li,{children:[(0,x.jsx)(r.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),` – lets the user type a date they know by heart, one part per field.`]}),`
`]}),`
