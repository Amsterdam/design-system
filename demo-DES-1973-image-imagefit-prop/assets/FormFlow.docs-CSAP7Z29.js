import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-DXSisYNI.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-Cv9XG0XS.js";import{n as u,t as d}from"./FormFlow.stories-BgEmUjaY.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Back link`}],[{height:`body`,label:`Questions`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.h3,{id:`how-to-use`,children:`How to use`}),`
`,(0,g.jsxs)(n.p,{children:[`Do not put a step counter such as ‘Stap 2 van 5’ on form pages by default.
The landing page can list the steps instead, and `,(0,g.jsx)(n.a,{href:`#with-a-progress-indicator`,children:`With a progress indicator`}),` says when a counter still helps.`]}),`
...
`]}),`
`,(0,g.jsx)(n.h3,{id:`with-a-progress-indicator`,children:`With a progress indicator`}),`
`,(0,g.jsx)(n.p,{children:`Form pages usually don’t have their own step counter for good reasons:`}),`
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsx)(n.li,{children:`A branching form cannot show a fixed total, since the count changes based on which path users take.`}),`
`,(0,g.jsx)(n.li,{children:`A counter takes up space above the question and reminds users how many steps remain, which may discourage them.`}),`
`,(0,g.jsx)(n.li,{children:`The landing page’s step list already sets expectations once, when users decide to begin.`}),`
`]}),`
`,(0,g.jsx)(n.p,{children:`Start by testing the form without a counter.
Improve the order, type, and number of questions first before adding one.
Only add a counter if users get lost and your own research proves it helps.
Use plain text above the heading:`}),`
`,(0,g.jsx)(n.pre,{children:(0,g.jsx)(n.code,{className:`language-tsx`,children:`<Paragraph className="ams-mb-m">Stap 2 van 5: Uw gegevens</Paragraph>
`})}),`
`,(0,g.jsx)(n.p,{children:`Keep it simple.
Show a total only for forms where every user answers the same questions in the same order.
Skip the total when the path changes: ‘Stap 2’ alone stays accurate.`}),`
`,(0,g.jsxs)(n.p,{children:[`This deviates from the `,(0,g.jsx)(n.a,{href:`https://nldesignsystem.nl/richtlijnen/formulieren/meerdere-stappen/voortgang-tonen/`,rel:`nofollow`,children:`NL Design System’s own step counter guidance`}),`, which also puts the count in the page `,(0,g.jsx)(n.code,{children:`<title>`}),`; this pattern only shows it above the heading.`]}),`
`,(0,g.jsxs)(n.p,{children:[`For more information, see `,(0,g.jsx)(n.a,{href:`https://design-system.service.gov.uk/patterns/question-pages/#using-progress-indicators`,rel:`nofollow`,children:`Question pages - Using progress indicators`}),`.`]}),`
