import{I as u}from"./Image-rQxFWC2n.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const g={title:"Components/Media/Image",component:u},s={args:{alt:"",src:"https://picsum.photos/640/360"},argTypes:{alt:{description:"Describes the image for non-visual users."},src:{description:"The url for the image."},srcSet:{description:"A set of candidate images."}}},e={args:{alt:"",sizes:"(max-width: 36rem) 640px, 50vw",src:"https://picsum.photos/1280/720",srcSet:"https://picsum.photos/640/360 640w, https://picsum.photos/1280/720 1280w"}},t={args:{alt:"",loading:"lazy",src:"https://picsum.photos/2560/1440"}};var r,a,o;s.parameters={...s.parameters,docs:{...(r=s.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    alt: '',
