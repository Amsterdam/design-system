import{j as r}from"./jsx-runtime-Cf8x2fCZ.js";import{G as d,g as S}from"./index.esm-iNl6MppM.js";import{c as h}from"./clsx-B-dksMZM.js";import{r as y}from"./index-G8LIXM5I.js";import{c as _}from"./exampleContent-B9pMnolB.js";const x=["azure","green","lime","magenta","orange","yellow"],i=y.forwardRef(({as:p="div",children:e,className:g,color:u,...v},f)=>r.jsx(p,{...v,className:h("ams-spotlight",u&&`ams-spotlight--${u}`,g),ref:f,children:e}));i.displayName="Spotlight";try{i.displayName="Spotlight",i.__docgenInfo={description:"",displayName:"Spotlight",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'}]}},color:{defaultValue:null,description:"The background colour.",name:"color",required:!1,type:{name:"enum",value:[{value:'"azure"'},{value:'"green"'},{value:'"lime"'},{value:'"magenta"'},{value:'"orange"'},{value:'"yellow"'}]}}}}}catch{}const j=_(),z={title:"Components/Containers/Spotlight",component:i,argTypes:{color:{control:{labels:{undefined:"purple (default)"}},options:[void 0,...x]}},render:({as:p,color:e})=>r.jsx(i,{as:p,color:e,children:r.jsx(d,{paddingVertical:"x-large",children:r.jsx(d.Cell,{span:"all",children:r.jsx(S,{color:!e||["azure","green","magenta"].includes(e)?"inverse":void 0,children:j})})})})},a={},o={args:{color:"azure"}},s={args:{color:"green"}},t={args:{color:"lime"}},n={args:{color:"magenta"}},c={args:{color:"orange"}},l={args:{color:"yellow"}},m={args:{as:"section"}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'azure'
  }
