...
`,(0,N.jsxs)(r.p,{children:[`Follow the `,(0,N.jsx)(r.a,{href:`/docs/pages-public-introduction--docs#how-to-size-the-grid-cells`,children:`optimal sizes of Grid Cells`}),` for typical page sections.`]}),`
...
A Subgrid is not: a grid container that establishes an independent formatting context cannot share its parent’s columns, so it would stop being a subgrid.
...
`,(0,N.jsx)(d,{tokens:k})]})}function M(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,N.jsx)(t,{...e,children:(0,N.jsx)(j,{...e})}):j(e)}var N;e((()=>{N=c(),f(),r(),u(),A(),_(),T(),D()}))();export{M as default};