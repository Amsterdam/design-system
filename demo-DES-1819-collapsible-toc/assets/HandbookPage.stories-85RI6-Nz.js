    ...
    return <>
        <Grid id="inhoud" paddingVertical="x-large">
          ...
          wide: 4
            ...
            <TableOfContents heading="Inhoudsopgave" key={currentSlug}>
              {renderTocList(pages, {
              currentSlug,
              expandedSlugs,
