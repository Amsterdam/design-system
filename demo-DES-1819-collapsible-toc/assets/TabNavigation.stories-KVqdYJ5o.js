import{a as e,n as t,r as n}from"./chunk-DnJy8xQt.js";import{Bt as r,En as i,Et as a,Ut as o,dt as s,ot as c,wt as l}from"./iframe-DrMi8JHI.js";import{s as u,t as d}from"./src-CzqIP6rx.js";var f=n({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{r(),d(),p=e(i()),m=o(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}}},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(_);return(0,m.jsx)(u,{...e,children:(0,m.jsx)(u.List,{children:_.map(e=>(0,m.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},b=[{icon:a,label:`Gegevens`},{icon:s,label:`Aanslagen`},{icon:c,label:`Documenten`},{icon:l,label:`Acties`}],x={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
