import{a as e,n as t,r as n}from"./chunk-DnJy8xQt.js";import{$ as r,Ft as i,Gt as a,Ht as o,Mt as s,On as c,Vt as l,ht as u,ut as d}from"./iframe-cl_YA5oF.js";import{E as f,T as p,j as m,t as h}from"./src-CXmMrksv.js";var g=n({Default:()=>w,Link:()=>T,__namedExportsOrder:()=>E,default:()=>C}),_,v,y,b,x,S,C,w,T,E,D=t((()=>{o(),h(),f(),_=e(c()),v=a(),y=e(c()),{useArgs:b}=__STORYBOOK_MODULE_PREVIEW_API__,x=[{href:`#`,icon:(0,v.jsx)(s,{}),text:`Dashboard`},{href:`#`,icon:(0,v.jsx)(u,{}),text:`Projecten`},{href:`#`,icon:(0,v.jsx)(d,{}),text:`Rapportages`},{href:`#`,icon:(0,v.jsx)(r,{}),text:`Analyses`},{href:`#`,icon:(0,v.jsx)(i,{}),text:`Instellingen`}],S=e=>{let[,t]=b();return(0,_.useEffect)(()=>{if(typeof window>`u`||!window.matchMedia)return;let e=window.matchMedia(`(min-width: ${p.wide})`);t({inWideWindow:e.matches});let n=e=>t({inWideWindow:e.matches});return e.addEventListener(`change`,n),()=>e.removeEventListener(`change`,n)},[t]),(0,v.jsx)(e,{})},C={title:`Components/Navigation/Menu`,component:m,args:{inWideWindow:!1},argTypes:{inWideWindow:{control:!1,description:`This prop gets automatically updated in Storybook. It is \`true\` when the viewport is wider than ${p.wide}.`,table:{category:`Derived`}}},decorators:[S],parameters:{themes:{themeOverride:`Compact`}}},m.Link,w={args:{children:x.map(({text:e,...t})=>(0,y.createElement)(m.Link,{...t,key:e},e))}},T={args:{children:x[0].text,href:`#`,icon:`PieChartFillIcon`},argTypes:{accessibleName:{table:{disable:!0}},children:{control:`text`,table:{disable:!1}},icon:{control:{labels:{undefined:`none`},type:`select`},mapping:l,options:[void 0,...Object.keys(l)]},inWideWindow:{table:{disable:!0}}},decorators:[e=>(0,v.jsx)(m,{inWideWindow:!0,style:{display:`inline-flex`,margin:0,paddingBlock:`var(--ams-menu-padding-block)`,paddingInline:`var(--ams-menu-padding-block)`},children:(0,v.jsx)(e,{})})],render:({children:e,...t})=>{let{accessibleName:n,inWideWindow:r,...i}=t;return(0,v.jsx)(m.Link,{...i,children:e})}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
