...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=m(x);return(0,p.jsx)(u,{...e,children:(0,p.jsx)(u.List,{children:x.map(e=>(0,p.jsxs)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:[`Tab `,e]},e))})})}},C=[`Default`,`Vertical`,`WithIcons`,`WithManyLinks`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`<TabNavigation>
...
}`,...S.parameters?.docs?.source}}}})))()}export{w as a,S as i,v as n,h as o,b as r,d as t};