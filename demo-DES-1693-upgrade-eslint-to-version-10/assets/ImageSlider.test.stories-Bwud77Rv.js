import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-ATHzeHXA.js";import{n,t as r}from"./renderComponentVariants-D8aXMKIK.js";import{n as i,t as a}from"./ImageSlider-D_rPj3oA.js";import{a as o,i as s}from"./ImageSlider.stories-C-BmkxEL.js";async function c(e,t){await d(()=>{e.forEach((e,n)=>{n===t?u(e).not.toHaveAttribute(`aria-hidden`):u(e).toHaveAttribute(`aria-hidden`,`true`)})})}var l,u,d,f,p,m;function h(){return(h=e((()=>{i(),r(),s(),l=t(),{expect:u,waitFor:d}=__STORYBOOK_MODULE_TEST__,f={...o,title:`Components/Media/Image Slider`},p={args:{images:[{alt:`Bridge`,src:`https://picsum.photos/id/122/1280/720`},{alt:`Bunker`,src:`https://picsum.photos/id/101/1280/720`},{alt:`Chairs`,src:`https://picsum.photos/id/153/1280/720`},{alt:`Droplet`,src:`https://picsum.photos/id/159/1280/720`},{alt:`Dew`,src:`https://picsum.photos/id/123/1280/720`}]},play:async({canvas:e,userEvent:t})=>{let n=e.queryAllByRole(`group`)[0]?.children,r=Array.from(n??[]),[i,a]=e.queryAllByRole(`button`);if(!a||!i)return;for(let e=0;e<r.length;e++)e>0&&await t.click(a),await c(r,e);for(let e=r.length-1;e>0;e--)await t.click(i),await c(r,e-1);let o=e.getAllByRole(`tab`,{name:`Afbeelding 3: Chairs`})[0];await t.click(o),await c(r,2)},render:(e,t)=>(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(a,{...e,"data-testid":`interaction-test`}),n(a,{args:e},t)]}),tags:[`!dev`,`!autodocs`,`!manifest`]},m=[`Test`],p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    images: [{
      alt: 'Bridge',
...
}`,...p.parameters?.docs?.source}}}})))()}h();export{p as Test,m as __namedExportsOrder,f as default};