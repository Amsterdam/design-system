import{j as e}from"./iframe-BWlKszIU.js";import{useMDXComponents as i}from"./index-DG52xHIb.js";import{M as t}from"./blocks-DI_HeA0I.js";import"./preload-helper-PPVm8Dsz.js";import"./index-5Rjmn65g.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(t,{title:"Docs/Developer Guide/Breakpoints"}),`
...
`,e.jsxs(n.p,{children:["By querying only on viewport width, and by not specifying a ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/At-rules/@media#media_types",rel:"nofollow",children:"media type"}),", the media type ",e.jsx(n.code,{children:"all"})," is implied and the page layout will also look correct when printing."]}),`
