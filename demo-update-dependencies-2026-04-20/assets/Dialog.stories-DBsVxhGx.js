import{n as e,r as t}from"./chunk-zsgVPwQN.js";import{t as n}from"./jsx-runtime-GmyBfqKJ.js";import{G as r,a as i,j as a,t as o}from"./index.esm-Cv-SSCnd.js";import{Z as s,t as c}from"./src-DVOPPjeo.js";var l=t({Confirmation:()=>m,Default:()=>p,__namedExportsOrder:()=>h,default:()=>f}),u,d,f,p,m,h,g=e((()=>{r(),c(),u=n(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,f={title:`Components/Containers/Dialog`,component:s,argTypes:{footer:{table:{disable:!0}},heading:{description:`The text for the heading.`},open:{description:`Whether the dialog box is active and available for interaction.`}},decorators:[(e,{args:t})=>(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(i,{onClick:()=>{d(`open`)(),s.open(`#${t.id}`)},children:`Open`}),(0,u.jsx)(e,{})]})]},p={args:{children:(0,u.jsx)(a,{children:`U ontvangt een bevestiging per e-mail.`}),footer:(0,u.jsx)(i,{onClick:e=>(d(`close`)(),s.close(e)),children:`Sluiten`}),heading:`De gegevens zijn opgeslagen`,id:`ams-dialog-default`}},m={args:{children:(0,u.jsx)(`form`,{id:`ams-dialog-form`,method:`dialog`,children:(0,u.jsx)(a,{children:`Weet u zeker dat u door wilt gaan met het uitvoeren van deze actie? Gegevens die nog niet opgeslagen zijn gaan dan verloren.`})}),footer:(0,u.jsxs)(o,{children:[(0,u.jsx)(i,{form:`ams-dialog-form`,onClick:d(`continue`),type:`submit`,value:`submit`,children:`Doorgaan`}),(0,u.jsx)(i,{onClick:e=>(d(`cancel`)(),s.close(e)),variant:`secondary`,children:`Stoppen`})]}),heading:`Niet alle gegevens zijn opgeslagen`,id:`ams-dialog-asking-to-confirm`}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
