import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-Bmd7fM3i.js";import{r as n}from"./react-DbUYMjRx.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-C6Hd8gUA.js";import{n as l,t as u}from"./DesignTokensTable-CGRc5UVm.js";import{t as d}from"./mdx-react-shim-CjtwJDvm.js";import{Alignment as f,HorizontalAlignment as p,ImproveSemantics as m,n as h,t as g}from"./Column.stories-DlXDfIJp.js";var _,v=e((()=>{_=`<!-- @license CC0-1.0 -->

# Column

Stacks its children vertically with gaps between them and offers alignment options.
`})),y,b,x=e((()=>{y={column:{gap:{"x-small":{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},small:{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},medium:{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},large:{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"x-large":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}}},b={ams:y}}));function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:g}),`
