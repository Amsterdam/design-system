...
Give that Grid a `,(0,m.jsx)(t.code,{children:`gapVertical`}),` of `,(0,m.jsx)(t.code,{children:`none`}),`, let the heading Cell set the right amount with an `,(0,m.jsx)(t.code,{children:`ams-mb-*`}),` utility, and put the Cells below it in a Subgrid with a `,(0,m.jsx)(t.code,{children:`gapVertical`}),` of `,(0,m.jsx)(t.code,{children:`x-large`}),`, which is the gap the Grid used to give them.
