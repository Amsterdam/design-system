...
`,(0,g.jsx)(n.h2,{id:`with-breakout`,children:`With Breakout`}),`
...
`,(0,g.jsxs)(n.p,{children:[`Stack a run of short link sections in one Grid Cell rather than giving each its own.
`,(0,g.jsx)(n.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` then spaces them against one another, pair by pair, as the vertical space guide asks.
...
Keep the name and the role above it in a Paragraph: they are not links, and a list of two items reads as a set of ways to get in touch.`]})]})}function h(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(m,{...e})}):m(e)}var g;function _(){return(_=e((()=>{g=a(),s(),n(),c(),p(),u()})))()}_();export{h as default};