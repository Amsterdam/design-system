import{I as d,h as m,j as r,H as z}from"./iframe-IvLP1EAe.js";import{i as p,I as c}from"./Icon-B50ASBZq.js";import{R as g}from"./Row-Dg6xDrWS.js";import{P as h}from"./Paragraph-gq_XDTst.js";const S={title:"Components/Media/Icon",component:c,args:{svg:m},argTypes:{color:{control:{labels:{undefined:"default"},type:"radio"},options:[void 0,"inverse"]},size:{control:{labels:{undefined:"default"},type:"select"},options:[void 0,...p]},svg:{control:{type:"select"},mapping:d,options:Object.keys(d)}}},a={},o={argTypes:{size:{control:{labels:{undefined:"medium (default)"}},options:["small",void 0,"large"]}},render:e=>{const s=e.size,u=l=>l===void 0?"Regular":l.charAt(0).toUpperCase()+l.slice(1);return r.jsxs(g,{gap:"small",children:[r.jsx(c,{...e}),r.jsxs(h,{color:e.color,size:s,children:[u(s)," body text"]})]})}},n={args:{size:"heading-3"},argTypes:{size:{options:[...p.filter(e=>e.startsWith("heading-")&&!["heading-0","heading-6"].includes(e))]}},render:e=>{const s=e.size?e.size.slice(-1):"3";return r.jsxs(g,{gap:"small",children:[r.jsx(c,{...e}),r.jsxs(z,{color:e.color,level:1,size:`level-${s}`,children:["Heading ",s," text"]})]})}},i={args:{square:!0}},t={args:{color:"inverse"}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{}",...a.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  ...
  argTypes: {
    size: {
      options: [...iconSizes.filter(size => size.startsWith('heading-') && !['heading-0', 'heading-6'].includes(size))]
    }
  },
  render: args => {
...
}`,...t.parameters?.docs?.source}}};const f=["Default","WithBodyText","WithAHeading","Square","InverseColour"],j=Object.freeze(Object.defineProperty({__proto__:null,Default:a,InverseColour:t,Square:i,WithAHeading:n,WithBodyText:o,__namedExportsOrder:f,default:S},Symbol.toStringTag,{value:"Module"}));export{j as I,i as S,o as W,n as a,t as b};
