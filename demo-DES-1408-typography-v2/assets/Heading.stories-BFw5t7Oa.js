import{j as a,C as m,r as l,R as u,g as z,h as S}from"./iframe-C3Tg_stg.js";import{e as f}from"./exampleContent-B7cDFRSs.js";import{H as r}from"./Heading-dwowNoNK.js";const h=f(),y={title:"Components/Text/Heading",component:r,args:{children:h,level:1},argTypes:{children:{description:"The heading text.",table:{disable:!1}},color:{control:{labels:{undefined:"default"},type:"radio"},options:[void 0,"inverse"]}}},n={},o={},i={args:{level:2}},t={args:{level:3}},c={args:{level:4}},d={args:{level:2},render:e=>a.jsxs(m,{gap:"small",children:[l.createElement(r,{...e,key:"level-1",size:"level-1"}),l.createElement(r,{...e,key:"level-2",size:"level-2"}),l.createElement(r,{...e,key:"level-3",size:"level-3"}),l.createElement(r,{...e,key:"level-4",size:"level-4"}),l.createElement(r,{...e,key:"level-5",size:"level-5"})]})},v={args:{color:"inverse",level:2}},p={args:{children:"Heading text",level:4},argTypes:{level:{options:[3,4]},size:{control:{labels:{undefined:"not set"}},options:[void 0,"level-3","level-4","level-5"]}},render:({children:e,...s})=>{let g;return s.level&&(g=`heading-${s.level}`),s.size&&(g=s.size.replace("level","heading")),a.jsxs(u,{gap:"small",children:[a.jsx(z,{color:s.color,size:g,svg:a.jsx(S,{})}),a.jsx(r,{...s,children:e})]})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"{}",...o.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
    level: 2
  }
