import{j as o}from"./iframe-Bg2ZLyAv.js";import{useMDXComponents as r}from"./index-BUr58BCQ.js";import{M as a,e as i,f as s,h as c,i as l}from"./blocks-CKdm6-la.js";import{a as h,H as g}from"./Spotlight.stories-CaUT1q1i.js";import{D as d}from"./DesignTokensTable-BHivcj29.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D3aoEcYY.js";import"./exampleContent-D2tKGi5u.js";import"./BorderSample-DA3zDn7c.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-Cxu7al4l.js";import"./ColorSample-BEWQ4Q02.js";import"./SpaceSample-D--6eo5-.js";import"./TypographySample-Z21kFVaG.js";const p=`<!-- @license CC0-1.0 -->
...
`,m={spotlight:{"background-color":{$value:"{ams.color.highlight.purple}",$type:"color"},azure:{"background-color":{$value:"{ams.color.highlight.azure}",$type:"color"}},green:{"background-color":{$value:"{ams.color.highlight.green}",$type:"color"}},lime:{"background-color":{$value:"{ams.color.highlight.lime}",$type:"color"}},magenta:{"background-color":{$value:"{ams.color.highlight.magenta}",$type:"color"}},orange:{"background-color":{$value:"{ams.color.highlight.orange}",$type:"color"}},yellow:{"background-color":{$value:"{ams.color.highlight.yellow}",$type:"color"}},print:{"background-color":{$value:"{ams.color.print.background}",$type:"color"}}}},u={ams:m};function e(n){const t={h2:"h2",h3:"h3",p:"p",...r(),...n.components};return o.jsxs(o.Fragment,{children:[`
`,`
`,`
`,`
`,o.jsx(a,{of:h}),`
