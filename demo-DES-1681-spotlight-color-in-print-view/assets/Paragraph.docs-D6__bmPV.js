import{j as e}from"./iframe-BHFickIL.js";import{useMDXComponents as s}from"./index-B2tmsJLC.js";import{M as r,e as i,f as h,h as l,i as a}from"./blocks-OZjfGHFq.js";import{P as p,L as c,S as d,I as g,W as m}from"./Paragraph.stories-BLZS9pQw.js";import{D as x}from"./DesignTokensTable-CsJVxgkZ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BEbCKiHE.js";import"./exampleContent-D2tKGi5u.js";import"./Paragraph-CM5jKl3r.js";import"./Row-CNeH_YYg.js";import"./Icon-CqQwDuKc.js";import"./BorderSample-DhPoT_uX.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-U6TdLDI5.js";import"./ColorSample-I4QsD_Xy.js";import"./SpaceSample-DHCB5Bvz.js";import"./TypographySample-CPl1ktW9.js";const u=`<!-- @license CC0-1.0 -->
...
`,f={paragraph:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}},print:{color:{$value:"{ams.color.print.text}",$type:"color"}},small:{"font-size":{$value:"{ams.typography.body-text.small.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"line-height":{$value:"{ams.typography.body-text.small.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}}},large:{"font-size":{$value:"{ams.typography.body-text.large.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"line-height":{$value:"{ams.typography.body-text.large.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"text-wrap":{$value:"balance"}}}},w={ams:f};function o(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:p}),`
...
`,e.jsx(x,{tokens:w})]})}function E(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{E as default};
