import{j as e}from"./jsx-runtime-j_jdvEMj.js";import{S as z}from"./index.esm-CcVijhgF.js";import{c as H}from"./clsx-B-dksMZM.js";import{r as F}from"./index-B-o1Wr-g.js";import{g as W,p as X}from"./paddingClasses-C5gheHLv.js";const J=F.forwardRef(({as:a="div",children:r,className:u,span:g,start:v,...y},f)=>e.jsx(a,{...y,ref:f,className:H("ams-grid__cell",W(g,v),u),children:r}));J.displayName="Grid.Cell";try{Grid.Cell.displayName="Grid.Cell",Grid.Cell.__docgenInfo={description:"",displayName:"Grid.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
