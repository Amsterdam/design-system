import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{Wt as n}from"./iframe-B0hLoJaV.js";import{t as r,ut as i}from"./src-VMDJOoIy.js";var a=t({DatesWithoutLinks:()=>d,Default:()=>u,__namedExportsOrder:()=>f,default:()=>l}),o,s,c,l,u,d,f,p=e((()=>{r(),o=n(),s=e=>`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`,c=({onClick:e,...t})=>(0,o.jsx)(`a`,{...t,onClick:t=>{t.preventDefault(),e?.(t)}}),l={title:`Components/Navigation/Calendar`,component:i,args:{linkComponent:c,linkTemplate:e=>`?date=${s(e)}`},argTypes:{defaultMonth:{table:{disable:!0}},linkComponent:{table:{disable:!0}},linkTemplate:{table:{disable:!0}},locale:{table:{disable:!0}}}},u={parameters:{docs:{source:{code:"<Calendar linkTemplate={(date: Date): string | undefined => `?date=${formatDate(date)}`} />"}}}},d={args:{linkTemplate:e=>e.getDay()===0||e.getDay()===6?void 0:`?date=${s(e)}`},parameters:{docs:{source:{code:`<Calendar
