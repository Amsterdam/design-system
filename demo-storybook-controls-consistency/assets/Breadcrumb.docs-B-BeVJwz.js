...
`,(0,S.jsx)(t.h3,{id:`link`,children:`Link`}),`
`,(0,S.jsxs)(t.p,{children:[`Renders both the list item and the anchor.
Set `,(0,S.jsx)(t.code,{children:`linkComponent`}),` to integrate with a routing library.`]}),`
`,(0,S.jsx)(o,{of:h}),`
`,(0,S.jsx)(c,{of:h}),`
`,(0,S.jsx)(t.h2,{id:`usage-guidelines`,children:`Usage guidelines`}),`
`,(0,S.jsx)(t.h3,{id:`when-to-use`,children:`When to use`}),`
`,(0,S.jsx)(t.p,{children:`Use a Breadcrumb to show where the current page sits within the hierarchy of the website and to let users navigate between levels.`}),`
`,(0,S.jsx)(t.h3,{id:`when-not-to-use`,children:`When not to use`}),`
`,(0,S.jsx)(t.p,{children:`Don’t use a Breadcrumb on pages that contain forms.
It can distract users from completing the form, or be confused with a progress indicator.`}),`
`,(0,S.jsx)(t.p,{children:`A Breadcrumb should not have more than 5 items.`}),`
`,(0,S.jsx)(t.h3,{id:`how-to-write`,children:`How to write`}),`
`,(0,S.jsx)(t.p,{children:`The first item links to the home page, with ‘Home’ as its text.
...
`,(0,S.jsx)(d,{tokens:v})]})}function x(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,S.jsx)(t,{...e,children:(0,S.jsx)(b,{...e})}):b(e)}var S;e((()=>{S=t(),f(),a(),u(),y(),p(),g()}))();export{x as default};