import{n as e}from"./chunk-DnJy8xQt.js";import{Gt as t}from"./iframe-BUyCNYZb.js";import{r as n}from"./react-Bzcw10Fo.js";import{l as r,m as i}from"./blocks-BBvpF1wH.js";import{t as a}from"./mdx-react-shim-W-DFM8wX.js";import{n as o,t as s}from"./HandbookPage.stories-BQM0Xky5.js";function c(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,u.jsxs)(u.Fragment,{children:[`
`,`
`,(0,u.jsx)(r,{of:s}),`
...
`,(0,u.jsxs)(t.ul,{children:[`
`,(0,u.jsxs)(t.li,{children:[`A `,(0,u.jsx)(t.a,{href:`/docs/components-navigation-skip-link--docs`,children:`Skip Link`}),` inside the Table of Contents lets keyboard users bypass it and jump straight to the content.`]}),`
`,(0,u.jsxs)(t.li,{children:[`Set `,(0,u.jsx)(t.code,{children:`aria-current="page"`}),` on the active link and `,(0,u.jsx)(t.code,{children:`defaultExpanded`}),` on its ancestors so the current position is pre-expanded on load.`]}),`
`]}),`
`]}),`
