import{a as e,n as t,r as n}from"./chunk-DnJy8xQt.js";import{Et as r,Gt as i,Ht as a,On as o,Ot as s,ct as c,pt as l}from"./iframe-BUyCNYZb.js";import{s as u,t as d}from"./src-EUHLDT-7.js";var f=n({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{a(),d(),p=e(o()),m=i(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}}},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(_);return(0,m.jsx)(u,{...e,children:(0,m.jsx)(u.List,{children:_.map(e=>(0,m.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},b=[{icon:s,label:`Gegevens`},{icon:l,label:`Aanslagen`},{icon:c,label:`Documenten`},{icon:r,label:`Acties`}],x={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
