import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-CV8OE4Vp.js";import{r as n}from"./react-DkT3fzMC.js";import{c as r,f as i,l as a,n as o,s,u as c}from"./blocks-0Scekayb.js";import{n as l,t as u}from"./DesignTokensTable-KqJCplqL.js";import{t as d}from"./mdx-react-shim-D4mV93Wn.js";import{WithInput as f,n as p,t as m}from"./FileList.stories-HBTekXrT.js";var h,g=e((()=>{h=`/**
 * @license EUPL-1.2+
...
`})),y,b,x=e((()=>{y={"file-list":{gap:{$value:`{ams.space.m}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"padding-block":{$value:`{ams.space.m}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},file:{"font-family":{$value:`{ams.typography.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.typography.body-text.small.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.font-weight}`,$type:`fontWeight`},gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"line-height":{$value:`{ams.typography.body-text.small.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},details:{color:{$value:`{ams.color.text.secondary}`,$type:`color`}},preview:{width:{$value:`clamp(2.5rem, 10vw, 5rem)`,$extensions:{"nl.amsterdam.type":`dimension`}}}}}},b={ams:y}}));function S(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:m}),`
