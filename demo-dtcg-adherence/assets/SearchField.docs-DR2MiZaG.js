import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-CV8OE4Vp.js";import{r as n}from"./react-DkT3fzMC.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-0Scekayb.js";import{n as l,t as u}from"./DesignTokensTable-KqJCplqL.js";import{t as d}from"./mdx-react-shim-D4mV93Wn.js";import{Controlled as f,WithPlaceholder as p,n as m,t as h}from"./SearchField.stories-BiFcs7Ts.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={"search-field":{input:{"background-color":{$value:`{ams.inputs.background-color}`,$type:`color`},"border-color":{$value:`{ams.inputs.border-color}`,$type:`color`},"border-style":{$value:`{ams.inputs.border-style}`,$extensions:{"nl.amsterdam.type":`borderStyle`}},"border-width":{$value:`{ams.inputs.border-width}`,$extensions:{"nl.amsterdam.type":`borderWidth`}},color:{$value:`{ams.inputs.color}`,$type:`color`},"font-family":{$value:`{ams.inputs.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.inputs.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.inputs.font-weight}`,$type:`fontWeight`},"line-height":{$value:`{ams.inputs.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},"outline-offset":{$value:`{ams.inputs.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.inputs.padding-block}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.inputs.padding-inline}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},hover:{"box-shadow":{$type:`shadow`,$value:`{ams.inputs.hover.box-shadow}`}},invalid:{"border-color":{$value:`{ams.inputs.invalid.border-color}`,$type:`color`},hover:{"border-color":{$value:`{ams.inputs.invalid.hover.border-color}`,$type:`color`},"box-shadow":{$type:`shadow`,$value:`{ams.inputs.invalid.hover.box-shadow}`}}},"cancel-button":{"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23004699' fill-rule='evenodd' d='M29.333 5.47 26.53 2.668 16 13.187 5.47 2.666 2.668 5.47 13.187 16 2.666 26.53l2.804 2.803L16 18.813l10.53 10.52 2.803-2.804L18.813 16z'/></svg>")`,$extensions:{"nl.amsterdam.type":`backgroundImage`}},"block-size":{$value:`{ams.typography.body-text.font-size}`,$type:`dimension`},color:{$value:`{ams.color.interactive.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},"inline-size":{$value:`{ams.typography.body-text.font-size}`,$type:`dimension`}},placeholder:{color:{$value:`{ams.inputs.placeholder.color}`,$type:`color`}}}}},y={ams:v}}));function x(e){let t={h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
