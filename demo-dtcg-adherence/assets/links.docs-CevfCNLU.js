import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-CV8OE4Vp.js";import{r as n}from"./react-DkT3fzMC.js";import{c as r,f as i}from"./blocks-0Scekayb.js";import{n as a,t as o}from"./DesignTokensTable-KqJCplqL.js";import{t as s}from"./mdx-react-shim-D4mV93Wn.js";var c,l,u=e((()=>{c={links:{$description:`Shared base styles for all link-like components.`,color:{$value:`{ams.color.interactive.default}`,$type:`color`},"text-decoration-thickness":{$value:{value:.125,unit:`rem`},$type:`dimension`,$description:`2px equivalent.`,$extensions:{"nl.amsterdam.hint":`2px`}},"text-underline-offset":{$value:{value:.15625,unit:`rem`},$type:`dimension`,$description:`2.5px equivalent.`,$extensions:{"nl.amsterdam.hint":`2.5px`,"nl.amsterdam.subtype":`space`}},hover:{$description:`On hover the underline thickens and moves closer to the text.`,color:{$value:`{ams.color.interactive.hover}`,$type:`color`},"text-decoration-thickness":{$value:{value:.1875,unit:`rem`},$type:`dimension`,$description:`3px equivalent.`,$extensions:{"nl.amsterdam.hint":`3px`}},"text-underline-offset":{$value:{value:.09375,unit:`rem`},$type:`dimension`,$description:`1.5px equivalent.`,$extensions:{"nl.amsterdam.hint":`1.5px`,"nl.amsterdam.subtype":`space`}}},subtle:{$description:`For links that are already recognisable from context, e.g. in navigation menus. No underline by default; underline appears on hover.`,"text-decoration-line":{$value:`none`,$extensions:{"nl.amsterdam.type":`textDecorationLine`}},hover:{"text-decoration-line":{$value:`underline`,$extensions:{"nl.amsterdam.type":`textDecorationLine`}}}},contrast:{$description:`For links on coloured backgrounds where the default blue lacks sufficient contrast.`,color:{$value:`{ams.color.interactive.contrast}`},hover:{color:{$value:`{ams.color.interactive.contrast}`}},$type:`color`},inverse:{$description:`For links on dark backgrounds.`,color:{$value:`{ams.color.interactive.inverse}`},hover:{color:{$value:`{ams.color.interactive.inverse}`}},$type:`color`}}},l={ams:c}}));function d(e){let t={h1:`h1`,h2:`h2`,p:`p`,...n(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[`
`,`
...
`,(0,p.jsx)(o,{path:`ams.links.subtle`,showDescriptions:!0,tokens:l}),`
...
`,(0,p.jsx)(o,{path:`ams.links.contrast`,showDescriptions:!0,tokens:l}),`
`,(0,p.jsx)(t.h2,{id:`inverse`,children:`Inverse`}),`
`,(0,p.jsx)(t.p,{children:`On dark backgrounds, links have the inverse colour.`}),`
`,(0,p.jsx)(o,{path:`ams.links.inverse`,showDescriptions:!0,tokens:l}),`
