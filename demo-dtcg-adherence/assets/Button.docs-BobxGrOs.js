import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-BY6BFzy7.js";import{r as n}from"./react-R3CUuDdq.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-C3naI7ce.js";import{n as l,t as u}from"./DesignTokensTable-Bfsm2FSg.js";import{t as d}from"./mdx-react-shim-DbkeoZER.js";import{Primary as f,Secondary as p,Tertiary as m,TextWrapping as h,WithIcon as g,WithIconBefore as _,WithIconOnly as v,n as y,t as b}from"./Button.stories-Wdjms_U_.js";var x,S=e((()=>{x=`<!-- @license CC0-1.0 -->
...
`})),C,w,T=e((()=>{C={button:{"border-style":{$value:`solid`,$extensions:{"nl.amsterdam.type":`borderStyle`}},"border-width":{$value:`{ams.border.width.m}`,$extensions:{"nl.amsterdam.type":`borderWidth`}},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},"font-family":{$value:`{ams.typography.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.typography.body-text.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.font-weight}`,$type:`fontWeight`},"line-height":{$value:`{ams.inputs.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"padding-inline":{$value:`{ams.space.m}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},disabled:{cursor:{$value:`{ams.cursor.disabled}`,$extensions:{"nl.amsterdam.type":`cursor`}}},"icon-only":{"padding-block":{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"padding-inline":{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}}},primary:{"background-color":{$value:`{ams.color.interactive.default}`},"border-color":{$value:`{ams.color.interactive.default}`},color:{$value:`{ams.color.text.inverse}`},disabled:{"background-color":{$value:`{ams.color.interactive.disabled}`},"border-color":{$value:`{ams.color.interactive.disabled}`}},hover:{"background-color":{$value:`{ams.color.interactive.hover}`},"border-color":{$value:`{ams.color.interactive.hover}`}},$type:`color`},secondary:{"background-color":{$value:`{ams.color.background.default}`,$type:`color`},"border-color":{$value:`currentColor`,$type:`color`},color:{$value:`{ams.color.interactive.default}`,$type:`color`},disabled:{"border-color":{$value:`{ams.color.interactive.disabled}`},color:{$value:`{ams.color.interactive.disabled}`},$type:`color`},hover:{"box-shadow":{$type:`shadow`,$value:{inset:!0,offsetX:{value:0,unit:`rem`},offsetY:{value:0,unit:`rem`},blur:{value:0,unit:`rem`},spread:`{ams.border.width.s}`,color:`currentColor`}},color:{$value:`{ams.color.interactive.hover}`,$type:`color`}}},tertiary:{"background-color":{$value:`transparent`},"border-color":{$value:`transparent`},color:{$value:`{ams.color.interactive.default}`},disabled:{color:{$value:`{ams.color.interactive.disabled}`}},hover:{"border-color":{$value:`currentColor`},color:{$value:`{ams.color.interactive.hover}`}},$type:`color`}}},w={ams:C}}));function E(e){let t={a:`a`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,O.jsxs)(O.Fragment,{children:[`
`,`
`,`
`,`
`,(0,O.jsx)(r,{of:b}),`
