import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-BlOiKA4y.js";import{r as n}from"./react-DtlZJakN.js";import{c as r,f as i,i as a,l as o,s}from"./blocks-BDBArWWP.js";import{n as c,t as l}from"./DesignTokensTable-B3MRkm3L.js";import{t as u}from"./mdx-react-shim-BIdh45KS.js";import{n as d,t as f}from"./Page.stories-CqlKAcWE.js";var p,m=e((()=>{p=`<!-- @license CC0-1.0 -->
...
`})),h,g,_=e((()=>{h={page:{"background-color":{$value:`{ams.color.background.body}`,$type:`color`},"max-inline-size":{$value:{value:90,unit:`rem`},$type:`dimension`},"with-menu":{"max-inline-size":{$value:{value:120,unit:`rem`}},"area-skip-link":{"margin-inline-end":{$value:`{ams.grid.padding-inline}`,$extensions:{"nl.amsterdam.hint":`Must be the Grid inline padding, to make sure Skip Link and Grid line up.`,"nl.amsterdam.subtype":`space`}}},$type:`dimension`}}},g={ams:h}}));function v(e){let t={a:`a`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[`
`,`
`,`
`,`
`,(0,b.jsx)(r,{of:f}),`
