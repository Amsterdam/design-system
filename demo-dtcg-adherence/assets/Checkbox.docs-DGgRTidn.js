...
`})),b,x,S=e((()=>{b={checkbox:{color:{$value:`{ams.color.text.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},"font-family":{$value:`{ams.typography.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.typography.body-text.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.font-weight}`,$type:`fontWeight`},gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"line-height":{$value:`{ams.typography.body-text.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"text-decoration-thickness":{$value:`{ams.links.text-decoration-thickness}`,$type:`dimension`},"text-underline-offset":{$value:`{ams.links.text-underline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},disabled:{cursor:{$value:`{ams.cursor.disabled}`,$extensions:{"nl.amsterdam.type":`cursor`}},color:{$value:`{ams.color.interactive.disabled}`,$type:`color`}},hover:{color:{$value:`{ams.color.interactive.hover}`,$type:`color`},"text-decoration-line":{$value:`{ams.links.subtle.hover.text-decoration-line}`,$extensions:{"nl.amsterdam.type":`textDecorationLine`}},"text-decoration-thickness":{$deprecated:"Use `ams.checkbox.text-decoration-thickness` instead. Will be removed in release 4.0.0.",$value:`{ams.border.width.m}`,$type:`dimension`}},"checked-indicator":{stroke:{$value:`{ams.color.interactive.inverse}`,$type:`color`}},"hover-indicator":{hover:{stroke:{$value:`{ams.color.interactive.hover}`}},invalid:{hover:{stroke:{$value:`{ams.color.interactive.invalid.hover}`}}},$type:`color`},"icon-container":{"block-size":{$value:`calc({ams.checkbox.font-size} * {ams.checkbox.line-height})`,$extensions:{"nl.amsterdam.type":`dimension`}},"inline-size":{$value:`{ams.checkbox.font-size}`,$type:`dimension`}},"indeterminate-indicator":{stroke:{$value:`{ams.color.interactive.inverse}`,$type:`color`}},rectangle:{fill:{$value:`{ams.color.background.default}`},stroke:{$value:`{ams.color.interactive.default}`},checked:{fill:{$value:`{ams.color.interactive.default}`},disabled:{fill:{$value:`{ams.color.interactive.disabled}`},hover:{fill:{$deprecated:`Will be removed in release 4.0.0.`,$value:`{ams.color.interactive.disabled}`}}},hover:{fill:{$value:`{ams.color.interactive.hover}`},"disabled-invalid":{fill:{$deprecated:`Will be removed in release 4.0.0.`,$value:`{ams.color.interactive.disabled}`}}},invalid:{fill:{$value:`{ams.color.interactive.invalid.default}`},hover:{fill:{$value:`{ams.color.interactive.invalid.hover}`}}}},disabled:{stroke:{$value:`{ams.color.interactive.disabled}`}},hover:{stroke:{$value:`{ams.color.interactive.hover}`},"disabled-invalid":{stroke:{$deprecated:`Will be removed in release 4.0.0.`,$value:`{ams.color.interactive.disabled}`}}},indeterminate:{fill:{$value:`{ams.color.interactive.default}`},disabled:{fill:{$value:`{ams.color.interactive.disabled}`},hover:{fill:{$deprecated:`Will be removed in release 4.0.0.`,$value:`{ams.color.interactive.disabled}`}}},hover:{fill:{$value:`{ams.color.interactive.hover}`},"disabled-invalid":{fill:{$deprecated:`Will be removed in release 4.0.0.`,$value:`{ams.color.interactive.disabled}`}}},invalid:{fill:{$value:`{ams.color.interactive.invalid.default}`},hover:{fill:{$value:`{ams.color.interactive.invalid.hover}`}}}},invalid:{stroke:{$value:`{ams.color.interactive.invalid.default}`},hover:{stroke:{$value:`{ams.color.interactive.invalid.hover}`}}},$type:`color`}}},x={ams:b}}));function C(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,T.jsxs)(T.Fragment,{children:[`
`,`
`,`
`,`
`,(0,T.jsx)(r,{of:_}),`
