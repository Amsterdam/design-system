import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-CV8OE4Vp.js";import{r as n}from"./react-DkT3fzMC.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-0Scekayb.js";import{n as l,t as u}from"./DesignTokensTable-KqJCplqL.js";import{t as d}from"./mdx-react-shim-D4mV93Wn.js";import{InverseColour as f,Level1 as p,Level2 as m,Level3 as h,Level4 as g,Sizes as _,WithIcon as v,n as y,t as b}from"./Heading.stories-CWQffR3H.js";var x,S=e((()=>{x=`<!-- @license CC0-1.0 -->
...
`})),C,w,T=e((()=>{C={heading:{1:{"font-size":{$value:`{ams.typography.heading.1.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.1.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},2:{"font-size":{$value:`{ams.typography.heading.2.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.2.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},3:{"font-size":{$value:`{ams.typography.heading.3.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.3.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},4:{"font-size":{$value:`{ams.typography.heading.4.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.4.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},5:{"font-size":{$value:`{ams.typography.heading.5.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.5.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},6:{"font-size":{$value:`{ams.typography.heading.6.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"line-height":{$value:`{ams.typography.heading.6.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`}},color:{$value:`{ams.color.text.default}`,$type:`color`},"font-family":{$value:`{ams.typography.font-family}`,$type:`fontFamily`},"font-weight":{$value:`{ams.typography.heading.font-weight}`,$type:`fontWeight`},"text-wrap":{$value:`{ams.typography.heading.text-wrap}`,$extensions:{"nl.amsterdam.type":`textWrap`}},inverse:{color:{$value:`{ams.color.text.inverse}`,$type:`color`}}}},w={ams:C}}));function E(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,...n(),...e.components};return(0,O.jsxs)(O.Fragment,{children:[`
`,`
`,`
`,`
`,(0,O.jsx)(r,{of:b}),`
