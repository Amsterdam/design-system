import{n as e}from"./chunk-BneVvdWh.js";import{At as t}from"./iframe-BY6BFzy7.js";import{r as n}from"./react-R3CUuDdq.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-C3naI7ce.js";import{n as l,t as u}from"./DesignTokensTable-Bfsm2FSg.js";import{t as d}from"./mdx-react-shim-DbkeoZER.js";import{Disabled as f,Grouped as p,InAField as m,InAFieldWithValidation as h,Invalid as g,n as _,t as v}from"./Select.stories-B-pwKzqL.js";var y,b=e((()=>{y=`<!-- @license CC0-1.0 -->
...
`})),x,S,C=e((()=>{x={select:{"background-color":{$value:`{ams.inputs.background-color}`,$type:`color`},"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23004699' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`,$extensions:{"nl.amsterdam.type":`backgroundImage`}},"background-position":{$value:`right {ams.space.m} center`,$extensions:{"nl.amsterdam.type":`backgroundPosition`}},"border-color":{$value:`{ams.inputs.border-color}`,$type:`color`},"border-style":{$value:`{ams.inputs.border-style}`,$extensions:{"nl.amsterdam.type":`borderStyle`}},"border-width":{$value:`{ams.inputs.border-width}`,$extensions:{"nl.amsterdam.type":`borderWidth`}},color:{$value:`{ams.inputs.color}`,$type:`color`},"font-family":{$value:`{ams.inputs.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.inputs.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.inputs.font-weight}`,$type:`fontWeight`},"line-height":{$value:`{ams.inputs.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},"outline-offset":{$value:`{ams.inputs.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.inputs.padding-block}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.inputs.padding-inline} calc(2 * {ams.inputs.padding-inline} + 1em)`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},disabled:{"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23767676' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`,$extensions:{"nl.amsterdam.type":`backgroundImage`}},color:{$value:`{ams.inputs.disabled.color}`,$type:`color`},cursor:{$value:`{ams.cursor.disabled}`,$extensions:{"nl.amsterdam.type":`cursor`}}},hover:{"box-shadow":{$type:`shadow`,$value:`{ams.inputs.hover.box-shadow}`},"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23003677' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`,$extensions:{"nl.amsterdam.type":`backgroundImage`}}},invalid:{"border-color":{$value:`{ams.inputs.invalid.border-color}`,$type:`color`},hover:{"border-color":{$value:`{ams.inputs.invalid.hover.border-color}`,$type:`color`},"box-shadow":{$type:`shadow`,$value:`{ams.inputs.invalid.hover.box-shadow}`}}},option:{disabled:{color:{$value:`{ams.color.interactive.disabled}`,$type:`color`}}}}},S={ams:x}}));function w(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,E.jsxs)(E.Fragment,{children:[`
`,`
`,`
`,`
`,(0,E.jsx)(r,{of:v}),`
