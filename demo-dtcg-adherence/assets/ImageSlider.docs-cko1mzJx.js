import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-Bz5c2DC8.js";import{r as n}from"./react-Bp5Cvj_f.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-DlHWOhZb.js";import{n as l,t as u}from"./DesignTokensTable-B9_CsXB9.js";import{t as d}from"./mdx-react-shim-BaTPcu_p.js";import{ResponsiveImages as f,WithCaptions as p,n as m,t as h}from"./ImageSlider.stories-B0JCwO0s.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={"image-slider":{gap:{$value:`{ams.space.xs}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},scroller:{gap:{$value:`{ams.space.xs}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},thumbnails:{gap:{$value:`{ams.space.xs}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},thumbnail:{"background-color":{$value:`transparent`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},opacity:{$value:`40%`,$extensions:{"nl.amsterdam.type":`opacity`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"in-view":{opacity:{$value:`100%`,$extensions:{"nl.amsterdam.type":`opacity`}}},hover:{opacity:{$value:`100%`,$extensions:{"nl.amsterdam.type":`opacity`}}}}},figure:{"margin-block-end":{$value:`{ams.space.m}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}}}}},y={ams:v}}));function x(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
