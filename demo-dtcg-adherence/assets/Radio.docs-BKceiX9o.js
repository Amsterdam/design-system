import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-Bz5c2DC8.js";import{r as n}from"./react-Bp5Cvj_f.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-DlHWOhZb.js";import{n as l,t as u}from"./DesignTokensTable-B9_CsXB9.js";import{t as d}from"./mdx-react-shim-BaTPcu_p.js";import{InAFieldSet as f,InAFieldSetWithValidation as p,WithCustomIcon as m,n as h,t as g}from"./Radio.stories-Bmnhb6Iv.js";var _,v=e((()=>{_=`<!-- @license CC0-1.0 -->
...
`})),y,b,x=e((()=>{y={radio:{color:{$value:`{ams.color.text.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},"font-family":{$value:`{ams.typography.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.typography.body-text.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.font-weight}`,$type:`fontWeight`},gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"line-height":{$value:`{ams.typography.body-text.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"text-decoration-thickness":{$value:`{ams.links.text-decoration-thickness}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"text-underline-offset":{$value:`{ams.links.text-underline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"checked-indicator":{fill:{$value:`{ams.color.interactive.default}`},disabled:{fill:{$value:`{ams.color.interactive.disabled}`}},"disabled-invalid":{fill:{$value:`{ams.color.interactive.disabled}`},hover:{fill:{$value:`{ams.color.interactive.disabled}`}}},hover:{fill:{$value:`{ams.color.interactive.hover}`}},invalid:{fill:{$value:`{ams.color.interactive.invalid.default}`},hover:{fill:{$value:`{ams.color.interactive.invalid.hover}`}}},$type:`color`},"hover-indicator":{hover:{stroke:{$value:`{ams.color.interactive.hover}`}},invalid:{hover:{stroke:{$value:`{ams.color.interactive.invalid.hover}`}}},$type:`color`},circle:{fill:{$value:`{ams.color.background.default}`},stroke:{$value:`{ams.color.interactive.default}`},disabled:{stroke:{$value:`{ams.color.interactive.disabled}`}},"disabled-invalid":{stroke:{$value:`{ams.color.interactive.disabled}`},hover:{stroke:{$value:`{ams.color.interactive.disabled}`}}},hover:{stroke:{$value:`{ams.color.interactive.hover}`}},invalid:{stroke:{$value:`{ams.color.interactive.invalid.default}`},hover:{stroke:{$value:`{ams.color.interactive.invalid.hover}`}}},$type:`color`},disabled:{color:{$value:`{ams.color.interactive.disabled}`,$type:`color`},cursor:{$value:`{ams.cursor.disabled}`,$extensions:{"nl.amsterdam.type":`cursor`}}},hover:{color:{$value:`{ams.color.interactive.hover}`,$type:`color`},"text-decoration-line":{$value:`{ams.links.subtle.hover.text-decoration-line}`,$extensions:{"nl.amsterdam.type":`textDecorationLine`}}},"icon-container":{"block-size":{$value:`calc({ams.radio.font-size} * {ams.radio.line-height})`,$extensions:{"nl.amsterdam.type":`dimension`}},"inline-size":{$value:`{ams.radio.font-size}`,$type:`dimension`}}}},b={ams:y}}));function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:g}),`
