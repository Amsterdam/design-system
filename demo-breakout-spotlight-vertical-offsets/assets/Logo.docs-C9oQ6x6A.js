import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,h as r,i,n as a,p as o,u as s}from"./blocks-CqryReaq.js";import{t as c}from"./jsx-runtime-Bq1bXGty.js";import{i as l}from"./react-BnCtKaSV.js";import{n as u,t as d}from"./DesignTokensTable-uVGeWRCl.js";import{t as f}from"./mdx-react-shim-9RzcSRdq.js";import{CustomLogo as p,n as m,t as h}from"./Logo.stories-8xQpTTU4.js";var g,_,v=e((()=>{g={logo:{"block-size":{$value:`{ams.space.xl}`,$extensions:{"nl.amsterdam.type":`dimension`}},"min-block-size":{$value:{value:2.5,unit:`rem`},$type:`dimension`},emblem:{color:{$value:`#ec0000`,$type:`color`}},subsite:{color:{$value:`{ams.color.text.default}`,$extensions:{"nl.amsterdam.type":`color`}}},title:{color:{$value:`#ec0000`,$type:`color`}}}},_={ams:g}}));function y(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components};return(0,x.jsxs)(x.Fragment,{children:[`
`,`
`,`
`,`
`,(0,x.jsx)(s,{of:h}),`
