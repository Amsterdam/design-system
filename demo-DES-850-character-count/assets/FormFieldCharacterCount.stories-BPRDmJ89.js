import{j as h}from"./jsx-runtime-X2b_N9AH.js";import{c as f}from"./clsx-B-dksMZM.js";import{r as g}from"./index-uCp2LrAq.js";const t=g.forwardRef(({className:a,length:o,maxLength:n,...i},p)=>h.jsx("div",{...i,ref:p,className:f("ams-form-field-character-count",o>n&&"ams-form-field-character-count--error",a),role:"status",children:`${o} van ${n} tekens`}));t.displayName="FormFieldCharacterCount";try{t.displayName="FormFieldCharacterCount",t.__docgenInfo={description:"",displayName:"FormFieldCharacterCount",props:{length:{defaultValue:null,description:"The current length of the field’s value.",name:"length",required:!0,type:{name:"number"}},maxLength:{defaultValue:null,description:"The maximum length of the field’s value.",name:"maxLength",required:!0,type:{name:"number"}}}}}catch{}/**
 * @license EUPL-1.2+
