import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-BqsN2jGA.js";import{E as n,l as r,m as i}from"./blocks-T7hHfzZA.js";import{t as a}from"./mdx-react-shim-DfLb-6nr.js";function o(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,...n(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[`
`,`
...
`,(0,c.jsxs)(t.p,{children:[`Refs are forwarded only to intrinsic elements – the default `,(0,c.jsx)(t.code,{children:`<a>`}),`, or a string tag such as `,(0,c.jsx)(t.code,{children:`linkComponent="a"`}),` – not to a custom `,(0,c.jsx)(t.code,{children:`linkComponent`}),`, which may not accept one.
If you need a ref to a custom link component, set it on that component directly.`]})]})}function s(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(o,{...e})}):o(e)}var c;e((()=>{c=t(),a(),i()}))();export{s as default};