import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{useMDXComponents as i}from"./index-CxbY7dAs.js";import{M as a,h as r,P as d,i as l,j as o}from"./index-ukgKbC09.js";import{G as c,V as h,a as p,S as m,b as u,c as x,d as w,I as g}from"./Grid.stories-BhJXkRWX.js";import"./index-yBjzXJbu.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-pCZLvKoJ.js";import"./index-fNjTmf9T.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./common-CfqFMx79.js";import"./Grid-DgTFY_ag.js";import"./clsx-B-dksMZM.js";import"./paddingClasses-C5gheHLv.js";const j=`<!-- @license CC0-1.0 -->
...
`,e.jsx(o,{of:w}),`
`,e.jsx(n.h3,{id:"common-configurations",children:"Common configurations"}),`
`,e.jsxs(n.p,{children:["Some typical page sections always use the same amount of responsive ",e.jsx(n.code,{children:"span"})," and ",e.jsx(n.code,{children:"start"})," values:"]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`For the header of a content page – the part that contains the Heading, date, and lead Paragraph:
`,e.jsx(n.code,{children:"span={{ narrow: 4, medium: 6, wide: 8 }} start={{ narrow: 1, medium: 1, wide: 2 }}"}),"."]}),`
`,e.jsx(n.li,{children:"Breadcrumbs have their own Grid above this section, with the same Cell configuration."}),`
`,e.jsxs(n.li,{children:[`For the body of a content page – the part that contains the main text:
`,e.jsx(n.code,{children:"span={{ narrow: 4, medium: 5, wide: 7 }} start={{ narrow: 1, medium: 2, wide: 3 }}"}),"."]}),`
`,e.jsxs(n.li,{children:[`A two-column layout for sections consisting of a Header, a Paragraph and a Standalone Link:
`,e.jsx(n.code,{children:"span={{ narrow: 4, medium: 4, wide: 6 }}"}),"."]}),`
`,e.jsxs(n.li,{children:[`A three-column layout for Cards:
`,e.jsx(n.code,{children:"span={4}"}),"."]}),`
`,e.jsxs(n.li,{children:[`A four-column layout for Cards:
`,e.jsx(n.code,{children:"span={{ narrow: 4, medium: 4, wide: 3 }}"}),"."]}),`
`]}),`
