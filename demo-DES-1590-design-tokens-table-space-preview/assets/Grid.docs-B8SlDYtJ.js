import{j as e}from"./iframe-Dvp8sHt0.js";import{useMDXComponents as o}from"./index-Ov97-FHm.js";import{M as a,f as l,P as d,h as r,i as s}from"./blocks-CC98D2VE.js";import{G as c,V as p,a as h,S as m,b as u,c as g,d as x,I as w}from"./Grid.stories-CkcKCKDu.js";import{D as f}from"./DesignTokensTable-nlmzRouq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BoH1EIR4.js";import"./common-HRWYXPjp.js";import"./Grid-D8EqRlZX.js";import"./gridCellClasses-DKw8XbSK.js";import"./BorderSample-CEWBA8e5.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-B6mfgo9l.js";import"./SpacingSample-DA4NtHaU.js";const j=`<!-- @license CC0-1.0 -->
...
`,y={grid:{"column-count":{$value:"4"},"column-gap":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-block":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},"padding-inline":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"row-gap":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},medium:{"column-count":{$value:"8"},"padding-inline":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},wide:{"column-count":{$value:"12"},"padding-inline":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}}}},v={ams:y};function i(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(f,{tokens:v})]})}function V(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{V as default};
