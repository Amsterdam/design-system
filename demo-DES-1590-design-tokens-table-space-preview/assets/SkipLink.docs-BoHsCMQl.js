import{j as e}from"./iframe-Dx3tBSCK.js";import{useMDXComponents as o}from"./index-Cm8WOTwj.js";import{M as a,f as p,P as r,h as l,i}from"./blocks-NS2XOqyi.js";import{a as m,O as c,M as d}from"./SkipLink.stories-DWChuUPT.js";import{D as h}from"./DesignTokensTable-Crs8EIUX.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BOhNFwf-.js";import"./BorderSample-BTSZ1UEW.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-Cjeb0sTL.js";import"./SpacingSample-awuARjeK.js";const u=`<!-- @license CC0-1.0 -->
...
`,y={"skip-link":{"background-color":{$value:"{ams.color.interactive.default}",$type:"color"},color:{$value:"{ams.color.text.inverse}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-inline":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},hover:{"background-color":{$value:"{ams.color.interactive.hover}",$type:"color"}}}},g={ams:y};function s(t){const n={h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:m}),`
...
`,e.jsx(h,{tokens:g})]})}function D(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{D as default};
