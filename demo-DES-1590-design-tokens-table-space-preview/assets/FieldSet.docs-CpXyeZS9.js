import{j as e}from"./iframe-Dvp8sHt0.js";import{useMDXComponents as o}from"./index-Ov97-FHm.js";import{M as r,f as a,P as d,h,i}from"./blocks-CC98D2VE.js";import{a as l,W as c,b as p,c as m,d as u,e as g}from"./FieldSet.stories-DmUEhiU8.js";import{D as f}from"./DesignTokensTable-nlmzRouq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BoH1EIR4.js";import"./exampleContent-Du2yH2Fl.js";import"./Hint-JxrMMlk1.js";import"./BorderSample-CEWBA8e5.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-B6mfgo9l.js";import"./SpacingSample-DA4NtHaU.js";const x=`<!-- @license CC0-1.0 -->
...
`,y={"field-set":{invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}",$type:"color"},"padding-inline-start":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},legend:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"},"in-fieldset":{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"}}}}},j={ams:y};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:l}),`
...
`,e.jsx(f,{tokens:j})]})}function H(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{H as default};
