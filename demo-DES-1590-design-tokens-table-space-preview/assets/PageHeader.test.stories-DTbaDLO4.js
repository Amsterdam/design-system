import{j as e}from"./iframe-fDnhSkPG.js";import{r as o}from"./renderComponentVariants-BngjYzd5.js";import{m as c,P as a}from"./PageHeader.stories-b4UqhSdc.js";import"./preload-helper-PPVm8Dsz.js";import"./useIsAfterBreakpoint-CJEeApng.js";import"./Grid-B-F0DRtp.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-CXq_VOyU.js";import"./Logo-4q_NkOd6.js";const{expect:d}=__STORYBOOK_MODULE_TEST__,H={...c,title:"Components/Containers/Page Header"},n={args:{brandName:"Data Amsterdam",children:e.jsx("p",{children:"test"}),menuItems:[e.jsx(a.MenuLink,{href:"#",lang:"en",children:"English"},"1"),e.jsx(a.MenuLink,{fixed:!0,href:"#",children:"Zoeken"},"2")]},play:async({canvas:t,userEvent:i})=>{const r=(await t.findByTestId("interaction-test")).querySelector("button"),s=await t.findByTestId("children");r&&(await i.click(r),d(s).toBeVisible(),await i.click(r),d(s).not.toBeVisible())},render:t=>e.jsxs(e.Fragment,{children:[e.jsx(a,{"data-testid":"interaction-test",...t,children:e.jsx("ul",{children:e.jsx("li",{"data-testid":"children",children:"English"})})}),o(a,{args:t})]}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
