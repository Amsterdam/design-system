import{j as e}from"./iframe-D6BrQqDK.js";import{useMDXComponents as o}from"./index-HqcjCZeY.js";import{M as r,f as a,P as d,h,i}from"./blocks-DGA2Zgqu.js";import{a as l,W as c,b as p,c as m,d as u,e as f}from"./FieldSet.stories-L_1iJyms.js";import{D as x}from"./DesignTokensTable-toaANAUY.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DnhsCwGO.js";import"./exampleContent-Du2yH2Fl.js";import"./Hint-xAHJDOXS.js";import"./ColorSample-BnCtOxFY.js";import"./SpacingSample-CoKnVqit.js";const g=`<!-- @license CC0-1.0 -->
...
`,y={"field-set":{invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}",$type:"color"},"padding-inline-start":{$value:"{ams.space.m}",$extensions:{"ams.type":"paddingInline"}}},legend:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$type:"number"},"margin-block-end":{$value:"{ams.space.s}",$extensions:{"ams.type":"marginBlock"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}",$extensions:{"ams.type":"textWrap"}},"in-fieldset":{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"}}}}},j={ams:y};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:l}),`
...
`,e.jsx(x,{tokens:j})]})}function D(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{D as default};
