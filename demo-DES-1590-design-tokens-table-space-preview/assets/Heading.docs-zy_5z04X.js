import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as o}from"./index-DFPspEHu.js";import{M as i,f as r,P as h,h as l,i as t}from"./blocks-D2W_cbFw.js";import{H as c,L as p,a as d,b as g,c as m,S as u,I as f,W as y}from"./Heading.stories-C9ItHHEM.js";import{D as v}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-CE7xyRPb.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const x=`<!-- @license CC0-1.0 -->
...
`,w={heading:{1:{"font-size":{$value:"{ams.typography.heading.1.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.1.line-height}",$type:"number"}},2:{"font-size":{$value:"{ams.typography.heading.2.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.2.line-height}",$type:"number"}},3:{"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.3.line-height}",$type:"number"}},4:{"font-size":{$value:"{ams.typography.heading.4.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.4.line-height}",$type:"number"}},5:{"font-size":{$value:"{ams.typography.heading.5.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.5.line-height}",$type:"number"}},6:{"font-size":{$value:"{ams.typography.heading.6.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.6.line-height}",$type:"number"}},color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"text-wrap":{$value:"{ams.typography.heading.text-wrap}",$extensions:{"ams.type":"textWrap"}},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}}}},j={ams:w};function a(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...o(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(v,{tokens:j})]})}function G(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{G as default};
