import{j as e}from"./iframe-Dx3tBSCK.js";import{useMDXComponents as i}from"./index-Cm8WOTwj.js";import{M as o,f as r,P as d,i as t}from"./blocks-NS2XOqyi.js";import{a as l,W as c,b as p,T as m}from"./Card.stories-6a0dRYxd.js";import{D as h}from"./DesignTokensTable-Crs8EIUX.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BOhNFwf-.js";import"./common-HRWYXPjp.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-DtIejrfA.js";import"./Paragraph-TUYVJmC_.js";import"./Image-DOZ4DpRD.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./BorderSample-BTSZ1UEW.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-Cjeb0sTL.js";import"./SpacingSample-awuARjeK.js";const g=`<!-- @license CC0-1.0 -->
...
`,u={card:{heading:{"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},"heading-group":{gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},image:{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},link:{color:{$value:"{ams.links.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}}},x={ams:u};function s(a){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...i(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(h,{tokens:x})]})}function I(a={}){const{wrapper:n}={...i(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(s,{...a})}):s(a)}export{I as default};
