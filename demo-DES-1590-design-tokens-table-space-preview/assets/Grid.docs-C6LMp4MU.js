import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as i}from"./index-DFPspEHu.js";import{M as a,f as l,P as r,h as d,i as s}from"./blocks-D2W_cbFw.js";import{G as c,V as h,a as p,S as m,b as u,c as x,d as g,I as w}from"./Grid.stories-CkfFROJ4.js";import{D as f}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./common-HRWYXPjp.js";import"./Grid-B-F0DRtp.js";import"./gridCellClasses-DKw8XbSK.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const j=`<!-- @license CC0-1.0 -->
...
`,v={grid:{"column-count":{$value:"4",$type:"number"},"column-gap":{$value:"{ams.space.xl}",$extensions:{"ams.type":"columnGap"}},"padding-block":{l:{$value:"{ams.space.l}",$extensions:{"ams.type":"paddingBlock"}},xl:{$value:"{ams.space.xl}",$extensions:{"ams.type":"paddingBlock"}},"2xl":{$value:"{ams.space.2xl}",$extensions:{"ams.type":"paddingBlock"}}},"padding-inline":{$value:"{ams.space.l}",$extensions:{"ams.type":"paddingInline"}},"row-gap":{l:{$value:"{ams.space.l}",$extensions:{"ams.type":"rowGap"}},xl:{$value:"{ams.space.xl}",$extensions:{"ams.type":"rowGap"}},"2xl":{$value:"{ams.space.2xl}",$extensions:{"ams.type":"rowGap"}}},medium:{"column-count":{$value:"8",$type:"number"},"padding-inline":{$value:"{ams.space.xl}",$extensions:{"ams.type":"paddingInline"}}},wide:{"column-count":{$value:"12",$type:"number"},"padding-inline":{$value:"{ams.space.2xl}",$extensions:{"ams.type":"paddingInline"}}}}},y={ams:v};function t(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(f,{tokens:y})]})}function P(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{P as default};
