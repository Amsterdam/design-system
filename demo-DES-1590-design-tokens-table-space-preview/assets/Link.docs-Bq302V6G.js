import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as i}from"./index-DFPspEHu.js";import{M as r,f as a,P as l,h as c,i as t}from"./blocks-D2W_cbFw.js";import{a as h,C as d,I as u}from"./Link.stories-To2zyCbE.js";import{D as p}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const m=`<!-- @license CC0-1.0 -->
...
`,k={link:{color:{$value:"{ams.links.color}",$type:"color"},"font-family":{$value:"inherit",$type:"color"},"font-size":{$value:"inherit",$type:"color"},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"inherit",$type:"color"},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$extensions:{"ams.type":"textDecorationThickness"}},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$extensions:{"ams.type":"textUnderlineOffset"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-thickness":{$value:"{ams.links.hover.text-decoration-thickness}",$extensions:{"ams.type":"textDecorationThickness"}},"text-underline-offset":{$value:"{ams.links.hover.text-underline-offset}",$extensions:{"ams.type":"textUnderlineOffset"}}},contrast:{color:{$value:"{ams.links.contrast.color}",$type:"color"},hover:{color:{$value:"{ams.links.contrast.hover.color}",$type:"color"}}},inverse:{color:{$value:"{ams.links.inverse.color}",$type:"color"},hover:{color:{$value:"{ams.links.inverse.hover.color}",$type:"color"}}}}},g={ams:k};function s(o){const n={a:"a",h2:"h2",h3:"h3",h4:"h4",p:"p",...i(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:h}),`
...
`,e.jsx(p,{tokens:g})]})}function A(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{A as default};
