import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as a}from"./index-DFPspEHu.js";import{M as r,f as o,P as l,h,i as s}from"./blocks-D2W_cbFw.js";import{a as d,T as m,S as p,D as c,W as u,I as x,b as y}from"./OrderedList.stories-CpWlrGlP.js";import{D as v}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./exampleContent-Du2yH2Fl.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const f=`<!-- @license CC0-1.0 -->
...
`,g={"ordered-list":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},gap:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$type:"number"},"list-style-type":{$value:"decimal",$extensions:{"ams.type":"listStyleType"}},small:{"font-size":{$value:"{ams.typography.body-text.small.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.body-text.small.line-height}",$type:"number"}},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}},item:{"margin-inline-start":{$value:{value:2.25,unit:"rem"},comment:"Divide your total indentation width over margin and padding to position the marker.",$type:"dimension"},"padding-inline-start":{$value:{value:.25,unit:"rem"},comment:"The total level 1 indentation for Amsterdam is 40 pixels, or 2.5rem.",$type:"dimension"}},"ordered-list":{gap:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},"list-style-type":{$value:"lower-alpha",$extensions:{"ams.type":"listStyleType"}},"padding-block-end":{$value:"{ams.space.s}",$extensions:{"ams.type":"paddingBlock"}},"padding-block-start":{$value:"{ams.space.s}",$extensions:{"ams.type":"paddingBlock"}},item:{"margin-inline-start":{$value:{value:1.5,unit:"rem"},comment:"Indent less than the parent to start-align the child’s marker with the parent text.",$type:"dimension"},"padding-inline-start":{$value:{value:.25,unit:"rem"},comment:"The total level >=2 indentation for Amsterdam is 28 pixels, or 1.75rem.",$type:"dimension"}}}}},$={ams:g};function i(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",...a(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:d}),`
...
`,e.jsx(v,{tokens:$})]})}function W(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i(n)}export{W as default};
