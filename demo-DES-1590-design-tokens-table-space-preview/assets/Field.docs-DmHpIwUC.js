import{j as e}from"./iframe-Dx3tBSCK.js";import{useMDXComponents as r}from"./index-Cm8WOTwj.js";import{M as o,f as a,P as d,h as c,i}from"./blocks-NS2XOqyi.js";import{a as l,W as h,b as p,I as m}from"./Field.stories-CR7iRo6J.js";import{D as x}from"./DesignTokensTable-Crs8EIUX.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BOhNFwf-.js";import"./exampleContent-Du2yH2Fl.js";import"./BorderSample-BTSZ1UEW.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-Cjeb0sTL.js";import"./SpacingSample-awuARjeK.js";const u=`<!-- @license CC0-1.0 -->
...
`,j={field:{gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}",$type:"color"},"padding-inline-start":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}}}},f={ams:j};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...r(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(x,{tokens:f})]})}function C(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{C as default};
