import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as i}from"./index-DFPspEHu.js";import{M as a,f as l,P as r,h as m,i as o}from"./blocks-D2W_cbFw.js";import{a as d,W as p,b as h,c,d as u,e as g}from"./PageHeader.stories-b4UqhSdc.js";import{D as x}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./useIsAfterBreakpoint-CJEeApng.js";import"./Grid-B-F0DRtp.js";import"./gridCellClasses-DKw8XbSK.js";import"./Icon-CXq_VOyU.js";import"./Logo-4q_NkOd6.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const f=`<!-- @license CC0-1.0 -->
...
`,y={"page-header":{"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"padding-block":{$value:"{ams.space.l}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.grid.padding-inline}",comment:"Must be the Grid inline padding, to make sure Header and Grid line up",$extensions:{"ams.type":"paddingInline"}},medium:{"padding-inline":{$value:"{ams.grid.medium.padding-inline}",$extensions:{"ams.type":"paddingInline"}}},wide:{"padding-inline":{$value:"{ams.grid.wide.padding-inline}",$extensions:{"ams.type":"paddingInline"}}},"logo-link":{"column-gap":{$value:"{ams.space.m}",$extensions:{"ams.type":"columnGap"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}}},"brand-name":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$type:"number"},"text-wrap":{$value:"{ams.typography.heading.text-wrap}",$extensions:{"ams.type":"textWrap"}}},"mega-menu":{"padding-block":{$value:"{ams.space.l}",$extensions:{"ams.type":"paddingBlock"}},button:{cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},label:{open:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}}}}},menu:{"column-gap":{$value:"{ams.space.l}",$extensions:{"ams.type":"columnGap"}},"row-gap":{$value:"{ams.space.xs}",$extensions:{"ams.type":"rowGap"}},item:{color:{$value:"{ams.links.color}",$type:"color"},"column-gap":{$value:"{ams.space.xs}",$extensions:{"ams.type":"columnGap"}},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$type:"number"},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.space.xs}",$extensions:{"ams.type":"paddingBlock"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"}}},link:{gap:{$value:"{ams.space.xs}",$extensions:{"ams.type":"gap"}},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}",$extensions:{"ams.type":"textDecorationLine"}},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$extensions:{"ams.type":"textDecorationThickness"}},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$extensions:{"ams.type":"textUnderlineOffset"}},hover:{"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}",$extensions:{"ams.type":"textDecorationLine"}}}}},navigation:{"column-gap":{$value:"{ams.space.l}",$extensions:{"ams.type":"columnGap"}},"row-gap":{$value:"{ams.space.l}",$extensions:{"ams.type":"rowGap"}}}}},w={ams:y};function s(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
...
`,e.jsx(x,{tokens:w})]})}function z(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{z as default};
