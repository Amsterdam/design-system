import{j as e}from"./iframe-Dvp8sHt0.js";import{useMDXComponents as r}from"./index-Ov97-FHm.js";import{M as i,f as a,P as m,h,i as o}from"./blocks-CC98D2VE.js";import{a as c,C as d,W as l}from"./ErrorMessage.stories-aG4br6M5.js";import{D as p}from"./DesignTokensTable-nlmzRouq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BoH1EIR4.js";import"./Icon-omCGIUF_.js";import"./BorderSample-CEWBA8e5.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-B6mfgo9l.js";import"./SpacingSample-DA4NtHaU.js";const f=`<!-- @license CC0-1.0 -->
...
`,u={"error-message":{color:{$value:"{ams.color.feedback.error}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}}}},x={ams:u};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...r(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
