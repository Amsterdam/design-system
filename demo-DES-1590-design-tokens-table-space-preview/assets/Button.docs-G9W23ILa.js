import{j as e}from"./iframe-Dx3tBSCK.js";import{useMDXComponents as a}from"./index-Cm8WOTwj.js";import{M as r,f as i,P as l,h as c,i as t}from"./blocks-NS2XOqyi.js";import{B as d,P as m,S as p,T as u,W as h,a as y,b,c as f}from"./Button.stories-DNEiJ_nF.js";import{D as v}from"./DesignTokensTable-Crs8EIUX.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BOhNFwf-.js";import"./Button-BBgsLrRF.js";import"./Icon-C6MQMutL.js";import"./BorderSample-BTSZ1UEW.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-Cjeb0sTL.js";import"./SpacingSample-awuARjeK.js";const g=`<!-- @license CC0-1.0 -->
...
`,$={button:{"border-style":{$value:"solid",$extensions:{"amsterdam.designsystem.type":"borderStyle"}},"border-width":{$value:"{ams.border.width.m}",$extensions:{"amsterdam.designsystem.type":"borderWidth"}},cursor:{$value:"{ams.cursor.interactive}"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-inline":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},disabled:{cursor:{$value:"{ams.cursor.disabled}"}},"icon-only":{"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}},"padding-inline":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"spacingSample"}}},primary:{"background-color":{$value:"{ams.color.interactive.default}",$type:"color"},"border-color":{$value:"{ams.color.interactive.default}",$type:"color"},color:{$value:"{ams.color.text.inverse}",$type:"color"},disabled:{"background-color":{$value:"{ams.color.interactive.disabled}",$type:"color"},"border-color":{$value:"{ams.color.interactive.disabled}",$type:"color"}},hover:{"background-color":{$value:"{ams.color.interactive.hover}",$type:"color"},"border-color":{$value:"{ams.color.interactive.hover}",$type:"color"}}},secondary:{"background-color":{$value:"{ams.color.background}",$type:"color"},"border-color":{$value:"currentColor",$type:"color"},color:{$value:"{ams.color.interactive.default}",$type:"color"},disabled:{"border-color":{$value:"{ams.color.interactive.disabled}",$type:"color"},color:{$value:"{ams.color.interactive.disabled}",$type:"color"}},hover:{"box-shadow":{$value:"inset 0 0 0 {ams.border.width.s}"},color:{$value:"{ams.color.interactive.hover}",$type:"color"}}},tertiary:{"background-color":{$value:"transparent",$type:"color"},"border-color":{$value:"transparent",$type:"color"},color:{$value:"{ams.color.interactive.default}",$type:"color"},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"}},hover:{"border-color":{$value:"currentColor",$type:"color"},color:{$value:"{ams.color.interactive.hover}",$type:"color"}}}}},x={ams:$};function s(n){const o={a:"a",h2:"h2",h3:"h3",p:"p",...a(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:d}),`
...
`,e.jsx(v,{tokens:x})]})}function I(n={}){const{wrapper:o}={...a(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(s,{...n})}):s(n)}export{I as default};
