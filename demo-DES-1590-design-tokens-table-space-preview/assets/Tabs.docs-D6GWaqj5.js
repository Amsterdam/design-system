import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as s}from"./index-DFPspEHu.js";import{M as i,f as r,P as h,h as l,i as a}from"./blocks-D2W_cbFw.js";import{a as c,W as d,b as p,P as m}from"./Tabs.stories-CsJgE4Iw.js";import{D as b}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const u=`<!-- @license CC0-1.0 -->
...
`,f={tabs:{gap:{$value:"{ams.space.m}",$extensions:{"ams.type":"gap"}},list:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1) {ams.color.separator}",$extensions:{"ams.type":"boxShadow"}}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$type:"number"},"outline-offset":{$value:"calc({ams.focus.outline-offset} * -1)",$extensions:{"ams.type":"outlineOffset"}},"padding-block":{$value:"{ams.space.s}",$extensions:{"ams.type":"paddingBlock"}},"padding-inline":{$value:"{ams.space.m}",$extensions:{"ams.type":"paddingInline"}},hover:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1)",$extensions:{"ams.type":"boxShadow"}},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},selected:{"box-shadow":{$value:"inset 0 calc({ams.border.width.xl} * -1)",$extensions:{"ams.type":"boxShadow"}},"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}",$extensions:{"ams.type":"cursor"}}}}}},x={ams:f};function o(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(b,{tokens:x})]})}function A(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{A as default};
