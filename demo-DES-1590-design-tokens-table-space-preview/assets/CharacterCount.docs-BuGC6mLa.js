import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as o}from"./index-DFPspEHu.js";import{M as a,f as s,P as h,h as i,i as c}from"./blocks-D2W_cbFw.js";import{a as m,E as l}from"./CharacterCount.stories-C2o0xmVC.js";import{D as u}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const p=`<!-- @license CC0-1.0 -->
...
`,y={"character-count":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.small.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.small.line-height}",$type:"number"},error:{color:{$value:"{ams.color.feedback.error}",$type:"color"}}}},f={ams:y};function r(n){const t={h2:"h2",h3:"h3",p:"p",...o(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:m}),`
...
`,e.jsx(u,{tokens:f})]})}function v(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{v as default};
