import{j as e}from"./iframe-fDnhSkPG.js";import{useMDXComponents as o}from"./index-DFPspEHu.js";import{M as i,f as r,P as d,i as a}from"./blocks-D2W_cbFw.js";import{a as l,W as c,b as h,T as p}from"./Card.stories-Jqncwsiz.js";import{D as m}from"./DesignTokensTable-8WOML4FS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dej7HHH1.js";import"./common-HRWYXPjp.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-CE7xyRPb.js";import"./Paragraph-zOkjzncj.js";import"./Image-DmZvcneW.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./ColorSample-B8ktT5Yc.js";import"./SpacingSample-DfIwnxKw.js";const g=`<!-- @license CC0-1.0 -->
...
`,u={card:{heading:{"margin-block-end":{$value:"{ams.space.xs}",$extensions:{"ams.type":"marginBlock"}}},"heading-group":{gap:{$value:"{ams.space.xs}",$extensions:{"ams.type":"gap"}},"margin-block-end":{$value:"{ams.space.xs}",$extensions:{"ams.type":"marginBlock"}}},image:{"margin-block-end":{$value:"{ams.space.s}",$extensions:{"ams.type":"marginBlock"}}},link:{color:{$value:"{ams.links.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}",$extensions:{"ams.type":"textDecorationLine"}},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$extensions:{"ams.type":"textDecorationThickness"}},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$extensions:{"ams.type":"textUnderlineOffset"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}",$extensions:{"ams.type":"textDecorationLine"}}}},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}}}},x={ams:u};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:l}),`
...
`,e.jsx(m,{tokens:x})]})}function L(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{L as default};
