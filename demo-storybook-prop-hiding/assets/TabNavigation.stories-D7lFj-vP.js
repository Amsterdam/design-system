import{a as e,i as t,s as n}from"./preload-helper-xPQekRTU.js";import{t as r}from"./react-a45N5K9M.js";import{t as i}from"./jsx-runtime-BqsN2jGA.js";import{Dt as a,Tt as o,Vt as s,ft as c,st as l}from"./iframe-DB4UCbr9.js";import{f as u,t as d}from"./src-D1hpWpkN.js";var f=e({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{s(),d(),p=n(r()),m=i(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}}},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
