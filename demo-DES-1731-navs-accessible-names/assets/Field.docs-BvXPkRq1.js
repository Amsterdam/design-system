import{j as e}from"./iframe-BHvEQ1YI.js";import{useMDXComponents as r}from"./index-CIn3xNxy.js";import{M as o,e as a,f as d,h as c,i}from"./blocks-B2HLwgjv.js";import{a as l,W as h,b as p,I as m}from"./Field.stories-wbB9nceb.js";import{D as x}from"./DesignTokensTable-94rfO-x8.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DGl3KdZr.js";import"./exampleContent-D2tKGi5u.js";import"./BorderSample-ClP_x67u.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-DEVPpg2k.js";import"./ColorSample-CDsZMWsf.js";import"./SpaceSample-CW0DMxcN.js";import"./TypographySample-BkYKtOLO.js";const u=`<!-- @license CC0-1.0 -->
...
`,j={field:{gap:{$deprecated:"Will be removed in release 5.0.0.",$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},child:{"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"before-error-message":{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}},invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}"},"padding-inline-start":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}}},f={ams:j};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...r(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(x,{tokens:f})]})}function A(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{A as default};
