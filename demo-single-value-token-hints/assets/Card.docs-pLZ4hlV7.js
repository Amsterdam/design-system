...
It accepts all props of a regular Image, such as `,(0,j.jsx)(r.code,{children:`aspectRatio`}),`.`]}),`
`,(0,j.jsx)(a,{of:S}),`
`,(0,j.jsx)(i,{of:S}),`
...
`,(0,j.jsx)(a,{of:h}),`
`,(0,j.jsx)(r.h3,{id:`with-image`,children:`With image`}),`
`,(0,j.jsxs)(r.p,{children:[`A Card often displays the image of the article it links to.
The Card Image subcomponent renders an `,(0,j.jsx)(r.a,{href:`/docs/components-media-image--docs`,children:`Image`}),` component and accepts its properties, e.g. to set an aspect ratio or provide a set of image sources.
Only use decorative images with `,(0,j.jsx)(r.code,{children:`alt=""`}),` here. Screen readers will not read the `,(0,j.jsx)(r.code,{children:`alt`}),` text of non-decorative images when navigating to a Card.`]}),`
`,(0,j.jsx)(a,{of:m}),`
`,(0,j.jsx)(r.h3,{id:`top-tasks`,children:`Top tasks`}),`
`,(0,j.jsxs)(r.p,{children:[`A set of cards can be used to present links to frequently accessed interactions.
...
`,(0,j.jsxs)(r.p,{children:[`An image in a Card is decoration, which is why ‘With image’ asks for an empty `,(0,j.jsx)(r.code,{children:`alt`}),`.
...
`,(0,j.jsx)(d,{tokens:D})]})}function A(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,j.jsx)(t,{...e,children:(0,j.jsx)(k,{...e})}):k(e)}var j;e((()=>{j=c(),f(),r(),u(),O(),g(),y(),x(),C(),T()}))();export{A as default};