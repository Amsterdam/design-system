import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./jsx-runtime-Bq1bXGty.js";import{G as r,I as i,Q as a,a as o,b as s,x as c}from"./index.esm-DI7iPt31.js";import{C as l,E as u,T as d,t as f,w as p}from"./src-7LbyeCaI.js";import{d as m,i as h,t as g}from"./argTypes-CQXDxDHP.js";import{d as _,h as v}from"./exampleContent-DJcgXd2S.js";import{i as y,t as b}from"./decorators-BXtJjPQl.js";import{n as x,t as S}from"./isCompactTheme-D2HTZcJ1.js";var C=t({Default:()=>D,HighlightContent:()=>O,__namedExportsOrder:()=>k,default:()=>E}),w,T,E,D,O,k,A=e((()=>{a(),f(),p(),m(),b(),v(),S(),w=n(),T=_(),E={title:`Components/Containers/Spotlight`,component:l,argTypes:{as:g(u),color:h(d,`purple`)},decorators:[y]},D={render:({as:e,color:t},n)=>(0,w.jsx)(l,{as:e,color:t,children:(0,w.jsx)(s,{paddingVertical:`x-large`,children:(0,w.jsx)(s.Cell,{appearance:x(n)?`transparent`:void 0,span:`all`,children:(0,w.jsx)(o,{color:!t||[`azure`,`green`,`magenta`].includes(t)?`inverse`:void 0,children:T})})})})},O={args:{color:`green`},render:({color:e},t)=>{let n=[`lime`,`orange`,`yellow`],a=n.includes(e)?void 0:`inverse`,o=n.includes(e)?`contrast`:`inverse`;return(0,w.jsx)(l,{color:e,children:(0,w.jsx)(s,{paddingVertical:`x-large`,children:(0,w.jsxs)(s.Cell,{appearance:x(t)?`transparent`:void 0,span:{narrow:4,medium:5,wide:7},children:[(0,w.jsx)(c,{className:`ams-mb-s`,color:a,level:2,size:`level-3`,children:`Steun geven aan een partij`}),(0,w.jsx)(i,{className:`ams-mb-m`,color:a,children:`Van 19 januari tot en met 2 februari kunt u uw steun geven aan een partij voor de gemeenteraad of een stadsdeel- of bestuurscommissie. Dit doet u met een ondersteuningsverklaring.`}),(0,w.jsx)(r,{color:o,href:`#`,children:`Ondersteuningsverklaring inleveren`})]})})})}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  render: ({
    as,
    color
