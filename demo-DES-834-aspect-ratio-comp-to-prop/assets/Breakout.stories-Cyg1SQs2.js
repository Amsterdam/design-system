import{j as e}from"./jsx-runtime-BlAj40OV.js";import{S as N,t as k,P as p,I as C}from"./index.esm-D6Ai7ti8.js";import{c as b}from"./clsx-B-dksMZM.js";import{r as _}from"./index-Cs7sjTYM.js";import{a as u,p as V}from"./paddingClasses-C5gheHLv.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const T=(a,l,t,o)=>[...u("ams-breakout__cell--col-span-",a),...u("ams-breakout__cell--col-start-",l),...u("ams-breakout__cell--row-span-",t),...u("ams-breakout__cell--row-start-",o)],B=_.forwardRef(({as:a="div",children:l,className:t,colSpan:o,colStart:d,has:i,rowSpan:m,rowStart:c,...y},j)=>e.jsx(a,{...y,ref:j,className:b("ams-breakout__cell",T(o,d,m,c),i&&`ams-breakout__cell--has-${i}`,t),children:l}));B.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(v=(S=s.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};const R=["Default","VerticalLayout"],L=Object.freeze(Object.defineProperty({__proto__:null,Default:n,VerticalLayout:s,__namedExportsOrder:R,default:q},Symbol.toStringTag,{value:"Module"}));export{L as B,s as V};
