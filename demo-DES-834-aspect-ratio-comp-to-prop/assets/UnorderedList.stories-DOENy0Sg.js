import{j as e}from"./jsx-runtime-j_jdvEMj.js";import{q as n,P as a}from"./index.esm-C2_JCJAQ.js";import{n as T,o as B,p as O,q as R,S as A,g as G,r as q,k as E}from"./index.esm-CEuZchO4.js";import{i as M}from"./decorators-DYZ3zH5Z.js";import{f as V}from"./exampleContent-hIIPvEhU.js";import{c as _}from"./clsx-B-dksMZM.js";import{r as W}from"./index-B-o1Wr-g.js";const b=W.forwardRef(({children:s,className:d,...c},I)=>e.jsx("li",{ref:I,className:_("ams-unordered-list__item",d),...c,children:s}));b.displayName="UnorderedList.Item";try{UnorderedList.Item.displayName="UnorderedList.Item",UnorderedList.Item.__docgenInfo={description:"",displayName:"UnorderedList.Item",props:{}}}catch{}const D=W.forwardRef(({children:s,className:d,inverseColor:c,markers:I=!0,size:p,...C},w)=>e.jsx("ul",{ref:w,className:_("ams-unordered-list",c&&"ams-unordered-list--inverse-color",!I&&"ams-unordered-list--no-markers",p&&`ams-unordered-list--${p}`,d),...C,children:s}));D.displayName="UnorderedList";const r=Object.assign(D,{Item:b});try{r.displayName="UnorderedList",r.__docgenInfo={description:"",displayName:"UnorderedList",props:{inverseColor:{defaultValue:null,description:"Changes the text colour for readability on a dark background.",name:"inverseColor",required:!1,type:{name:"boolean"}},markers:{defaultValue:{value:"true"},description:"Whether the list items show a marker.",name:"markers",required:!1,type:{name:"boolean"}},size:{defaultValue:null,description:"The size of the text.",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'}]}}}}}catch{}const H=V().map((s,d)=>e.jsx(r.Item,{children:s},d)),K={title:"Components/Text/Unordered List",component:r,args:{children:H,inverseColor:!1,markers:void 0},argTypes:{size:{control:{type:"radio",labels:{small:"small",undefined:"medium"}},options:["small",void 0]}},decorators:[M]},t={},o={render:s=>e.jsxs(r,{...s,children:[e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]}),e.jsxs(r.Item,{children:["Stadsdeel Nieuw-West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"De Aker, Sloten en Nieuw Sloten"}),e.jsx(r.Item,{children:"Geuzenveld, Slotermeer en Sloterdijken"}),e.jsx(r.Item,{children:"Osdorp"}),e.jsx(r.Item,{children:"Slotervaart"})]})]})]})},i={args:{children:[e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:T,size:"level-6"}),e.jsx(a,{children:"Stadsloket: locaties en openingstijden"})]})},1),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:B,size:"level-6"}),e.jsx(a,{children:"Parkeren + Reizen (P+R)"})]})},2),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:O,size:"level-6"}),e.jsx(a,{children:"Paspoort, ID-kaart en Rijbewijs"})]})},3),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:R,size:"level-6"}),e.jsx(a,{children:"Gemeentebelastingen"})]})},4),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:A,size:"level-6"}),e.jsx(a,{children:"Melding openbare ruimte en overlast"})]})},5),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:G,size:"level-6"}),e.jsx(a,{children:"Verhuizing doorgeven"})]})},6),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:q,size:"level-6"}),e.jsx(a,{children:"Grof afval"})]})},7),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:E,size:"level-6"}),e.jsx(a,{children:"Kennisgevingen en bekendmakingen"})]})},8)],markers:!1}},l={args:{inverseColor:!0},render:s=>e.jsx(r,{...s,children:e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]})})},m={args:{size:"small"}};var v,g,h;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:"{}",...(h=(g=t.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var u,L,j;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
