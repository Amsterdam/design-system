import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{x as T,y as k,P as p,I as y}from"./index.esm-B3eFeUl2.js";import{g as V}from"./common-DYX7ZGrz.js";import{c as C}from"./clsx-B-dksMZM.js";import{r as x}from"./index-G8LIXM5I.js";import{a as i,p as N}from"./paddingClasses-BhwbQ8nP.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const q=(a,t,l,o)=>[...i("ams-breakout__cell--col-span-",a),...i("ams-breakout__cell--col-start-",t),...i("ams-breakout__cell--row-span-",l),...i("ams-breakout__cell--row-start-",o)],b=x.forwardRef(({as:a="div",children:t,className:l,colSpan:o,colStart:d,has:u,rowSpan:c,rowStart:m,...B},j)=>e.jsx(a,{...B,className:C("ams-breakout__cell",q(o,d,c,m),u&&`ams-breakout__cell--has-${u}`,l),ref:j,children:t}));b.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
