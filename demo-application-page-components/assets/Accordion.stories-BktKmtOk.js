import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{P as n}from"./index.esm-Dc4dH97g.js";import{h as x,b as S}from"./exampleContent-r-zRGsZY.js";import{c as u}from"./clsx-B-dksMZM.js";import{r as o}from"./index-G8LIXM5I.js";import{E as K}from"./index.esm-DkCfOvfV.js";import{g as M}from"./getHeadingTag-C4Rztoc8.js";import{I as F}from"./Icon-BBW_x4VP.js";import{u as W}from"./useKeyboardFocus-BsBpr6qG.js";/**
 * @license EUPL-1.2+
...
Note: this intentionally does not change the font size.`,name:"headingLevel",required:!0,type:{name:"enum",value:[{value:"1"},{value:"3"},{value:"4"},{value:"2"}]}},sectionAs:{defaultValue:{value:"section"},description:"The HTML element to use for each Accordion Section.",name:"sectionAs",required:!1,type:{name:"enum",value:[{value:'"div"'},{value:'"section"'}]}}}}}catch{}const _=x(),f=x(),A=x(),y=S(),b=S(),j=S(),J={title:"Components/Containers/Accordion",component:a,args:{headingLevel:3}},i={args:{children:[e.jsx(a.Section,{label:_,children:e.jsx(n,{children:y})},1),e.jsx(a.Section,{label:f,children:e.jsx(n,{children:b})},2),e.jsx(a.Section,{label:A,children:e.jsx(n,{children:j})},3)]}},t={args:{children:[e.jsx(a.Section,{label:_,children:e.jsx(n,{children:y})},1),e.jsx(a.Section,{expanded:!0,label:f,children:e.jsx(n,{children:b})},2),e.jsx(a.Section,{label:A,children:e.jsx(n,{children:j})},3)]}},s={args:{children:[e.jsx(a.Section,{label:_,children:e.jsx(n,{children:y})},1),e.jsx(a.Section,{label:f,children:e.jsx(n,{children:b})},2),e.jsx(a.Section,{label:A,children:e.jsx(n,{children:j})},3)],sectionAs:"div"}};var k,C,E;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(E=(C=i.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var I,R,T;t.parameters={...t.parameters,docs:{...(I=t.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    children: [<Accordion.Section key={1} label={heading1}>
        <Paragraph>{paragraph1}</Paragraph>
