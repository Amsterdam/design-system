import{r as f,j as e,c as j,P as g,G as u,K as c,C as k,p as h,H as v}from"./iframe-DuvPaAFK.js";const o=f.forwardRef(({children:a,className:t,...s},r)=>e.jsx("mark",{...s,className:j("ams-mark",t),ref:r,children:a}));o.displayName="Mark";try{o.displayName="Mark",o.__docgenInfo={description:"",displayName:"Mark",props:{}}}catch{}const x={title:"Components/Text/Mark",component:o},l={args:{children:"Wat vinden Amsterdammers belangrijk?"},argTypes:{children:{description:"The text to mark.",table:{disable:!1}}},render:({children:a})=>e.jsxs(g,{children:["Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. ",e.jsx(o,{children:a})," Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren."]})},w=[{category:"Kansspelen",date:new Date("2025-10-27"),fragment:"Op dit moment zijn alle vergunning voor speelautomatenhallen verleend. Als u kansspelautomaten wilt plaatsen in uw horecabedrijf dan heeft u de …",heading:"Vergunning speelautomatenhal of kansspelautomaten aanvragen"},{category:"Veelgevraagd",date:new Date("2024-09-15"),fragment:"U heeft een ontheffing nodig als u de geldende geluidsgrenzen van uw horecagelegenheid wil overschrijden. Kijk hier hoe het werkt en hoe u de …",heading:"Ontheffing geluidsvoorschriften"},{category:"Vergunningen",date:new Date("2023-08-03"),fragment:"Voor de organisatie van grootschalige vechtsportgala’s in Amsterdam moet u een vergunning aanvragen bij de gemeente. Vooraf moet u een Bibobformulier …",heading:"Vergunning vechtsportevenementen"}],b=new Intl.DateTimeFormat("nl",{day:"numeric",month:"long",year:"numeric"}),p=(a,t)=>{if(!t)return a;const s=t.split(/\s+/).filter(Boolean).map(n=>n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"));if(s.length===0)return a;const r=new RegExp(`(${s.join("|")})`,"gi");return a.split(r).map(n=>n.match(r)?e.jsx(o,{children:n},n):n)},d={render:()=>{const[a,t]=f.useState("horeca vergunning"),s=w.filter(({fragment:r,heading:i})=>[r,i].some(n=>a.split(/\s+/).filter(Boolean).some(m=>n.toLowerCase().includes(m.toLowerCase()))));return e.jsx(u,{children:e.jsxs(u.Cell,{span:{narrow:4,medium:6,wide:8},children:[e.jsxs(c,{className:"ams-mb-m",children:[e.jsx(c.Input,{label:"Zoeken",onChange:r=>t(r.target.value),value:a}),e.jsx(c.Button,{})]}),e.jsxs(g,{className:"ams-mb-xl",children:[e.jsx("strong",{children:s.length})," artikelen gaan over ‘",a,"’."]}),e.jsx(k,{gap:"x-large",children:s.map(({category:r,date:i,fragment:n,heading:m})=>e.jsxs(h,{children:[e.jsx(h.HeadingGroup,{tagline:r,children:e.jsx(v,{level:2,size:"level-4",children:e.jsx(h.Link,{href:"#",children:p(m,a)})})}),e.jsx(g,{className:"ams-mb-xs",children:p(n,a)}),e.jsx(g,{size:"small",children:e.jsx("time",{dateTime:i.toISOString(),children:b.format(i)})})]},m))})]})})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...d.parameters?.docs?.source}}};const y=["Default","SearchResults"],S=Object.freeze(Object.defineProperty({__proto__:null,Default:l,SearchResults:d,__namedExportsOrder:y,default:x},Symbol.toStringTag,{value:"Module"}));export{S as M,d as S};
