import{S as y,j as v}from"./index.esm-Dydeoktt.js";import{j as o}from"./jsx-runtime-j_jdvEMj.js";import{c as b}from"./clsx-B-dksMZM.js";import{r as S}from"./index-B-o1Wr-g.js";import{I as j}from"./Icon-B6-t9cKk.js";const a=S.forwardRef(({children:n,className:h,icon:t,prefix:x="Invoerfout",...E},_)=>o.jsxs("p",{...E,ref:_,className:b("ams-error-message",h),children:[o.jsx(j,{svg:t||y,size:"level-6"}),o.jsxs("span",{className:"ams-visually-hidden",children:[x,": "]}),n]}));a.displayName="ErrorMessage";try{a.displayName="ErrorMessage",a.__docgenInfo={description:"",displayName:"ErrorMessage",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"Function"}},prefix:{defaultValue:{value:"Invoerfout"},description:"An accessible phrase that screen readers announce before the error message. Should translate to something like ‘input error’.",name:"prefix",required:!1,type:{name:"string"}}}}}catch{}/**
 * @license EUPL-1.2+
