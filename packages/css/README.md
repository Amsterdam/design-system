...
[Load the wireframe tokens](https://github.com/Amsterdam/design-system/blob/main/packages-proprietary/tokens/README.md) to present pages as a sketch, e.g. to keep a design review focused on structure and content.
