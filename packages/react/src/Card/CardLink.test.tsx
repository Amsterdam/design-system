...
describe('CardLink', () => {
  ...
  it('renders a custom link component', () => {
    ...
    render(<CardLink href="/test" linkComponent={CustomLink} />)
  ...
  it('forwards the ref to an intrinsic link component', () => {
    ...
    render(<CardLink href="/test" linkComponent="a" ref={ref} />)
  ...
  it('does not forward the ref to a custom link component', () => {
    ...
    render(<CardLink href="/test" linkComponent={CustomLink} ref={ref} />)
