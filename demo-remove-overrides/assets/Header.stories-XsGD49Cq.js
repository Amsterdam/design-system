import{j as e}from"./jsx-runtime-z8MfsBtr.js";import{G as d,m as r,H as k}from"./index.esm-DEOhk3Tb.js";import{c as t}from"./clsx-B-dksMZM.js";import{r as o}from"./index-D7uoVdV3.js";import{G as ee}from"./Grid-Dd0v49Eq.js";import{L as M}from"./Logo-C81konWM.js";import{H as ae}from"./Heading-D8PRwfYB.js";import{I as ne}from"./Icon-BoBhPfLP.js";const U=o.forwardRef(({children:a,className:n,...s},l)=>e.jsx(ee.Cell,{...s,className:t("ams-header__grid-cell-narrow-window-only",n),ref:l,children:a}));U.displayName="Header.GridCellNarrowWindowOnly";try{Header.GridCellNarrowWindowOnly.displayName="Header.GridCellNarrowWindowOnly",Header.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"Header.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"footer"'},{value:'"aside"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
