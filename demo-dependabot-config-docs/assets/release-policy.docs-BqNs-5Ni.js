...
`]}),`
`,e.jsx(s.h2,{id:"peer-dependencies",children:"Peer dependencies"}),`
`,e.jsx(s.p,{children:`Our packages are interconnected through peer dependencies.
...
`,e.jsxs(s.p,{children:["Without additional configuration, tools like ",e.jsx(s.strong,{children:"Dependabot by GitHub"}),` might create separate pull requests for each package, which could fail due to unmet peer dependency constraints.
Grouping the design system packages into a single update can prevent this issue.
`,e.jsx(s.a,{href:"https://docs.github.com/en/code-security/tutorials/secure-your-dependencies/optimizing-pr-creation-version-updates#grouping-related-dependencies-together",rel:"nofollow",children:"Their documentation"})," provides details on this."]}),`
