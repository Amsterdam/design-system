import{j as e}from"./iframe-m8cc1be-.js";import{useMDXComponents as r}from"./index-Ba2m8n-e.js";import{M as t}from"./blocks-9ENkA4J_.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DNGd1qdt.js";function o(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://docs.github.com/en/code-security/getting-started/dependabot-quickstart-guide",rel:"nofollow",children:"Dependabot"}),` automatically opens pull requests when new versions of your dependencies are available.
...
`,e.jsxs(n.p,{children:["Our packages depend on each other through ",e.jsx(n.strong,{children:"peer dependencies"}),`.
The React package requires a matching version of the CSS package, and the CSS package requires matching versions of the Tokens and Assets packages.
When you upgrade one package, you'll likely need to upgrade the others as well.`]}),`
...
It groups all Amsterdam Design System packages into a single pull request, so peer dependencies stay in sync.
Only patch and minor versions are updated automatically – major versions require a manual upgrade.`]}),`
