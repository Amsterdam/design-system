import{j as f}from"./jsx-runtime-ffb262ed.js";import{B as S}from"./index.esm-129bbbc7.js";import{c as _}from"./clsx-1229b3e0.js";import{r as v}from"./index-76fb7be0.js";function B(a){switch(a){case"secondary":return"secondary-action-button";case"tertiary":return"subtle-button";default:return"primary-action-button"}}const o=v.forwardRef(({children:a,disabled:b,variant:s="primary",...g},h)=>f.jsx(S,{...g,appearance:B(s),ref:h,disabled:b,className:_("amsterdam-button",s==="secondary"&&"amsterdam-button--secondary",s==="tertiary"&&"amsterdam-button--tertiary"),children:a}));o.displayName="Button";try{o.displayName="Button",o.__docgenInfo={description:"",displayName:"Button",props:{variant:{defaultValue:{value:"primary"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}}}}}catch{}/**
 * @license EUPL-1.2+
...
//# sourceMappingURL=Button.stories-7e41778b.js.map
