import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,u as n}from"./blocks-CNG2gRRe.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{i,r as a}from"./react-Dyi61YEg.js";import{n as o,t as s}from"./WebAppIcons-Da4nMR-R.js";function c(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...i(),...e.components};return(0,u.jsxs)(u.Fragment,{children:[`
`,`
`,`
`,(0,u.jsx)(n,{title:`Docs/Guidelines/Web app`}),`
`,(0,u.jsx)(t.h1,{id:`web-app`,children:`Web app`}),`
`,(0,u.jsx)(t.p,{children:`Turn a website into a progressive web app (PWA) with a web app manifest and app icons.
The instructions below cover all combinations of common operating systems (Android, iOS, macOS, and Windows) and browsers (Chrome, Safari, Edge, and Firefox).`}),`
`,(0,u.jsx)(t.h2,{id:`how-to-use`,children:`How to use`}),`
`,(0,u.jsx)(t.p,{children:`The web app manifest is the ‘web manifest’ throughout this page.`}),`
...
`,(0,u.jsxs)(t.p,{children:[`Copy the app icons found in `,(0,u.jsx)(t.code,{children:`node_modules/@amsterdam/design-system-assets/app-icons`}),` and the web manifest from `,(0,u.jsx)(t.code,{children:`node_modules/@amsterdam/design-system-assets/manifest/app.webmanifest`}),` to your project.
Typically this is the `,(0,u.jsx)(t.code,{children:`public`}),` folder next to your `,(0,u.jsx)(t.code,{children:`index.html`}),`, though the right location depends on your project structure and build process.`]}),`
`,(0,u.jsxs)(t.p,{children:[`Alternatively, on macOS and Linux you can create a `,(0,u.jsx)(t.a,{href:`https://en.wikipedia.org/wiki/Symbolic_link#POSIX_and_Unix-like_operating_systems`,rel:`nofollow`,children:`symbolic link`}),` in your project that points to the package directory.
An advantage of symlinking is that it tracks changes to the assets when there are package updates.
Symlinks are basically shortcuts to files or directories.`]}),`
...
`})}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.strong,{children:`Important`}),`: the target path (the first argument) is resolved relative to the directory containing the symlink, not your current shell directory.
The simplest way to avoid surprises is to `,(0,u.jsx)(t.code,{children:`cd`}),` to that directory first, as in the example above.`]}),`
...
`})}),`
`,(0,u.jsx)(t.p,{children:`How this is done exactly depends on your project structure and build process.
Follow the documentation of your framework or build tool for the best way to link static assets in the HTML.`}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.strong,{children:`Note`}),`: not all servers recognize the `,(0,u.jsx)(t.code,{children:`.webmanifest`}),` extension.
...
`,(0,u.jsx)(s,{}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.a,{href:`#edit-web-manifest`,children:`Edit web manifest`}),` above lists these icons, and `,(0,u.jsx)(t.a,{href:`#link-in-html`,children:`Link in HTML`}),` links the manifest that references them.`]}),`
`,(0,u.jsxs)(t.p,{children:[(0,u.jsx)(t.strong,{children:`Note`}),`: only include a web manifest if you want the website to be installable as a progressive web app (PWA).
...
`,(0,u.jsx)(t.li,{children:(0,u.jsxs)(t.a,{href:`https://evilmartians.com/chronicles/how-to-favicon-in-2021-six-files-that-fit-most-needs`,rel:`nofollow`,children:[(0,u.jsx)(t.em,{children:`How to Favicon in 2026: Three files that fit most needs`}),` by Andrey Sitnik`]})}),`
`]})]})}function l(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,u.jsx)(t,{...e,children:(0,u.jsx)(c,{...e})}):c(e)}var u;function d(){return(d=e((()=>{u=r(),a(),t(),o()})))()}d();export{l as default};