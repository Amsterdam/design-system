import{j as e}from"./jsx-runtime-ffb262ed.js";import{c as f}from"./clsx-1229b3e0.js";import{r as i}from"./index-76fb7be0.js";import{e as D}from"./index.esm-63fc0a45.js";import{g as P}from"./Heading-de553b97.js";import{I as N}from"./Icon-3496fcf1.js";import{P as b}from"./Paragraph-8d413420.js";const I={headingLevel:1,section:!0},L=i.createContext(I),J=L,y=i.forwardRef(({label:c,expanded:m=!1,children:d,className:h,..._},p)=>{const{headingLevel:n,section:x}=i.useContext(J),[o,a]=i.useState(m),u=P(n),s=i.useId(),l=`button-${s}`,w=`panel-${s}`;return e.jsxs("div",{className:f("amsterdam-accordion__section",h),ref:p,..._,children:[e.jsx(u,{className:"amsterdam-accordion__header",children:e.jsxs("button",{"aria-controls":w,"aria-expanded":o,className:"amsterdam-accordion__button",id:l,onClick:()=>a(!o),type:"button",children:[c,e.jsx(N,{svg:D,size:"level-5"})]})}),x?e.jsx("section",{id:w,"aria-labelledby":l,className:f("amsterdam-accordion__panel",{"amsterdam-accordion__panel--expanded":o}),children:d}):e.jsx("div",{id:w,"aria-labelledby":l,className:f("amsterdam-accordion__panel",{"amsterdam-accordion__panel--expanded":o}),children:d})]})});y.displayName="AccordionSection";try{y.displayName="AccordionSection",y.__docgenInfo={description:"",displayName:"AccordionSection",props:{label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},expanded:{defaultValue:{value:"false"},description:"",name:"expanded",required:!1,type:{name:"boolean"}}}}}catch{}/**
 * @license EUPL-1.2+
...
//# sourceMappingURL=Accordion.stories-0cb45ba2.js.map
