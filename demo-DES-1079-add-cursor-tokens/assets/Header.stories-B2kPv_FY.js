import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{G as d,m as r,H as k}from"./index.esm-DnZEN8Ye.js";import{c as t}from"./clsx-B-dksMZM.js";import{r as o}from"./index-C0MU9AHG.js";import{G as ee}from"./Grid-BnZOqUkS.js";import{L as M}from"./Logo-DAtY6oNF.js";import{H as ae}from"./Heading-YmEnH81o.js";import{I as ne}from"./Icon-plsGHcLz.js";const U=o.forwardRef(({children:a,className:n,...l},s)=>e.jsx(ee.Cell,{...l,className:t("ams-header__grid-cell-narrow-window-only",n),ref:s,children:a}));U.displayName="Header.GridCellNarrowWindowOnly";try{Header.GridCellNarrowWindowOnly.displayName="Header.GridCellNarrowWindowOnly",Header.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"Header.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"footer"'},{value:'"aside"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
