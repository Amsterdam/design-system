import{M as l}from"./index-4bfc7ddc.js";import{j as e}from"./jsx-runtime-2abd473f.js";import{u as d}from"./index-a0644a7c.js";import"./iframe-022850ab.js";import"../sb-preview/runtime.js";import"./index-565f84a4.js";import"./_commonjsHelpers-de833af9.js";import"./index-d37d4223.js";import"./index-356e4a49.js";function r(i){const n=Object.assign({h1:"h1",p:"p",em:"em",h2:"h2",h3:"h3",h4:"h4",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",ul:"ul",li:"li"},d(),i.components);return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Docs/Designrichtlijnen/Grid"}),`
...
`,e.jsx(n.h3,{id:"drie-kolombreedtes",children:"Drie kolombreedtes"}),`
`,e.jsx(n.p,{children:`Het grid bezet steeds de volledige beschikbare breedte.
...
`,e.jsx(n.p,{children:`De huisstijl voor online is ontworpen op eenvoud.
...
Voor websites is het grid behoorlijk daarom ruimtelijk.`}),`
...
`,e.jsx(n.p,{children:"Alle andere eigenschappen van het compacte thema zijn gelijk aan die van het ruimtelijke."}),`
`,e.jsx(n.h3,{id:"marges-links-en-rechts",children:"Marges links en rechts"}),`
`,e.jsx(n.p,{children:`Het grid staat horizontaal gecentreerd.
...
Sommige elementen mogen over deze marges gepositioneerd worden, zoals de pagina-footer en een schermvullende afbeelding.
Die zijn dan dus breder dan de rest van de content.
Ze worden nog wel beperkt door een maximale breedte.`}),`
...
`,e.jsx(n.p,{children:`In het middelbrede en smalle grid wordt het menu verticaal.
...
`,e.jsx(n.p,{children:`Voor websites, in het ruimtelijke thema, is de maximale breedte van het grid 1432 pixels.
...
`,e.jsx(n.p,{children:"Deze ontwerpkeuzes hebben in de praktijk het volgende resultaat."}),`
`,e.jsx(n.h3,{id:"breedtes-per-breakpoint",children:"Breedtes per breakpoint"}),`
`,e.jsx(n.p,{children:"Op de drie breakpoints hebben de kolommen, witruimtes en marges de volgende breedtes in pixels."}),`
...
`,e.jsx(n.p,{children:`Ondanks dat is het bij het ontwerpen van een scherm toch nodig een bepaald canvas te kiezen.
...
`]})]})}function s(i={}){const{wrapper:n}=Object.assign({},d(),i.components);return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}const a=()=>{throw new Error("Docs-only story")};a.parameters={docsOnly:!0};const t={title:"Docs/Designrichtlijnen/Grid",tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:s};const k=["__page"];export{k as __namedExportsOrder,a as __page,t as default};
//# sourceMappingURL=grid.stories-feb0ff47.js.map
