import{j as n}from"./jsx-runtime-Cf8x2fCZ.js";import{r as D}from"./index-G8LIXM5I.js";import{I as m,f as P,g as F,h as H,i as W}from"./index.esm-jhuYF6FN.js";import{backgroundColourOptions as M,backgroundColourOptionsLight as N,backgroundColourOptionsDark as R,getForegroundColor as q}from"./preview-2NwzIGZY.js";import{a as G}from"./exampleContent-r-zRGsZY.js";import{L as e}from"./LinkList-CY5A71mH.js";const E=G(),J={title:"Components/Navigation/Link List",component:e};e.Link;const p={args:{children:E.map((r,o)=>n.jsx(e.Link,{href:"#",children:r},o))}},d={args:{children:E[0],href:"#",icon:P},argTypes:{color:{control:{labels:{undefined:"default"},type:"radio"},options:[void 0,"contrast","inverse"]},icon:{control:{labels:{undefined:"none"},type:"select"},mapping:m,options:[void 0,...Object.keys(m)]},size:{control:{labels:{undefined:"medium"},type:"radio"},options:["small",void 0,"large"]}},decorators:[r=>n.jsx(e,{children:n.jsx(r,{})})],render:({children:r,...o})=>n.jsx(e.Link,{...o,children:r})},s={...p,parameters:{backgrounds:{options:M}},render:(r,{globals:{backgrounds:o}})=>n.jsx(e,{...r,children:Array.isArray(r.children)&&r.children.map((k,_)=>{const B=q(o.value);return D.createElement(e.Link,{...k.props,color:B,key:_},k.props.children)})})},a={...p,args:{children:[n.jsx(e.Link,{href:"#",icon:F,children:"Contactformulier"},"form"),n.jsx(e.Link,{href:"#",icon:H,children:"Adressen en openingstijden"},"address"),n.jsx(e.Link,{href:"#",icon:W,children:"Bel 14 020"},"phone")]}},i={...p,args:{children:[n.jsx(e.Link,{href:"#",size:"small",children:"Over deze website"},"about"),n.jsx(e.Link,{href:"#",size:"small",children:"Abonneer u op de nieuwsbrief"},"newsletter"),n.jsx(e.Link,{href:"#",size:"small",children:"Werken bij de gemeente Amsterdam"},"jobs")]}},t={...d},l={...d,args:{...d.args,color:"contrast"},globals:{backgrounds:{value:"yellow"}},parameters:{backgrounds:{options:{yellow:N.yellow}}}},c={...d,args:{...d.args,color:"inverse"},globals:{backgrounds:{value:"blue"}},parameters:{backgrounds:{options:{blue:R.blue}}}};var u,L,g;s.parameters={...s.parameters,docs:{...(u=s.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...StoryTemplate,
  parameters: {
    backgrounds: {
