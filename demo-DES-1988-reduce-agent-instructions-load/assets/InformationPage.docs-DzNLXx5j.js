import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-msKSRvUz.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-DTlzNtZs.js";import{n as u,t as d}from"./InformationPage.stories-C3ZkNBUz.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Breadcrumb`}],[{height:`title`,label:`Page title`},{height:`panel`,label:`Lead paragraph`},`Lead image`],[{height:`body`,label:`Information body`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
That gap stays at `,(0,g.jsx)(n.code,{children:`x-large`}),` rather than the medium that `,(0,g.jsx)(n.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`vertical space`}),` asks for within a Cell: the default background colour of the page runs along it — at the left-hand side, and across the full width on the narrow grid — so the wider gap still reads as one Content Header.`]}),`
...
`,(0,g.jsxs)(n.li,{children:[`The `,(0,g.jsx)(n.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` utility class sets the vertical space within the Content Header and within the body Cell, following the `,(0,g.jsx)(n.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`vertical space`}),` recommendations.
