import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-zzQRermb.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-DSp90v5V.js";import{n as u,t as d}from"./InformationPage.stories-NcTkDDoY.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Breadcrumb`}],[{height:`title`,label:`Page title`},{height:`panel`,label:`Lead paragraph`},`Lead image`],[{height:`body`,label:`Information body`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.p,{children:`Use this page to explain a subject a reader wants to understand: its background, the rules, and what they mean.`}),`
...
`]}),`
`,(0,g.jsxs)(n.li,{children:[`
`,(0,g.jsxs)(n.p,{children:[`The Content Header contains the title and a Metadata Paragraph that classifies the page: taxonomy tags, optionally preceded by a date.
...
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.a,{href:`/docs/pages-public-product-page--docs`,children:`Product Page`}),` – for a subject that ends in an application.`]}),`
