import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-zzQRermb.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-BoxwfHkQ.js";import{n as u,t as d}from"./NavigationPage.stories-Cqg44zU1.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Breadcrumb`}],[{height:`title`,label:`Page title`}],[...Array.from({length:10},()=>({height:`card`,label:`Link section`}))]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.p,{children:`Use this page as the entry point of one subject, where the page itself carries little content and mostly points onward.`}),`
...
`,(0,g.jsxs)(n.p,{children:[`Adds a `,(0,g.jsx)(n.a,{href:`/docs/components-containers-spotlight--docs`,children:`Spotlight`}),` holding a `,(0,g.jsx)(n.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),` and the links around it, for a subject where a visitor looks something up rather than browses to it.
...
`,(0,g.jsx)(n.p,{children:`Opens with a full-width Image at a 16:5 ratio and introduces the people behind the subject as Cards that each carry a portrait.
...
`,(0,g.jsxs)(n.p,{children:[`A page with a side navigation has two places worth reaching, so give it a second `,(0,g.jsx)(n.a,{href:`/docs/components-navigation-skip-link--docs`,children:`Skip Link`}),`: one to the navigation and one to the entry.
