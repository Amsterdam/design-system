import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,u as n}from"./blocks-zzQRermb.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{i,r as a}from"./react-Dyi61YEg.js";function o(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,ul:`ul`,...i(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[`
`,`
...
`,(0,c.jsxs)(t.p,{children:[`Below the page title, a Heading keeps the size of its level where it introduces a content body, and takes a `,(0,c.jsx)(t.code,{children:`size`}),` one step smaller where it introduces a block or a group of blocks.
