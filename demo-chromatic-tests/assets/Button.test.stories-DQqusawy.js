import{j as t,e as o}from"./iframe-CWw67oni.js";import{B as s}from"./Button-9KHoLWQR.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-BUv0Au03.js";const l={title:"Components/Buttons/Button",component:s},d=["primary","secondary","tertiary"],i=["default","disabled","hover","icon"],a={parameters:{pseudo:{hover:[".hover"]}},render:()=>t.jsx("table",{children:t.jsx("tbody",{children:d.map(n=>t.jsx("tr",{children:i.map(e=>{const r=`${n}-${e}`;return t.jsx("td",{children:t.jsx(s,{className:e==="hover"?"hover":void 0,"data-testid":r,disabled:e==="disabled",icon:e==="icon"?t.jsx(o,{}):void 0,variant:n,children:r})},r)})},n))})}),tags:["!dev","!autodocs"]};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      hover: ['.hover']
    }
