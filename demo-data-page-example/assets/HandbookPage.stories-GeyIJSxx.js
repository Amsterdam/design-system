...
</Grid>`,language:`tsx`}}},render:()=>{let[e,t]=(0,_.useState)(b),[n,r]=(0,_.useState)(()=>x(b)),s=(e,n)=>{e.preventDefault(),t(n),r(e=>new Set([...e,...x(n)]))},l=(e,t)=>{r(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),r})},u=m(e)??f[0];return(0,v.jsxs)(a,{paddingBottom:`2x-large`,paddingTop:`large`,children:[(0,v.jsx)(a.Cell,{span:{narrow:4,medium:3,wide:4},children:(0,v.jsx)(o,{collapsible:!0,heading:`Inhoudsopgave`,id:`inhoudsopgave`,children:S(f,{currentSlug:e,expandedSlugs:n,onSelect:s,onToggle:l})})}),(0,v.jsx)(a.Cell,{span:{narrow:4,medium:5,wide:7},children:(0,v.jsxs)(`main`,{className:`ams-prose`,id:`inhoud`,children:[(0,v.jsx)(i,{level:1,children:u.heading}),(0,v.jsx)(c,{size:`large`,children:u.lead}),(0,v.jsx)(c,{children:u.body})]})})]})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
<Grid paddingBottom="2x-large" paddingTop="large">
  ...
  render: () => {
    ...
    return /* One Grid for the whole page combines both rules: a paddingTop of large and a paddingBottom of 2x-large. */<Grid paddingBottom="2x-large" paddingTop="large">
        <Grid.Cell span={{
        narrow: 4,
        medium: 3,
        wide: 4
...
}`,...C.parameters?.docs?.source}}},w=[`Default`]})))()}export{T as n,g as t};