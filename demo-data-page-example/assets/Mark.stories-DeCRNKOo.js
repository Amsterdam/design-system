import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{C as i,S as a,U as o,d as s,et as c,tt as l,z as u}from"./index.esm-DOZDBJez.js";import{n as d,t as f}from"./Mark-53OgeruV.js";import{d as p,r as m}from"./argTypes-CTYEle7b.js";var h=t({Default:()=>y,SearchResults:()=>C,__namedExportsOrder:()=>w,default:()=>v}),g,_,v,y,b,x,S,C,w;function T(){return(T=e((()=>{l(),d(),g=n(),p(),_=r(),v={title:`Components/Text/Mark`,component:f},y={args:{children:`Wat vinden Amsterdammers belangrijk?`},argTypes:{children:m(`The text to mark.`)},render:({children:e})=>(0,_.jsxs)(u,{children:[`Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. `,(0,_.jsx)(f,{children:e}),` Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren.`]})},b=[{category:`Kansspelen`,date:new Date(`2025-10-27`),fragment:`Op dit moment zijn alle vergunning voor speelautomatenhallen verleend. Als u kansspelautomaten wilt plaatsen in uw horecabedrijf dan heeft u de …`,heading:`Vergunning speelautomatenhal of kansspelautomaten aanvragen`},{category:`Veelgevraagd`,date:new Date(`2024-09-15`),fragment:`U heeft een ontheffing nodig als u de geldende geluidsgrenzen van uw horecagelegenheid wil overschrijden. Kijk hier hoe het werkt en hoe u de …`,heading:`Ontheffing geluidsvoorschriften`},{category:`Vergunningen`,date:new Date(`2023-08-03`),fragment:`Voor de organisatie van grootschalige vechtsportgala’s in Amsterdam moet u een vergunning aanvragen bij de gemeente. Vooraf moet u een Bibobformulier …`,heading:`Vergunning vechtsportevenementen`}],x=new Intl.DateTimeFormat(`nl`,{day:`numeric`,month:`long`,year:`numeric`}),S=(e,t,n)=>{if(!t)return e;let r=t.split(/\s+/).filter(Boolean).map(e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`));if(r.length===0)return e;let i=RegExp(`(${r.join(`|`)})`,`gi`);return e.split(i).map(e=>e.match(i)?(0,_.jsx)(f,{...n,children:e},e):e)},C={render:e=>{let[t,n]=(0,g.useState)(`horeca vergunning`),r=b.filter(({fragment:e,heading:n})=>[e,n].some(e=>t.split(/\s+/).filter(Boolean).some(t=>e.toLowerCase().includes(t.toLowerCase()))));return(0,_.jsx)(a,{children:(0,_.jsxs)(a.Cell,{span:{narrow:4,medium:6,wide:7},start:{narrow:1,medium:2,wide:3},children:[(0,_.jsxs)(o,{className:`ams-mb-m`,children:[(0,_.jsx)(o.Input,{label:`Zoeken`,onChange:e=>n(e.target.value),value:t}),(0,_.jsx)(o.Button,{})]}),(0,_.jsxs)(u,{className:`ams-mb-xl`,children:[(0,_.jsx)(`strong`,{children:r.length}),` artikelen gaan over ‘`,t,`’.`]}),(0,_.jsx)(c,{className:`ams-gap-xl`,markers:!1,children:r.map(({category:n,date:r,fragment:a,heading:o})=>(0,_.jsx)(c.Item,{children:(0,_.jsxs)(s,{children:[(0,_.jsx)(s.HeadingGroup,{tagline:n,children:(0,_.jsx)(i,{level:2,size:`level-4`,children:(0,_.jsx)(s.Link,{href:`#`,children:S(o,t,e)})})}),(0,_.jsx)(u,{className:`ams-mb-xs`,children:S(a,t,e)}),(0,_.jsx)(u,{size:`small`,children:(0,_.jsx)(`time`,{dateTime:r.toISOString(),children:x.format(r)})})]})},o))})]})})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
