import{j as e}from"./iframe-B77K6cjp.js";import{useMDXComponents as i}from"./index-BgzXQC9Y.js";import{M as s,f as a,P as r,h as l}from"./blocks-BAgXdj-6.js";import{a as c}from"./CallToActionLink.stories-CN-03szM.js";import{D as m}from"./DesignTokensTable-DodtoeUr.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bq_JpOC-.js";import"./BorderSample--sV2jBDX.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-CdGiNRFW.js";const d=`<!-- @license CC0-1.0 -->
...
`,p={"call-to-action-link":{"background-color":{$value:"#00a03c",$type:"color"},color:{$value:"{ams.color.text.inverse}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},"padding-block":{$value:"{ams.space.xs}",$type:"dimension"},"padding-inline":{$value:"{ams.space.m}",$type:"dimension"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension"},hover:{"background-color":{$value:"#007c2e",$type:"color"},"text-decoration-thickness":{$value:"{ams.links.hover.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.hover.text-underline-offset}",$type:"dimension"}}}},u={ams:p};function o(n){const t={h2:"h2",...i(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(s,{of:c}),`
...
`,e.jsx(m,{tokens:u})]})}function w(n={}){const{wrapper:t}={...i(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{w as default};
