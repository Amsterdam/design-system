import{j as e}from"./iframe-DjWJ2YNd.js";import{useMDXComponents as l}from"./index-BSeyWPbt.js";import{M as o,f as a,P as r,h,i}from"./blocks-YpHQP-Ue.js";import{R as d,A as c,E as p,a as g,b as x,V as m,W as j}from"./Row.stories-5IGEsyP_.js";import{D as u}from"./DesignTokensTable-DfwwVEhC.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B9EsZJQz.js";import"./types-CjGn4A4T.js";import"./Row-BkadixAT.js";const f=`<!-- @license CC0-1.0 -->

# Row

Stacks its children horizontally with gaps between them and offers alignment options.
`,w={row:{gap:{"x-small":{$value:"{ams.space.xs}",$extensions:{"ams.type":"gap"}},small:{$value:"{ams.space.s}",$extensions:{"ams.type":"gap"}},medium:{$value:"{ams.space.m}",$extensions:{"ams.type":"gap"}},large:{$value:"{ams.space.l}",$extensions:{"ams.type":"gap"}},"x-large":{$value:"{ams.space.xl}",$extensions:{"ams.type":"gap"}}}}},y={ams:w};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:d}),`
...
`,e.jsx(u,{tokens:y})]})}function M(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{M as default};
