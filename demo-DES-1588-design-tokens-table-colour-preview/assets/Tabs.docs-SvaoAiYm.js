import{j as e}from"./iframe-B77K6cjp.js";import{useMDXComponents as s}from"./index-BgzXQC9Y.js";import{M as i,f as r,P as h,h as l,i as a}from"./blocks-BAgXdj-6.js";import{a as c,W as d,b as m,P as p}from"./Tabs.stories-C_OO-38j.js";import{D as b}from"./DesignTokensTable-DodtoeUr.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bq_JpOC-.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./BorderSample--sV2jBDX.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-CdGiNRFW.js";const u=`<!-- @license CC0-1.0 -->
...
`,f={tabs:{gap:{$value:"{ams.space.m}",$type:"dimension"},list:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1) {ams.color.separator}"}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"calc({ams.focus.outline-offset} * -1)",$type:"dimension"},"padding-block":{$value:"{ams.space.s}",$type:"dimension"},"padding-inline":{$value:"{ams.space.m}",$type:"dimension"},hover:{"box-shadow":{$value:"inset 0 calc({ams.border.width.m} * -1)"},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},selected:{"box-shadow":{$value:"inset 0 calc({ams.border.width.xl} * -1)"},"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}}}}},v={ams:f};function o(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(b,{tokens:v})]})}function M(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{M as default};
