import{j as e}from"./iframe-B77K6cjp.js";import{useMDXComponents as a}from"./index-BgzXQC9Y.js";import{M as i,f as c,P as r,h as d,i as o}from"./blocks-BAgXdj-6.js";import{a as h,L as l,E as m,R as u}from"./Accordion.stories-5M6uqtzZ.js";import{D as p}from"./DesignTokensTable-DodtoeUr.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bq_JpOC-.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./Icon-37cr_bY9.js";import"./Heading-ZzeHX68A.js";import"./BorderSample--sV2jBDX.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-CdGiNRFW.js";const f=`<!-- @license CC0-1.0 -->
...
`,g={accordion:{gap:{$value:"{ams.space.s}",$type:"dimension"},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},gap:{$value:"{ams.space.s}",$type:"dimension"},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},"padding-block":{$value:"{ams.space.s}",$type:"dimension"},"padding-inline":{$value:"0"},hover:{color:{$value:"{ams.color.interactive.hover}",$type:"color"}}}}},x={ams:g};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:h}),`
...
`,e.jsx(p,{tokens:x})]})}function I(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{I as default};
