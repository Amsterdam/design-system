import{j as e}from"./iframe-DnBePZqG.js";import{useMDXComponents as o}from"./index-CK937RcF.js";import{M as a,f as s,P as r,h as l}from"./blocks-Cfrr9rc5.js";import{a as p}from"./Pagination.stories-BWjJLX1p.js";import{D as m}from"./DesignTokensTable-BFE6Aawx.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Bz_GHSVd.js";import"./Icon-7vYXh2yY.js";import"./BorderSample-COA7WDwz.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-DUmku21j.js";const c=`<!-- @license CC0-1.0 -->
...
`,h={pagination:{"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},link:{color:{$value:"{ams.links.color}",$type:"color"},gap:{$value:"{ams.space.xs}",$type:"dimension"},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension"},"padding-inline":{$value:"{ams.space.s}",$type:"dimension"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension"},current:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}}}},d={ams:h};function i(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:p}),`
...
`,e.jsx(m,{tokens:d})]})}function P(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{P as default};
