import{r as L,j as e,c as d,G as l,_ as r,H as x}from"./iframe-1bCY-k-l.js";import{u as S}from"./useIsAfterBreakpoint-CaqWIGHS.js";import{G as E}from"./Grid-glHk0ywS.js";import{I as q}from"./Icon-B1wNjV7K.js";import{L as z}from"./Logo-B2YZKutu.js";const G=L.forwardRef(({children:a,className:n,...s},o)=>e.jsx(E.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:o,children:a}));G.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"aside"'},{value:'"div"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'},{value:'"section"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...p.parameters?.docs?.source}}};const D=["Default","WithMovingLinks","WithoutMenuButtonOnWideWindow","WithoutMenuButton","WithCustomLogoLink","WithCustomTexts"],J=Object.freeze(Object.defineProperty({__proto__:null,Default:m,WithCustomLogoLink:h,WithCustomTexts:p,WithMovingLinks:c,WithoutMenuButton:g,WithoutMenuButtonOnWideWindow:u,__namedExportsOrder:D,default:R},Symbol.toStringTag,{value:"Module"}));export{i as P,c as W,J as a,u as b,g as c,h as d,p as e,R as m};
