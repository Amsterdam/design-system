import{j as r}from"./jsx-runtime-BlAj40OV.js";import{F as l,f as s,E as a,T as t,P as o,C as x,R as d,g as n}from"./index.esm-BF58LKzl.js";import{c as ee}from"./clsx-B-dksMZM.js";import{r as re}from"./index-Cs7sjTYM.js";import{a as ae}from"./Label-nD_f5r9k.js";const i=re.forwardRef(({children:e,className:K,invalid:Q,legend:U,required:X,notRequiredLabel:j="niet verplicht",...Y},Z)=>r.jsxs("fieldset",{...Y,ref:Z,className:ee("ams-field-set",Q&&"ams-field-set--invalid",K),children:[r.jsxs("legend",{className:"ams-field-set__legend",children:[U,!X&&j&&r.jsx(ae,{notRequiredLabel:j})]}),e]}));i.displayName="FieldSet";try{i.displayName="FieldSet",i.__docgenInfo={description:"",displayName:"FieldSet",props:{invalid:{defaultValue:null,description:"Whether the field set has an input with a validation error",name:"invalid",required:!1,type:{name:"boolean"}},legend:{defaultValue:null,description:"The text for the caption.",name:"legend",required:!0,type:{name:"string"}},notRequiredLabel:{defaultValue:{value:"niet verplicht"},description:"Text to inform the user that the field is explicitely not required.",name:"notRequiredLabel",required:!1,type:{name:"string"}},required:{defaultValue:null,description:"Whether the field set is required.",name:"required",required:!1,type:{name:"boolean"}}}}}catch{}const ie={title:"Components/Forms/Field Set",component:i,args:{invalid:!1,legend:"Wat is uw naam?",notRequiredLabel:"niet verplicht",required:!1},decorators:[e=>r.jsx("form",{children:r.jsx(e,{})})]},u={render:e=>r.jsxs(i,{invalid:e.invalid,legend:e.legend,required:e.required,notRequiredLabel:e.notRequiredLabel,children:[r.jsxs(l,{className:"ams-mb--sm",children:[r.jsx(s,{htmlFor:"input-a1",required:e.required,notRequiredLabel:"",children:"Voornaam"}),e.invalid&&r.jsx(a,{id:"error-a1",children:"Vul uw voornaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-a1":void 0,"aria-required":"true",id:"input-a1",invalid:e.invalid})]}),r.jsxs(l,{children:[r.jsx(s,{htmlFor:"input-a2",required:e.required,notRequiredLabel:"",children:"Achternaam"}),e.invalid&&r.jsx(a,{id:"error-a2",children:"Vul uw achternaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-a2":void 0,"aria-required":"true",id:"input-a2",invalid:e.invalid})]})]})},m={render:e=>r.jsxs(i,{invalid:e.invalid,legend:e.legend,required:e.required,"aria-describedby":"description-b",children:[r.jsx(o,{id:"description-b",size:"small",className:"ams-mb--sm",children:"Vul uw naam in zoals in uw paspoort staat."}),r.jsxs(l,{className:"ams-mb--sm",children:[r.jsx(s,{htmlFor:"input-b1",required:e.required,notRequiredLabel:"",children:"Voornaam"}),e.invalid&&r.jsx(a,{id:"error-b1",children:"Vul uw voornaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-b1":void 0,"aria-required":"true",id:"input-b1",invalid:e.invalid})]}),r.jsxs(l,{children:[r.jsx(s,{htmlFor:"input-b2",required:e.required,notRequiredLabel:"",children:"Achternaam"}),e.invalid&&r.jsx(a,{id:"error-b2",children:"Vul uw achternaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-b2":void 0,"aria-required":"true",id:"input-b2",invalid:e.invalid})]})]})},c={args:{required:!0,notRequiredLabel:"niet verplicht"},render:e=>r.jsxs(i,{invalid:e.invalid,legend:e.legend,required:e.required,notRequiredLabel:e.notRequiredLabel,children:[r.jsxs(l,{className:"ams-mb--sm",children:[r.jsx(s,{htmlFor:"input-a1",required:e.required,notRequiredLabel:"",children:"Voornaam"}),e.invalid&&r.jsx(a,{id:"error-a1",children:"Vul uw voornaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-a1":void 0,"aria-required":"true",id:"input-a1",invalid:e.invalid})]}),r.jsxs(l,{children:[r.jsx(s,{htmlFor:"input-a2",required:e.required,notRequiredLabel:"",children:"Achternaam"}),e.invalid&&r.jsx(a,{id:"error-a2",children:"Vul uw achternaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-a2":void 0,"aria-required":"true",id:"input-a2",invalid:e.invalid})]})]})},v={args:{invalid:!0},render:e=>r.jsxs(i,{invalid:e.invalid,legend:e.legend,required:e.required,"aria-describedby":"description-c",children:[r.jsx(o,{id:"description-c",size:"small",className:"ams-mb--sm",children:"Vul uw naam in zoals in uw paspoort staat."}),r.jsxs(l,{className:"ams-mb--sm",children:[r.jsx(s,{htmlFor:"input-c1",required:e.required,notRequiredLabel:"",children:"Voornaam"}),e.invalid&&r.jsx(a,{id:"error-c1",children:"Vul uw voornaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-c1":void 0,"aria-required":"true",id:"input-c1",invalid:e.invalid})]}),r.jsxs(l,{children:[r.jsx(s,{htmlFor:"input-c2",required:e.required,notRequiredLabel:"",children:"Achternaam"}),e.invalid&&r.jsx(a,{id:"error-c2",children:"Vul uw achternaam in."}),r.jsx(t,{"aria-describedby":e.invalid?"error-c2":void 0,"aria-required":"true",id:"input-c2",invalid:e.invalid})]})]})},b={args:{legend:"Waar gaat uw melding over?"},render:e=>r.jsxs(i,{"aria-describedby":`description-d${e.invalid?" error-d":""}`,"aria-required":"true",invalid:e.invalid,legend:e.legend,required:e.required,role:"radiogroup",children:[r.jsx(o,{className:"ams-mb--sm",id:"description-d",size:"small",children:"De laatstgenoemde melding."}),e.invalid&&r.jsx(a,{className:"ams-mb--sm",id:"error-d",children:"Geef aan waar uw laatstgenoemde melding over gaat."}),r.jsxs(x,{gap:"extra-small",children:[r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"evenement",children:"Evenement"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},g={args:{legend:"Waar gaat uw melding over?",required:!0,notRequiredLabel:"niet verplicht"},render:e=>r.jsxs(i,{"aria-describedby":`description-d${e.invalid?" error-d":""}`,"aria-required":"true",invalid:e.invalid,legend:e.legend,required:e.required,role:"radiogroup",children:[r.jsx(o,{className:"ams-mb--sm",id:"description-d",size:"small",children:"De laatstgenoemde melding."}),e.invalid&&r.jsx(a,{className:"ams-mb--sm",id:"error-d",children:"Geef aan waar uw laatstgenoemde melding over gaat."}),r.jsxs(x,{gap:"extra-small",children:[r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"evenement",children:"Evenement"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},p={args:{legend:"Waar gaat uw melding over?",invalid:!0},render:e=>r.jsxs(i,{"aria-describedby":`description-e${e.invalid?" error-e":""}`,"aria-required":"true",invalid:e.invalid,legend:e.legend,required:e.required,role:"radiogroup",children:[r.jsx(o,{className:"ams-mb--sm",id:"description-e",size:"small",children:"De laatstgenoemde melding."}),e.invalid&&r.jsx(a,{className:"ams-mb--sm",id:"error-e",children:"Geef aan waar uw laatstgenoemde melding over gaat."}),r.jsxs(x,{gap:"extra-small",children:[r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"evenement",children:"Evenement"}),r.jsx(d,{"aria-required":"true",invalid:e.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},h={args:{legend:"Waar gaat uw melding over?"},render:e=>r.jsxs(i,{"aria-labelledby":`fieldset-f description-f${e.invalid?" error-f":""}`,id:"fieldset-f",invalid:e.invalid,legend:e.legend,required:e.required,children:[r.jsx(o,{className:"ams-mb--sm",id:"description-f",size:"small",children:"De laatstgenoemde melding."}),e.invalid&&r.jsx(a,{className:"ams-mb--sm",id:"error-f",children:"Geef aan waar uw melding over gaat."}),r.jsxs(x,{gap:"extra-small",children:[r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"evenement",children:"Evenement"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},q={args:{invalid:!0,legend:"Waar gaat uw melding over?"},render:e=>r.jsxs(i,{"aria-labelledby":`fieldset-g description-g${e.invalid?" error-g":""}`,id:"fieldset-g",invalid:e.invalid,legend:e.legend,required:e.required,children:[r.jsx(o,{id:"description-g",size:"small",className:"ams-mb--sm",children:"De laatstgenoemde melding."}),e.invalid&&r.jsx(a,{className:"ams-mb--sm",id:"error-g",children:"Geef aan waar uw melding over gaat."}),r.jsxs(x,{gap:"extra-small",children:[r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"evenement",children:"Evenement"}),r.jsx(n,{"aria-required":"true",invalid:e.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})};var f,R,F;u.parameters={...u.parameters,docs:{...(f=u.parameters)==null?void 0:f.docs,source:{originalSource:`{
