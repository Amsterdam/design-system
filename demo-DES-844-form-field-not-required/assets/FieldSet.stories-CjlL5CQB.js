import{j as e}from"./jsx-runtime-BlAj40OV.js";import{e as l,f as s,E as r,T as o,P as t,C as q,R as d,h as n}from"./index.esm-Du1ulxR3.js";import{c as Q}from"./clsx-B-dksMZM.js";import{r as X}from"./index-Cs7sjTYM.js";import{H as Y}from"./Hint-D4Fy8YuO.js";const i=X.forwardRef(({children:a,className:u,invalid:m,legend:c,hint:U,optional:B,...J},K)=>e.jsxs("fieldset",{...J,ref:K,className:Q("ams-field-set",m&&"ams-field-set--invalid",u),children:[e.jsxs("legend",{className:"ams-field-set__legend",children:[c," ",e.jsx(Y,{hint:U,optional:B})]}),a]}));i.displayName="FieldSet";try{i.displayName="FieldSet",i.__docgenInfo={description:"",displayName:"FieldSet",props:{invalid:{defaultValue:null,description:"Whether the field set has an input with a validation error",name:"invalid",required:!1,type:{name:"boolean"}},legend:{defaultValue:null,description:"The text for the caption.",name:"legend",required:!0,type:{name:"string"}},hint:{defaultValue:null,description:"Show a custom hint text.",name:"hint",required:!1,type:{name:"string"}},optional:{defaultValue:null,description:"Appends the text '(niet verplicht)' to the label or legend if no hint is provided. Use when the associated inputs are optional.",name:"optional",required:!1,type:{name:"boolean"}}}}}catch{}const Z={title:"Components/Forms/Field Set",component:i,args:{invalid:!1,legend:"Wat is uw naam?",optional:!1,hint:""},decorators:[a=>e.jsx("form",{children:e.jsx(a,{})})]},v={render:({invalid:a,legend:u,hint:m,optional:c})=>e.jsxs(i,{"aria-required":!0,hint:m,invalid:a,legend:u,optional:c,children:[e.jsxs(l,{className:"ams-mb--sm",children:[e.jsx(s,{htmlFor:"input-a1",children:"Voornaam"}),a&&e.jsx(r,{id:"error-a1",children:"Vul uw voornaam in."}),e.jsx(o,{"aria-describedby":a?"error-a1":void 0,"aria-required":!0,id:"input-a1",invalid:a})]}),e.jsxs(l,{children:[e.jsx(s,{htmlFor:"input-a2",children:"Achternaam"}),a&&e.jsx(r,{id:"error-a2",children:"Vul uw achternaam in."}),e.jsx(o,{"aria-describedby":a?"error-a2":void 0,"aria-required":!0,id:"input-a2",invalid:a})]})]})},b={render:a=>e.jsxs(i,{"aria-describedby":"description-b","aria-required":!0,invalid:a.invalid,legend:a.legend,children:[e.jsx(t,{id:"description-b",size:"small",className:"ams-mb--sm",children:"Vul uw naam in zoals in uw paspoort staat."}),e.jsxs(l,{className:"ams-mb--sm",children:[e.jsx(s,{htmlFor:"input-b1",children:"Voornaam"}),a.invalid&&e.jsx(r,{id:"error-b1",children:"Vul uw voornaam in."}),e.jsx(o,{"aria-describedby":a.invalid?"error-b1":void 0,"aria-required":!0,id:"input-b1",invalid:a.invalid})]}),e.jsxs(l,{children:[e.jsx(s,{htmlFor:"input-b2",children:"Achternaam"}),a.invalid&&e.jsx(r,{id:"error-b2",children:"Vul uw achternaam in."}),e.jsx(o,{"aria-describedby":a.invalid?"error-b2":void 0,"aria-required":!0,id:"input-b2",invalid:a.invalid})]})]})},g={args:{optional:!1,hint:"verplicht"},render:({invalid:a,legend:u,hint:m,optional:c})=>e.jsxs(i,{"aria-required":!0,hint:m,invalid:a,legend:u,optional:c,children:[e.jsxs(l,{className:"ams-mb--sm",children:[e.jsx(s,{htmlFor:"input-b3",children:"Voornaam"}),a&&e.jsx(r,{id:"error-b3",children:"Vul uw voornaam in."}),e.jsx(o,{"aria-describedby":a?"error-b3":void 0,"aria-required":!0,id:"input-b3",invalid:a})]}),e.jsxs(l,{children:[e.jsx(s,{htmlFor:"input-b4",children:"Achternaam"}),a&&e.jsx(r,{id:"error-b4",children:"Vul uw achternaam in."}),e.jsx(o,{"aria-describedby":a?"error-b4":void 0,"aria-required":!0,id:"input-b4",invalid:a})]})]})},p={args:{invalid:!0},render:a=>e.jsxs(i,{"aria-describedby":"description-c","aria-required":!0,invalid:a.invalid,legend:a.legend,children:[e.jsx(t,{id:"description-c",size:"small",className:"ams-mb--sm",children:"Vul uw naam in zoals in uw paspoort staat."}),e.jsxs(l,{className:"ams-mb--sm",children:[e.jsx(s,{htmlFor:"input-c1",children:"Voornaam"}),a.invalid&&e.jsx(r,{id:"error-c1",children:"Vul uw voornaam in."}),e.jsx(o,{"aria-describedby":a.invalid?"error-c1":void 0,"aria-required":!0,id:"input-c1",invalid:a.invalid})]}),e.jsxs(l,{children:[e.jsx(s,{htmlFor:"input-c2",children:"Achternaam"}),a.invalid&&e.jsx(r,{id:"error-c2",children:"Vul uw achternaam in."}),e.jsx(o,{"aria-describedby":a.invalid?"error-c2":void 0,"aria-required":!0,id:"input-c2",invalid:a.invalid})]})]})},h={args:{legend:"Waar gaat uw melding over?"},render:a=>e.jsxs(i,{"aria-describedby":`description-d${a.invalid?" error-d":""}`,"aria-required":!0,invalid:a.invalid,legend:a.legend,role:"radiogroup",children:[e.jsx(t,{className:"ams-mb--sm",id:"description-d",size:"small",children:"De laatstgenoemde melding."}),a.invalid&&e.jsx(r,{className:"ams-mb--sm",id:"error-d",children:"Geef aan waar uw laatstgenoemde melding over gaat."}),e.jsxs(q,{gap:"extra-small",children:[e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"evenement",children:"Evenement"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},x={args:{legend:"Waar gaat uw melding over?",invalid:!0},render:a=>e.jsxs(i,{"aria-describedby":`description-e${a.invalid?" error-e":""}`,"aria-required":!0,invalid:a.invalid,legend:a.legend,role:"radiogroup",children:[e.jsx(t,{className:"ams-mb--sm",id:"description-e",size:"small",children:"De laatstgenoemde melding."}),a.invalid&&e.jsx(r,{className:"ams-mb--sm",id:"error-e",children:"Geef aan waar uw laatstgenoemde melding over gaat."}),e.jsxs(q,{gap:"extra-small",children:[e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"evenement",children:"Evenement"}),e.jsx(d,{"aria-required":!0,invalid:a.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},j={args:{legend:"Waar gaat uw melding over?"},render:a=>e.jsxs(i,{"aria-labelledby":`fieldset-f description-f${a.invalid?" error-f":""}`,"aria-required":!0,id:"fieldset-f",invalid:a.invalid,legend:a.legend,children:[e.jsx(t,{className:"ams-mb--sm",id:"description-f",size:"small",children:"De laatstgenoemde melding."}),a.invalid&&e.jsx(r,{className:"ams-mb--sm",id:"error-f",children:"Geef aan waar uw melding over gaat."}),e.jsxs(q,{gap:"extra-small",children:[e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"evenement",children:"Evenement"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})},f={args:{invalid:!0,legend:"Waar gaat uw melding over?"},render:a=>e.jsxs(i,{"aria-labelledby":`fieldset-g description-g${a.invalid?" error-g":""}`,"aria-required":!0,id:"fieldset-g",invalid:a.invalid,legend:a.legend,children:[e.jsx(t,{id:"description-g",size:"small",className:"ams-mb--sm",children:"De laatstgenoemde melding."}),a.invalid&&e.jsx(r,{className:"ams-mb--sm",id:"error-g",children:"Geef aan waar uw melding over gaat."}),e.jsxs(q,{gap:"extra-small",children:[e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"horeca",children:"Horecabedrijf"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"ander_bedrijf",children:"Ander soort bedrijf"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"evenement",children:"Evenement"}),e.jsx(n,{"aria-required":!0,invalid:a.invalid,name:"about",value:"anders",children:"Iets anders"})]})]})};var F,w,y;v.parameters={...v.parameters,docs:{...(F=v.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: ({
    invalid,
    legend,
    hint,
  ...
  render: args => <FieldSet aria-describedby="description-b" aria-required invalid={args.invalid} legend={args.legend}>
      ...
      <Field className="ams-mb--sm">
        ...
        <TextInput aria-describedby={args.invalid ? 'error-b1' : undefined} aria-required id="input-b1" invalid={args.invalid} />
      </Field>
      <Field>
        <Label htmlFor="input-b2">Achternaam</Label>
        {args.invalid && <ErrorMessage id="error-b2">Vul uw achternaam in.</ErrorMessage>}
        <TextInput aria-describedby={args.invalid ? 'error-b2' : undefined} aria-required id="input-b2" invalid={args.invalid} />
      </Field>
    </FieldSet>
  ...
  render: args => <FieldSet aria-describedby="description-c" aria-required invalid={args.invalid} legend={args.legend}>
      ...
      <Field className="ams-mb--sm">
        ...
        <TextInput aria-describedby={args.invalid ? 'error-c1' : undefined} aria-required id="input-c1" invalid={args.invalid} />
      </Field>
      <Field>
        <Label htmlFor="input-c2">Achternaam</Label>
        {args.invalid && <ErrorMessage id="error-c2">Vul uw achternaam in.</ErrorMessage>}
        <TextInput aria-describedby={args.invalid ? 'error-c2' : undefined} aria-required id="input-c2" invalid={args.invalid} />
      </Field>
    </FieldSet>
  ...
  render: args => <FieldSet aria-describedby={\`description-d\${args.invalid ? ' error-d' : ''}\`} aria-required invalid={args.invalid} legend={args.legend} role="radiogroup">
  ...
  render: args => <FieldSet aria-describedby={\`description-e\${args.invalid ? ' error-e' : ''}\`} aria-required invalid={args.invalid} legend={args.legend} role="radiogroup">
  ...
  render: args => <FieldSet aria-labelledby={\`fieldset-f description-f\${args.invalid ? ' error-f' : ''}\`} aria-required id="fieldset-f" invalid={args.invalid} legend={args.legend}>
  ...
  render: args => <FieldSet aria-labelledby={\`fieldset-g description-g\${args.invalid ? ' error-g' : ''}\`} aria-required id="fieldset-g" invalid={args.invalid} legend={args.legend}>
