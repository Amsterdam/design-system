import{j as e}from"./jsx-runtime-BlAj40OV.js";import{useMDXComponents as o}from"./index-BI1Biiay.js";import{ae as s,ak as a,al as d,am as l,an as n}from"./index-NvpalOgX.js";import{F as h,W as c,a as p,b as u,R as x,c as j,d as g,C as m,e as f}from"./FieldSet.stories-CzAEXqBd.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-zi76hdn8.js";import"../sb-preview/runtime.js";import"./index-BU4L-DQy.js";import"./index-D-8MO0q_.js";import"./index-nrpnv_Jx.js";import"./index-DrFu-skq.js";import"./index.esm-BXcx5UUI.js";import"./clsx-B-dksMZM.js";import"./index.esm-Bsc2owIZ.js";import"./Hint-D4EIfW8U.js";const b=`<!-- @license CC0-1.0 -->
...
`;/*@license CC0-1.0*/function r(t){const i={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(s,{of:h}),`
`,e.jsx(a,{children:b}),`
`,e.jsx(d,{}),`
...
Make sure to add a `,e.jsx(i.code,{children:"required"})," or ",e.jsx(i.code,{children:'aria-required="true"'})," attribute to ",e.jsx("em",{children:"all"})," form element in this Field Set."]}),`
`,e.jsx(n,{of:p}),`
...
`,e.jsx(n,{of:x}),`
`,e.jsx(i.h3,{id:"radio-group-with-hint",children:"Radio group with Hint"}),`
...
Make sure to add the `,e.jsx(i.code,{children:"required"})," or ",e.jsx(i.code,{children:'aria-required="true"'})," attribute to ",e.jsx("em",{children:"any"})," samely named Radios in this Field Set."]}),`
`,e.jsx(n,{of:j}),`
...
`})}),`
`,e.jsxs(i.p,{children:["The order of the ",e.jsx(i.code,{children:"id"}),"s is the order in which they are read by screen readers."]}),`
`,e.jsx(n,{of:f})]})}function U(t={}){const{wrapper:i}={...o(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(r,{...t})}):r(t)}export{U as default};
