import{n as e}from"./chunk-zsgVPwQN.js";import{At as t}from"./iframe-LMw21FmS.js";import{r as n}from"./react-BWbzhqUM.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-7mj2AQY4.js";import{n as l,t as u}from"./DesignTokensTable-DZYrJZxJ.js";import{t as d}from"./mdx-react-shim-uwIOjeI8.js";import{HighlightContent as f,n as p,t as m}from"./Spotlight.stories-Cf9B7pjP.js";var h,g=e((()=>{h=`<!-- @license CC0-1.0 -->
...
`})),_,v,y=e((()=>{_={spotlight:{"background-color":{$value:`{ams.color.highlight.purple}`,$type:`color`},azure:{"background-color":{$value:`{ams.color.highlight.azure}`,$type:`color`}},green:{"background-color":{$value:`{ams.color.highlight.green}`,$type:`color`}},lime:{"background-color":{$value:`{ams.color.highlight.lime}`,$type:`color`}},magenta:{"background-color":{$value:`{ams.color.highlight.magenta}`,$type:`color`}},orange:{"background-color":{$value:`{ams.color.highlight.orange}`,$type:`color`}},yellow:{"background-color":{$value:`{ams.color.highlight.yellow}`,$type:`color`}}}},v={ams:_}}));function b(e){let t={h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(r,{of:m}),`
