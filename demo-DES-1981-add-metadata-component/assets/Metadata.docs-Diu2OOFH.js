...
`,(0,C.jsxs)(r.p,{children:[`The separator is not read aloud, so say in the words themselves whatever the grouping is meant to convey.
Anything a reader can only get from the way the line is divided is unavailable to someone who does not see it, which is what `,(0,C.jsx)(r.a,{href:`https://www.w3.org/TR/WCAG22/#info-and-relationships`,rel:`nofollow`,children:`WCAG 1.3.1`}),` asks you to avoid.`]}),`
...
`,(0,C.jsxs)(r.p,{children:[`The square is the shape Amsterdam Sans gives the bullet character that marks an `,(0,C.jsx)(r.a,{href:`/docs/components-text-unordered-list--docs`,children:`Unordered List`}),`, but a much smaller one: set as text at the size the typeface draws it, that character would be far heavier than the words on either side of it.`]}),`
...
`,(0,C.jsxs)(r.p,{children:[`A Metadata renders a paragraph rather than a list, because it has to be able to sit in the heading group of a `,(0,C.jsx)(r.a,{href:`/docs/components-navigation-card--docs`,children:`Card`}),`, where HTML allows only a heading and paragraphs.
