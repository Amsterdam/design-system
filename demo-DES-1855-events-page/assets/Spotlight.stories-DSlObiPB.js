import{a as e,i as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./jsx-runtime-BqsN2jGA.js";import{B as r,Tt as i,_t as a,jt as o,nt as s,tt as c}from"./iframe-ClqxS2aw.js";import{C as l,S as u,t as d,w as f}from"./src-DixGIAab.js";import{l as p,p as m}from"./exampleContent--bKQaizt.js";var h=e({Default:()=>y,HighlightContent:()=>b,__namedExportsOrder:()=>x,default:()=>v}),g,_,v,y,b,x,S=t((()=>{o(),d(),l(),m(),g=n(),_=p(),v={title:`Components/Containers/Spotlight`,component:u,argTypes:{color:{control:{labels:{undefined:`purple (default)`}},options:[void 0,...f]}}},y={render:({as:e,color:t})=>(0,g.jsx)(u,{as:e,color:t,children:(0,g.jsx)(c,{paddingVertical:`x-large`,children:(0,g.jsx)(c.Cell,{span:`all`,children:(0,g.jsx)(r,{color:!t||[`azure`,`green`,`magenta`].includes(t)?`inverse`:void 0,children:_})})})})},b={args:{color:`green`},render:({color:e})=>{let t=[`lime`,`orange`,`yellow`],n=t.includes(e)?void 0:`inverse`,r=t.includes(e)?`contrast`:`inverse`;return(0,g.jsx)(u,{color:e,children:(0,g.jsx)(c,{paddingVertical:`x-large`,children:(0,g.jsxs)(c.Cell,{span:{narrow:4,medium:5,wide:7},children:[(0,g.jsx)(s,{className:`ams-mb-s`,color:n,level:2,size:`level-3`,children:`Steun geven aan een partij`}),(0,g.jsx)(a,{className:`ams-mb-m`,color:n,children:`Van 19 januari tot en met 2 februari kunt u uw steun geven aan een partij voor de gemeenteraad of een stadsdeel- of bestuurscommissie. Dit doet u met een ondersteuningsverklaring.`}),(0,g.jsx)(i,{color:r,href:`#`,children:`Ondersteuningsverklaring inleveren`})]})})})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: ({
    as,
    color
