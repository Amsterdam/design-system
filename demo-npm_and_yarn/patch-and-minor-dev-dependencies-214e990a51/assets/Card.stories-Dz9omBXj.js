import{r as g,j as e,c as m,P as d,C as x,G as l}from"./iframe-Doavr_St.js";import{f as _}from"./common-HRWYXPjp.js";import{k as w}from"./exampleContent-Du2yH2Fl.js";import{H as y}from"./Heading-BBAOL3Jv.js";import{P as H}from"./Paragraph-DM-UGGL6.js";import{I as b}from"./Image-B_CfF9Gk.js";const C=g.forwardRef(({children:r,className:n,size:i="level-3",...s},u)=>e.jsx(y,{...s,className:m("ams-card__heading",n),ref:u,size:i,children:r}));C.displayName="Card.Heading";try{Card.Heading.displayName="Card.Heading",Card.Heading.__docgenInfo={description:"",displayName:"Card.Heading",props:{color:{defaultValue:null,description:"Changes the text colour for readability on a dark background.",name:"color",required:!1,type:{name:"enum",value:[{value:'"inverse"'}]}},level:{defaultValue:null,description:"The hierarchical level within the document.",name:"level",required:!0,type:{name:"enum",value:[{value:"1"},{value:"4"},{value:"2"},{value:"3"}]}},size:{defaultValue:{value:"level-3"},description:`Uses larger or smaller text without changing its position in the heading hierarchy.
