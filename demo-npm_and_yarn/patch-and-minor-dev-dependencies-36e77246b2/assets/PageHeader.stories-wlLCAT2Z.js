import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{G as t,r,H as x}from"./index.esm-C4Aaqgc8.js";import{c as d}from"./clsx-B-dksMZM.js";import{r as m}from"./index-G8LIXM5I.js";import{G as ie}from"./Grid-BHIDbP7U.js";import{I as se}from"./Icon-BBW_x4VP.js";import{L as le}from"./Logo-BXVw7-MZ.js";const F=m.forwardRef(({children:a,className:n,...s},l)=>e.jsx(ie.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:l,children:a}));F.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
