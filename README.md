...
The assets in the proprietary folder are not covered by the open source licenses. Each folder in the proprietary folder specifies the license that applies to that folder. For more information about proprietary assets, please carefully read the [NOTICE file](NOTICE.md).
