...
In [.stylelintrc.json](../../../.stylelintrc.json), `csstools/value-no-unknown-custom-properties` and the `ams/*` rules all take the built token CSS as an `importFrom` dictionary and validate declarations against it.
