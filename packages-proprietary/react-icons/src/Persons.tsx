...
const SvgPersons = (props: SVGProps<SVGSVGElement>) => (
  <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    />
    <path
      d="M6.945 16.345a2 2 0 0 1 1.927-1.465h6.257a2 2 0 0 1 1.928 1.465l.907 3.267h-2.076l-.759-2.732H8.872l-.76 2.732H6.038z"
      fill="#181818"
    />
    <path
      clipRule="evenodd"
    ...
    />
    <path
      d="M3.856 11.38h3.86c.042.732.271 1.414.64 2h-4.5l-.765 2.732H1l.915-3.267a2.01 2.01 0 0 1 1.941-1.465M20.144 13.38h-4.52c.37-.586.598-1.268.641-2h3.879c.905 0 1.7.599 1.941 1.465L23 16.112h-2.091z"
      fill="#181818"
    />
  </svg>
)
