import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{t as r}from"./react-Wx6hiPly.js";import{t as i}from"./jsx-runtime-GmyBfqKJ.js";import{E as a,c as o,p as s,w as c,z as l}from"./index.esm-B_OH5ZB5.js";import{s as u,t as d}from"./src-CDXIRUad.js";var f=n({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=e((()=>{l(),d(),p=t(r()),m=i(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}}},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
...
</TabNavigation>`,language:`tsx`}}},render:e=>{let{current:t,handleClick:n}=h(_);return(0,m.jsx)(u,{...e,children:(0,m.jsx)(u.List,{children:_.map(e=>(0,m.jsx)(u.Link,{"aria-current":t===e?`page`:void 0,href:`#${e.toLowerCase()}`,onClick:t=>n(t,e),children:e},e))})})}},b=[{icon:a,label:`Gegevens`},{icon:s,label:`Aanslagen`},{icon:o,label:`Documenten`},{icon:c,label:`Acties`}],x={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
