import{n as e}from"./chunk-DnJy8xQt.js";import{Vt as t}from"./iframe-qFwuzTha.js";import{r as n}from"./react-Al8iO7tU.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-J6tU47qO.js";import{n as l,t as u}from"./DesignTokensTable-Bl6XOIt6.js";import{t as d}from"./mdx-react-shim-KYAFRPVS.js";import{LazyLoading as f,ResponsiveImages as p,n as m,t as h}from"./Image.stories-BOwYSW4t.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={image:{"aspect-ratio":{$value:`{ams.aspect-ratio.16-9}`,$extensions:{"nl.amsterdam.type":`aspectRatio`}}}},y={ams:v}}));function x(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
...
`,(0,C.jsxs)(t.p,{children:[`Provide a set of smaller and larger instances of the image (through `,(0,C.jsx)(t.code,{children:`srcSet`}),`, see `,(0,C.jsx)(t.a,{href:`https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#srcset`,rel:`nofollow`,children:`MDN`}),`) to let the browser select the optimal source file.
...
`,(0,C.jsxs)(t.p,{children:[`Set the `,(0,C.jsx)(t.code,{children:`loading`}),` attribute (see `,(0,C.jsx)(t.a,{href:`https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img#loading`,rel:`nofollow`,children:`MDN`}),`) to `,(0,C.jsx)(t.code,{children:`lazy`}),` and the browser will wait to load the image until it is close to the viewport.
