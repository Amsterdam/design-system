import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-BM1tnykR.js";import{r as n}from"./react-DSGRDtLw.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-BfISIBWW.js";import{n as l,t as u}from"./DesignTokensTable-BRAojYir.js";import{t as d}from"./mdx-react-shim-DQd8mFNY.js";import{InAFieldSet as f,WithDescription as p,WithValidation as m,n as h,t as g}from"./Field.stories-DHBogRTm.js";var _,v=e((()=>{_=`<!-- @license CC0-1.0 -->
...
`})),y,b,x=e((()=>{y={field:{gap:{$deprecated:`Will be removed in release 5.0.0.`,$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},child:{"margin-block-end":{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"before-error-message":{"margin-block-end":{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}},invalid:{"border-inline-start":{$value:`{ams.border.width.l} solid {ams.color.feedback.error}`},"padding-inline-start":{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}}},b={ams:y}}));function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:g}),`
