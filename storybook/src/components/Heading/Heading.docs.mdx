...
Six sizes from the set of [Text Levels](/docs/brand-design-tokens-typography--docs) can be used for this purpose.
...
Set the `color` prop to `inverse` if the Heading sits on a dark background.
