...
- The five sizes of [Component Space](/docs/foundation-design-tokens-space--docs) are available for the height of the gap.
...
- **Start**: align items to the left of the column.
