...
When the Description List sits in a narrow container, it switches to a vertical layout (terms above their descriptions) based on the container width instead of the viewport width.

<Canvas of={DescriptionListStories.NarrowContainer} />
