...
- [Scott O’Hara: Unintentionally tabling table semantics](https://www.scottohara.me/blog/2019/04/19/tabled-tables.html) – why a table needs a caption to keep its semantics rather than an ARIA label.
