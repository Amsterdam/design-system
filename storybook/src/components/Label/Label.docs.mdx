...
import tokens from "../../../../packages-proprietary/tokens/src/components/ams/label.tokens.json";
...
Always associate a Label with its form control so screen readers announce them together.
