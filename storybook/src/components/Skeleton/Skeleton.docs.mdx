...
Line lengths vary deterministically – paragraph lines in sets of three with a shorter last line, alternating list and table widths.
...
A subtle animation signals that loading is under way.
