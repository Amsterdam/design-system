...
import * as SelectGroupStories from "./SelectGroup.stories.tsx";
import * as SelectOptionStories from "./SelectOption.stories.tsx";
...
<Canvas of={SelectGroupStories.Group} />

### Option

<Canvas of={SelectOptionStories.Option} />
