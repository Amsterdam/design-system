...
Place the Card in a [Grid](/docs/components-layout-grid--docs) cell or another [inline-size query container](/docs/utilities-css-query-container--docs) to enable this.
