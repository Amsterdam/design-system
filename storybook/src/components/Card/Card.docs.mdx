...
Wrap the tagline and the card heading in a `Card.HeadingGroup`.
...
A card often displays the [image](/docs/components-media-image--docs) of the detail page by using a `Card.Image`.
