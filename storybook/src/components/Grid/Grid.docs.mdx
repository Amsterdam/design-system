...
In Compact Mode, cells have a white background and padding to clearly set them apart.
This is because the limited white space makes it more difficult to distinguish cells from each other.

Cells can be made transparent, such as the one with the the Breadcrumb and Heading.
This removes the padding as well.

The ‘flush’ appearance only removes the padding, keeping the white background.
