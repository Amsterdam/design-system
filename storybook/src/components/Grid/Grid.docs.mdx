...
This is useful on a coloured background, like [Page Footer](/docs/components-containers-page-footer--docs) or [Spotlight](/docs/components-containers-spotlight--docs), or between two consecutive grids.
Specify a value of `medium` to get horizontal white space that is as wide as the vertical gap between columns.
