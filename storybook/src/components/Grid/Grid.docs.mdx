...
Use the `rowSpan` prop to make a cell span more rows.

<Canvas of={GridStories.SpanMultipleRows} />
...
Use the `coverGap` prop to make a cell span the gaps and margins around it.

<Canvas of={GridStories.CoverGap} />
