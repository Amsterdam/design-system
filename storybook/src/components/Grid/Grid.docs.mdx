...
In Spacious Mode, gaps between columns use the `xl` space token — from 36 to 60 pixels between windows 320 and 1440 pixels wide.
...
The breakpoints respond to the browser window width, not the screen resolution.
