...
import * as SpotlightGridStories from "./SpotlightGrid.stories.tsx";
import README from "../../../../packages/css/src/components/spotlight-grid/README.md?raw";

<Meta of={SpotlightGridStories} />
...
Additionally, `SpotlightGrid` allows cells to span multiple rows.
...
<Canvas of={SpotlightGridStories.VerticalLayout} />
