...
We use a smaller font size for text in a Figure Caption.
For a date or a category, reach for [Metadata](/docs/components-text-metadata--docs) instead.
...
The browser decides where to split them, so the [language of the document](/docs/docs-guidelines-localisation--docs#specify-the-language-for-the-entire-document) must be set correctly.
...
- [Metadata](/docs/components-text-metadata--docs) – for the date and the categories of a piece of content.
