...
This field helps the user enter a decimal number. Use the `text` type for decimal numbers. We do not recommend
using `inputMode="decimal"` as it may not work consistently across all browsers and devices. The language
settings of the user’s browser or device may affect the decimal separator used.
