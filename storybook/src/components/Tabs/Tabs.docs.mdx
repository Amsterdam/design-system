...
Hovering a tab that is not selected draws a line at the intermediate weight, so the three states read as one scale rather than as three different treatments.
