...
const HEADING_SAMPLE = 'Kapers aan de poort, kanonskogels op de Dam: de aanval op Amsterdam'
const STRING_SAMPLE = '14 kades en bruggen hersteld in 2023'
const NUMBER_SAMPLE = 42
