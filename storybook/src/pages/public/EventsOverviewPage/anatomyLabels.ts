...
export const anatomyLabels: AnatomyLabels = [
  ...
  [
    { height: 'panel', label: 'Calendar' },
    { height: 'heading', label: 'District filter' },
    { height: 'panel', label: 'Category filter' },
    { height: 'line', label: 'Result count' },
    ...Array.from({ length: 6 }, (): AnatomyLabel => ({ height: 'card', label: 'Activity card' })),
