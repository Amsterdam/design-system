...
An index of activities that a visitor narrows down: a city events calendar, a course programme, a schedule of public meetings.
...
The date keeps its `time` element wherever it sits.
