...
Give each activity its metadata at the top rather than at the foot of the Card.
...
The date stays in the body of the Card, where a `time` element can carry it.
