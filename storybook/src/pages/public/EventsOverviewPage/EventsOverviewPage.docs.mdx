...
Close the Card with when and where it happens, below the description, as a second Metadata: the date, the time, and then the venue after a middot.
Those two answer a different question from the facets above — not what kind of activity this is, but whether the visitor can be there — so they read better as a footnote to the description than beside the heading.
