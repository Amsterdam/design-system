...
import * as DetailPageStories from "./DetailPage.stories";

<Meta of={DetailPageStories} />
...
<Description of={DetailPageStories} />

## Anatomy

This schematic shows the default sections for this page type and how the grids and vertical space work.

<PageAnatomy labels={anatomyLabels} menu mode="compact" of={DetailPageStories} />
