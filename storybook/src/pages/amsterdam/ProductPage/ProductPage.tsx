  ...
  <Grid paddingBottom="x-large" paddingTop="large">
    <Grid.Cell span={{ narrow: 4, medium: 5, wide: 7 }} start={{ narrow: 1, medium: 2, wide: 3 }}>
      <Breadcrumb>
        ...
        <Breadcrumb.Link>Stadspas</Breadcrumb.Link>
      </Breadcrumb>
      ...
      <Paragraph className="ams-mb-m">
        Doe de check en kijk of u in aanmerking komt voor een gratis laptop of tablet voor uw kind of andere regelingen.
      </Paragraph>
      <UnorderedList className="ams-mb-xl">
      ...
      <Paragraph className="ams-mb-xl">
        Als u geen afspraak maakt, deelt de gemeente u in. U krijgt dan wel een uitnodiging. Na de computerles krijgt u
