  ...
  <>
    ...
    <Grid paddingBottom="medium">
      <Grid.Cell span={{ narrow: 4, medium: 5, wide: 7 }} start={{ narrow: 1, medium: 2, wide: 3 }}>
        ...
        <Heading className="ams-mb--sm" id="zo-werkt-het" level={2}>
          Zo werkt het
        </Heading>
        <Paragraph className="ams-mb--xl">
          Kijk voor alle regelingen voor Amsterdammers met weinig geld op{' '}
          <Link href="https://www.amsterdam.nl/werk-inkomen/hulp-bij-laag-inkomen/" variant="inline">
            Hulp bij laag inkomen (Pak Je Kans)
          </Link>
          .
        </Paragraph>
        <Heading className="ams-mb--sm" id="voorwaarden" level={2}>
          Voorwaarden
        </Heading>
        <UnorderedList className="ams-mb--xl">
          ...
          <UnorderedList.Item>
            U moet een{' '}
            <Link
              href="https://www.amsterdam.nl/werk-inkomen/hulp-bij-laag-inkomen/laag-inkomen-weinig-vermogen/"
              variant="inline"
            >
          ...
          <UnorderedList.Item>
            ...
            <Link
              href="https://www.amsterdam.nl/werk-inkomen/hulp-bij-laag-inkomen/regelingen-alfabet/gratis-laptop-tablet-basisschool/computerles-basisschool/"
              variant="inline"
            >
              computerles
            </Link>{' '}
        ...
        <Heading className="ams-mb--sm" id="kosten" level={2}>
          Kosten
        </Heading>
        ...
        <Heading className="ams-mb--sm" id="aanvragen" level={2}>
          Aanvragen
        </Heading>
        <Paragraph className="ams-mb--md">
        ...
        <Button className="ams-mb--lg" variant="primary">
          Online aanvragen
        </Button>
        ...
        <Heading className="ams-mb--sm" id="wat-u-nodig-hebt" level={2}>
          Wat u nodig hebt
        </Heading>
        ...
        <Heading className="ams-mb--sm" id="digid" level={2}>
          DigiD
        </Heading>
        <Paragraph className="ams-mb--md">
          Na de aanvraag krijgt u binnen 8 weken een reactie. U krijgt per regeling een brief. We vertellen u dan of u
        ...
        <Accordion className="ams-mb--xl" headingLevel={3}>
          ...
          <Accordion.Section expanded label="Geen DigiD?">
            <UnorderedList>
              <UnorderedList.Item>
                Ga naar{' '}
                <Link href="https://www.digid.nl" variant="inline">
                  www.digid.nl
                </Link>{' '}
              ...
              <UnorderedList.Item>
                ...
                en download het{' '}
                <Link
                  href="https://assets.amsterdam.nl/publish/pages/911413/aanvraag_gratis_pc_basisschool_2023-2024.pdf"
                  variant="inline"
                >
        ...
        <Heading className="ams-mb--sm" id="betalen" level={2}>
          Betalen
        </Heading>
        <Paragraph className="ams-mb--md">
        ...
        <Heading className="ams-mb--sm" id="zo-lang-duurt-het" level={2}>
          Zo lang duurt het
        </Heading>
        <Paragraph className="ams-mb--xl">
          Blanditiis ea ipsum maiores optio quo sapiente, unde ut. Ducimus eius eum ex impedit ipsam ipsum?{' '}
        </Paragraph>
        <Heading className="ams-mb--sm" id="bijzonderheden" level={2}>
          Bijzonderheden
        </Heading>
        <Paragraph className="ams-mb--xl">
        ...
        <Paragraph className="ams-mb--md">
          ...
          <Link
            href="https://formulieren.amsterdam.nl/TriplEforms/DirectRegelen/formulier/nl-NL/evAmsterdam/Contactformulier.aspx/Contactformulier"
            variant="inline"
          >
        ...
        <Heading className="ams-mb--sm" id="bijzonderheden" level={3} size="level-5">
          Hulp nodig bij het aanvragen?
        </Heading>
        <Paragraph className="ams-mb--md">
          Ga naar een{' '}
          <Link href="https://www.buurtteamamsterdam.nl" variant="inline">
            buurtteam
          </Link>
          .
        </Paragraph>
        ...
        <Heading className="ams-mb--sm" id="meer-informatie" level={2}>
    ...
    <Spotlight className="ams-mb--2xl">
      <Grid paddingVertical="medium">
        <Grid.Cell span={{ narrow: 4, medium: 5, wide: 7 }} start={{ narrow: 1, medium: 1, wide: 2 }}>
          <Heading className="ams-mb--sm" color="inverse" level={2}>
            Zie ook – taxonomie
          </Heading>
          <LinkList>
