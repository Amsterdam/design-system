...
export const HomeNews = () => (
  <Grid paddingVertical="medium">
    ...
    <Grid.Cell span={4}>
      <Card>
        <Image alt="" className="ams-mb-s" src="https://picsum.photos/640/360?random=1" />
    ...
    <Grid.Cell span={4}>
      <Card>
        <Image alt="" className="ams-mb-s" src="https://picsum.photos/640/360?random=2" />
        <Card.HeadingGroup tagline="Nieuws">
          <Heading level={2} size="level-4">
    ...
    <Grid.Cell span={4}>
      <Card>
        <Image alt="" className="ams-mb-s" src="https://picsum.photos/640/360?random=3" />
        <Card.HeadingGroup tagline="Nieuws">
          <Heading level={2} size="level-4">
