...
- Do not use a level 1 Heading on a home page.
- Use level 2 Headings with a size of ‘level 1’ for the main headings.
- Use the default size 3 headings in Cards and set the appropriate level.
- Do the same for compositions of Heading, Paragraph, Standalone Link and Link List.
