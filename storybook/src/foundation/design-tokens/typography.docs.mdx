...
| `var(--ams-font-size-2x-large)` | `clamp(1.7865rem, calc(1.5007rem + 1.429vw), 2.9297rem)`  | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-font-size-2x-large)' }}>Abc</div> |
| `var(--ams-font-size-3x-large)` | `clamp(2.0842rem, calc(1.6897rem + 1.9724vw), 3.6621rem)` | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-font-size-3x-large)' }}>Abc</div> |
| `var(--ams-font-size-4x-large)` | `clamp(2.4316rem, calc(1.8951rem + 2.6826vw), 4.5776rem)` | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-font-size-4x-large)' }}>Abc</div> |
