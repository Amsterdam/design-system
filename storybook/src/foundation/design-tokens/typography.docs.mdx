...
| :----------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| `ams.brand.typography.font-size.sm`  | clamp(0.9643rem, calc(0.9054rem + 0.2946vw), 1.2rem)    | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-sm)' }}>Abc</div>  |
| `ams.brand.typography.font-size.md`  | clamp(1.125rem, calc(1.0313rem + 0.4688vw), 1.5rem)     | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-md)' }}>Abc</div>  |
| `ams.brand.typography.font-size.lg`  | clamp(1.3125rem, calc(1.1719rem + 0.7031vw), 1.875rem)  | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-lg)' }}>Abc</div>  |
| `ams.brand.typography.font-size.xl`  | clamp(1.5313rem, calc(1.3281rem + 1.0156vw), 2.3438rem) | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-xl)' }}>Abc</div>  |
| `ams.brand.typography.font-size.2xl` | clamp(1.7865rem, calc(1.5007rem + 1.429vw), 2.9297rem)  | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-2xl)' }}>Abc</div> |
| `ams.brand.typography.font-size.3xl` | clamp(2.0842rem, calc(1.6897rem + 1.9724vw), 3.6621rem) | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-3xl)' }}>Abc</div> |
| `ams.brand.typography.font-size.4xl` | clamp(2.4316rem, calc(1.8951rem + 2.6826vw), 4.5776rem) | <div className="ams-docs-token-example--font-size" style={{ fontSize: 'var(--ams-brand-typography-font-size-4xl)' }}>Abc</div> |
...
| Level | Heading components | Body text components                   |
| ----: | :----------------- | -------------------------------------- |
|     0 | Page heading       |                                        |
|     1 | Heading 1          |                                        |
|     2 | Heading 2          |                                        |
...
|     5 | Heading 5          | Paragraph, List, Link, Button          |
|     6 | Heading 6          | Small Paragraph, Page Menu, Breadcrumb |
