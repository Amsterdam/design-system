...
Symlinking [the entire favicon directory](https://github.com/Amsterdam/design-system/tree/develop/proprietary/assets/favicon) and the [Web Manifest](https://github.com/Amsterdam/design-system/tree/develop/proprietary/assets/app.manifest) can be done as follows:
...
> Note: the symlink, the last argument in above command, cannot be a path, but needs to be just the file or directory name. I.e. you need to be in the directory where you want to make the symbolic link.
