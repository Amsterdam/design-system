...
This also complements the responsive [grid](/docs/react-components-layout-grid--docs).
...
In the 12-column [grid](/docs/react-components-layout-grid--docs), paragraphs meet this when they occupy 8 columns or fewer.
