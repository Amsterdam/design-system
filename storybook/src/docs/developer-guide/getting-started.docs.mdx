...
A browser reports no inset there, because its own toolbar already occupies that space, but a web app that sets `display: standalone` in its [web manifest](/docs/docs-developer-guide-web-app--docs) does.
...
If you use [Lo-fi Mode](/docs/docs-developer-guide-modes--docs#fidelity),
