...
Or at the four edges of a component: at the top, bottom, start, and end of its containing box,
as used for buttons and input fields, and for larger components with a coloured background or border.

This type of space is based on the font size – the medium space length equals the font size.
...
|                        |       |    320 |   1600 |
| ---------------------: | :---: | -----: | -----: |
| **Double extra small** | `2xs` |    3.5 |    4.5 |
|        **Extra small** | `xs`  |      7 |      9 |
|              **Small** | `sm`  |   10.5 |   13.5 |
|             **Medium** | `md`  | **14** | **18** |
|              **Large** | `lg`  |     21 |     27 |
|        **Extra large** | `xl`  |     28 |     36 |
| **Double extra large** | `2xl` |     35 |     45 |
