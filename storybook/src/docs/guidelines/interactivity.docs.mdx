...
Elements the user can interact with, such as links, buttons and form fields, must be clearly recognisable and easily distinguishable from the ones they cannot.
