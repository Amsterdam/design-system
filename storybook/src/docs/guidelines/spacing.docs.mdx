...
<Meta title="Docs/Guidelines/Spacing" />
...
Refer to the [vertical space](/docs/docs-guidelines-vertical-space--docs) guidelines to find the recommended size for each combination.
...
- [Vertical space](/docs/docs-guidelines-vertical-space--docs) – how much space to use between specific combinations.
