...
The gap between columns uses our `xl` space token, which grows from 36 to 56 pixels in windows between 320 and 1440 pixels wide.
...
For websites, the maximum width of the grid is 1248 pixels.
The grid has this width in windows of at least 1440 pixels wide – the margins are 84 pixels here.
