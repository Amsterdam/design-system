export const buurten = [
  ...
  'Amerikahaven',
  'Westhaven-Noord',
  'Minervahaven-Noordoost',
  'Petroleumhaven',
  'Vervoerscentrum',
  'Westhaven-Zuid',
  'Coenhaven',
  'Vlothaven',
  'Minervahaven-Noordwest',
  'Minervahaven-Zuidwest',
  'Minervahaven-Zuidoost',
  'Alfa-driehoek',
  'Hemknoop-Noord',
  'Bretten-West',
  'Hoptille',
  'Sloterdijk De Heining',
  'Sloterdijk Poort-Noord',
  'Sloterdijk Poort-Zuid',
  'Sloterdijk Rhônepark',
  'Sloterdijk Donauhoek',
  'Bretten-Oost',
