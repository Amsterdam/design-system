...
The five [spacing](?path=/docs/docs-design-guidelines-spacing--docs) sizes are available for the size of the gap.

## How to Use

Wrap a Column around a set of components that need the same amount of whitespace between them.

To add whitespace below a single element, you can alternatively use a utility class for bottom margins, e.g. `class="amsterdam-mb-md`.
