...
A [Grid](?path=/docs/react_layout-grid--docs) provides horizontal spacing on both sides and columns for layout.
...
- Follow [the general guidelines for images](?path=/docs/react_media-image--docs#guidelines).
