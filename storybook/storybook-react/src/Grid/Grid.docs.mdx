...
Dit is handig in een gekleurd vlak zoals [Footer](?path=/docs/react_containers-footer--docs) of [Spotlight](?path=/docs/react_containers-spotlight--docs) of tussen twee opvolgende grids.
