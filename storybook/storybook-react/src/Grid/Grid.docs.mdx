...
De opties `spaceVertical`, `spaceTop` en `spaceBottom` voegen witruimte boven en/of onder het grid toe.
Dit is bijvoorbeeld handig in Footer of Highlight, of tussen twee opvolgende grids.
...
- Gebruik de `spaceVertical` prop niet tegelijk met de `spaceTop` of `spaceBottom` props.
