...
In andere gevallen installeer je Amsterdam Sans op 1 van deze 2 manieren:

1. Kopieer [deze regels CSS](https://amsterdam.nl/publish/pages/1007152/amsterdam_sans_v_0_9.css) naar je applicatie.
   Het maakt gebruik van ons snelle CDN.
   Dit levert korte laadtijden voor bezoekers.
2. Installeer het npm-pakket `@amsterdam/design-system-assets` en importeer `@amsterdam/design-system-assets/font/index.css` in je applicatie.

Als het niet mogelijk is Amsterdam Sans te gebruiken pas je het lettertype Arial toe, of het generieke sans-serif lettertype van het apparaat.
