...
De afstand tussen de onderstreping en de letterlijn is 3/8 van de tekstgrootte –
...
Lange regels tekst zijn lastig om te lezen.
Rond de 80 letters op een regel is het maximum.
In het 12-koloms [grid](?path=/docs/react_layout-grid--docs) voldoen paragrafen daaraan als ze 8 kolommen of minder beslaan.
