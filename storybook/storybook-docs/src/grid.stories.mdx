...
We refer to these three variants as the narrow, medium-wide, and wide grid.
...
The online house style had been designed for simplicity.
...
The menu is placed horizontally below the header in the medium-wide and narrow grids.
...
| medium-wide |               576 |                 8 |           42 |                24 |           36 |        504 |
...
| medium-wide |               576 |                 8 |              0 |           54 |                16 |           16 |        544 |
...
For the same reason, we do not refer to the three grid breakpoints as "mobile, tablet, and desktop" but as "for narrow, medium-wide, and wide" screens or windows.
...
We intentionally talk about windows, while responsive design often discusses screen widths.
...
Like the grid, the [text sizes](?path=/docs/docs-designrichtlijnen-typografie--docs) respond to the window width.
