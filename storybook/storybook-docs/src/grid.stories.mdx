...
| Naam variant | Vanaf vensterbreedte | Aantal kolommen | Breedte kolom | Breedte witruimte | Breedte marge | Breedte grid |
| :----------- | -------------------: | --------------: | ------------: | ----------------: | ------------: | -----------: |
| smal         |                  320 |               4 |            60 |                16 |            16 |          288 |
| middelbreed  |                  576 |               8 |            54 |                16 |            16 |          544 |
| breed        |                 1088 |              12 |            44 |                16 |            16 |          944 |

### Referentie-breedtes voor design

In Figma werken we met drie referentie-breedtes om het ontwerp van een scherm uit te werken voor de drie klassen van apparaten.
...
Vanaf een vensterbreedte van 1088 pixels staat bij applicaties een navigatiebalk naast het grid.

| Klasse apparaat | Referentie-breedte | Aantal kolommen | Breedte navigatiebalk | Breedte kolom | Breedte witruimte | Breedte marge | Breedte grid |
| :-------------- | -----------------: | --------------: | --------------------: | ------------: | ----------------: | ------------: | -----------: |
