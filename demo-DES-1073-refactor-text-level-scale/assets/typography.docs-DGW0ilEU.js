import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{useMDXComponents as s}from"./index-1Ha5aU2j.js";import{M as r,T as i}from"./index-drgfWvaU.js";import"./index-yBjzXJbu.js";import"./index-C0MU9AHG.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-eahEVxbn.js";import"./index-IE9ObSwG.js";import"./index-Cu4lwwaE.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";/*@license CC0-1.0*/function l(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Example"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-small-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(0.9643rem, calc(0.9054rem + 0.2946vw), 1.2rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-small-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.125rem, calc(1.0313rem + 0.4688vw), 1.5rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-large-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.3125rem, calc(1.1719rem + 0.7031vw), 1.875rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-large-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-x-large-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.5313rem, calc(1.3281rem + 1.0156vw), 2.3438rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-x-large-font-size)"},children:"Abc"})})]})]})]}),`
`,e.jsx(t.h3,{id:"line-height",children:"Line height"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-small-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-large-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.5"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-x-large-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.3"})]})]})]}),`
`,e.jsx(t.h3,{id:"font-weight",children:"Font weight"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-font-weight)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"400"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-bold-font-weight)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"800"})]})]})]}),`
...
`,e.jsx(t.p,{children:"All text uses the Amsterdam Sans font."}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsx(t.tbody,{children:e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-family)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"'Amsterdam Sans', Arial, sans-serif"})]})})]}),`
...
`})}),`
`,e.jsxs(t.p,{children:["Further reading: ",e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_text/Wrapping_breaking_text",rel:"nofollow",children:"Wrapping and breaking text on MDN"})]})]})}function f(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(l,{...n})}):l(n)}export{f as default};
