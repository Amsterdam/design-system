import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{useMDXComponents as s}from"./index-1Ha5aU2j.js";import{M as r,T as i}from"./index-a5SXbdgQ.js";import"./index-yBjzXJbu.js";import"./index-C0MU9AHG.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-Bljx_tfZ.js";import"./index-IE9ObSwG.js";import"./index-Cu4lwwaE.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";/*@license CC0-1.0*/function l(n){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
They use the Amsterdam Sans font.
Four text sizes and corresponding line heights are available.
The font weight is 400 for regular text and 700 for bold text.`}),`
`,e.jsx(t.h3,{id:"font-family",children:"Font family"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsx(t.tbody,{children:e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-font-family)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"'Amsterdam Sans', Arial, sans-serif"})]})})]}),`
`,e.jsx(t.h3,{id:"font-size",children:"Font size"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Example"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-sm-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(0.9643rem, calc(0.9054rem + 0.2946vw), 1.2rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-sm-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.125rem, calc(1.0313rem + 0.4688vw), 1.5rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-lg-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.3125rem, calc(1.1719rem + 0.7031vw), 1.875rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-lg-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-xl-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.5313rem, calc(1.3281rem + 1.0156vw), 2.3438rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-body-text-xl-font-size)"},children:"Abc"})})]})]})]}),`
`,e.jsx(t.h3,{id:"line-height",children:"Line height"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-sm-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-lg-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.5"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-xl-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.3"})]})]})]}),`
`,e.jsx(t.h3,{id:"font-weight",children:"Font weight"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-font-weight)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"400"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-body-text-bold-font-weight)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"700"})]})]})]}),`
`,e.jsx(t.h2,{id:"headings",children:"Headings"}),`
`,e.jsx(t.p,{children:`Headings have their own group of tokens.
They use the Amsterdam Sans font as well.
It has six text sizes and corresponding line heights.
The font weight is 800, which is extra bold.`}),`
`,e.jsx(t.h3,{id:"font-family-1",children:"Font family"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsx(t.tbody,{children:e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-font-family)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"'Amsterdam Sans', Arial, sans-serif"})]})})]}),`
`,e.jsx(t.h3,{id:"font-size-1",children:"Font size"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Example"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-0-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(2.4316rem, calc(1.8951rem + 2.6826vw), 4.5776rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-0-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-1-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(2.0842rem, calc(1.6897rem + 1.9724vw), 3.6621rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-1-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-2-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.7865rem, calc(1.5007rem + 1.429vw), 2.9297rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-2-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-3-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.5313rem, calc(1.3281rem + 1.0156vw), 2.3438rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-3-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-4-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.3125rem, calc(1.1719rem + 0.7031vw), 1.875rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-4-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-5-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.125rem, calc(1.0313rem + 0.4688vw), 1.5rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-5-font-size)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-6-font-size)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(0.9643rem, calc(0.9054rem + 0.2946vw), 1.2rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-heading-6-font-size)"},children:"Abc"})})]})]})]}),`
`,e.jsx(t.h3,{id:"line-height-1",children:"Line height"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-0-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.15"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-1-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.2"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-2-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.25"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-3-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.3"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-4-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.5"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-5-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-6-line-height)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"1.6"})]})]})]}),`
`,e.jsx(t.h3,{id:"font-weight-1",children:"Font weight"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"CSS variable"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"})]})}),e.jsx(t.tbody,{children:e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-heading-font-weight)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"800"})]})})]}),`
...
`})}),`
`,e.jsxs(t.p,{children:["Further reading: ",e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_text/Wrapping_breaking_text",rel:"nofollow",children:"Wrapping and breaking text on MDN"})]})]})}function p(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(l,{...n})}):l(n)}export{p as default};
