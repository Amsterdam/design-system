import{j as e}from"./jsx-runtime-z8MfsBtr.js";import{useMDXComponents as l}from"./index-BAvqEBP-.js";import{M as r,T as n}from"./index-CojA5xKU.js";import"./index-C9rmetsa.js";import"./index-D7uoVdV3.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-0peTVJyW.js";import"./index-D-OUEn-9.js";import"./index-Cu4lwwaE.js";import"./index-NOh9rqHv.js";import"./index-ogSvIofg.js";/*@license CC0-1.0*/function s(i){const t={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...l(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsx(t.h3,{id:"brand-tokens",children:"Brand tokens"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"left"},children:"Token name"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Value"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Example"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-sm)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(0.9643rem, calc(0.9054rem + 0.2946vw), 1.2rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-sm)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-md)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.125rem, calc(1.0313rem + 0.4688vw), 1.5rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-md)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-lg)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.3125rem, calc(1.1719rem + 0.7031vw), 1.875rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-lg)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-xl)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.5313rem, calc(1.3281rem + 1.0156vw), 2.3438rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-xl)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-2xl)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(1.7865rem, calc(1.5007rem + 1.429vw), 2.9297rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-2xl)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-3xl)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(2.0842rem, calc(1.6897rem + 1.9724vw), 3.6621rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-3xl)"},children:"Abc"})})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx(t.code,{children:"var(--ams-typography-font-size-4xl)"})}),e.jsx(t.td,{style:{textAlign:"left"},children:"clamp(2.4316rem, calc(1.8951rem + 2.6826vw), 4.5776rem)"}),e.jsx(t.td,{style:{textAlign:"left"},children:e.jsx("div",{className:"ams-docs-token-example--font-size",style:{fontSize:"var(--ams-typography-font-size-4xl)"},children:"Abc"})})]})]})]}),`
`,e.jsx(t.h3,{id:"seven-text-levels",children:"Seven text levels"}),`
`,e.jsx(t.p,{children:`There are 7 levels of font size and corresponding line height.
...
Examples:`}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{style:{textAlign:"right"},children:"Level"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Heading components"}),e.jsx(t.th,{style:{textAlign:"left"},children:"Body text components"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"0"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Page heading"}),e.jsx(t.td,{style:{textAlign:"left"}})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"1"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 1"}),e.jsx(t.td,{style:{textAlign:"left"}})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"2"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 2"}),e.jsx(t.td,{style:{textAlign:"left"}})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"3"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 3"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Blockquote"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"4"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 4"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Large Paragraph"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"5"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 5"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Paragraph, List, Link, Button"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{style:{textAlign:"right"},children:"6"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Heading 6"}),e.jsx(t.td,{style:{textAlign:"left"},children:"Small Paragraph, Breadcrumb, Figure Caption"})]})]})]}),`
...
`,e.jsx(n,{fontFamily:"Amsterdam Sans, Arial, sans-serif",fontSizes:[28.8,25.6,22.8,20.3,18,16,14.2],fontWeight:400,sampleText:"Jouw typograaf biedt mij zulke exquise schreven"}),`
`,e.jsx(t.p,{children:"And the minimum:"}),`
`,e.jsx(n,{fontFamily:"Amsterdam Sans, Arial, sans-serif",fontSizes:[25.8,23.4,21.3,19.4,17.6,16,14.6],fontWeight:400,sampleText:"Jouw typograaf biedt mij zulke exquise schreven"}),`
...
`})}),`
`,e.jsxs(t.p,{children:["Further reading: ",e.jsx(t.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_text/Wrapping_breaking_text",rel:"nofollow",children:"Wrapping and breaking text op MDN"})]})]})}function f(i={}){const{wrapper:t}={...l(),...i.components};return t?e.jsx(t,{...i,children:e.jsx(s,{...i})}):s(i)}export{f as default};
