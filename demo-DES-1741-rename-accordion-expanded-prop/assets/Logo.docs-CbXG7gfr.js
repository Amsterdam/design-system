import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-wq2zwHXV.js";import{r as n}from"./react-B5PhQJrz.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-CHRgHjMS.js";import{n as l,t as u}from"./DesignTokensTable-CsmdJ-6V.js";import{t as d}from"./mdx-react-shim-CxYsQ9Gk.js";import{AmsterdamEnglish as f,Custom as p,GgdAmsterdam as m,GgdAmsterdamInspectie as h,MuseumWeesp as g,Stadsarchief as _,StadsbankVanLening as v,VgaVerzekeringen as y,n as b,t as x}from"./Logo.stories-BdUFjA9s.js";var S,C=e((()=>{S=`<!-- @license CC0-1.0 -->
...
`})),w,T,E=e((()=>{w={logo:{"block-size":{$value:`{ams.space.xl}`,$extensions:{"nl.amsterdam.type":`dimension`}},"min-block-size":{$value:{value:2.5,unit:`rem`},$type:`dimension`},emblem:{color:{$value:`#ec0000`,$type:`color`}},subsite:{color:{$value:`{ams.color.text.default}`,$type:`color`}},title:{color:{$value:`#ec0000`,$type:`color`}}}},T={ams:w}}));function D(e){let t={h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,strong:`strong`,...n(),...e.components};return(0,k.jsxs)(k.Fragment,{children:[`
`,`
`,`
`,`
`,(0,k.jsx)(r,{of:x}),`
