import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-wq2zwHXV.js";import{r as n}from"./react-B5PhQJrz.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-CHRgHjMS.js";import{n as l,t as u}from"./DesignTokensTable-CsmdJ-6V.js";import{t as d}from"./mdx-react-shim-CxYsQ9Gk.js";import{ExpandedByDefault as f,Level as p,ReduceLandmarks as m,n as h,t as g}from"./Accordion.stories-DlWxXq00.js";var _,v=e((()=>{_=`<!-- @license CC0-1.0 -->
...
`})),y,b,x=e((()=>{y={accordion:{gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},button:{color:{$value:`{ams.color.interactive.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`,$extensions:{"nl.amsterdam.type":`cursor`}},gap:{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.space.s}`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"padding-inline":{$value:`0`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},hover:{color:{$value:`{ams.color.interactive.hover}`,$type:`color`}}},panel:{"padding-block":{$deprecated:`Will be removed in release 4.0.0.`,$value:`0`,$extensions:{"nl.amsterdam.type":`dimension`}},"padding-inline":{$deprecated:`Will be removed in release 4.0.0.`,$value:`0`,$extensions:{"nl.amsterdam.type":`dimension`}}}}},b={ams:y}}));function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,w.jsxs)(w.Fragment,{children:[`
`,`
`,`
`,`
`,(0,w.jsx)(r,{of:g}),`
...
`,(0,w.jsxs)(t.p,{children:[`If you want the contents of an Accordion Section to appear initially, pass the `,(0,w.jsx)(t.code,{children:`defaultExpanded`}),` property to the `,(0,w.jsx)(t.code,{children:`Accordion.Section`}),` component.`]}),`
`,(0,w.jsx)(s,{of:f}),`
