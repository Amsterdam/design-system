import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-wq2zwHXV.js";import{r as n}from"./react-B5PhQJrz.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-CHRgHjMS.js";import{n as l,t as u}from"./DesignTokensTable-CsmdJ-6V.js";import{t as d}from"./mdx-react-shim-CxYsQ9Gk.js";import{Disabled as f,HorizontalResize as p,InAField as m,InAFieldWithValidation as h,Invalid as g,NoResize as _,VerticalResize as v,n as y,t as b}from"./TextArea.stories-Bi1jxXXR.js";var x,S=e((()=>{x=`<!-- @license CC0-1.0 -->
...
`})),C,w,T=e((()=>{C={"text-area":{"background-color":{$value:`{ams.inputs.background-color}`,$type:`color`},"border-color":{$value:`{ams.inputs.border-color}`,$type:`color`},"border-style":{$value:`{ams.inputs.border-style}`,$extensions:{"nl.amsterdam.type":`borderStyle`}},"border-width":{$value:`{ams.inputs.border-width}`,$extensions:{"nl.amsterdam.type":`borderWidth`}},color:{$value:`{ams.inputs.color}`,$type:`color`},"font-family":{$value:`{ams.inputs.font-family}`,$type:`fontFamily`},"font-size":{$value:`{ams.inputs.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.inputs.font-weight}`,$type:`fontWeight`},"line-height":{$value:`{ams.inputs.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`},$type:`number`},"min-block-size":{$value:`calc({ams.typography.body-text.line-height} * 1em + 2 * {ams.text-area.padding-block})`,$extensions:{"nl.amsterdam.subtype":`space`,"nl.amsterdam.type":`dimension`}},"outline-offset":{$value:`{ams.inputs.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{$value:`{ams.inputs.padding-block}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-inline":{$value:`{ams.inputs.padding-inline}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},disabled:{color:{$value:`{ams.inputs.disabled.color}`,$type:`color`},cursor:{$value:`{ams.cursor.disabled}`,$extensions:{"nl.amsterdam.type":`cursor`}}},hover:{"box-shadow":{$type:`shadow`,$value:`{ams.inputs.hover.box-shadow}`}},invalid:{"border-color":{$value:`{ams.inputs.invalid.border-color}`,$type:`color`},hover:{"border-color":{$value:`{ams.inputs.invalid.hover.border-color}`,$type:`color`},"box-shadow":{$type:`shadow`,$value:`{ams.inputs.invalid.hover.box-shadow}`}}},placeholder:{color:{$value:`{ams.inputs.placeholder.color}`,$type:`color`}}}},w={ams:C}}));function E(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,...n(),...e.components};return(0,O.jsxs)(O.Fragment,{children:[`
`,`
`,`
`,`
`,(0,O.jsx)(r,{of:b}),`
