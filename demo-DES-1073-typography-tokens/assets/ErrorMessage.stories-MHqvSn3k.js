import{S as y,j as b}from"./index.esm-DvoLfDtE.js";import{j as o}from"./jsx-runtime-Cf8x2fCZ.js";import{c as v}from"./clsx-B-dksMZM.js";import{r as S}from"./index-C0MU9AHG.js";import{I as j}from"./Icon-Bimwd819.js";const a=S.forwardRef(({children:t,className:h,icon:n,prefix:x="Invoerfout",...E},_)=>o.jsxs("p",{...E,className:v("ams-error-message",h),ref:_,children:[o.jsx(j,{size:"body-text-small",svg:n||y}),o.jsxs("span",{className:"ams-visually-hidden",children:[x,": "]}),t]}));a.displayName="ErrorMessage";try{a.displayName="ErrorMessage",a.__docgenInfo={description:"",displayName:"ErrorMessage",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"Function"}},prefix:{defaultValue:{value:"Invoerfout"},description:"An accessible phrase that screen readers announce before the error message. Should translate to something like ‘input error’.",name:"prefix",required:!1,type:{name:"string"}}}}}catch{}/**
 * @license EUPL-1.2+
