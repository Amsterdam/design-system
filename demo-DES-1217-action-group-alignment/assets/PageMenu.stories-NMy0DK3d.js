...
}`,...(p=(h=i.parameters)==null?void 0:h.docs)==null?void 0:p.source}}};var m,f,L;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    children: [<PageMenu.Link href="#" key={1}>
        Onderzoeken
      </PageMenu.Link>, <PageMenu.Link href="#" key={2}>
...
}`,...(L=(f=s.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};const O=["Default","Alignment","Wrapping"],b=Object.freeze(Object.defineProperty({__proto__:null,Alignment:i,Default:a,Wrapping:s,__namedExportsOrder:O,default:w},Symbol.toStringTag,{value:"Module"}));export{i as A,b as P,s as W};
