import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-zzQRermb.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-DgHjp2UC.js";import{n as u,t as d}from"./EventsOverviewPage.stories-Clr2lXS7.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Breadcrumb`}],[{height:`card`,label:`Page title and search`}],[{height:`panel`,label:`Calendar`},{height:`heading`,label:`District filter`},{height:`panel`,label:`Category filter`},{height:`line`,label:`Result count`},...Array.from({length:6},()=>({height:`card`,label:`Activity card`})),{height:`heading`,label:`Pagination`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.h3,{id:`cards`,children:`Cards`}),`
`,(0,g.jsx)(n.p,{children:`The same activities as a card grid, which suits browsing by image rather than comparing by date.`}),`
...
`,(0,g.jsx)(n.h3,{id:`no-results`,children:`No results`}),`
`,(0,g.jsx)(n.p,{children:`An empty result set is a place people leave, so give them a way on.`}),`
`,(0,g.jsxs)(n.p,{children:[`Name the filters that produced it twice over: once in the sentence the live region announces, and once as a row of `,(0,g.jsx)(n.a,{href:`/docs/components-feedback-badge--docs`,children:`Badges`}),` beside a link that clears them all.
The visitor can then see what narrowed the search without going back up the filter column.`]}),`
`,(0,g.jsx)(n.p,{children:`Follow that with a paragraph suggesting what to widen.
...
`,(0,g.jsx)(n.p,{children:`Close the Card with when and where it happens, below the description, as a second Metadata: the date, the time, and then the venue after a middot.
