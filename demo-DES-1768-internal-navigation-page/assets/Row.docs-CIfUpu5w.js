import{n as e}from"./chunk-zsgVPwQN.js";import{Rt as t}from"./iframe-CQDLaEB0.js";import{r as n}from"./react-BfZpHusR.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-Chw0reSi.js";import{n as l,t as u}from"./DesignTokensTable-DLd0MNho.js";import{t as d}from"./mdx-react-shim-BoawSFpW.js";import{AlignOpposingTexts as f,Alignment as p,EndAlignASingleChild as m,EndAlignASingleChildRtl as h,VerticalAlignment as g,Wrapping as _,n as v,t as y}from"./Row.stories-DoZpVoxk.js";var b,x=e((()=>{b=`<!-- @license CC0-1.0 -->

# Row

Stacks its children horizontally with gaps between them and offers alignment options.
`})),S,C,w=e((()=>{S={row:{gap:{"x-small":{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},small:{$value:`{ams.space.s}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},medium:{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},large:{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"x-large":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}}},C={ams:S}}));function T(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,D.jsxs)(D.Fragment,{children:[`
`,`
`,`
`,`
`,(0,D.jsx)(r,{of:y}),`
