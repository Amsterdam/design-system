import{n as e,r as t}from"./chunk-zsgVPwQN.js";import{N as n,Rt as r,U as i,q as a,y as o}from"./iframe-BNZXMPxS.js";import{o as s,t as c}from"./src-BzDhucBq.js";import{l,m as u,t as d}from"./exampleContent-BwA2seBs.js";var f=t({Default:()=>v,PreventTabsFromChanging:()=>S,WithInitialTab:()=>y,WithWideContent:()=>b,__namedExportsOrder:()=>C,default:()=>_}),p,m,h,g,_,v,y,b,x,S,C,w=e((()=>{a(),c(),u(),p=r(),m=1e3,h=({children:e})=>{console.log(`[ARTIFICIALLY SLOW] Adding a ${m}ms delay…`);let t=performance.now();for(;performance.now()-t<m;);return e},g=[{body:l(),label:`Gegevens`},{body:l(),label:`Aanslagen`},{body:(0,p.jsxs)(p.Fragment,{children:[`(This tab panel simulates a load time of `,m,` milliseconds.)`,(0,p.jsx)(h,{})]}),label:`Documenten`},{body:l(),label:`Acties`}],_={title:`Components/Containers/Tabs`,component:s,args:{children:[(0,p.jsx)(s.List,{children:g.map(({label:e})=>(0,p.jsx)(s.Button,{"aria-controls":e,children:e},e))},`tabsList`),g.map(({body:e,label:t})=>(0,p.jsxs)(s.Panel,{id:t,children:[(0,p.jsx)(o,{className:`ams-mb-xs`,level:3,children:t}),(0,p.jsx)(n,{children:e})]},t))]},argTypes:{onTabChange:{action:`clicked`,description:`Provides the id of the activated tab.`}}},v={},y={args:{activeTab:`Acties`}},b={args:{children:[(0,p.jsx)(s.List,{children:d.map(e=>(0,p.jsx)(s.Button,{"aria-controls":e,children:e},e))},`tabsList`),d.map(e=>(0,p.jsx)(s.Panel,{id:e,children:(0,p.jsxs)(i,{children:[(0,p.jsx)(i.Caption,{children:(0,p.jsxs)(o,{level:3,children:[`Voorbeeld van een tabel voor `,e===`Weesp`?`stadsgebied`:`stadsdeel`,` `,e]})}),(0,p.jsx)(i.Header,{children:(0,p.jsxs)(i.Row,{children:[(0,p.jsx)(i.HeaderCell,{}),Array.from({length:12},(e,t)=>(0,p.jsx)(i.HeaderCell,{children:`Kolom`},`headercell-${t}`))]})}),(0,p.jsx)(i.Body,{children:Array.from({length:3},(e,t)=>(0,p.jsxs)(i.Row,{children:[(0,p.jsx)(i.HeaderCell,{scope:`row`,children:`Rij`}),Array.from({length:12},(e,n)=>(0,p.jsxs)(i.Cell,{style:{textAlign:`end`},children:[(t+1)*(n+1),`.000`]},n))]},t))})]})},e))]}},x=g.filter(({label:e})=>e!==`Documenten`),S={args:{children:[(0,p.jsx)(s.List,{children:x.map(({label:e})=>(0,p.jsx)(s.Button,{"aria-controls":e,onClick:e=>{window.confirm(`You have unsaved changes. Do you want to leave?`)||e.preventDefault()},children:e},e))},`tabsList`),x.map(({body:e,label:t})=>(0,p.jsxs)(s.Panel,{id:t,children:[(0,p.jsx)(o,{className:`ams-mb-xs`,level:3,children:t}),(0,p.jsx)(n,{children:e})]},t))]}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{}`,...v.parameters?.docs?.source}}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    activeTab: 'Acties'
  }
