...
`,(0,c.jsxs)(t.p,{children:[`Some icons point in a direction — chevrons and arrows, for example — and must flip in a right-to-left context.
The design system’s own directional icons handle this automatically: each carries a `,(0,c.jsx)(t.code,{children:`data-directional="true"`}),` attribute on its root `,(0,c.jsx)(t.code,{children:`<svg>`}),`, and the `,(0,c.jsx)(t.a,{href:`/docs/components-media-icon--docs`,children:`Icon`}),` styles mirror any icon with that attribute under `,(0,c.jsx)(t.code,{children:`dir="rtl"`}),`.
The `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-calendar--docs`,children:`Calendar`}),` and `,(0,c.jsx)(t.a,{href:`/docs/components-forms-date-picker--docs`,children:`Date Picker`}),` navigation chevrons are one example.
