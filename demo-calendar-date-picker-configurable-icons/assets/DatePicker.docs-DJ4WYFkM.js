...
`,(0,w.jsx)(i,{}),`
`,(0,w.jsx)(c,{}),`
`,(0,w.jsxs)(t.p,{children:[(0,w.jsx)(t.strong,{children:`Note`}),`: Some props are excluded from the controls panel: `,(0,w.jsx)(t.code,{children:`mode`}),`, `,(0,w.jsx)(t.code,{children:`onChange`}),`, and `,(0,w.jsx)(t.code,{children:`value`}),` are managed by the story’s state wrapper; `,(0,w.jsx)(t.code,{children:`defaultMonth`}),`, `,(0,w.jsx)(t.code,{children:`isDateDisabled`}),`, `,(0,w.jsx)(t.code,{children:`maxDate`}),`, and `,(0,w.jsx)(t.code,{children:`minDate`}),` have no suitable control widget for their type.
The `,(0,w.jsx)(t.code,{children:`dir`}),` and the navigation and accessible-name labels are read-only and follow `,(0,w.jsx)(t.code,{children:`locale`}),`, so the controls show a fully localised Date Picker; set them yourself in your app.`]}),`
...
`,(0,w.jsxs)(t.p,{children:[`If you set `,(0,w.jsx)(t.code,{children:`minDate`}),` or `,(0,w.jsx)(t.code,{children:`maxDate`}),`, ensure the initial `,(0,w.jsx)(t.code,{children:`value`}),` falls within those bounds.
The component does not clamp or validate the incoming value.`]}),`
`,(0,w.jsx)(t.h4,{id:`localisation`,children:`Localisation`}),`
`,(0,w.jsxs)(t.p,{children:[`The Date Picker renders weekday names, the month caption, and the accessible date labels in the language of `,(0,w.jsx)(t.code,{children:`locale`}),`, which defaults to `,(0,w.jsx)(t.code,{children:`nl-NL`}),`.
It does not translate the rest: set `,(0,w.jsx)(t.code,{children:`nextMonthButtonLabel`}),`, `,(0,w.jsx)(t.code,{children:`nextYearButtonLabel`}),`, `,(0,w.jsx)(t.code,{children:`previousMonthButtonLabel`}),`, and `,(0,w.jsx)(t.code,{children:`previousYearButtonLabel`}),` in the same language, or they stay Dutch and screen readers announce a mix.
In range mode, also localise `,(0,w.jsx)(t.code,{children:`rangeStartAccessibleName`}),` and `,(0,w.jsx)(t.code,{children:`rangeEndAccessibleName`}),`; they are appended to the start and end dates when those are announced.
For right-to-left scripts such as Arabic, also add `,(0,w.jsx)(t.code,{children:`dir="rtl"`}),`; this mirrors the layout and the navigation chevrons.
Try the `,(0,w.jsx)(t.code,{children:`locale`}),` control above to preview each language; see the `,(0,w.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),` for the tested locales.`]}),`
`,(0,w.jsx)(t.p,{children:`If your app uses Date Picker in multiple places with the same language, a small wrapper component avoids repeating these props:`}),`
`,(0,w.jsx)(t.pre,{children:(0,w.jsx)(t.code,{className:`language-tsx`,children:`import type { DatePickerProps } from "@amsterdam/design-system-react";
...
`,(0,w.jsxs)(t.p,{children:[`When `,(0,w.jsx)(t.code,{children:`minDate`}),` and `,(0,w.jsx)(t.code,{children:`maxDate`}),` align with month edges, all dates remain selectable.
...
`,(0,w.jsx)(t.h3,{id:`custom-navigation-icons`,children:`Custom navigation icons`}),`
`,(0,w.jsxs)(t.p,{children:[`Other `,(0,w.jsx)(t.a,{href:`https://nldesignsystem.nl/`,rel:`nofollow`,children:`NL Design System`}),` organisations can replace the navigation chevrons through the `,(0,w.jsx)(t.code,{children:`*ButtonIcon`}),` props, which each take the same value as the `,(0,w.jsx)(t.a,{href:`/docs/components-media-icon--docs`,children:`Icon`}),` component’s `,(0,w.jsx)(t.code,{children:`svg`}),` prop.
Websites for Amsterdam must use the default icons.
For right-to-left scripts, give a custom icon a `,(0,w.jsx)(t.code,{children:`data-directional="true"`}),` attribute so it mirrors like the default chevrons; see the `,(0,w.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),`.`]}),`
