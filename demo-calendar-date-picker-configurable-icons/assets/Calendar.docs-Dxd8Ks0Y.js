...
`,(0,x.jsxs)(t.p,{children:[`Other `,(0,x.jsx)(t.a,{href:`https://nldesignsystem.nl/`,rel:`nofollow`,children:`NL Design System`}),` organisations can replace the navigation chevrons through the `,(0,x.jsx)(t.code,{children:`*ButtonIcon`}),` props, which each take the same value as the `,(0,x.jsx)(t.a,{href:`/docs/components-media-icon--docs`,children:`Icon`}),` component’s `,(0,x.jsx)(t.code,{children:`svg`}),` prop.
Websites for Amsterdam must use the default icons.
For right-to-left scripts, give a custom icon a `,(0,x.jsx)(t.code,{children:`data-directional="true"`}),` attribute so it mirrors like the default chevrons; see the `,(0,x.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),`.`]}),`
