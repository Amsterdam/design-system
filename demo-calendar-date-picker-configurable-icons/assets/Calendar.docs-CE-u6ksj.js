...
For right-to-left scripts such as Arabic, also add `,(0,x.jsx)(t.code,{children:`dir="rtl"`}),`; this mirrors the layout and the navigation chevrons.
...
`,(0,x.jsx)(t.h3,{id:`custom-navigation-icons`,children:`Custom navigation icons`}),`
`,(0,x.jsxs)(t.p,{children:[`By default, the month and year navigation buttons use the Amsterdam chevron icons, so Amsterdam websites need to set nothing.
Other `,(0,x.jsx)(t.a,{href:`https://nldesignsystem.nl/`,rel:`nofollow`,children:`NL Design System`}),` organisations can match their own iconography with `,(0,x.jsx)(t.code,{children:`previousYearButtonIcon`}),`, `,(0,x.jsx)(t.code,{children:`previousMonthButtonIcon`}),`, `,(0,x.jsx)(t.code,{children:`nextMonthButtonIcon`}),`, and `,(0,x.jsx)(t.code,{children:`nextYearButtonIcon`}),`.
Each accepts the same value as the `,(0,x.jsx)(t.a,{href:`/docs/components-media-icon--docs`,children:`Icon`}),` component’s `,(0,x.jsx)(t.code,{children:`svg`}),` prop.`]}),`
`,(0,x.jsxs)(t.p,{children:[`For a right-to-left script such as Arabic, the buttons need to point the other way.
The default chevrons flip automatically because they carry a `,(0,x.jsx)(t.code,{children:`data-directional="true"`}),` attribute; the Icon styles mirror any icon with that attribute under `,(0,x.jsx)(t.code,{children:`dir="rtl"`}),`.
Give your own icons the same attribute so they flip too.
See the `,(0,x.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),` for more on right-to-left support.`]}),`
