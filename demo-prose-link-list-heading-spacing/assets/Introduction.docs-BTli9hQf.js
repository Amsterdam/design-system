...
`,(0,c.jsx)(t.h2,{id:`vertical-space`,children:`Vertical space`}),`
`,(0,c.jsxs)(t.p,{children:[`Between the Page Header and the Page Footer, an internal page holds one or more Grids.
Give each of them a `,(0,c.jsx)(t.code,{children:`paddingVertical`}),` of `,(0,c.jsx)(t.code,{children:`x-large`}),`.
The public templates vary this padding along the page; internal pages use the same value everywhere.`]}),`
`,(0,c.jsxs)(t.p,{children:[`Leave `,(0,c.jsx)(t.code,{children:`gapVertical`}),` at its default of `,(0,c.jsx)(t.code,{children:`x-large`}),` as well, so the space between the rows matches the space above and below them.`]}),`
`,(0,c.jsxs)(t.p,{children:[`Use the `,(0,c.jsx)(t.a,{href:`/docs/utilities-css-margin--docs`,children:`Margin`}),` utility classes for the space between the elements within a Grid Cell, in the amounts of the `,(0,c.jsx)(t.a,{href:`/docs/docs-designer-guide-vertical-space--docs`,children:`vertical space`}),` guide.`]}),`
