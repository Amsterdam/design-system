import{n as e}from"./chunk-DnJy8xQt.js";import{Vt as t}from"./iframe-C37rVdrP.js";import{r as n}from"./react-BIEtGYGN.js";import{c as r,f as i,i as a,l as o,s}from"./blocks-B7MQeEov.js";import{n as c,t as l}from"./DesignTokensTable-BTnNkMLV.js";import{t as u}from"./mdx-react-shim-BFPRfsfT.js";import{n as d,t as f}from"./Page.stories-bwJTlS-8.js";var p,m=e((()=>{p=`<!-- @license CC0-1.0 -->
...
`})),h,g,_=e((()=>{h={page:{"background-color":{$value:`{ams.color.background.body}`,$extensions:{"nl.amsterdam.type":`color`}},"container-name":{$value:`ams-inline-size-context`},"container-type":{$value:`inline-size`},"max-inline-size":{$value:{value:90,unit:`rem`},$type:`dimension`},"with-menu":{"max-inline-size":{$value:{value:120,unit:`rem`},$type:`dimension`},"area-skip-link":{"margin-inline-end":{$value:`{ams.grid.padding-inline}`,$extensions:{"nl.amsterdam.hint":`Must be the Grid inline padding, to make sure Skip Link and Grid line up.`,"nl.amsterdam.type":`dimension`,"nl.amsterdam.subtype":`space`}}}}}},g={ams:h}}));function v(e){let t={a:`a`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[`
`,`
`,`
`,`
`,(0,b.jsx)(r,{of:f}),`
