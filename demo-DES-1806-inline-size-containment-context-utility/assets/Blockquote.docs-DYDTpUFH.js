import{n as e}from"./chunk-DnJy8xQt.js";import{Vt as t}from"./iframe-D8SeYqVt.js";import{r as n}from"./react-i1-Hmnfh.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-Dc6kZ0g6.js";import{n as l,t as u}from"./DesignTokensTable-seCdjgnG.js";import{t as d}from"./mdx-react-shim-C43xo2k1.js";import{InverseColour as f,n as p,t as m}from"./Blockquote.stories-W2Mv-ISW.js";var h,g=e((()=>{h=`<!-- @license CC0-1.0 -->
...
`})),_,v,y=e((()=>{_={blockquote:{color:{$value:`{ams.color.text.default}`,$extensions:{"nl.amsterdam.type":`color`}},"font-family":{$value:`{ams.typography.font-family}`,$extensions:{"nl.amsterdam.type":`fontFamily`}},"font-size":{$value:`{ams.typography.body-text.x-large.font-size}`,$extensions:{"nl.amsterdam.type":`fontSize`}},"font-weight":{$value:`{ams.typography.body-text.bold.font-weight}`,$extensions:{"nl.amsterdam.type":`fontWeight`}},"line-height":{$value:`{ams.typography.body-text.x-large.line-height}`,$extensions:{"nl.amsterdam.subtype":`lineHeight`,"nl.amsterdam.type":`number`}},inverse:{color:{$value:`{ams.color.text.inverse}`,$extensions:{"nl.amsterdam.type":`color`}}}}},v={ams:_}}));function b(e){let t={a:`a`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,S.jsxs)(S.Fragment,{children:[`
`,`
`,`
`,`
`,(0,S.jsx)(r,{of:m}),`
...
`,(0,S.jsx)(t.h3,{id:`inverse-colour`,children:`Inverse colour`}),`
`,(0,S.jsx)(t.p,{children:`Use the inverse colour if the Blockquote sits on a dark background.
