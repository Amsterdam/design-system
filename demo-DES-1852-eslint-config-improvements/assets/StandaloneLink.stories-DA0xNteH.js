import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{F as n,Lt as r,Rt as i,Vt as a,Y as o,b as s,st as c}from"./iframe-BNw5_Qgt.js";import{d as l,t as u}from"./src-B85Bp66m.js";var d=t({ContrastColour:()=>h,Default:()=>m,InverseColour:()=>g,WithCustomIcon:()=>v,WithHeadingAndParagraph:()=>_,__namedExportsOrder:()=>y,default:()=>p}),f,p,m,h,g,_,v,y,b=e((()=>{o(),i(),u(),f=a(),p={title:`Components/Navigation/Standalone Link`,component:l,args:{children:`Bekijk alle onderwerpen`,href:`#`},argTypes:{children:{description:`The link text.`,table:{disable:!1}},color:{control:{labels:{undefined:`default`},type:`radio`},options:[void 0,`contrast`,`inverse`]},href:{description:`The url for the link.`,name:`href`,type:{name:`string`,required:!1}},icon:{control:{labels:{undefined:`none`},type:`select`},mapping:r,options:[void 0,...Object.keys(r)],table:{defaultValue:{summary:`ChevronForwardIcon`}}}}},m={},h={args:{color:`contrast`}},g={args:{color:`inverse`}},_={args:{children:`Bekijk alle werkzaamheden`},decorators:[e=>(0,f.jsx)(`article`,{style:{maxInlineSize:`32rem`},children:(0,f.jsx)(e,{})})],render:({children:e,...t})=>(0,f.jsxs)(`article`,{children:[(0,f.jsx)(s,{className:`ams-mb-s`,level:2,size:`level-3`,children:`Werkzaamheden`}),(0,f.jsx)(n,{className:`ams-mb-m`,children:`Lees waar en wanneer we werken aan nieuwbouw, groot onderhoud, herinrichting van straten en wegen, aanpak van parken of ontwikkeling van hele gebieden.`}),(0,f.jsx)(l,{...t,children:e})]})},v={args:{children:`Downloaden`,icon:(0,f.jsx)(c,{})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{}`,...m.parameters?.docs?.source}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'contrast'
  }
