import{n as e}from"./chunk-DnJy8xQt.js";import{Vt as t}from"./iframe-DHvoaJMD.js";import{n,t as r}from"./renderComponentVariants-q1kPT3i0.js";import{o as i,t as a}from"./src-BWp9X406.js";import o,{n as s}from"./Tabs.stories-S0Q1VPiP.js";var c,l,u,d,f;e((()=>{a(),r(),s(),c=t(),{expect:l}=__STORYBOOK_MODULE_TEST__,u={...o,title:`Components/Containers/Tabs`},d={args:{activeTab:`Gegevens`,children:[(0,c.jsxs)(i.List,{children:[(0,c.jsx)(i.Button,{"aria-controls":`Gegevens`,"data-testid":`gegevens`,children:`Gegevens`}),(0,c.jsx)(i.Button,{"aria-controls":`Aanslagen`,"data-testid":`aanslagen`,children:`Aanslagen`}),(0,c.jsx)(i.Button,{"aria-controls":`Acties`,children:`Acties`})]},1),(0,c.jsx)(i.Panel,{id:`Gegevens`,children:(0,c.jsx)(`p`,{"data-testid":`gegevens-panel`,children:`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 6 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`})},2),(0,c.jsx)(i.Panel,{id:`Aanslagen`,children:(0,c.jsx)(`p`,{"data-testid":`aanslagen-panel`,children:`Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. Wat vinden Amsterdammers belangrijk? Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren.`})},3),(0,c.jsx)(i.Panel,{id:`Acties`,children:(0,c.jsx)(`p`,{children:`Afgelopen maand konden bewoners hun reactie op de plannen geven tijdens informatiebijeenkomsten. Online kunt u tot en met 31 oktober reageren via amsterdam.nl/oranjeloper. Daar vindt u ook een overzicht van alle werkzaamheden die op de planning staan. En u kunt zich inschrijven voor de digitale nieuwsbrief.`})},4)]},play:async({canvas:e,userEvent:t})=>{await new Promise(e=>setTimeout(e,500));let n=e.getByTestId(`gegevens-panel`),r=e.getByTestId(`aanslagen`);await l(n).toBeVisible(),await t.click(r),await new Promise(e=>setTimeout(e,500)),await l(e.getByTestId(`aanslagen-panel`)).toBeVisible(),await l(n).not.toBeVisible()},render:(e,t)=>n(i,{args:e},t),tags:[`!dev`,`!autodocs`]},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    activeTab: 'Gegevens',
