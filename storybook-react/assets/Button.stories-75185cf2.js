import{j as v,c as f}from"./clsx.m-fdfad4c1.js";import{B as b}from"./index.esm-6dcd05e7.js";import{r as _}from"./index-8db94870.js";import"./_commonjsHelpers-042e6b4d.js";function h(a){switch(a){case"secondary":return"secondary-action-button";case"tertiary":return"subtle-button";default:return"primary-action-button"}}const n=_.forwardRef(({children:a,disabled:g,variant:o="primary",...B},T)=>v(b,{...B,appearance:h(o),ref:T,disabled:g,className:f(o==="secondary"&&"amsterdam-button--secondary"),children:a}));n.displayName="Button";try{n.displayName="Button",n.__docgenInfo={description:"",displayName:"Button",props:{variant:{defaultValue:{value:"primary"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}}}}}catch{}/**
 * @license EUPL-1.2+
...
//# sourceMappingURL=Button.stories-75185cf2.js.map
