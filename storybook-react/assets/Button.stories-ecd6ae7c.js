import{j as b}from"./jsx-runtime-94f6e698.js";import{B as S}from"./index.esm-00c4f8db.js";import{c as v}from"./clsx.m-1229b3e0.js";import{r as h}from"./index-8db94870.js";function B(t){switch(t){case"secondary":return"secondary-action-button";case"tertiary":return"subtle-button";default:return"primary-action-button"}}const o=h.forwardRef(({children:t,disabled:f,variant:n="primary",...g},_)=>b.jsx(S,{...g,appearance:B(n),ref:_,disabled:f,className:v("amsterdam-button",n==="secondary"&&"amsterdam-button--secondary",n==="tertiary"&&"amsterdam-button--tertiary"),children:t}));o.displayName="Button";try{o.displayName="Button",o.__docgenInfo={description:"",displayName:"Button",props:{variant:{defaultValue:{value:"primary"},description:"",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}}}}}catch{}/**
 * @license EUPL-1.2+
...
//# sourceMappingURL=Button.stories-ecd6ae7c.js.map
