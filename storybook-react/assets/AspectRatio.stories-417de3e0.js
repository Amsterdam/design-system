import{A,j as i}from"./index.esm-7773f790.js";const R={title:"Layout/Aspect Ratio",component:A,args:{ratio:"square"},argTypes:{ratio:{control:"radio",options:["extra-wide","wide","square","tall","extra-tall"]}},parameters:{docs:{canvas:{sourceState:"hidden"}}}},p={"extra-wide":{image:"https://picsum.photos/1600/900",maxWidth:"888px"},wide:{image:"https://picsum.photos/1000/800",maxWidth:"625px"},square:{image:"https://picsum.photos/800/800",maxWidth:"500px"},tall:{image:"https://picsum.photos/800/1000",maxWidth:"400px"},"extra-tall":{image:"https://picsum.photos/900/1600",maxWidth:"300px"}},e={decorators:[a=>i.jsx("div",{style:{display:"flex",justifyContent:"center"},children:i.jsx(a,{})})],render:({ratio:a})=>i.jsx(A,{ratio:a,style:{maxWidth:a?p[a].maxWidth:"500px"},children:i.jsx("img",{src:a?p[a].image:"https://picsum.photos/800/800",style:{width:"100%"}})})},r={...e,parameters:{docs:{canvas:{sourceState:"shown"}}}},t={...e,args:{ratio:"extra-wide"}},s={...e,args:{ratio:"wide"}},o={...e,args:{ratio:"square"}},c={...e,args:{ratio:"tall"}},n={...e,args:{ratio:"extra-tall"}};var m,d,l;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...StoryTemplate,
  parameters: {
    docs: {
      canvas: {
...
//# sourceMappingURL=AspectRatio.stories-417de3e0.js.map
