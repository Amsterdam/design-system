import{r,j as e,c as S,w as H,P as n}from"./iframe-_HsFhEIr.js";import{j as _,b as A}from"./exampleContent-Du2yH2Fl.js";import{u as D}from"./useKeyboardFocus-CO72QOjh.js";import{I as V}from"./Icon-Bm1t1A98.js";import{H as q}from"./Heading-DJp3agU8.js";const O={headingLevel:2},L=r.createContext(O);try{Context.displayName="Context",Context.__docgenInfo={description:`Context lets components pass information deep down without explicitly
passing props.

Created from {@link createContext}`,displayName:"Context",props:{}}}catch{}const N=r.forwardRef(({children:o,className:h,expanded:g=!1,label:u,...m},c)=>{const{headingLevel:l,sectionAs:w}=r.useContext(L),[x,E]=r.useState(g),R=w||"section",P=r.useId(),T=`heading-${l}`,k=`button-${P}`,C=`panel-${P}`;return e.jsxs("div",{className:S("ams-accordion__section",h),ref:c,...m,children:[e.jsx(q,{className:"ams-accordion__header",level:l,children:e.jsxs("button",{"aria-controls":C,"aria-expanded":x,className:"ams-accordion__button",id:k,onClick:()=>E(!x),type:"button",children:[e.jsx(V,{className:"ams-accordion__icon",size:T,svg:H}),u]})}),e.jsx(R,{"aria-labelledby":k,className:S("ams-accordion__panel",{"ams-accordion__panel--expanded":x}),id:C,children:o})]})});N.displayName="Accordion.Section";try{Accordion.Section.displayName="Accordion.Section",Accordion.Section.__docgenInfo={description:"",displayName:"Accordion.Section",props:{expanded:{defaultValue:{value:"false"},description:"Whether the content is displayed initially.",name:"expanded",required:!1,type:{name:"boolean"}},label:{defaultValue:null,description:"The heading text.",name:"label",required:!0,type:{name:"string"}}}}}catch{}const I=r.forwardRef(({children:o,className:h,headingLevel:g,sectionAs:u="section"},m)=>{const c=r.useRef(null);r.useImperativeHandle(m,()=>c.current);const{keyDown:l}=D(c,{focusableElements:[".ams-accordion__button:not([disabled])"],rotating:!0});return e.jsx(L.Provider,{value:{headingLevel:g,sectionAs:u},children:e.jsx("div",{className:S("ams-accordion",h),onKeyDown:l,ref:c,children:o})})});I.displayName="Accordion";const a=Object.assign(I,{Section:N});try{a.displayName="Accordion",a.__docgenInfo={description:"",displayName:"Accordion",props:{headingLevel:{defaultValue:null,description:`The hierarchical level of this Accordion’s Section Headings within the document.
