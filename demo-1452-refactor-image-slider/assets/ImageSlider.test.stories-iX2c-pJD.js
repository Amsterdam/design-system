import{j as d}from"./iframe-B-Atn6hq.js";import{r as g}from"./renderComponentVariants-bX-LE6ID.js";import{m as v,I as m}from"./ImageSlider.stories-dXGDC2-d.js";import"./preload-helper-PPVm8Dsz.js";import"./Image-CatpvzTz.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./Button-DX32kEX4.js";import"./Icon-1bWelDKt.js";const{expect:i}=__STORYBOOK_MODULE_TEST__,C={...v,title:"Components/Media/Image Slider"},r={args:{images:[{alt:"Bridge",src:"https://picsum.photos/id/122/1280/720"},{alt:"Bunker",src:"https://picsum.photos/id/101/1280/720"},{alt:"Chairs",src:"https://picsum.photos/id/153/1280/720"},{alt:"Droplet",src:"https://picsum.photos/id/159/1280/720"},{alt:"Dew",src:"https://picsum.photos/id/123/1280/720"}]},play:async({canvas:a,userEvent:n})=>{const h=a.queryAllByRole("group")[0]?.children,e=Array.from(h??[]),l=a.queryAllByRole("button"),c=l[0],u=l[1];if(!u||!c)return;for(const[o,s]of e.entries())if(o===0){i(s).not.toHaveAttribute("aria-hidden");for(let t=1;t<e.length;t++)i(e[t]).toHaveAttribute("aria-hidden","true")}else{await n.click(u),await new Promise(t=>setTimeout(t,500)),i(s).not.toHaveAttribute("aria-hidden");for(let t=0;t<e.length;t++)t!==o&&i(e[t]).toHaveAttribute("aria-hidden","true")}for(const[o,s]of e.reverse().entries())o===0||(await n.click(c),await new Promise(t=>setTimeout(t,500))),i(s).not.toHaveAttribute("aria-hidden");const p=a.getAllByRole("tab",{name:"Afbeelding 3: Chairs"})[0];await n.click(p),await new Promise(o=>setTimeout(o,1e3)),i(e[2]).not.toHaveAttribute("aria-hidden")},render:a=>d.jsxs(d.Fragment,{children:[d.jsx(m,{...a,"data-testid":"interaction-test"}),g(m,{args:a})]}),tags:["!dev","!autodocs"]};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    images: [{
      alt: 'Bridge',
