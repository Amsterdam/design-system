import{n as e}from"./chunk-zsgVPwQN.js";import{At as t}from"./iframe-CjVbXz4k.js";import{r as n}from"./react-BXr6f8Gw.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-Cc32xMd7.js";import{n as l,t as u}from"./DesignTokensTable-Bu0t5Zfu.js";import{t as d}from"./mdx-react-shim-BNooXIpe.js";import{BackgroundInCompactMode as f,ImproveSemantics as p,SpanAllColumns as m,SpanColumns as h,SpanResponsively as g,SpanRows as _,StartPosition as v,VerticalGap as y,VerticalPadding as b,n as x,t as S}from"./Grid.stories-i7JX4kSO.js";var C,w=e((()=>{C=`<!-- @license CC0-1.0 -->
...
`})),T,E,D=e((()=>{T={grid:{"column-count":{$value:`4`},"column-gap":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"padding-block":{l:{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},xl:{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"2xl":{$value:`{ams.space.2xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},"padding-inline":{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"row-gap":{l:{$value:`{ams.space.l}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},xl:{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"2xl":{$value:`{ams.space.2xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},medium:{"column-count":{$value:`8`},"padding-inline":{$value:`{ams.space.xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},wide:{"column-count":{$value:`12`},"padding-inline":{$value:`{ams.space.2xl}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},cell:{"background-color":{$value:`initial`},"padding-block":{$value:`initial`},"padding-inline":{$value:`initial`}}}},E={ams:T}}));function O(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,A.jsxs)(A.Fragment,{children:[`
`,`
`,`
`,`
`,(0,A.jsx)(r,{of:S}),`
...
`,(0,A.jsxs)(t.p,{children:[`The `,(0,A.jsx)(t.code,{children:`rowSpan`}),` prop makes a Cell span multiple (currently 2, 3 or 4) rows.`]}),`
`,(0,A.jsx)(s,{of:_}),`
`,(0,A.jsx)(t.h3,{id:`span-responsively`,children:`Span responsively`}),`
`,(0,A.jsxs)(t.p,{children:[`You can make the number of columns a cell spans depend on the window width.
...
`,(0,A.jsxs)(t.p,{children:[`Each cell automatically starts in the next available column in the grid.
...
`,(0,A.jsxs)(t.p,{children:[`Use the `,(0,A.jsx)(t.code,{children:`transparent`}),` appearance to let a cell blend into the page background instead.
