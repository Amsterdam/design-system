import{n as e}from"./chunk-zsgVPwQN.js";import{At as t}from"./iframe-CjVbXz4k.js";import{r as n}from"./react-BXr6f8Gw.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-Cc32xMd7.js";import{n as l,t as u}from"./DesignTokensTable-Bu0t5Zfu.js";import{t as d}from"./mdx-react-shim-BNooXIpe.js";import{ContrastColour as f,InverseColour as p,n as m,t as h}from"./IconButton.stories-Dxb8VqwN.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={"icon-button":{color:{$value:`{ams.color.interactive.default}`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},hover:{"background-color":{$value:`rgb(0 70 153 / 12.5%)`,$type:`color`},color:{$value:`{ams.color.interactive.hover}`,$type:`color`}},disabled:{color:{$value:`{ams.color.interactive.disabled}`,$type:`color`},cursor:{$value:`{ams.cursor.disabled}`}},contrast:{color:{$value:`{ams.color.interactive.contrast}`,$type:`color`},hover:{"background-color":{$value:`rgb(0 0 0 / 12.5%)`,$type:`color`},color:{$value:`{ams.color.interactive.contrast}`,$type:`color`}},disabled:{color:{$value:`{ams.color.interactive.disabled}`,$type:`color`}}},inverse:{"background-color":{$value:`{ams.color.interactive.default}`,$type:`color`},color:{$value:`{ams.color.interactive.inverse}`,$type:`color`},hover:{"background-color":{$value:`{ams.color.interactive.hover}`,$type:`color`},color:{$value:`{ams.color.interactive.inverse}`,$type:`color`}},disabled:{color:{$value:`{ams.color.interactive.inverse}`,$type:`color`},"background-color":{$value:`{ams.color.interactive.disabled}`,$type:`color`}}}}},y={ams:v}}));function x(e){let t={a:`a`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
