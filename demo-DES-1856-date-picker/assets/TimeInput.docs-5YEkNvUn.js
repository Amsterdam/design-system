...
`,(0,w.jsx)(t.p,{children:`Use a Time Input when the user must enter a time of day.`}),`
`,(0,w.jsx)(t.h3,{id:`how-to-use`,children:`How to use`}),`
`,(0,w.jsx)(t.p,{children:`Wrap a Time Input in a Field to associate it with a Label, description, and Error Message.`}),`
...
`,(0,w.jsx)(t.p,{children:`Use a Field to group a Time Input with a Label, description and / or an Error Message.`}),`
`,(0,w.jsxs)(t.p,{children:[`If you don’t need the description, remove its Paragraph and the `,(0,w.jsx)(t.code,{children:`aria-describedby`}),` from the Time Input.`]}),`
...
`,(0,w.jsxs)(t.p,{children:[`If the Time Input can become invalid, add an Error Message and its `,(0,w.jsx)(t.code,{children:`id`}),` to the `,(0,w.jsx)(t.code,{children:`aria-describedby`}),` attribute of the Time Input.`]}),`
`,(0,w.jsxs)(t.p,{children:[`Check `,(0,w.jsx)(t.a,{href:`/docs/components-forms-field--docs`,children:`the Field docs`}),` for more information on configuring it.`]}),`
`,(0,w.jsx)(c,{of:h}),`
`,(0,w.jsx)(t.h2,{id:`design`,children:`Design`}),`
`,(0,w.jsx)(t.p,{children:`This component uses a native time input, which is styled differently in different browsers and operating systems.
...
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),` – the counterpart for entering a date.`]}),`
`,(0,w.jsxs)(t.li,{children:[(0,w.jsx)(t.a,{href:`/docs/components-forms-field--docs`,children:`Field`}),` – wraps a Time Input with its Label, description, and Error Message.`]}),`
`]}),`
