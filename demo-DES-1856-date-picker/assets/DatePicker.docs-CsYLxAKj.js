...
`,(0,C.jsxs)(t.p,{children:[`Use a `,(0,C.jsx)(t.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),` instead when the user knows the date and can type it into a form field.
Use a `,(0,C.jsx)(t.a,{href:`/docs/components-navigation-calendar--docs`,children:`Calendar`}),` instead to browse content grouped by date, such as an events calendar.`]}),`
