import{j as e}from"./iframe-LKBzW34W.js";import{useMDXComponents as l}from"./index-DeTc-HNi.js";import{M as o,f as a,P as r,h,i}from"./blocks-03y7gpTp.js";import{R as d,A as c,E as m,a as p,b as g,V as x,W as j}from"./Row.stories-BYZfvP9L.js";import{D as u}from"./DesignTokensTable-CzlhkH5z.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ZVO2Psur.js";import"./types-CjGn4A4T.js";import"./Row-BNQgcEdC.js";import"./BorderSample-CO7JbiiC.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CuPtTmzU.js";import"./ColorSample-BmgbbwgL.js";import"./SpaceSample-dy2dbuYM.js";import"./TypographySample-DNH6IqQ5.js";const f=`<!-- @license CC0-1.0 -->

# Row

Stacks its children horizontally with gaps between them and offers alignment options.
`,w={row:{gap:{"x-small":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},small:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},medium:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},large:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"x-large":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}}}},y={ams:w};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:d}),`
...
`,e.jsx(u,{tokens:y})]})}function I(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{I as default};
