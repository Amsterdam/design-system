import{j as e}from"./iframe-LKBzW34W.js";import{useMDXComponents as a}from"./index-DeTc-HNi.js";import{M as i,f as r,P as c,h as d,i as o}from"./blocks-03y7gpTp.js";import{a as h,L as l,E as m,R as p}from"./Accordion.stories-C7SM6Gx1.js";import{D as u}from"./DesignTokensTable-CzlhkH5z.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ZVO2Psur.js";import"./exampleContent-Du2yH2Fl.js";import"./useKeyboardFocus-CO72QOjh.js";import"./Icon-Dz4-Mfr0.js";import"./Heading-Cpz0q3J9.js";import"./getHeadingTag-Dv1eMqvl.js";import"./BorderSample-CO7JbiiC.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CuPtTmzU.js";import"./ColorSample-BmgbbwgL.js";import"./SpaceSample-dy2dbuYM.js";import"./TypographySample-DNH6IqQ5.js";const f=`<!-- @license CC0-1.0 -->
...
`,g={accordion:{gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-inline":{$value:"0",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},hover:{color:{$value:"{ams.color.interactive.hover}",$type:"color"}}}}},x={ams:g};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:h}),`
...
`,e.jsx(u,{tokens:x})]})}function D(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{D as default};
