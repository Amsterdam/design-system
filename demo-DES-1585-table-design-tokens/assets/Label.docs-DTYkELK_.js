import{j as e}from"./iframe-Cvsr9Wek.js";import{useMDXComponents as s}from"./index-C_nmgpEA.js";import{M as a,f as h,P as r,h as l,i}from"./blocks-DFxfA0-X.js";import{a as d,O as p,W as m,b as c,I as f}from"./Label.stories-IrOAvVLu.js";import{D as x}from"./DesignTokensTable-DF_sTGBq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B2eEMmnS.js";import"./Hint-fST0wlbN.js";import"./BorderSample-BlJHHsZD.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-BFXCHfEL.js";import"./SpaceSample-U6dv6OIx.js";import"./TypographySample-Xw5GdK06.js";const j=`<!-- @license CC0-1.0 -->
...
`,u={label:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"},"in-fieldset":{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"}}}},g={ams:u};function o(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
...
`,e.jsx(x,{tokens:g})]})}function H(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{H as default};
