import{j as e}from"./iframe-C-BgkQ27.js";import{useMDXComponents as i}from"./index-DVmM5o2F.js";import{M as a,f as d,P as r,h as l,i as s}from"./blocks-BcKFDq5P.js";import{G as c,V as h,a as p,S as m,b as u,c as x,d as g,I as w}from"./Grid.stories-B8v6CDco.js";import{D as f}from"./DesignTokensTable-DidEtMCt.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D9u1S6Fa.js";import"./common-HRWYXPjp.js";import"./Grid-CGTuuHmI.js";import"./gridCellClasses-DKw8XbSK.js";import"./BorderSample-B-NIB8SG.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-DwCvKElt.js";import"./SpaceSample-jYOttI79.js";import"./TypographySample-CjgYmxv2.js";const j=`<!-- @license CC0-1.0 -->
...
`,y={grid:{"column-count":{$value:"4"},"column-gap":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-block":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},"padding-inline":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"row-gap":{l:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},xl:{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"2xl":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},medium:{"column-count":{$value:"8"},"padding-inline":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},wide:{"column-count":{$value:"12"},"padding-inline":{$value:"{ams.space.2xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}}}},v={ams:y};function o(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(f,{tokens:v})]})}function z(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{z as default};
