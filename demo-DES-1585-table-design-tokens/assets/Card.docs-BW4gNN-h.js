import{j as e}from"./iframe-C-BgkQ27.js";import{useMDXComponents as i}from"./index-DVmM5o2F.js";import{M as o,f as r,P as d,i as a}from"./blocks-BcKFDq5P.js";import{a as l,W as c,b as p,T as m}from"./Card.stories-C-x0sBLW.js";import{D as h}from"./DesignTokensTable-DidEtMCt.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D9u1S6Fa.js";import"./common-HRWYXPjp.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-DEwUmeKF.js";import"./getHeadingTag-Dv1eMqvl.js";import"./Paragraph-aaXOkF_S.js";import"./Image-BEdnikyu.js";import"./generateAspectRatioClass-jt2KOtJX.js";import"./BorderSample-B-NIB8SG.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-DwCvKElt.js";import"./SpaceSample-jYOttI79.js";import"./TypographySample-CjgYmxv2.js";const g=`<!-- @license CC0-1.0 -->
...
`,u={card:{heading:{"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},"heading-group":{gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"margin-block-end":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},image:{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}},link:{color:{$value:"{ams.links.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}}},x={ams:u};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:l}),`
...
`,e.jsx(h,{tokens:x})]})}function G(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{G as default};
