import{j as e}from"./iframe-LKBzW34W.js";import{useMDXComponents as a}from"./index-DeTc-HNi.js";import{M as o,f as l,P as r,h as m,i as t}from"./blocks-03y7gpTp.js";import{a as h,A as c,H as d,I as p}from"./Column.stories-CtVEpUqn.js";import{D as x}from"./DesignTokensTable-CzlhkH5z.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ZVO2Psur.js";import"./types-CjGn4A4T.js";import"./BorderSample-CO7JbiiC.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CuPtTmzU.js";import"./ColorSample-BmgbbwgL.js";import"./SpaceSample-dy2dbuYM.js";import"./TypographySample-DNH6IqQ5.js";const u=`<!-- @license CC0-1.0 -->

# Column

Stacks its children vertically with gaps between them and offers alignment options.
`,g={column:{gap:{"x-small":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},small:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},medium:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},large:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"x-large":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}}}}},j={ams:g};function i(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...a(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:h}),`
...
`,e.jsx(x,{tokens:j})]})}function D(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{D as default};
