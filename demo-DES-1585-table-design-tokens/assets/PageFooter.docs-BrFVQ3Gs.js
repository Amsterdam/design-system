import{j as e}from"./iframe-DxFJ3SCQ.js";import{useMDXComponents as i}from"./index-CdbzGJT0.js";import{M as s,f as a,P as r,i as l}from"./blocks-DPfOuimJ.js";import{a as d,O as c}from"./PageFooter.stories-DqmjwYwe.js";import{D as m}from"./DesignTokensTable-CKsYRah6.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CnyXa-QK.js";const u=`<!-- @license CC0-1.0 -->
...
`,h={"page-footer":{menu:{"column-gap":{value:"{ams.space.l}"},"padding-block":{value:"{ams.space.l}"},"padding-inline":{value:"{ams.grid.padding-inline}"},"row-gap":{value:"{ams.space.xs}"},medium:{"padding-inline":{value:"{ams.grid.medium.padding-inline}"}},wide:{"padding-inline":{value:"{ams.grid.wide.padding-inline}"}},link:{color:{value:"{ams.links.color}"},"font-family":{value:"{ams.typography.font-family}"},"font-size":{value:"{ams.typography.body-text.font-size}"},"font-weight":{value:"{ams.typography.body-text.font-weight}"},"line-height":{value:"{ams.typography.body-text.line-height}"},"outline-offset":{value:"{ams.focus.outline-offset}"},"text-decoration-line":{value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{value:"{ams.links.text-decoration-thickness}"},"text-underline-offset":{value:"{ams.links.text-underline-offset}"},hover:{color:{value:"{ams.links.hover.color}"},"text-decoration-line":{value:"{ams.links.subtle.hover.text-decoration-line}"}}}},spotlight:{"background-color":{value:"#004699"}}}},f={ams:h};function o(t){const n={h2:"h2",h3:"h3",p:"p",...i(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(s,{of:d}),`
...
`,e.jsx(m,{tokens:f})]})}function w(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}export{w as default};
