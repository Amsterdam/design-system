import{j as e}from"./iframe-CXihyJP3.js";import{useMDXComponents as o}from"./index-CKZ3TBTR.js";import{M as a,f as s,P as r,h as l}from"./blocks-BYXYtXPk.js";import{a as p}from"./Pagination.stories-Bnqb1Uop.js";import{D as m}from"./DesignTokensTable-ChDyzEew.js";import"./preload-helper-PPVm8Dsz.js";import"./index-OoWPHhOp.js";import"./Icon-BxBB2WMT.js";import"./BorderSample-DR35xC81.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-CVjxTrJR.js";import"./SpaceSample-DDWXS5k8.js";import"./TypographySample-BaAQ8dS7.js";const c=`<!-- @license CC0-1.0 -->
...
`,d={pagination:{"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},link:{color:{$value:"{ams.links.color}",$type:"color"},gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-inline":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"text-decoration-line":{$value:"{ams.links.subtle.text-decoration-line}"},"text-decoration-thickness":{$value:"{ams.links.text-decoration-thickness}",$type:"dimension"},"text-underline-offset":{$value:"{ams.links.text-underline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},current:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},hover:{color:{$value:"{ams.links.hover.color}",$type:"color"},"text-decoration-line":{$value:"{ams.links.subtle.hover.text-decoration-line}"}}}}},h={ams:d};function i(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:p}),`
...
`,e.jsx(m,{tokens:h})]})}function M(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{M as default};
