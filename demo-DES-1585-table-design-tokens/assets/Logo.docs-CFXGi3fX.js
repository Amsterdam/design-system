import{j as e}from"./iframe-Cvsr9Wek.js";import{useMDXComponents as a}from"./index-C_nmgpEA.js";import{M as i,f as r,P as l,h,i as o}from"./blocks-DFxfA0-X.js";import{L as m,G as d,S as g,a as c,V as p,M as u,C as b}from"./Logo.stories-BQSJTfSw.js";import{D as f}from"./DesignTokensTable-DF_sTGBq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B2eEMmnS.js";import"./ExampleLogo-BmwT_M1u.js";import"./BorderSample-BlJHHsZD.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-BFXCHfEL.js";import"./SpaceSample-U6dv6OIx.js";import"./TypographySample-Xw5GdK06.js";const x=`<!-- @license CC0-1.0 -->
...
`,w={logo:{"block-size":{$value:"{ams.space.xl}",$extensions:{"amsterdam.designsystem.type":"blockSize"}},"min-block-size":{$value:{value:2.5,unit:"rem"},$type:"dimension"},emblem:{color:{$value:"#ec0000",$type:"color"}},subsite:{color:{$value:"{ams.color.text.default}",$type:"color"}},title:{color:{$value:"#ec0000",$type:"color"}}}},j={ams:w};function t(s){const n={h2:"h2",h3:"h3",p:"p",strong:"strong",...a(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:m}),`
...
`,e.jsx(n.h3,{id:"ggd-amsterdam",children:"GGD Amsterdam"}),`
`,e.jsx(o,{of:d}),`
`,e.jsx(n.h3,{id:"stadsarchief",children:"Stadsarchief"}),`
`,e.jsx(o,{of:g}),`
`,e.jsx(n.h3,{id:"stadsbank-van-lening",children:"Stadsbank van Lening"}),`
`,e.jsx(o,{of:c}),`
`,e.jsx(n.h3,{id:"vga-verzekeringen",children:"VGA Verzekeringen"}),`
`,e.jsx(o,{of:p}),`
`,e.jsx(n.h3,{id:"museum-weesp",children:"Museum Weesp"}),`
`,e.jsx(o,{of:u}),`
...
`,e.jsx(f,{tokens:j})]})}function L(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{L as default};
