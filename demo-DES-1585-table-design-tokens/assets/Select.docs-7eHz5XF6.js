import{j as e}from"./iframe-Cvsr9Wek.js";import{useMDXComponents as t}from"./index-C_nmgpEA.js";import{M as a,f as r,P as l,h as d,i as n}from"./blocks-DFxfA0-X.js";import{a as c,G as m,I as p,D as h,b as u,c as x}from"./Select.stories-3qMpbV06.js";import{D as g}from"./DesignTokensTable-DF_sTGBq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B2eEMmnS.js";import"./BorderSample-BlJHHsZD.js";import"./formatTokenValue-BYjgZrXg.js";import"./ColorSample-BFXCHfEL.js";import"./SpaceSample-U6dv6OIx.js";import"./TypographySample-Xw5GdK06.js";const f=`<!-- @license CC0-1.0 -->
...
`,v={select:{"background-color":{$value:"{ams.inputs.background-color}",$type:"color"},"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23004699' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`},"background-position":{$value:"right {ams.space.m} center"},"border-color":{$value:"{ams.inputs.border-color}",$type:"color"},"border-style":{$value:"{ams.inputs.border-style}",$extensions:{"amsterdam.designsystem.type":"borderStyle"}},"border-width":{$value:"{ams.inputs.border-width}",$extensions:{"amsterdam.designsystem.type":"borderWidth"}},color:{$value:"{ams.inputs.color}",$type:"color"},"font-family":{$value:"{ams.inputs.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.inputs.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.inputs.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},"outline-offset":{$value:"{ams.inputs.outline-offset}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-block":{$value:"{ams.inputs.padding-block}",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},"padding-inline":{$value:"{ams.inputs.padding-inline} calc(2 * {ams.inputs.padding-inline} + 1em)",$type:"dimension",$extensions:{"amsterdam.designsystem.subtype":"space"}},disabled:{"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23767676' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`},color:{$value:"{ams.inputs.disabled.color}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}},hover:{"box-shadow":{$value:"{ams.inputs.hover.box-shadow}"},"background-image":{$value:`url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><path fill='%23003677' fill-rule='evenodd' d='m16 25.757-16-16 2.91-2.9L16 19.937l13.09-13.08 2.91 2.9z'/></svg>")`}},invalid:{"border-color":{$value:"{ams.inputs.invalid.border-color}",$type:"color"},hover:{"border-color":{$value:"{ams.inputs.invalid.hover.border-color}",$type:"color"},"box-shadow":{$value:"{ams.inputs.invalid.hover.box-shadow}"}}},option:{disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"}}}}},b={ams:v};function i(s){const o={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...t(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:c}),`
...
`,e.jsx(g,{tokens:b})]})}function E(s={}){const{wrapper:o}={...t(),...s.components};return o?e.jsx(o,{...s,children:e.jsx(i,{...s})}):i(s)}export{E as default};
