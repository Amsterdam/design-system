import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{C as i,G as a,V as o,d as s,q as c,rt as l,w as u}from"./index.esm-BGcEkOJC.js";import{n as d,r as f,t as p}from"./commonMeta-gxViu1Ii.js";var m=t({Default:()=>T,Loaded:()=>D,Loading:()=>E,__namedExportsOrder:()=>O,default:()=>b}),h,g,_,v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{l(),h=n(),d(),g=r(),_=`woningbouw`,v=[{description:`Een levendige, groene en duurzame woonbuurt tussen de Gooiseweg en het Nelson Mandelapark.`,heading:`Nederlands eerste houten woonwijk komt in Zuidoost`,imageSrc:`https://picsum.photos/id/1015/640/360`},{description:`De komende jaren bouwt de gemeente duizenden nieuwe woningen in stadsdeel Noord.`,heading:`Meer betaalbare woningen in Noord`,imageSrc:`https://picsum.photos/id/1016/640/360`},{description:`Havenstad groeit uit tot een gemengd stadsgebied met ruimte om te wonen en te werken.`,heading:`Woningbouwplannen Havenstad`,imageSrc:`https://picsum.photos/id/1029/640/360`},{description:`Bekijk hoe u zich inschrijft en wat de wachttijden zijn voor een sociale huurwoning.`,heading:`Sneller een sociale huurwoning`,imageSrc:`https://picsum.photos/id/1039/640/360`},{description:`Subsidies en advies om uw huis te isoleren en van het gas af te gaan.`,heading:`Verduurzaam uw woning`,imageSrc:`https://picsum.photos/id/1043/640/360`},{description:`Op het Zeeburgereiland verrijst een hoogstedelijke buurt met hoge woontorens.`,heading:`Nieuwbouw in de Sluisbuurt`,imageSrc:`https://picsum.photos/id/1044/640/360`}],y={narrow:4,medium:4,wide:4},b={...p,title:`Pages/Public/Loading Page`,args:{initialPhase:`idle`},argTypes:{initialPhase:{table:{disable:!0}}},parameters:f(`Shows how a page behaves while it fetches its content, keeping the layout stable as placeholders make way for the real results.`),render:({initialPhase:e})=>{let[t,n]=(0,h.useState)(e),[r,l]=(0,h.useState)(_),d=(0,h.useRef)(null);(0,h.useEffect)(()=>()=>{d.current&&clearTimeout(d.current)},[]);let f=e=>{e.preventDefault();let t=new FormData(e.currentTarget).get(`search`);typeof t==`string`&&t.trim()&&l(t.trim()),d.current&&clearTimeout(d.current),n(`loading`),d.current=setTimeout(()=>n(`loaded`),3e3)},p=t===`loading`?`Zoekresultaten voor ‘${r}’ worden geladen`:t===`loaded`?`${v.length} resultaten voor ‘${r}’ gevonden`:``;return(0,g.jsxs)(`main`,{id:`inhoud`,children:[(0,g.jsx)(i,{paddingTop:`large`,children:(0,g.jsxs)(i.Cell,{className:`ams-prose`,span:{narrow:4,medium:6,wide:6},children:[(0,g.jsx)(u,{level:1,children:`Zoeken op amsterdam.nl`}),(0,g.jsxs)(a,{onSubmit:f,children:[(0,g.jsx)(a.Input,{defaultValue:_,label:`Zoek op de website`,name:`search`}),(0,g.jsx)(a.Button,{})]})]})}),(0,g.jsxs)(i,{"aria-busy":t===`loading`,paddingBottom:`2x-large`,paddingTop:`2x-large`,children:[(0,g.jsxs)(i.Cell,{span:`all`,children:[(0,g.jsx)(`p`,{className:`ams-visually-hidden`,role:`status`,children:p}),t===`idle`&&(0,g.jsx)(o,{children:`Klik op de zoekknop om de resultaten te laden.`}),t===`loaded`&&(0,g.jsx)(u,{level:2,size:`level-3`,children:`${v.length} resultaten voor ‘${r}’`})]}),t===`loading`&&v.map((e,t)=>(0,g.jsx)(i.Cell,{span:y,children:(0,g.jsxs)(c,{children:[(0,g.jsx)(c.Image,{}),(0,g.jsx)(c.Heading,{}),(0,g.jsx)(c.Paragraph,{lines:2})]})},t)),t===`loaded`&&v.map(e=>(0,g.jsx)(i.Cell,{span:y,children:(0,g.jsxs)(s,{children:[(0,g.jsx)(s.Image,{alt:``,aspectRatio:`16:9`,src:e.imageSrc}),(0,g.jsx)(s.Heading,{level:3,children:(0,g.jsx)(s.Link,{href:`#`,children:e.heading})}),(0,g.jsx)(o,{children:e.description})]})},e.heading))]})]})}},x=({busy:e,extraCells:t=``,status:n,statusCell:r=``})=>`// The Skip Link in the Page Layout targets this id, so the next Tab press lands in the main content.
