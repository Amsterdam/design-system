import{n as e,r as t}from"./chunk-zsgVPwQN.js";import{t as n}from"./jsx-runtime-GmyBfqKJ.js";import{B as r,K as i,M as a,_ as o,g as s,r as c}from"./index.esm-Be98E8le.js";import{f as l,m as u,p as d,t as f}from"./src-DOXA34Ic.js";import{l as p,p as m}from"./exampleContent-Da4iKy_l.js";var h=t({Default:()=>y,HighlightContent:()=>b,__namedExportsOrder:()=>x,default:()=>v}),g,_,v,y,b,x,S=e((()=>{i(),f(),d(),m(),g=n(),_=p(),v={title:`Components/Containers/Spotlight`,component:l,argTypes:{color:{control:{labels:{undefined:`purple (default)`}},options:[void 0,...u]}}},y={render:({as:e,color:t})=>(0,g.jsx)(l,{as:e,color:t,children:(0,g.jsx)(s,{paddingVertical:`x-large`,children:(0,g.jsx)(s.Cell,{span:`all`,children:(0,g.jsx)(c,{color:!t||[`azure`,`green`,`magenta`].includes(t)?`inverse`:void 0,children:_})})})})},b={args:{color:`green`},render:({color:e})=>{let t=[`lime`,`orange`,`yellow`],n=t.includes(e)?void 0:`inverse`,i=t.includes(e)?`contrast`:`inverse`;return(0,g.jsx)(l,{color:e,children:(0,g.jsx)(s,{paddingVertical:`x-large`,children:(0,g.jsxs)(s.Cell,{span:{narrow:4,medium:5,wide:7},children:[(0,g.jsx)(o,{className:`ams-mb-s`,color:n,level:2,size:`level-3`,children:`Steun geven aan een partij`}),(0,g.jsx)(a,{className:`ams-mb-m`,color:n,children:`Van 19 januari tot en met 2 februari kunt u uw steun geven aan een partij voor de gemeenteraad of een stadsdeel- of bestuurscommissie. Dit doet u met een ondersteuningsverklaring.`}),(0,g.jsx)(r,{color:i,href:`#`,children:`Ondersteuningsverklaring inleveren`})]})})})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: ({
    as,
    color
