import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-DXSisYNI.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-CWHB2xcz.js";import{n as u,t as d}from"./FormFlow.stories-OZ2KTCTa.js";var f;function p(){return(p=e((()=>{f=[[{height:`line`,label:`Back link`}],[{height:`body`,label:`Questions`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.h3,{id:`showing-progress`,children:`Showing progress`}),`
`,(0,g.jsxs)(n.p,{children:[`Do not put a step counter such as ‘Stap 2 van 5’ on form pages by default.
List the steps on the landing page instead, and read `,(0,g.jsx)(n.a,{href:`#with-a-progress-indicator`,children:`With a Progress Indicator`}),` before adding one anyway.`]}),`
...
`,(0,g.jsx)(n.p,{children:`Form pages typically carry no step counter of their own:`}),`
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsx)(n.li,{children:`A form that branches cannot state a total it keeps to, so the count drifts from the number of pages a user actually sees.`}),`
`,(0,g.jsx)(n.li,{children:`A counter also takes up the space right above the question, and it tells users how much is left to give up on.`}),`
`,(0,g.jsx)(n.li,{children:`Setting expectations is the job of the step list on the landing page: it is written once, on the page where users decide whether to start.`}),`
`]}),`
`,(0,g.jsx)(n.p,{children:`Test the form without an indicator first, and improve the order, type or number of questions before reaching for one.
...
`})}),`
`,(0,g.jsx)(n.p,{children:`Keep it plain, and state a total only for a form that asks every user the same questions in the same order.
