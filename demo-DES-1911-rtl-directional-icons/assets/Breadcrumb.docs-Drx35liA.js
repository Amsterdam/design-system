...
`,(0,y.jsx)(t.p,{children:`Use a Breadcrumb to show where the current page sits within the hierarchy of the website and to let users navigate between levels.`}),`
`,(0,y.jsx)(t.h3,{id:`when-not-to-use`,children:`When not to use`}),`
`,(0,y.jsx)(t.p,{children:`Don’t use a Breadcrumb on pages that contain forms.
It can distract users from completing the form, or be confused with a progress indicator.`}),`
`,(0,y.jsx)(t.p,{children:`A Breadcrumb should not have more than 5 items.`}),`
`,(0,y.jsx)(t.h3,{id:`how-to-write`,children:`How to write`}),`
`,(0,y.jsx)(t.p,{children:`The first item links to the home page, with ‘Home’ as its text.
This applies to Dutch websites as well.`}),`
`,(0,y.jsx)(t.h2,{id:`see-also`,children:`See also`}),`
`,(0,y.jsxs)(t.ul,{children:[`
`,(0,y.jsxs)(t.li,{children:[(0,y.jsx)(t.a,{href:`/docs/docs-developer-guide-routing-libraries--docs`,children:`Routing libraries`}),` – how to integrate links with external routing libraries.`]}),`
`]}),`
