...
`})}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsx(n.p,{children:"Note: for the symlink, the last argument in the above command cannot be a path, but can only be the file or directory name. I.e. you need to be in the directory where you want to make the symbolic link."}),`
`]}),`
`,e.jsxs(n.blockquote,{children:[`
...
`]}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Note: not all servers recognize the ",e.jsx(n.code,{children:".webmanifest"})," extension. See ",e.jsx(n.a,{href:"https://www.w3.org/TR/appmanifest/#using-a-link-element-to-link-to-a-manifest",rel:"nofollow",children:"Using a link element to link to a manifest on W3.org"})," for more information."]}),`
`]}),`
`,e.jsxs(n.p,{children:["Make sure that the Web Manifest, stating the app's name and referencing the PNG icons, is available in the same location. Edit the ",e.jsx(n.code,{children:"app.webmanifest"})," file to include the app's name and the icons you want to use. For example:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{
