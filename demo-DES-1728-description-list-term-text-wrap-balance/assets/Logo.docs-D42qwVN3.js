import{j as e}from"./iframe-DSh9TUeg.js";import{useMDXComponents as i}from"./index-DYDi9YyP.js";import{M as a,e as r,f as l,h,i as s}from"./blocks-CLt_TIkK.js";import{L as d,G as m,M as g,S as c,a as p,V as u,A as f,C as b}from"./Logo.stories-xZxRglRL.js";import{D as x}from"./DesignTokensTable-DQ61JG1s.js";import"./preload-helper-PPVm8Dsz.js";import"./index-brhMaa0_.js";import"./ExampleLogo-CStnP7QK.js";import"./BorderSample-C0ntnIkm.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-BsYqAUf8.js";import"./ColorSample-NILsQ8Oa.js";import"./SpaceSample-BrKcgq_r.js";import"./TypographySample-NiCgwSiH.js";const j=`<!-- @license CC0-1.0 -->
...
`,w={logo:{"block-size":{$value:"{ams.space.xl}",$type:"dimension"},"min-block-size":{$value:{value:2.5,unit:"rem"},$type:"dimension"},emblem:{color:{$value:"#ec0000",$type:"color"}},subsite:{color:{$value:"{ams.color.text.default}",$type:"color"}},title:{color:{$value:"#ec0000",$type:"color"}}}},k={ams:w};function t(o){const n={h2:"h2",h3:"h3",h4:"h4",p:"p",strong:"strong",...i(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
...
`,e.jsx(x,{tokens:k})]})}function _(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{_ as default};
