...
Try the `,(0,x.jsx)(r.code,{children:`locale`}),` control above to preview each language; see the `,(0,x.jsx)(r.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),` for the tested locales.`]}),`
`,(0,x.jsx)(r.p,{children:`If your app uses Calendar in multiple places with the same language, a small wrapper component avoids repeating these props:`}),`
`,(0,x.jsx)(r.pre,{children:(0,x.jsx)(r.code,{className:`language-tsx`,children:`import type { CalendarProps } from "@amsterdam/design-system-react";
...
For more details, see the `,(0,x.jsx)(r.a,{href:`/docs/docs-developer-guide-routing-libraries--docs`,children:`routing libraries developer guide`}),`.`]}),`
`,(0,x.jsxs)(r.p,{children:[`This example for a `,(0,x.jsx)(r.code,{children:`linkTemplate`}),` function produces links like `,(0,x.jsx)(r.code,{children:`?date=2026-12-04`}),` for December 4, 2026:`]}),`
`,`
...
For right-to-left scripts, give a custom icon a `,(0,x.jsx)(r.code,{children:`data-directional="true"`}),` attribute so it mirrors like the default chevrons; see the `,(0,x.jsx)(r.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),`.`]}),`
