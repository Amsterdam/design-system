import{j as r}from"./jsx-runtime-CKrituN3.js";import{R as c,n as d}from"./index.esm-B5ihbtz_.js";const p={title:"Forms/Switch",component:c,args:{disabled:!1},argTypes:{disabled:{control:"boolean"}}},e={args:{"aria-label":"Default"}},a={render:m=>r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"5rem"},children:[r.jsx(d,{htmlFor:"switch-with-label",children:"Label"}),r.jsx(c,{...m,id:"switch-with-label"})]})};var t,s,l;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    'aria-label': 'Default'
  }
