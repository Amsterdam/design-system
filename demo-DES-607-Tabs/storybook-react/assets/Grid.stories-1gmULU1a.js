import{G as r,j as e,v as F}from"./index.esm-FyDjFim0.js";/**
 * @license EUPL-1.2+
...
}`,...(G=(j=o.parameters)==null?void 0:j.docs)==null?void 0:G.source}}};var f,v,N;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...StoryTemplate,
  args: {
    children: Array.from(Array(6).keys()).map(i => <Grid.Cell className="amsterdam-docs-pink-box" span={4} key={i} />),
    gapVertical: 'small'
  }
}`,...(N=(v=l.parameters)==null?void 0:v.docs)==null?void 0:N.source}}};var V,D,z;t.parameters={...t.parameters,docs:{...(V=t.parameters)==null?void 0:V.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
