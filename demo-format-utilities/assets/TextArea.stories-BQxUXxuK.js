import{r as z,j as r,c as j,a4 as m,i as g,P as v,a5 as h}from"./iframe-Czx-_c1G.js";import{c as y}from"./exampleContent-D2tKGi5u.js";const a=z.forwardRef(({className:e,dir:b,invalid:x,resize:p,...u},f)=>r.jsx("textarea",{...u,"aria-invalid":x||void 0,className:j("ams-text-area",p&&`ams-text-area--resize-${p}`,u.cols&&"ams-text-area--cols",e),dir:b??"auto",ref:f}));a.displayName="TextArea";try{a.displayName="TextArea",a.__docgenInfo={description:"",displayName:"TextArea",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}},resize:{defaultValue:null,description:`Allows the user to resize the text box. The default is resizing in both directions.
Note: this feature is not fully supported in Safari on iOS.`,name:"resize",required:!1,type:{name:"enum",value:[{value:'"none"'},{value:'"horizontal"'},{value:'"vertical"'}]}}}}}catch{}const F=y(),A={title:"Components/Forms/Text Area",component:a,args:{defaultValue:F,disabled:!1,invalid:!1},argTypes:{cols:{control:{type:"number"},description:"The width, expressed in the average number of characters."},defaultValue:{table:{disable:!0}},disabled:{description:"Prevents interaction. Avoid if possible."},resize:{control:{labels:{horizontal:"horizontal",none:"none",undefined:"default",vertical:"vertical"},type:"radio"},options:[void 0,"none","horizontal","vertical"]},rows:{control:{type:"number"},description:"The number of lines to show"}}},i={},s={args:{resize:"vertical"}},o={args:{resize:"horizontal"}},t={args:{resize:"none"}},n={args:{invalid:!0}},d={args:{disabled:!0}},l={render:e=>r.jsxs(m,{invalid:e.invalid,children:[r.jsx(g,{htmlFor:"input1",children:"Label"}),r.jsx(v,{id:"description1",children:"Omschrijving."}),e.invalid&&r.jsx(h,{id:"error1",children:"Foutmelding."}),r.jsx(a,{"aria-describedby":`description1${e.invalid?" error1":""}`,id:"input1",...e})]})},c={args:{invalid:!0},render:e=>r.jsxs(m,{invalid:e.invalid,children:[r.jsx(g,{htmlFor:"input2",children:"Label"}),r.jsx(v,{id:"description2",children:"Omschrijving."}),e.invalid&&r.jsx(h,{id:"error2",children:"Foutmelding."}),r.jsx(a,{"aria-describedby":`description2${e.invalid?" error2":""}`,id:"input2",...e})]})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:"{}",...i.parameters?.docs?.source}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    resize: 'vertical'
  }
...
}`,...c.parameters?.docs?.source}}};const T=["Default","VerticalResize","HorizontalResize","NoResize","Invalid","Disabled","InAField","InAFieldWithValidation"],L=Object.freeze(Object.defineProperty({__proto__:null,Default:i,Disabled:d,HorizontalResize:o,InAField:l,InAFieldWithValidation:c,Invalid:n,NoResize:t,VerticalResize:s,__namedExportsOrder:T,default:A},Symbol.toStringTag,{value:"Module"}));export{d as D,o as H,n as I,t as N,a as T,s as V,L as a,l as b,c,A as m};
