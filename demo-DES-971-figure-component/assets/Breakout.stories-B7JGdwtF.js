import{j as e}from"./jsx-runtime-BjgbQsUx.js";import{s as P,t as w,P as m,I as g,u as S}from"./index.esm-CRlu2SWP.js";import{c as y}from"./clsx-B-dksMZM.js";import{r as V}from"./index-RigO-4kf.js";import{a as d,p as R}from"./paddingClasses-C5gheHLv.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const I=(r,o,t,n)=>[...d("ams-breakout__cell--col-span-",r),...d("ams-breakout__cell--col-start-",o),...d("ams-breakout__cell--row-span-",t),...d("ams-breakout__cell--row-start-",n)],N=V.forwardRef(({as:r="div",children:o,className:t,colSpan:n,colStart:c,has:u,rowSpan:p,rowStart:h,...z},q)=>e.jsx(r,{...z,ref:q,className:y("ams-breakout__cell",I(n,c,p,h),u&&`ams-breakout__cell--has-${u}`,t),children:o}));N.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(b=(B=s.parameters)==null?void 0:B.docs)==null?void 0:b.source}}};var x,_,j;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
...
}`,...(j=(_=i.parameters)==null?void 0:_.docs)==null?void 0:j.source}}};const G=["Default","WithCaption","VerticalLayout"],D=Object.freeze(Object.defineProperty({__proto__:null,Default:l,VerticalLayout:i,WithCaption:s,__namedExportsOrder:G,default:F},Symbol.toStringTag,{value:"Module"}));export{D as B,i as V,s as W};
