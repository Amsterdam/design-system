import{r as z,j as r,c as j,F as m,t as g,P as v,E as h}from"./iframe-BMyLMXlG.js";import{b as F}from"./exampleContent-DRope23M.js";const a=z.forwardRef(({className:e,dir:b,invalid:x,resize:p,...u},f)=>r.jsx("textarea",{...u,"aria-invalid":x||void 0,className:j("ams-text-area",p&&`ams-text-area--resize-${p}`,u.cols&&"ams-text-area--cols",e),dir:b??"auto",ref:f}));a.displayName="TextArea";try{a.displayName="TextArea",a.__docgenInfo={description:"",displayName:"TextArea",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}},resize:{defaultValue:null,description:`Allows the user to resize the text box. The default is resizing in both directions.
