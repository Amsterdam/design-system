import{j as r}from"./jsx-runtime-vNq4Oc-g.js";import{K as c,j as m}from"./index.esm-ysgW4aSw.js";const b={title:"Forms/Switch",component:c,argTypes:{disabled:{control:"boolean"}}},e={args:{"aria-label":"Default",disabled:!1}},a={render:d=>r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"5rem"},children:[r.jsx(m,{htmlFor:"switch-with-label",children:"Label"}),r.jsx(c,{...d,id:"switch-with-label"})]}),args:{disabled:!1}};var s,t,l;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    'aria-label': 'Default',
    disabled: false
  }
