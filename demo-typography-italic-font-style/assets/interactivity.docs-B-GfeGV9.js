import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-BqsN2jGA.js";import{l as n,m as r,v as i}from"./iframe-DKTKNzSI.js";import{t as a}from"./mdx-react-shim-CjEaAEVa.js";function o(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...i(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[`
`,`
`,(0,c.jsx)(n,{title:`Docs/Developer Guide/Interactivity`}),`
...
`,(0,c.jsxs)(t.p,{children:[`We use the CSS rule `,(0,c.jsx)(t.code,{children:`touch-action: manipulation`}),` on all interactive elements to prevent devices from unintentionally zooming in and out when clicking or tapping twice.`]})]})}function s(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(o,{...e})}):o(e)}var c;e((()=>{c=t(),a(),r()}))();export{s as default};