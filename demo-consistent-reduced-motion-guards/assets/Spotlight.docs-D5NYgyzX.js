import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,h as r,i,n as a,p as o,u as s}from"./blocks-CqryReaq.js";import{t as c}from"./jsx-runtime-Bq1bXGty.js";import{i as l}from"./react-BnCtKaSV.js";import{n as u,t as d}from"./DesignTokensTable-C1bLEtxW.js";import{t as f}from"./mdx-react-shim-9RzcSRdq.js";import{HighlightContent as p,n as m,t as h}from"./Spotlight.stories-JadPdJWw.js";var g,_,v=e((()=>{g={spotlight:{"background-color":{$value:`{ams.color.highlight.purple}`,$extensions:{"nl.amsterdam.type":`color`}},azure:{"background-color":{$value:`{ams.color.highlight.azure}`,$extensions:{"nl.amsterdam.type":`color`}}},green:{"background-color":{$value:`{ams.color.highlight.green}`,$extensions:{"nl.amsterdam.type":`color`}}},lime:{"background-color":{$value:`{ams.color.highlight.lime}`,$extensions:{"nl.amsterdam.type":`color`}}},magenta:{"background-color":{$value:`{ams.color.highlight.magenta}`,$extensions:{"nl.amsterdam.type":`color`}}},orange:{"background-color":{$value:`{ams.color.highlight.orange}`,$extensions:{"nl.amsterdam.type":`color`}}},yellow:{"background-color":{$value:`{ams.color.highlight.yellow}`,$extensions:{"nl.amsterdam.type":`color`}}}}},_={ams:g}}));function y(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components};return(0,x.jsxs)(x.Fragment,{children:[`
`,`
`,`
`,`
`,(0,x.jsx)(s,{of:h}),`
...
Select `,(0,x.jsx)(r.a,{href:`/docs/brand-design-tokens-colour--docs#pairing-foreground-with-background-colours`,children:`the correct colour`}),` for text and links against the background you choose.`]}),`
...
`,(0,x.jsxs)(r.p,{children:[`Which foreground colour to use depends on the highlight colour behind it.
Follow `,(0,x.jsx)(r.a,{href:`/docs/brand-design-tokens-colour--docs#pairing-foreground-with-background-colours`,children:`Pairing foreground with background colours`}),`.`]}),`
`,(0,x.jsxs)(r.p,{children:[`On a dark background, set `,(0,x.jsx)(r.code,{children:`color="inverse"`}),` on every Heading, Paragraph, and Link inside the Spotlight.
...
`,(0,x.jsxs)(r.p,{children:[(0,x.jsx)(r.code,{children:`as="aside"`}),` makes the Spotlight a complementary landmark, and `,(0,x.jsx)(r.code,{children:`as="section"`}),` makes it a region once it has an accessible name.
Point `,(0,x.jsx)(r.code,{children:`aria-labelledby`}),` at the `,(0,x.jsx)(r.code,{children:`id`}),` of the heading inside the Spotlight to name that landmark, so users of assistive technology can tell it apart from the other landmarks on the page.`]}),`
