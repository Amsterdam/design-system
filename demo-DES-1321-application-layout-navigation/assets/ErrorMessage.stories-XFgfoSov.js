import{w as p,x as d}from"./index.esm-BuHuBT3Q.js";import{j as o}from"./jsx-runtime-Cf8x2fCZ.js";import{c as u}from"./clsx-B-dksMZM.js";import{r as f}from"./index-G8LIXM5I.js";import{I as g}from"./Icon-BBW_x4VP.js";const s=f.forwardRef(({children:t,className:i,icon:n,prefix:c="Invoerfout",...m},l)=>o.jsxs("p",{...m,className:u("ams-error-message",i),ref:l,children:[o.jsx(g,{size:"small",svg:n||p}),o.jsxs("span",{className:"ams-visually-hidden",children:[c,": "]}),t]}));s.displayName="ErrorMessage";try{s.displayName="ErrorMessage",s.__docgenInfo={description:"",displayName:"ErrorMessage",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"Function"}},prefix:{defaultValue:{value:"Invoerfout"},description:"An accessible phrase that screen readers announce before the error message. Should translate to something like ‘input error’.",name:"prefix",required:!1,type:{name:"string"}}}}}catch{}/**
 * @license EUPL-1.2+
