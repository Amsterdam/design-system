import{j as e}from"./jsx-runtime-CKrituN3.js";import{i as F}from"./decorators-CJr_2w8M.js";import{f as J}from"./exampleContent-CRK3_7Hv.js";import{c as G}from"./clsx-B-dksMZM.js";import{r as R}from"./index-CBqU2yxZ.js";import{H as h}from"./Heading-DWMBrRCk.js";import{P as t}from"./Paragraph-XcXe9TCG.js";const Z=R.forwardRef(({children:s,className:a,...g},p)=>e.jsx("li",{ref:p,className:G("ams-ordered-list__item",a),...g,children:s}));Z.displayName="OrderedList.Item";try{OrderedList.Item.displayName="OrderedList.Item",OrderedList.Item.__docgenInfo={description:"",displayName:"OrderedList.Item",props:{}}}catch{}const q=R.forwardRef(({children:s,className:a,inverseColor:g,size:p,markers:M=!0,...V},$)=>e.jsx("ol",{ref:$,className:G("ams-ordered-list",g&&"ams-ordered-list--inverse-color",!M&&"ams-ordered-list--no-markers",p&&`ams-ordered-list--${p}`,a),...V,children:s}));q.displayName="OrderedList";const r=Object.assign(q,{Item:Z});try{r.displayName="OrderedList",r.__docgenInfo={description:"",displayName:"OrderedList",props:{markers:{defaultValue:{value:"true"},description:"",name:"markers",required:!1,type:{name:"boolean"}},inverseColor:{defaultValue:null,description:"Changes the text color for readability on a dark background.",name:"inverseColor",required:!1,type:{name:"boolean"}},size:{defaultValue:null,description:"The size of the ordered list",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'},{value:'"large"'}]}}}}}catch{}const K=J().map((s,a)=>e.jsx(r.Item,{children:s},a)),Q={title:"Components/Text/Ordered List",component:r,args:{children:K,inverseColor:!1,markers:void 0,reversed:void 0,start:void 0},argTypes:{reversed:{control:"boolean"},start:{control:"number"}},decorators:[F]},d={},n={args:{size:"small"}},i={args:{size:"large"}},o={render:s=>e.jsxs(r,{...s,children:[e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]}),e.jsxs(r.Item,{children:["Stadsdeel Nieuw-West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"De Aker, Sloten en Nieuw Sloten"}),e.jsx(r.Item,{children:"Geuzenveld, Slotermeer en Sloterdijken"}),e.jsx(r.Item,{children:"Osdorp"}),e.jsx(r.Item,{children:"Slotervaart"})]})]})]})},l={args:{children:[e.jsx(r.Item,{children:"Zes"},6),e.jsx(r.Item,{children:"Zeven"},7),e.jsx(r.Item,{children:"Acht"},8)],start:6}},m={args:{children:[e.jsx(r.Item,{children:"Drie"},3),e.jsx(r.Item,{children:"Twee"},2),e.jsx(r.Item,{children:"Eén"},1)],reversed:!0,start:3}},c={args:{children:[e.jsxs(r.Item,{children:[e.jsx(h,{size:"level-4",children:"Weg met steen, hallo extra groen en koelte"}),e.jsx(t,{children:"Sinds 2021 kwamen er maar liefst 60 nieuwe groene plekken bij in de stad. Groen is fijn en het verkoelt de stad in de zomer. Een paar voorbeelden."}),e.jsx(t,{size:"small",children:"16 augustus 2023"})]},1),e.jsxs(r.Item,{children:[e.jsx(h,{size:"level-4",children:"Amsterdam bindt de strijd aan met lawaaierige voertuigen"}),e.jsx(t,{children:"Deze zomer testen we of digitale borden langs de weg kunnen helpen om geluidsoverlast van voertuigen zoals motoren en auto’s tegen te gaan."}),e.jsx(t,{size:"small",children:"10 augustus 2023"})]},2),e.jsxs(r.Item,{children:[e.jsx(h,{size:"level-4",children:"Een prachtroute door de wonderlijke Baarsjes"}),e.jsx(t,{children:"In de Baarsjes zijn kunst en cultuur met elkaar vervlochten. We zetten een prachtige wandelroute voor u uit en laten zien hoe het was en hoe het nu is."}),e.jsx(t,{size:"small",children:"8 augustus 2023"})]},3)],markers:!1}},u={args:{inverseColor:!0},render:s=>e.jsx(r,{...s,children:e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]})})};var I,O,L;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:"{}",...(L=(O=d.parameters)==null?void 0:O.docs)==null?void 0:L.source}}};var j,v,x;n.parameters={...n.parameters,docs:{...(j=n.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    size: 'small'
  }
...
}`,...(y=(w=o.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};var _,b,W;l.parameters={...l.parameters,docs:{...(_=l.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
...
}`,...(W=(b=l.parameters)==null?void 0:b.docs)==null?void 0:W.source}}};var D,N,P;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
...
}`,...(P=(N=m.parameters)==null?void 0:N.docs)==null?void 0:P.source}}};var B,C,E;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
...
}`,...(E=(C=c.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};var T,H,A;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    inverseColor: true
  },
  render: args => <OrderedList {...args}>
...
}`,...(A=(H=u.parameters)==null?void 0:H.docs)==null?void 0:A.source}}};const U=["Default","Small","Large","TwoLevels","StartingNumber","DescendingNumbers","WithoutMarkers","InverseColor"],de=Object.freeze(Object.defineProperty({__proto__:null,Default:d,DescendingNumbers:m,InverseColor:u,Large:i,Small:n,StartingNumber:l,TwoLevels:o,WithoutMarkers:c,__namedExportsOrder:U,default:Q},Symbol.toStringTag,{value:"Module"}));export{m as D,u as I,i as L,de as O,n as S,o as T,c as W,l as a};
