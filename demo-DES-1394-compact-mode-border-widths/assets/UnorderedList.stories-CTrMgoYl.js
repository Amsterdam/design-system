import{r as g,j as e,c as h,g as n,a2 as L,P as a,a3 as U,a4 as k,a5 as S,w as f,l as N,a6 as P,x as y}from"./iframe-BRVb4hR1.js";import{i as _}from"./exampleContent-B7cDFRSs.js";const j=g.forwardRef(({children:s,className:l,...c},I)=>e.jsx("li",{className:h("ams-unordered-list__item",l),ref:I,...c,children:s}));j.displayName="UnorderedList.Item";try{UnorderedList.Item.displayName="UnorderedList.Item",UnorderedList.Item.__docgenInfo={description:"",displayName:"UnorderedList.Item",props:{}}}catch{}const u=g.forwardRef(({children:s,className:l,color:c,markers:I=!0,size:p,...v},x)=>e.jsx("ul",{className:h("ams-unordered-list",c&&`ams-unordered-list--${c}`,!I&&"ams-unordered-list--no-markers",p&&`ams-unordered-list--${p}`,l),ref:x,...v,children:s}));u.displayName="UnorderedList";const r=Object.assign(u,{Item:j});try{r.displayName="UnorderedList",r.__docgenInfo={description:"",displayName:"UnorderedList",props:{color:{defaultValue:null,description:"Changes the text colour for readability on a dark background.",name:"color",required:!1,type:{name:"enum",value:[{value:'"inverse"'}]}},markers:{defaultValue:{value:"true"},description:"Whether the list items show a marker.",name:"markers",required:!1,type:{name:"boolean"}},size:{defaultValue:null,description:"The size of the text.",name:"size",required:!1,type:{name:"enum",value:[{value:'"small"'}]}}}}}catch{}const W=_().map(s=>e.jsx(r.Item,{children:s},s)),b={title:"Components/Text/Unordered List",component:r,args:{children:W,markers:void 0},argTypes:{size:{control:{labels:{small:"small",undefined:"medium"},type:"radio"},options:["small",void 0]}}},d={},t={render:s=>e.jsxs(r,{...s,children:[e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]}),e.jsxs(r.Item,{children:["Stadsdeel Nieuw-West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"De Aker, Sloten en Nieuw Sloten"}),e.jsx(r.Item,{children:"Geuzenveld, Slotermeer en Sloterdijken"}),e.jsx(r.Item,{children:"Osdorp"}),e.jsx(r.Item,{children:"Slotervaart"})]})]})]})},o={args:{children:[e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(L,{})}),e.jsx(a,{children:"Stadsloket: locaties en openingstijden"})]})},1),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(U,{})}),e.jsx(a,{children:"Parkeren + Reizen (P+R)"})]})},2),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(k,{})}),e.jsx(a,{children:"Paspoort, ID-kaart en Rijbewijs"})]})},3),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(S,{})}),e.jsx(a,{children:"Gemeentebelastingen"})]})},4),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(f,{})}),e.jsx(a,{children:"Melding openbare ruimte en overlast"})]})},5),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(N,{})}),e.jsx(a,{children:"Verhuizing doorgeven"})]})},6),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(P,{})}),e.jsx(a,{children:"Grof afval"})]})},7),e.jsx(r.Item,{children:e.jsxs("div",{className:"ams-docs-card",children:[e.jsx(n,{svg:e.jsx(y,{})}),e.jsx(a,{children:"Kennisgevingen en bekendmakingen"})]})},8)],markers:!1}},i={args:{color:"inverse"},render:s=>e.jsx(r,{...s,children:e.jsxs(r.Item,{children:["Stadsdeel West",e.jsxs(r,{...s,children:[e.jsx(r.Item,{children:"Bos en Lommer"}),e.jsx(r.Item,{children:"Oud West / De Baarsjes"}),e.jsx(r.Item,{children:"Westerpark"})]})]})})},m={args:{size:"small"}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:"{}",...d.parameters?.docs?.source}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source}}};const M=["Default","TwoLevels","WithoutMarkers","InverseColor","SmallText"],D=Object.freeze(Object.defineProperty({__proto__:null,Default:d,InverseColor:i,SmallText:m,TwoLevels:t,WithoutMarkers:o,__namedExportsOrder:M,default:b},Symbol.toStringTag,{value:"Module"}));export{i as I,m as S,t as T,D as U,o as W};
