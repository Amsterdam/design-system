import{j as h}from"./jsx-runtime-Cf8x2fCZ.js";import{c as g}from"./clsx-B-dksMZM.js";import{r as f}from"./index-G8LIXM5I.js";const t=f.forwardRef(({className:a,length:o,maxLength:n,...d},i)=>h.jsx("div",{...d,className:g("ams-character-count",o>n&&"ams-character-count--error",a),ref:i,role:"status",children:`${o} van ${n} tekens`}));t.displayName="CharacterCount";try{t.displayName="CharacterCount",t.__docgenInfo={description:"",displayName:"CharacterCount",props:{length:{defaultValue:null,description:"The current length of the field’s value.",name:"length",required:!0,type:{name:"number"}},maxLength:{defaultValue:null,description:"The maximum length of the field’s value.",name:"maxLength",required:!0,type:{name:"number"}}}}}catch{}/**
 * @license EUPL-1.2+
