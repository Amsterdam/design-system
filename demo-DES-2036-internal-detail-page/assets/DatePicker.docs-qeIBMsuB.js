...
`,(0,w.jsxs)(r.li,{children:[`Use a `,(0,w.jsx)(r.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),` when a single form field with the browser’s own date control is enough.`]}),`
`,(0,w.jsxs)(r.li,{children:[`Use a `,(0,w.jsx)(r.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),` when the user knows the exact date, such as a date of birth, and no calendar is needed.`]}),`
...
Try the `,(0,w.jsx)(r.code,{children:`locale`}),` control above to preview each language; see the `,(0,w.jsx)(r.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`localisation guide`}),` for the tested locales.`]}),`
`,(0,w.jsxs)(r.p,{children:[`If your app uses Date Picker in multiple places with the same language, a small wrapper component avoids repeating these props; the `,(0,w.jsx)(r.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`Localisation guide`}),` shows an example.`]}),`
`,(0,w.jsx)(r.h2,{id:`design`,children:`Design`}),`
`,(0,w.jsxs)(r.p,{children:[`The Date Picker is intentionally an inline component.
...
If the layout truly has no room, placing the Date Picker inside a `,(0,w.jsx)(r.a,{href:`/docs/components-containers-modal-dialog--docs`,children:`Modal Dialog`}),` is an acceptable last resort.`]}),`
...
For right-to-left scripts, give a custom icon a `,(0,w.jsx)(r.code,{children:`data-directional="true"`}),` attribute so it mirrors like the default chevrons; see the `,(0,w.jsx)(r.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`localisation guide`}),`.`]}),`
`,(0,w.jsx)(r.h2,{id:`design-1`,children:`Design`}),`
...
`,(0,w.jsxs)(r.ul,{children:[`
`,(0,w.jsxs)(r.li,{children:[(0,w.jsx)(r.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),` – lets the user pick a date with the browser’s own control.`]}),`
`,(0,w.jsxs)(r.li,{children:[(0,w.jsx)(r.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),` – lets the user type a date they know by heart, one part per field.`]}),`
