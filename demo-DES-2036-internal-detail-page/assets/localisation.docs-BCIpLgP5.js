...
`,(0,c.jsxs)(t.p,{children:[`It also applies to a `,(0,c.jsx)(t.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),`, where a wrapper sets the labels and the order of the fields:`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-tsx`,children:`import type { KnownDateInputProps } from "@amsterdam/design-system-react";

import { KnownDateInput } from "@amsterdam/design-system-react";

const AmericanKnownDateInput = (props: KnownDateInputProps) => (
  <KnownDateInput {...props}>
    <KnownDateInput.Month label="Month" />
    <KnownDateInput.Day label="Day" />
    <KnownDateInput.Year label="Year" />
  </KnownDateInput>
);
`})}),`
...
`,(0,c.jsxs)(t.p,{children:[`The `,(0,c.jsx)(t.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),` has the same limitation: it wraps `,(0,c.jsx)(t.code,{children:`<input type="date">`}),`, so the browser decides the order of its day, month and year segments from its own locale, not from `,(0,c.jsx)(t.code,{children:`lang`}),`.
The `,(0,c.jsx)(t.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),` has no such control to render, so it has no such limitation.
Its day, month and year are separate fields that appear in the order you place them in markup, so you set that order yourself to match the language you write the surrounding labels in.`]}),`
...
When you supply your own directional icon anywhere, give it the same attribute so it mirrors as well.`]})]})}function s(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(o,{...e})}):o(e)}var c;function l(){return(l=e((()=>{c=r(),a(),t()})))()}l();export{s as default};