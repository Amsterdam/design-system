import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-ATHzeHXA.js";import{V as n,Z as r}from"./index.esm-DcQRYqjl.js";import{C as i,V as a,_ as o,c as s,et as c,k as l,n as u,p as d,rt as f,tt as p}from"./index.esm-C9Use5x8.js";import{n as m,t as h}from"./ModalDialog-C97fbH3J.js";import{a as g,o as _}from"./ModalDialog.stories-CNx7TOrG.js";var v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{f(),r(),m(),g(),v=t(),{expect:y,within:b}=__STORYBOOK_MODULE_TEST__,x={..._,title:`Components/Containers/Modal Dialog`},S=e=>{e&&!e.open&&e.show()},C={position:`static`},w={...C,"--ams-modal-dialog-max-block-size":`12rem`,"--ams-modal-dialog-vi-medium-max-block-size":`12rem`},T=`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 7 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`,E={play:async({canvas:e,userEvent:t})=>{let n=e.getByRole(`button`,{name:`Open de interactietest`});await t.click(n);let r=e.getByTestId(`interaction-dialog`);await y(r).toBeVisible();let i=b(r).getByRole(`button`,{name:`Sluiten`});await y(i).toHaveFocus(),await t.click(i),await y(r).not.toBeVisible(),await y(n).toHaveFocus(),await t.click(n),await t.click(b(r).getByRole(`button`,{name:`Stoppen`})),await y(r).not.toBeVisible()},render:()=>(0,v.jsxs)(v.Fragment,{children:[(0,v.jsxs)(`div`,{className:`_ams-tests-stack`,children:[(0,v.jsxs)(h,{"aria-labelledby":`test-form-heading`,ref:S,style:C,children:[(0,v.jsx)(h.Header,{children:(0,v.jsx)(i,{id:`test-form-heading`,level:1,size:`level-2`,children:`Notitie toevoegen`})}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(`form`,{method:`dialog`,children:(0,v.jsxs)(d,{gap:`small`,children:[(0,v.jsxs)(o,{children:[(0,v.jsx)(l,{htmlFor:`test-note-subject`,children:`Onderwerp`}),(0,v.jsx)(p,{id:`test-note-subject`})]}),(0,v.jsxs)(o,{children:[(0,v.jsx)(l,{htmlFor:`test-note-text`,children:`Notitie`}),(0,v.jsx)(c,{id:`test-note-text`,rows:3})]})]})})}),(0,v.jsx)(h.Footer,{children:(0,v.jsxs)(u,{children:[(0,v.jsx)(s,{children:`Opslaan`}),(0,v.jsx)(s,{variant:`secondary`,children:`Annuleren`})]})})]}),(0,v.jsxs)(h,{"aria-labelledby":`test-subtitle-heading`,ref:S,style:C,children:[(0,v.jsxs)(h.Header,{children:[(0,v.jsx)(i,{id:`test-subtitle-heading`,level:1,size:`level-2`,children:`Reactie versturen`}),(0,v.jsx)(a,{size:`small`,children:`Plan Nieuw-West, fase 2`})]}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(a,{children:`Controleer uw gegevens voordat u uw reactie verstuurt.`})}),(0,v.jsx)(h.Footer,{children:(0,v.jsx)(s,{children:`Sluiten`})})]}),(0,v.jsxs)(h,{"aria-labelledby":`test-custom-icon-heading`,ref:S,style:C,children:[(0,v.jsx)(h.Header,{closeButtonIcon:n,children:(0,v.jsx)(i,{id:`test-custom-icon-heading`,level:1,size:`level-2`,children:`Melding versturen`})}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(a,{children:`Wij nemen uw melding binnen één werkdag in behandeling.`})})]}),(0,v.jsxs)(h,{"aria-labelledby":`test-long-heading-heading`,ref:S,style:{...C,maxInlineSize:`24rem`},children:[(0,v.jsx)(h.Header,{children:(0,v.jsx)(i,{id:`test-long-heading-heading`,level:1,size:`level-2`,children:`Een lange kop die over meerdere regels doorloopt naast de sluitknop`})}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(a,{children:`De sluitknop hoort naast de eerste regel van de kop te staan.`})})]}),(0,v.jsxs)(h,{"aria-labelledby":`test-short-window-heading`,ref:S,style:w,children:[(0,v.jsx)(h.Header,{children:(0,v.jsx)(i,{id:`test-short-window-heading`,level:1,size:`level-2`,children:`Een dialoogvenster in een verticaal krap venster`})}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(a,{children:T})}),(0,v.jsx)(h.Footer,{children:(0,v.jsx)(s,{children:`Sluiten`})})]})]}),(0,v.jsx)(s,{onClick:()=>h.open(`#test-interactions`),children:`Open de interactietest`}),(0,v.jsxs)(h,{"aria-labelledby":`test-interactions-heading`,"data-testid":`interaction-dialog`,id:`test-interactions`,children:[(0,v.jsx)(h.Header,{children:(0,v.jsx)(i,{id:`test-interactions-heading`,level:1,size:`level-2`,children:`De gegevens zijn opgeslagen`})}),(0,v.jsx)(h.Body,{children:(0,v.jsx)(a,{children:`U ontvangt een bevestiging per e-mail.`})}),(0,v.jsx)(h.Footer,{children:(0,v.jsx)(s,{onClick:h.close,children:`Stoppen`})})]})]}),tags:[`!dev`,`!autodocs`,`!manifest`]},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvas,
    userEvent
  }) => {
