...
`,(0,A.jsx)(r.p,{children:`A field that cannot (yet) be used takes a grey background, and its value greys out with it.
...
`,(0,A.jsxs)(r.p,{children:[`A Text Input fills the width of whatever holds it unless a `,(0,A.jsx)(r.code,{children:`size`}),` is given, and never grows past it.
...
`,(0,A.jsx)(r.p,{children:`The border is two pixels and the corners are square.
...
`,(0,A.jsx)(r.p,{children:`An invalid field turns its border red, and a disabled one greys its background rather than its border.
The two states are told apart by which part changes, so neither is read as the other at a glance.`}),`
`,(0,A.jsxs)(r.p,{children:[`The text inside the field is the size of body text with a tighter line height, and its padding is the same as a `,(0,A.jsx)(r.a,{href:`/docs/components-buttons-button--docs`,children:`Button`}),`’s.
...
`,(0,A.jsxs)(r.p,{children:[`A Text Input renders an `,(0,A.jsx)(r.code,{children:`input`}),` element, so it is announced with its type, its label, and anything `,(0,A.jsx)(r.code,{children:`aria-describedby`}),` points at.`]}),`
`,(0,A.jsxs)(r.p,{children:[`The invalid styling responds to `,(0,A.jsx)(r.code,{children:`aria-invalid="true"`}),` and to the browser’s own `,(0,A.jsx)(r.code,{children:`:invalid`}),` state alike.
The second matches as soon as the page loads for a field that is `,(0,A.jsx)(r.code,{children:`required`}),` and empty, so a form that leans on it marks its fields red before anyone has typed; set `,(0,A.jsx)(r.code,{children:`aria-invalid`}),` from your own validation to control when that happens.`]}),`
`,(0,A.jsx)(r.p,{children:`A disabled field is greyed and removed from the tab order, which is why ‘When not to use’ lists alternatives to it rather than treating it as an ordinary state.`}),`
`,(0,A.jsx)(r.p,{children:`Placeholder text is styled but not recommended, and it is not a label: it disappears on the first keystroke and is not reliably announced.
...
`,(0,A.jsxs)(r.li,{children:[(0,A.jsx)(r.a,{href:`/docs/components-forms-known-date-input--docs`,children:`Known Date Input`}),` – for a date the user knows by heart, in a Text Input per part.`]}),`
...
`,(0,A.jsx)(f,{tokens:E})]})}function k(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,A.jsx)(t,{...e,children:(0,A.jsx)(O,{...e})}):O(e)}var A;function j(){return(j=e((()=>{A=c(),u(),r(),d(),D(),g()})))()}j();export{k as default};