import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./react-B6tGW3fj.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{C as i,G as a,S as o,V as s,d as c,q as l,rt as u}from"./index.esm-DY-3wTRx.js";import{n as d,r as f,t as p}from"./commonMeta-DPxz3GVj.js";var m=t({Default:()=>T,Loaded:()=>D,Loading:()=>E,__namedExportsOrder:()=>O,default:()=>b}),h,g,_,v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{u(),h=n(),d(),g=r(),_=`woningbouw`,v=[{description:`Een levendige, groene en duurzame woonbuurt tussen de Gooiseweg en het Nelson Mandelapark.`,heading:`Nederlands eerste houten woonwijk komt in Zuidoost`,imageSrc:`https://picsum.photos/id/1015/640/360`},{description:`De komende jaren bouwt de gemeente duizenden nieuwe woningen in stadsdeel Noord.`,heading:`Meer betaalbare woningen in Noord`,imageSrc:`https://picsum.photos/id/1016/640/360`},{description:`Havenstad groeit uit tot een gemengd stadsgebied met ruimte om te wonen en te werken.`,heading:`Woningbouwplannen Havenstad`,imageSrc:`https://picsum.photos/id/1029/640/360`},{description:`Bekijk hoe u zich inschrijft en wat de wachttijden zijn voor een sociale huurwoning.`,heading:`Sneller een sociale huurwoning`,imageSrc:`https://picsum.photos/id/1039/640/360`},{description:`Subsidies en advies om uw huis te isoleren en van het gas af te gaan.`,heading:`Verduurzaam uw woning`,imageSrc:`https://picsum.photos/id/1043/640/360`},{description:`Op het Zeeburgereiland verrijst een hoogstedelijke buurt met hoge woontorens.`,heading:`Nieuwbouw in de Sluisbuurt`,imageSrc:`https://picsum.photos/id/1044/640/360`}],y={narrow:4,medium:4,wide:4},b={...p,title:`Pages/Public/Loading Page`,args:{initialPhase:`idle`},argTypes:{initialPhase:{table:{disable:!0}}},parameters:f(`Shows how a page behaves while it fetches its content, keeping the layout stable as placeholders make way for the real results.`),render:({initialPhase:e})=>{let[t,n]=(0,h.useState)(e),[r,u]=(0,h.useState)(_),d=(0,h.useRef)(null);(0,h.useEffect)(()=>()=>{d.current&&clearTimeout(d.current)},[]);let f=e=>{e.preventDefault();let t=new FormData(e.currentTarget).get(`search`);typeof t==`string`&&t.trim()&&u(t.trim()),d.current&&clearTimeout(d.current),n(`loading`),d.current=setTimeout(()=>n(`loaded`),3e3)},p=t===`loading`?`Zoekresultaten voor ‘${r}’ worden geladen`:t===`loaded`?`${v.length} resultaten voor ‘${r}’ gevonden`:``;return(0,g.jsxs)(`main`,{id:`inhoud`,children:[(0,g.jsx)(o,{paddingTop:`large`,children:(0,g.jsxs)(o.Cell,{className:`ams-prose`,span:{narrow:4,medium:6,wide:6},children:[(0,g.jsx)(i,{level:1,children:`Zoeken op amsterdam.nl`}),(0,g.jsxs)(a,{onSubmit:f,children:[(0,g.jsx)(a.Input,{defaultValue:_,label:`Zoek op de website`,name:`search`}),(0,g.jsx)(a.Button,{})]})]})}),(0,g.jsxs)(o,{"aria-busy":t===`loading`,paddingBottom:`2x-large`,paddingTop:`2x-large`,children:[(0,g.jsxs)(o.Cell,{span:`all`,children:[(0,g.jsx)(`p`,{className:`ams-visually-hidden`,role:`status`,children:p}),t===`idle`&&(0,g.jsx)(s,{children:`Klik op de zoekknop om de resultaten te laden.`}),t===`loaded`&&(0,g.jsx)(i,{level:2,size:`level-3`,children:`${v.length} resultaten voor ‘${r}’`})]}),t===`loading`&&v.map((e,t)=>(0,g.jsx)(o.Cell,{span:y,children:(0,g.jsxs)(l,{children:[(0,g.jsx)(l.Image,{}),(0,g.jsx)(l.Heading,{}),(0,g.jsx)(l.Paragraph,{lines:2})]})},t)),t===`loaded`&&v.map(e=>(0,g.jsx)(o.Cell,{span:y,children:(0,g.jsxs)(c,{children:[(0,g.jsx)(c.Image,{alt:``,aspectRatio:`16:9`,src:e.imageSrc}),(0,g.jsx)(c.Heading,{level:3,children:(0,g.jsx)(c.Link,{href:`#`,children:e.heading})}),(0,g.jsx)(s,{children:e.description})]})},e.heading))]})]})}},x=({busy:e,extraCells:t=``,status:n,statusCell:r=``})=>`// The Skip Link in the Page Layout targets this id, so the next Tab press lands in the main content.
...
<main id="inhoud">
  ...
  <Grid aria-busy={${e}} paddingBottom="2x-large" paddingTop="2x-large">
    ...
    {/* … five more Cards, in the same cells the Skeletons occupied … */}`,status:`6 resultaten voor ‘woningbouw’ gevonden`,statusCell:`
      <Heading level={2} size="level-3">6 resultaten voor ‘woningbouw’</Heading>`}),T={parameters:{docs:{source:{code:S,language:`tsx`}}}},E={args:{initialPhase:`loading`},parameters:{docs:{source:{code:C,language:`tsx`}}}},D={args:{initialPhase:`loaded`},parameters:{docs:{source:{code:w,language:`tsx`}}}},O=[`Default`,`Loading`,`Loaded`],T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: idleSource,
...
}`,...D.parameters?.docs?.source}}}})))()}export{k as n,m as t};