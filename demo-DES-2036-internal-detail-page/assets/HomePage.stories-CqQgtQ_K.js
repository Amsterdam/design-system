import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{C as r,S as i,V as a,rt as o}from"./index.esm-DY-3wTRx.js";import{n as s,r as c,t as l}from"./commonMeta-CSU6JFTe.js";import{f as u,g as d}from"./exampleContent-DRei7MoO.js";var f=t({Default:()=>_,__namedExportsOrder:()=>v,default:()=>g}),p,m,h,g,_,v;function y(){return(y=e((()=>{o(),d(),s(),p=n(),m=u(),h=u(),g={...l,title:`Pages/Internal/Home Page`,parameters:c(`The entry point of an internal website, such as a backoffice system. This example concentrates on the overall page layout rather than any particular content.`),render:e=>(0,p.jsxs)(i,{paddingVertical:`x-large`,children:[(0,p.jsx)(i.Cell,{appearance:`transparent`,span:`all`,children:(0,p.jsx)(r,{level:1,children:`Titel van de pagina`})}),(0,p.jsx)(i.Cell,{span:{narrow:4,medium:5,wide:8},style:{blockSize:`12rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:1,medium:3,wide:4},style:{blockSize:`10rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:3,medium:3,wide:3},children:(0,p.jsx)(a,{children:m})}),(0,p.jsx)(i.Cell,{span:{narrow:4,medium:5,wide:9},children:(0,p.jsx)(a,{children:h})}),(0,p.jsx)(i.Cell,{span:{narrow:2,medium:3,wide:6},style:{blockSize:`8rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:2,medium:3,wide:6},style:{blockSize:`8rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:3,medium:2,wide:4},style:{blockSize:`6rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:1,medium:4,wide:4},style:{blockSize:`8rem`}}),(0,p.jsx)(i.Cell,{span:{narrow:4,medium:4,wide:4},style:{blockSize:`6rem`}})]})},_={parameters:{docs:{source:{code:`<Grid paddingVertical="x-large">
  {/*
...
</Grid>`,language:`tsx`}}}},v=[`Default`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,..._.parameters?.docs?.source}}}})))()}export{y as n,f as t};