import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{B as r,C as i,G as a,K as o,P as s,S as c,V as l,_ as u,c as d,d as f,f as p,k as m,o as h,p as g,rt as _,v}from"./index.esm-Dbw1PAJ4.js";import{_ as y,g as b,t as x,v as S}from"./exampleContent-DRei7MoO.js";import{n as C,r as w,t as T}from"./commonMeta-2OEjURf9.js";import{t as E}from"./formatFieldValue-D9hm7vmg.js";var D=t({Default:()=>z,__namedExportsOrder:()=>B,default:()=>R}),O,k,A,j,M,N,P,F,I,L,R,z,B;function V(){return(V=e((()=>{_(),b(),C(),O=n(),k=`tramspoor`,A=[`Achtergrond`],j=[`Centrum`,`Noord`,`Oost`],M=12,N=2,P=new Intl.ListFormat(`nl`,{style:`long`,type:`conjunction`}),F=e=>P.format(e.map(e=>`‘${e}’`)),I=j.length===1?F(j):`de stadsdelen ${F(j)}`,L=`${M} resultaten gevonden voor ‘${k}’ met soort nieuws ${F(A)} en ${I}.`,R={...T,title:`Pages/Public/News Overview Page`,parameters:w(`Lists content items that a visitor narrows down with filters: news, blogs, vacancies, activities, or search results.`)},z={parameters:{docs:{source:{code:`<>
