import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{C as r,S as i,V as a,X as o,a as s,rt as c}from"./index.esm-A0TpI1De.js";import{i as l,n as u,r as d,t as f}from"./Spotlight-Dp00IPqW.js";import{g as p,p as m}from"./exampleContent-DRei7MoO.js";import{i as h,t as g}from"./decorators-B3LaFONZ.js";import{f as _,i as v,t as y}from"./argTypes-Diu0Wtb4.js";import{n as b,t as x}from"./useIsCompactTheme-Lkm9dUAp.js";var S=t({Default:()=>E,HighlightContent:()=>D,__namedExportsOrder:()=>O,default:()=>T}),C,w,T,E,D,O;function k(){return(k=e((()=>{c(),u(),_(),g(),p(),x(),C=n(),w=m(),T={title:`Components/Containers/Spotlight`,component:f,argTypes:{as:y(l),color:v(d,`purple`)},decorators:[h],parameters:{layout:`fullscreen`}},E={render:({as:e,color:t})=>{let n=b();return(0,C.jsx)(f,{as:e,color:t,children:(0,C.jsx)(i,{paddingVertical:`x-large`,children:(0,C.jsx)(i.Cell,{appearance:n?`transparent`:void 0,span:`all`,children:(0,C.jsx)(s,{color:!t||[`azure`,`green`,`magenta`].includes(t)?`inverse`:void 0,children:w})})})})}},D={args:{color:`green`},render:({color:e})=>{let t=b(),n=[`lime`,`orange`,`yellow`],s=n.includes(e)?void 0:`inverse`,c=n.includes(e)?`contrast`:`inverse`;return(0,C.jsx)(f,{color:e,children:(0,C.jsx)(i,{paddingVertical:`x-large`,children:(0,C.jsxs)(i.Cell,{appearance:t?`transparent`:void 0,className:`ams-prose`,span:{narrow:4,medium:5,wide:7},children:[(0,C.jsx)(r,{color:s,level:2,size:`level-3`,children:`Steun geven aan een partij`}),(0,C.jsx)(a,{color:s,children:`Van 19 januari tot en met 2 februari kunt u uw steun geven aan een partij voor de gemeenteraad of een stadsdeel- of bestuurscommissie. Dit doet u met een ondersteuningsverklaring.`}),(0,C.jsx)(o,{color:c,href:`#`,children:`Ondersteuningsverklaring inleveren`})]})})})}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  render: ({
    as,
    color
  }) => {
