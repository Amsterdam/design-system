...
`,(0,c.jsxs)(t.p,{children:[`Below the page title, a `,(0,c.jsx)(t.a,{href:`/docs/components-text-heading--docs#sections-and-blocks`,children:`Heading`}),` that introduces a section keeps the size of its level, and one that introduces a single block takes a `,(0,c.jsx)(t.code,{children:`size`}),` one step smaller.
