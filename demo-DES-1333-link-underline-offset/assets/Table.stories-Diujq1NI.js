import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{c as s}from"./clsx-B-dksMZM.js";import{r as n}from"./index-G8LIXM5I.js";const b=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("tbody",{...o,className:s("ams-table__body",r),ref:d,children:a}));b.displayName="Table.Body";try{Table.Body.displayName="Table.Body",Table.Body.__docgenInfo={description:"",displayName:"Table.Body",props:{}}}catch{}const i=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("caption",{...o,className:s("ams-table__caption",r),ref:d,children:a}));i.displayName="Table.Caption";try{Table.Caption.displayName="Table.Caption",Table.Caption.__docgenInfo={description:"",displayName:"Table.Caption",props:{}}}catch{}const T=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("td",{...o,className:s("ams-table__cell",r),ref:d,children:a}));T.displayName="Table.Cell";try{Table.Cell.displayName="Table.Cell",Table.Cell.__docgenInfo={description:"",displayName:"Table.Cell",props:{}}}catch{}const p=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("tfoot",{...o,className:s("ams-table__footer",r),ref:d,children:a}));p.displayName="Table.Footer";try{Table.Footer.displayName="Table.Footer",Table.Footer.__docgenInfo={description:"",displayName:"Table.Footer",props:{}}}catch{}const _=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("thead",{...o,className:s("ams-table__header",r),ref:d,children:a}));_.displayName="Table.Header";try{Table.Header.displayName="Table.Header",Table.Header.__docgenInfo={description:"",displayName:"Table.Header",props:{}}}catch{}const C=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("th",{...o,className:s("ams-table__header-cell",r),ref:d,children:a}));C.displayName="Table.HeaderCell";try{Table.HeaderCell.displayName="Table.HeaderCell",Table.HeaderCell.__docgenInfo={description:"",displayName:"Table.HeaderCell",props:{}}}catch{}const y=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("tr",{...o,className:s("ams-table__row",r),ref:d,children:a}));y.displayName="Table.Row";try{Table.Row.displayName="Table.Row",Table.Row.__docgenInfo={description:"",displayName:"Table.Row",props:{}}}catch{}const m=n.forwardRef(({children:a,className:r,...o},d)=>e.jsx("div",{className:"ams-table",children:e.jsx("table",{...o,className:s("ams-table__table",r),ref:d,children:a})}));m.displayName="Table";const l=Object.assign(m,{Body:b,Caption:i,Cell:T,Footer:p,Header:_,HeaderCell:C,Row:y});try{l.displayName="Table",l.__docgenInfo={description:"",displayName:"Table",props:{}}}catch{}const w={title:"Components/Containers/Table",component:l},t={args:{children:[e.jsx(l.Caption,{children:"Kosten en levertijd"},"caption"),e.jsx(l.Header,{children:e.jsxs(l.Row,{children:[e.jsx(l.HeaderCell,{children:"Type"}),e.jsxs(l.HeaderCell,{children:["Normale levertijd",e.jsx("br",{}),"1 week"]}),e.jsxs(l.HeaderCell,{children:["Spoed",e.jsx("br",{}),"2 werkdagen"]})]})},"header"),e.jsxs(l.Body,{children:[e.jsxs(l.Row,{children:[e.jsx(l.Cell,{children:"Paspoort"}),e.jsx(l.Cell,{children:"€ 77,85"}),e.jsx(l.Cell,{children:"€ 130,80"})]}),e.jsxs(l.Row,{children:[e.jsx(l.Cell,{children:"ID-kaart"}),e.jsx(l.Cell,{children:"€ 70,35"}),e.jsx(l.Cell,{children:"€ 123,30"})]})]},"body")]}},c={args:{children:[e.jsx(l.Caption,{children:"Kosten en tijd"},"caption"),e.jsx(l.Header,{children:e.jsxs(l.Row,{children:[e.jsx(l.HeaderCell,{children:"Tijd"}),e.jsx(l.HeaderCell,{children:"Kosten"})]})},"header"),e.jsxs(l.Body,{children:[e.jsxs(l.Row,{children:[e.jsx(l.HeaderCell,{scope:"row",children:"Eerste 6 weken"}),e.jsx(l.Cell,{children:"€ 109,80 per week"})]}),e.jsxs(l.Row,{children:[e.jsx(l.HeaderCell,{scope:"row",children:"Volgende 33 weken"}),e.jsx(l.Cell,{children:"€ 79,80 per week"})]})]},"body"),e.jsx(l.Footer,{children:e.jsxs(l.Row,{children:[e.jsx(l.HeaderCell,{scope:"row",children:"Totale verwachte kosten"}),e.jsx(l.Cell,{children:"€ 3.292,20"})]})},"footer")]}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...c.parameters?.docs?.source}}};const h=["Default","WithFooterAndRowHeaders"],R=Object.freeze(Object.defineProperty({__proto__:null,Default:t,WithFooterAndRowHeaders:c,__namedExportsOrder:h,default:w},Symbol.toStringTag,{value:"Module"}));export{R as T,c as W};
