import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as o}from"./index-CWS76TmM.js";import{M as i}from"./blocks-Bszj2iAJ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";function s(n){const t={code:"code",h1:"h1",h2:"h2",p:"p",...o(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsxs(t.p,{children:["In traditional multipage applications (MPAs), navigating to another page resets the focus to the ",e.jsx(t.code,{children:"<body>"}),` element,
...
`,e.jsxs(t.p,{children:[`Make sure to correct this focus behaviour in your website.
...
including for users of screen readers.`]})]})}function m(n={}){const{wrapper:t}={...o(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(s,{...n})}):s(n)}export{m as default};
