import{r as q,j as e,c as g,F as a,w as r,E as d,T as l,P as x,J as L,C as M,K as F}from"./iframe-DyECs4ch.js";import{f as _,d as T}from"./exampleContent-Du2yH2Fl.js";import{H as I}from"./Hint-TSRip_oJ.js";const n=q.forwardRef(({children:i,className:j,hint:f,inFieldSet:p,invalid:S,legend:y,legendIsPageHeading:w,optional:V,...N},E)=>{const b=e.jsxs(e.Fragment,{children:[y," ",e.jsx(I,{hint:f,inFieldSet:p,optional:V})]});return e.jsxs("fieldset",{...N,className:g("ams-field-set",S&&"ams-field-set--invalid",j),ref:E,children:[e.jsx("legend",{className:g("ams-field-set__legend",p&&"ams-field-set__legend--in-fieldset"),children:w?e.jsx("h1",{className:"ams-field-set__heading",children:b}):b}),i]})});n.displayName="FieldSet";try{n.displayName="FieldSet",n.__docgenInfo={description:"",displayName:"FieldSet",props:{inFieldSet:{defaultValue:null,description:`Whether the fieldset is nested inside another fieldset.
