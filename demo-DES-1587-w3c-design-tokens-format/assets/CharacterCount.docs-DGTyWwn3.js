import{j as e}from"./iframe-io1_ciOy.js";import{useMDXComponents as a}from"./index-DzfHeplb.js";import{M as o,f as s,P as h,h as i,i as c}from"./blocks-CZbwjBWQ.js";import{a as m,E as l}from"./CharacterCount.stories-CmX_etyt.js";import{D as u}from"./DesignTokensTable-zksFS1ST.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Df8kt4OW.js";const y=`<!-- @license CC0-1.0 -->
...
`,p={"character-count":{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.small.font-size}",$extensions:{"amsterdam.designsystem.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.small.line-height}",$extensions:{"amsterdam.designsystem.type":"lineHeight"}},error:{color:{$value:"{ams.color.feedback.error}",$type:"color"}}}},d={ams:p};function r(n){const t={h2:"h2",h3:"h3",p:"p",...a(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:m}),`
...
`,e.jsx(u,{tokens:d})]})}function $(n={}){const{wrapper:t}={...a(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}export{$ as default};
