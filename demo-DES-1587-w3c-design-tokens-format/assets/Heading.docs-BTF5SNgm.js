import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as i}from"./index-CWS76TmM.js";import{M as o,f as r,P as h,h as l,i as t}from"./blocks-Bszj2iAJ.js";import{H as c,L as d,a as p,b as g,c as m,S as u,I as f,W as y}from"./Heading.stories-CbjParaE.js";import{D as v}from"./DesignTokensTable-g8mmQRZO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";import"./exampleContent-Du2yH2Fl.js";import"./Heading-BlfU4yXk.js";const x=`<!-- @license CC0-1.0 -->
...
`,w={heading:{1:{"font-size":{$value:"{ams.typography.heading.1.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.1.line-height}",$extensions:{"ams.type":"lineHeight"}}},2:{"font-size":{$value:"{ams.typography.heading.2.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.2.line-height}",$extensions:{"ams.type":"lineHeight"}}},3:{"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"ams.type":"lineHeight"}}},4:{"font-size":{$value:"{ams.typography.heading.4.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.4.line-height}",$extensions:{"ams.type":"lineHeight"}}},5:{"font-size":{$value:"{ams.typography.heading.5.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.5.line-height}",$extensions:{"ams.type":"lineHeight"}}},6:{"font-size":{$value:"{ams.typography.heading.6.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.heading.6.line-height}",$extensions:{"ams.type":"lineHeight"}}},color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}}}},j={ams:w};function a(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",p:"p",...i(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:c}),`
...
`,e.jsx(v,{tokens:j})]})}function I(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{I as default};
