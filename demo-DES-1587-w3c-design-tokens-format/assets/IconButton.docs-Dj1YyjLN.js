import{j as o}from"./iframe-XWRU7AeR.js";import{useMDXComponents as s}from"./index-CSZifgYw.js";import{M as a,f as c,P as l,h as i,i as t}from"./blocks-DZFFVZ8g.js";import{I as u,C as d,a as m}from"./IconButton.stories-xT-65cSy.js";import{D as h}from"./DesignTokensTable-DKZIzSB2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Cg7UAlX6.js";import"./Icon-Bd_3S9Q8.js";import"./IconButton-CJTh2kjJ.js";const v=`<!-- @license CC0-1.0 -->
...
`,p={"icon-button":{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}",$extensions:{"ams.type":"cursor"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$extensions:{"ams.type":"outlineOffset"}},hover:{"background-color":{$value:"rgb(0 70 153 / 12.5%)",$extensions:{"ams.type":"backgroundColor"}},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}",$extensions:{"ams.type":"cursor"}}},contrast:{color:{$value:"{ams.color.interactive.contrast}",$type:"color"},hover:{"background-color":{$value:"rgb(0 0 0 / 12.5%)",$extensions:{"ams.type":"backgroundColor"}},color:{$value:"{ams.color.interactive.contrast}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"}}},inverse:{"background-color":{$value:"{ams.color.interactive.default}",$type:"color"},color:{$value:"{ams.color.interactive.inverse}",$type:"color"},hover:{"background-color":{$value:"{ams.color.interactive.hover}",$type:"color"},color:{$value:"{ams.color.interactive.inverse}",$type:"color"}},disabled:{color:{$value:"{ams.color.interactive.inverse}",$type:"color"},"background-color":{$value:"{ams.color.interactive.disabled}",$type:"color"}}}}},b={ams:p};function r(n){const e={a:"a",h2:"h2",h3:"h3",h4:"h4",p:"p",...s(),...n.components};return o.jsxs(o.Fragment,{children:[`
`,`
`,`
`,`
`,o.jsx(a,{of:u}),`
...
`,o.jsx(h,{tokens:b})]})}function w(n={}){const{wrapper:e}={...s(),...n.components};return e?o.jsx(e,{...n,children:o.jsx(r,{...n})}):r(n)}export{w as default};
