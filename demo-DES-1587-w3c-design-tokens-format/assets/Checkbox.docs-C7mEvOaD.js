import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as s}from"./index-CWS76TmM.js";import{M as a,f as r,P as l,h as c,i}from"./blocks-Bszj2iAJ.js";import{a as d,L as h,I as u,b as m,W as f}from"./Checkbox.stories-KY_CMC0Q.js";import{D as v}from"./DesignTokensTable-g8mmQRZO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";const p=`<!-- @license CC0-1.0 -->
...
`,e.jsx(o.h3,{id:"long-label",children:"Long label"}),`
`,e.jsx(i,{of:h}),`
`,e.jsx(o.h3,{id:"in-a-field-set",children:"In a Field Set"}),`
`,e.jsx(o.p,{children:"Use a Field Set to group several Checkboxes with a legend, description and / or an Error Message."}),`
`,e.jsxs(o.p,{children:["Because of an ",e.jsx(o.a,{href:"https://github.com/nvaccess/nvda/issues/12718",rel:"nofollow",children:"NVDA bug"}),", we add the description text to the Field Set with ",e.jsx(o.code,{children:"aria-labelledby"}),`,
instead of `,e.jsx(o.code,{children:"aria-describedby"}),`.
...
The order of the `,e.jsx(o.code,{children:"id"}),"s is the order in which they are read by screen readers."]}),`
`,e.jsxs(o.p,{children:["If you don’t need the description, remove its Paragraph and the ",e.jsx(o.code,{children:"aria-labelledby"})," and ",e.jsx(o.code,{children:"id"})," attributes from the Field Set."]}),`
`,e.jsxs(o.p,{children:["Do not use rich text (such as links or lists) in descriptions. ",e.jsx(o.a,{href:"/docs/components-forms-field--docs#no-rich-text",children:"Find out why"}),"."]}),`
...
`,e.jsxs(o.p,{children:[`A Field Set with Checkboxes can become invalid.
In this case, connect an Error Message to the Field Set.
Because of `,e.jsx(o.a,{href:"https://github.com/nvaccess/nvda/issues/12718",rel:"nofollow",children:"the NVDA bug mentioned earlier"}),`,
we add the Error Message text to the label as well.
Add an `,e.jsx(o.code,{children:"aria-labelledby"})," attribute to the Field Set and provide the ",e.jsx(o.code,{children:"id"}),` of Error Message as its value.
The order of the `,e.jsx(o.code,{children:"id"}),"s is the order in which they are read by screen readers."]}),`
...
`,e.jsxs(o.p,{children:[`Replace the icon with a custom version to use the Checkbox in a different theme or visual identity.
Use `,e.jsx(o.code,{children:"ams-checkbox__rectangle"}),", ",e.jsx(o.code,{children:"ams-checkbox__hover-indicator"}),", ",e.jsx(o.code,{children:"ams-checkbox__checked-indicator"}),`
and `,e.jsx(o.code,{children:"ams-checkbox__indeterminate-indicator"}),` classes in its SVG markup.
Websites for the City of Amsterdam must use the default icon.`]}),`
`,e.jsx(i,{of:f}),`
`,e.jsx(o.h2,{id:"tokens",children:"Tokens"}),`
`,e.jsx(v,{tokens:b})]})}function A(t={}){const{wrapper:o}={...s(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(n,{...t})}):n(t)}export{A as default};
