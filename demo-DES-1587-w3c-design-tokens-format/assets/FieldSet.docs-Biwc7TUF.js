import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as o}from"./index-CWS76TmM.js";import{M as r,f as a,P as d,h,i}from"./blocks-Bszj2iAJ.js";import{a as l,W as c,b as p,c as m,d as u,e as f}from"./FieldSet.stories-Cx_U5uaa.js";import{D as x}from"./DesignTokensTable-g8mmQRZO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";import"./exampleContent-Du2yH2Fl.js";import"./Hint-TSRip_oJ.js";const g=`<!-- @license CC0-1.0 -->
...
`,j={"field-set":{invalid:{"border-inline-start":{$value:"{ams.border.width.l} solid {ams.color.feedback.error}",$type:"color"},"padding-inline-start":{$value:"{ams.space.m}",$type:"dimension"}},legend:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"ams.type":"lineHeight"}},"margin-block-end":{$value:"{ams.space.s}",$type:"dimension"},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"},"in-fieldset":{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"}}}}},y={ams:j};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:l}),`
...
`,e.jsx(x,{tokens:y})]})}function k(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{k as default};
