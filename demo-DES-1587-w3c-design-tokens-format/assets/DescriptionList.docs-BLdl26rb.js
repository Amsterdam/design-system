import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as o}from"./index-CWS76TmM.js";import{M as r,f as a,P as l,h as p,i as s}from"./blocks-Bszj2iAJ.js";import{a as c,M as m,b as d,R as h,I as u}from"./DescriptionList.stories-Dy1cSiqm.js";import{D as f}from"./DesignTokensTable-g8mmQRZO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";const x=`<!-- @license CC0-1.0 -->
...
`,g={"description-list":{color:{$value:"{ams.color.text.default}",$type:"color"},"column-gap":{$value:"{ams.space.l}",$type:"dimension"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"fontSize"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"ams.type":"lineHeight"}},"row-gap":{$value:"{ams.space.s}",$type:"dimension"},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}},term:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},description:{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"padding-inline-start":{$value:"{ams.space.l}",$type:"dimension"}},narrow:{"grid-template-columns":{$value:"1fr 4fr"}},medium:{"grid-template-columns":{$value:"1fr 2fr"}},wide:{"grid-template-columns":{$value:"1fr 1fr"}}}},y={ams:g};function i(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:c}),`
...
`,e.jsx(f,{tokens:y})]})}function C(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{C as default};
