import{j as e}from"./iframe-DyECs4ch.js";import{useMDXComponents as r}from"./index-CWS76TmM.js";import{M as i,f as a,P as m,h,i as s}from"./blocks-Bszj2iAJ.js";import{a as c,C as l,W as d}from"./ErrorMessage.stories-D7pbgCxt.js";import{D as f}from"./DesignTokensTable-g8mmQRZO.js";import"./preload-helper-PPVm8Dsz.js";import"./index-fKMJsk9n.js";import"./Icon-i5sJ-tPF.js";const p=`<!-- @license CC0-1.0 -->
...
`,u={"error-message":{color:{$value:"{ams.color.feedback.error}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"ams.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},gap:{$value:"{ams.space.xs}",$type:"dimension"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"ams.type":"lineHeight"}}}},x={ams:u};function t(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...r(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
