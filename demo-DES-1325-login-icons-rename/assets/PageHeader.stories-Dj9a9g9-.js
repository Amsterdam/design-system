import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{G as l,r,H as x}from"./index.esm-izLc_sUP.js";import{c as d}from"./clsx-B-dksMZM.js";import{r as m}from"./index-G8LIXM5I.js";import{G as ie}from"./Grid-BHIDbP7U.js";import{I as se}from"./Icon-BBW_x4VP.js";import{L as le}from"./Logo-BXVw7-MZ.js";const F=m.forwardRef(({children:a,className:n,...s},t)=>e.jsx(ie.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:t,children:a}));F.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(A=(T=g.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var I,V,B;h.parameters={...h.parameters,docs:{...(I=h.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(B=(V=h.parameters)==null?void 0:V.docs)==null?void 0:B.source}}};var E,S,q;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(q=(S=p.parameters)==null?void 0:S.docs)==null?void 0:q.source}}};var R,D,Z;L.parameters={...L.parameters,docs:{...(R=L.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
