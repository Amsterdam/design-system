...
`,(0,S.jsxs)(r.p,{children:[`In a right-to-left writing direction the images and the previous and next buttons follow the reading order, so the previous image sits to the right and the next to the left.
