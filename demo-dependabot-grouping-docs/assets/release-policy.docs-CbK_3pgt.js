...
`,`
`,(0,c.jsx)(n,{title:`Docs/Developer guide/Release policy`}),`
...
`,(0,c.jsx)(t.h2,{id:`grouping-dependency-updates`,children:`Grouping dependency updates`}),`
`,(0,c.jsx)(t.p,{children:`Two rules keep our packages together in one pull request.`}),`
`,(0,c.jsxs)(t.ol,{children:[`
`,(0,c.jsxs)(t.li,{children:[`Put every package whose name starts with `,(0,c.jsx)(t.code,{children:`@amsterdam/design-system-`}),` in `,(0,c.jsx)(t.strong,{children:`one group`}),`, and let that group accept major updates next to minor and patch ones.
Our major releases tend to move several packages at once, which is precisely when grouping matters most.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Exclude that same pattern`}),` from any catch-all group you already have.
...
`]}),`
`,(0,c.jsxs)(t.p,{children:[`In Dependabot, both rules fit in the `,(0,c.jsx)(t.code,{children:`groups`}),` option in `,(0,c.jsx)(t.code,{children:`.github/dependabot.yml`}),`:`]}),`
`,(0,c.jsx)(t.pre,{children:(0,c.jsx)(t.code,{className:`language-yaml`,children:`version: 2
    ...
    groups:
      ...
      patch-and-minor-dependencies:
        ...
        update-types:
          ...
          - "minor"
`})}),`
`,(0,c.jsxs)(t.p,{children:[`Dependencies that match no group still get their own pull request, so nothing goes unnoticed.
`,(0,c.jsx)(t.a,{href:`https://docs.github.com/en/code-security/tutorials/secure-your-dependencies/optimizing-pr-creation-version-updates#grouping-related-dependencies-together`,rel:`nofollow`,children:`Dependabot’s documentation`}),` describes the available options.
