import{j as e}from"./iframe-BTHZpmIa.js";import{useMDXComponents as r}from"./index-D5dNpvy1.js";import{M as t}from"./blocks-DPU4PNpu.js";import"./index-CWkIOTD6.js";/*@license CC0-1.0*/function o(n){const s={a:"a",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsx(s.h2,{id:"deprecated-api",children:"Deprecated API"}),`
`,e.jsx(s.p,{children:"We deprecate public features – React components, CSS classes and design tokens – before removing them, so you have enough time to migrate."}),`
...
`,e.jsx(s.h2,{id:"deleted-api",children:"Deleted API"}),`
`,e.jsxs(s.ul,{children:[`
