...
`,(0,u.jsx)(t.pre,{children:(0,u.jsx)(t.code,{className:`language-sh`,children:`# May not be a path, but only the file or directory name without a trailing slash.
unlink app-icons
rm app.webmanifest
`})}),`
`]}),`
