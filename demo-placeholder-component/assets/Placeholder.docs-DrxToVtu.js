...
`,(0,w.jsx)(t.p,{children:`Show a Placeholder while loading content that takes a noticeable time to arrive – roughly between 1 and 10 seconds.
...
`,(0,w.jsx)(t.p,{children:`Do not show a Placeholder for waits shorter than about a second: a flash of grey blocks is more distracting than helpful.
...
`,(0,w.jsxs)(t.p,{children:[`Choose the appearance that matches the component the Placeholder stands in for: a Card, a Heading of level 2, an Unordered List, a Paragraph, or a Table.
...
`,(0,w.jsxs)(t.p,{children:[`The Placeholder itself is hidden from assistive technologies.
