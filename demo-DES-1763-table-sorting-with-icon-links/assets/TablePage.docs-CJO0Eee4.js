import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-msKSRvUz.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-I1l8WMv6.js";import{n as u,t as d}from"./TablePage.stories-w5bUOr6i.js";var f;function p(){return(p=e((()=>{f=[[{height:`heading`,label:`Page title`},{height:`body`,label:`Table`}]]})))()}function m(e){let n={a:`a`,code:`code`,em:`em`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
It renders the column label and a chevron inside one link, so the whole header is the target, and it sets the `,(0,g.jsx)(n.code,{children:`aria-sort`}),` attribute the `,(0,g.jsx)(n.a,{href:`https://www.w3.org/WAI/ARIA/apg/patterns/table/examples/sortable-table/`,rel:`nofollow`,children:`WAI-ARIA sortable table pattern`}),` expects.`]}),`
`,(0,g.jsxs)(n.p,{children:[`Make only the columns the data can actually be sorted by links; the rest stay plain `,(0,g.jsx)(n.code,{children:`Table.HeaderCell`}),`s without an `,(0,g.jsx)(n.code,{children:`aria-sort`}),` attribute.`]}),`
...
The heading text is duplicated for assistive technology; this is the trade-off for placing the controls on the same line as the heading.`]}),`
`,(0,g.jsxs)(n.p,{children:[(0,g.jsx)(n.code,{children:`Table.SortableHeaderCell`}),` puts `,(0,g.jsx)(n.code,{children:`aria-sort`}),` on the `,(0,g.jsx)(n.code,{children:`<th>`}),` and the chevron inside the link, where it is hidden from assistive technology.
