import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-DXSisYNI.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-HNCmkBoj.js";import{n as u,t as d}from"./TablePage.stories-DOBH74Zh.js";var f;function p(){return(p=e((()=>{f=[[{height:`heading`,label:`Page title`},{height:`body`,label:`Table`}]]})))()}function m(e){let n={a:`a`,code:`code`,em:`em`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.h3,{id:`with-filters`,children:`With Filters`}),`
`,(0,g.jsx)(n.p,{children:`A wider layout with a separate filter form beside the table when the table has many columns.`}),`
...
`,(0,g.jsxs)(n.p,{children:[`There are three ways to lay this out, and all keep a `,(0,g.jsx)(n.code,{children:`<caption>`}),` on the table for its accessible name and data-table semantics:`]}),`
...
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.strong,{children:`Separate filter panel.`}),` When the table has many columns or the filter form needs more room, place the filters in an adjacent aside and keep the table caption visible inside the table.
This keeps the controls outside the table while leaving enough room for a field per column.`]}),`
`]}),`
