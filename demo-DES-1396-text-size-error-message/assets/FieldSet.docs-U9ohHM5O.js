import{j as e}from"./iframe-CCMocYvc.js";import{useMDXComponents as o}from"./index-B5e3jfbJ.js";import{M as s,c as d,P as a,e as l,f as n}from"./blocks-DzG8BP53.js";import{F as h,W as c,a as p,b as u,R as x,c as j,C as g,d as f}from"./FieldSet.stories-DFJgKcJ_.js";import"./index-l9vD08W5.js";import"./Hint-B0xyVuud.js";const b=`<!-- @license CC0-1.0 -->
...
`})}),`
`,e.jsxs(i.p,{children:["The order of the ",e.jsx(i.code,{children:"id"}),"s is the order in which they are read by screen readers."]}),`
`,e.jsx(n,{of:f})]})}function M(t={}){const{wrapper:i}={...o(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(r,{...t})}):r(t)}export{M as default};
