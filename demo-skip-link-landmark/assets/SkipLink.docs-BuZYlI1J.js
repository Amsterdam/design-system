...
`,(0,S.jsxs)(r.p,{children:[`Place the Skip Link in a `,(0,S.jsx)(r.code,{children:`nav`}),` that is the first element in the `,(0,S.jsx)(r.a,{href:`/docs/components-containers-page--docs`,children:`Page`}),` container.`]}),`
...
Wrap it in a `,(0,S.jsx)(r.code,{children:`nav`}),` so that it sits in one like the rest of the page, and give that `,(0,S.jsx)(r.code,{children:`nav`}),` an accessible name to tell it apart from the other navigation landmarks:`]}),`
`,(0,S.jsx)(r.pre,{children:(0,S.jsx)(r.code,{className:`language-tsx`,children:`<nav aria-label="Snelkoppelingen">
  <SkipLink href="#inhoud">Direct naar inhoud</SkipLink>
</nav>
`})}),`
`,(0,S.jsxs)(r.p,{children:[`Put every Skip Link of a page in that same `,(0,S.jsx)(r.code,{children:`nav`}),`, rather than giving each one its own.`]}),`
`,(0,S.jsx)(r.h2,{id:`see-also`,children:`See also`}),`
`,(0,S.jsxs)(r.ul,{children:[`
`,(0,S.jsxs)(r.li,{children:[(0,S.jsx)(r.a,{href:`/docs/components-containers-page--docs`,children:`Page`}),` – contains the Skip Link in its first element.`]}),`
`]}),`
