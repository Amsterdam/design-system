...
Its children – a `,(0,y.jsx)(r.code,{children:`nav`}),` holding the `,(0,y.jsx)(r.a,{href:`/docs/components-navigation-skip-link--docs`,children:`Skip Links`}),`, the Page Header, the sections of the page, and the Page Footer – follow one another in document order.
...
`,(0,y.jsxs)(r.li,{children:[(0,y.jsx)(r.a,{href:`/docs/components-navigation-skip-link--docs`,children:`Skip Link`}),` – sits in the first element of the Page, above the Page Header.`]}),`
