import{n as e}from"./chunk-zsgVPwQN.js";import{jt as t}from"./iframe-CpFNxYAC.js";import{r as n}from"./react-Ciefhm4F.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-Da-Og3Qg.js";import{n as l,t as u}from"./DesignTokensTable-B2ESxJqd.js";import{t as d}from"./mdx-react-shim-DdQs1RuP.js";import{ResponsiveImages as f,WithCaptions as p,n as m,t as h}from"./ImageSlider.stories-CPXX2Q7V.js";var g,_=e((()=>{g=`<!-- @license CC0-1.0 -->
...
`})),v,y,b=e((()=>{v={"image-slider":{gap:{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},scroller:{gap:{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}},thumbnails:{gap:{$value:`{ams.space.xs}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},thumbnail:{"background-color":{$value:`transparent`,$type:`color`},cursor:{$value:`{ams.cursor.interactive}`},opacity:{$value:`40%`},"outline-offset":{$value:`{ams.focus.outline-offset}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}},"in-view":{opacity:{$value:`100%`}},hover:{opacity:{$value:`100%`}}}},figure:{"margin-block-end":{$value:`{ams.space.m}`,$type:`dimension`,$extensions:{"nl.amsterdam.subtype":`space`}}}}},y={ams:v}}));function x(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...n(),...e.components};return(0,C.jsxs)(C.Fragment,{children:[`
`,`
`,`
`,`
`,(0,C.jsx)(r,{of:h}),`
