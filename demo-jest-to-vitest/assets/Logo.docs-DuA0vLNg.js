import{j as e}from"./iframe-C0VnjWFY.js";import{useMDXComponents as a}from"./index-r69pEpsa.js";import{M as i,e as r,f as l,h,i as o}from"./blocks-BFfBT1nu.js";import{L as m,G as d,S as g,a as c,V as p,M as u,C as f}from"./Logo.stories-C6ZF8MXs.js";import{D as b}from"./DesignTokensTable-ShcxXLRh.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CsOhfieo.js";import"./ExampleLogo-DvK6JXA8.js";import"./BorderSample-PjOq9Y7p.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-zX1rOIi5.js";import"./ColorSample-KfgquRxx.js";import"./SpaceSample-CC57EgYm.js";import"./TypographySample-E0x6lJkm.js";const x=`<!-- @license CC0-1.0 -->
...
`,w={logo:{"block-size":{$value:"{ams.space.xl}",$type:"dimension"},"min-block-size":{$value:{value:2.5,unit:"rem"},$type:"dimension"},emblem:{color:{$value:"#ec0000",$type:"color"}},subsite:{color:{$value:"{ams.color.text.default}",$type:"color"}},title:{color:{$value:"#ec0000",$type:"color"}}}},j={ams:w};function t(s){const n={h2:"h2",h3:"h3",p:"p",strong:"strong",...a(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:m}),`
...
`,e.jsx(b,{tokens:j})]})}function V(s={}){const{wrapper:n}={...a(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{V as default};
