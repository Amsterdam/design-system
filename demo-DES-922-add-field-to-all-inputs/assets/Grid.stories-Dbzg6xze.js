import{j as a}from"./jsx-runtime-BlAj40OV.js";import{k as z}from"./index.esm-ZbIVeNIZ.js";import{c as H}from"./clsx-B-dksMZM.js";import{r as F}from"./index-Cs7sjTYM.js";/**
 * @license EUPL-1.2+
...
}`,...(T=(N=m.parameters)==null?void 0:N.docs)==null?void 0:T.source}}};var x,b,V;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...StoryTemplate,
  args: {
    children: Array.from(Array(6).keys()).map(i => <Grid.Cell className="ams-docs-item" span={4} key={i} />),
    gapVertical: 'small'
  }
}`,...(V=(b=d.parameters)==null?void 0:b.docs)==null?void 0:V.source}}};var j,w,$;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
    children: <div className="ams-docs-item" />,
    span: 4
  }
}`,...($=(w=c.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var A,q,k;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
    children: <div className="ams-docs-item" />,
    span: {
...
}`,...(k=(q=p.parameters)==null?void 0:q.docs)==null?void 0:k.source}}};var M,O,P;u.parameters={...u.parameters,docs:{...(M=u.parameters)==null?void 0:M.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
    children: <div className="ams-docs-item" />,
    span: 'all'
  }
}`,...(P=(O=u.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};var R,E,L;g.parameters={...g.parameters,docs:{...(R=g.parameters)==null?void 0:R.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
    children: <div className="ams-docs-item" />,
    span: 3,
...
}`,...(L=(E=g.parameters)==null?void 0:E.docs)==null?void 0:L.source}}};var B,D,I;f.parameters={...f.parameters,docs:{...(B=f.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...CellStoryTemplate,
  args: {
    as: 'section'
  },
...
}`,...(I=(D=f.parameters)==null?void 0:D.docs)==null?void 0:I.source}}};const Z=["Default","VerticalSpace","VerticalGap","SpanMultipleColumns","ConfigureGridVariants","SpanAllColumns","StartPosition","CustomTagName"],le=Object.freeze(Object.defineProperty({__proto__:null,ConfigureGridVariants:p,CustomTagName:f,Default:t,SpanAllColumns:u,SpanMultipleColumns:c,StartPosition:g,VerticalGap:d,VerticalSpace:m,__namedExportsOrder:Z,default:Y},Symbol.toStringTag,{value:"Module"}));export{p as C,le as G,c as S,m as V,d as a,u as b,g as c,f as d};
