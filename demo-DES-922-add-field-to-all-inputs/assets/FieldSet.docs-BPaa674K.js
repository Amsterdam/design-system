import{j as e}from"./jsx-runtime-BlAj40OV.js";import{useMDXComponents as o}from"./index-BI1Biiay.js";import{ae as s,ak as d,al as a,am as h,an as i}from"./index-CGTTrZB_.js";import{F as l,W as c,a as p,R as u,b as x,C as g,c as j}from"./FieldSet.stories-COOw-bYe.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-uZvklSem.js";import"../sb-preview/runtime.js";import"./index-BU4L-DQy.js";import"./index-D-8MO0q_.js";import"./index-nrpnv_Jx.js";import"./index-DrFu-skq.js";import"./index.esm-BEwyunnw.js";import"./clsx-B-dksMZM.js";import"./index.esm-Bsc2owIZ.js";const b=`<!-- @license CC0-1.0 -->
...
`,e.jsx(r.p,{children:"Use a Field Set to group several Radios with a legend, description, and / or an error message."}),`
`,e.jsxs(r.p,{children:["When grouping Radios, add ",e.jsx(r.code,{children:'role="radiogroup"'}),` to the Field Set to have it explicitly announced as a radio group (the default role is just ‘group’).
The ‘radio group’ role also allows using `,e.jsx(r.code,{children:"aria-required"}),` on Field Set; that isn’t allowed for the ‘group’ role.
Always also set `,e.jsx(r.code,{children:"aria-required"})," on the individual Radios though, to make sure it’s read by screen readers."]}),`
`,e.jsx(i,{of:u}),`
`,e.jsx(r.h3,{id:"radio-group-with-error",children:"Radio group with error"}),`
`,e.jsxs(r.p,{children:[`A Field Set with a Radio group can also have a validation error.
...
`})}),`
`,e.jsxs(r.p,{children:["The order of the ",e.jsx(r.code,{children:"id"}),"s is the order in which they are read by screen readers."]}),`
`,e.jsx(i,{of:j})]})}function G(n={}){const{wrapper:r}={...o(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(t,{...n})}):t(n)}export{G as default};
