...
`,(0,g.jsx)(n.li,{children:`The title uses a level 1 Heading; each section uses a level 2 Heading.`}),`
...
`,(0,g.jsxs)(n.li,{children:[`A `,(0,g.jsx)(n.a,{href:`/docs/components-containers-spotlight--docs`,children:`Spotlight`}),` holds a newsletter call-to-action; all text and link components inside use `,(0,g.jsx)(n.code,{children:`color="inverse"`}),`.`]}),`
...
`,(0,g.jsxs)(n.li,{children:[`The `,(0,g.jsx)(n.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` utility class sets the vertical space within the Content Header and within the article body, following the `,(0,g.jsx)(n.a,{href:`/docs/docs-designer-guide-vertical-space--docs`,children:`vertical space`}),` recommendations.
