...
</>`,language:`tsx`}}},render:()=>(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(m,{paddingTop:`large`,children:(0,D.jsx)(m.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:(0,D.jsx)(s,{children:(0,D.jsx)(s.Link,{href:`#`,children:`Home`})})})}),(0,D.jsxs)(`main`,{id:`inhoud`,children:[(0,D.jsx)(m,{paddingBottom:`x-large`,children:(0,D.jsxs)(m.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:[(0,D.jsx)(g,{className:`ams-mb-m`,level:1,children:`Nieuws uit Amsterdam`}),(0,D.jsxs)(a,{children:[(0,D.jsx)(a.Input,{defaultValue:`tramspoor`,label:`Zoek in het nieuws`,name:`trefwoord`}),(0,D.jsx)(a.Button,{children:`Zoeken`})]})]})}),(0,D.jsxs)(m,{paddingBottom:`2x-large`,children:[(0,D.jsxs)(m.Cell,{"aria-labelledby":`sorteren-en-filteren`,as:`aside`,span:{narrow:4,medium:3,wide:3},children:[(0,D.jsx)(g,{className:`ams-visually-hidden`,id:`sorteren-en-filteren`,level:2,children:`Sorteren en filteren`}),(0,D.jsxs)(`form`,{method:`get`,children:[(0,D.jsxs)(f,{className:`ams-mb-l`,children:[(0,D.jsx)(h,{htmlFor:`sorteren`,children:`Sorteren`}),(0,D.jsxs)(_,{id:`sorteren`,name:`sorteren`,children:[(0,D.jsx)(_.Option,{value:`nieuwste`,children:`Nieuwste eerst`}),(0,D.jsx)(_.Option,{value:`oudste`,children:`Oudste eerst`}),(0,D.jsx)(_.Option,{value:`relevantie`,children:`Op relevantie`})]})]}),(0,D.jsx)(u,{className:`ams-mb-l`,legend:`Soort nieuws`,children:(0,D.jsx)(p,{gap:`x-small`,children:S.map(e=>(0,D.jsx)(l,{defaultChecked:k.includes(e),name:`soort`,value:e.toLowerCase(),children:e},e))})}),(0,D.jsx)(u,{className:`ams-mb-l`,legend:`Stadsdelen`,children:(0,D.jsx)(p,{gap:`x-small`,children:C.map(e=>(0,D.jsx)(l,{defaultChecked:A.includes(e),name:`stadsdeel`,value:e.toLowerCase(),children:e},e))})}),(0,D.jsx)(d,{type:`submit`,children:`Resultaten tonen`})]})]}),(0,D.jsxs)(m.Subgrid,{span:{narrow:4,medium:5,wide:9},start:{narrow:1,medium:4,wide:4},children:[(0,D.jsxs)(m.Cell,{span:`all`,children:[(0,D.jsx)(g,{className:`ams-visually-hidden`,level:2,children:`Nieuwsberichten`}),(0,D.jsx)(i,{role:`status`,children:I})]}),w.map(e=>(0,D.jsx)(m.Cell,{span:{narrow:4,medium:4,wide:9},children:(0,D.jsxs)(c,{children:[(0,D.jsx)(c.Image,{alt:``,loading:`lazy`,src:e.imageSource}),(0,D.jsxs)(c.Content,{children:[(0,D.jsx)(c.HeadingGroup,{tagline:e.category,children:(0,D.jsx)(c.Heading,{level:3,children:(0,D.jsx)(c.Link,{href:`#`,children:e.title})})}),(0,D.jsxs)(p,{gap:`small`,children:[(0,D.jsx)(i,{children:e.teaser}),(0,D.jsx)(i,{size:`small`,children:(0,D.jsx)(`time`,{dateTime:e.isoDate,children:e.date})})]})]})]})},e.id)),(0,D.jsx)(m.Cell,{span:`all`,children:(0,D.jsx)(r,{accessibleNameId:`paginering`,linkTemplate:e=>`?pagina=${e}`,page:1,totalPages:M})})]})]})]})]})},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...R.parameters?.docs?.source}}},z=[`Default`]}));B();export{R as Default,z as __namedExportsOrder,L as default,B as n,E as t};