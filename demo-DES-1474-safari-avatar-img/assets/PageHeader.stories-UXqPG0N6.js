import{r as L,j as e,c as d,G as l,$ as r,H as x}from"./iframe-B0M0q5P2.js";import{u as S}from"./useIsAfterBreakpoint-Bc9O_9AQ.js";import{G as E}from"./Grid-CPZox28q.js";import{I as q}from"./Icon-B_A6EyDF.js";import{L as z}from"./Logo-DycUa8go.js";const G=L.forwardRef(({children:a,className:n,...s},o)=>e.jsx(E.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:o,children:a}));G.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"aside"'},{value:'"div"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'},{value:'"section"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
