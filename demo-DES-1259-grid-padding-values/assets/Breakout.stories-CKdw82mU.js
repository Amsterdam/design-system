import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{o as T,p as k,P as p,I as y}from"./index.esm-B0AKU8Wx.js";import{g as V}from"./common-CfqFMx79.js";import{c as C}from"./clsx-B-dksMZM.js";import{r as b}from"./index-G8LIXM5I.js";import{a as u,p as N}from"./paddingClasses-C5gheHLv.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const q=(a,o,l,t)=>[...u("ams-breakout__cell--col-span-",a),...u("ams-breakout__cell--col-start-",o),...u("ams-breakout__cell--row-span-",l),...u("ams-breakout__cell--row-start-",t)],x=b.forwardRef(({as:a="div",children:o,className:l,colSpan:t,colStart:d,has:i,rowSpan:c,rowStart:m,...B},j)=>e.jsx(a,{...B,className:C("ams-breakout__cell",q(t,d,c,m),i&&`ams-breakout__cell--has-${i}`,l),ref:j,children:o}));x.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(S=(v=s.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};const P=["Default","VerticalLayout"],H=Object.freeze(Object.defineProperty({__proto__:null,Default:n,VerticalLayout:s,__namedExportsOrder:P,default:z},Symbol.toStringTag,{value:"Module"}));export{H as B,s as V};
