import{j as e}from"./iframe-mmeen-4b.js";import{useMDXComponents as s}from"./index-B_Gr74Uh.js";import{M as i}from"./blocks-CIt2FqiH.js";import{H as t}from"./HomePage.stories-0MBAZhG-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CSThfc3h.js";/*@license CC0-1.0*/function o(a){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",...s(),...a.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(i,{of:t}),`
`,e.jsx(n.h1,{id:"home-page",children:"Home page"}),`
`,e.jsx(n.p,{children:`The content for the home page of an internal website will vary.
Our example currently focuses on the overall layout.`}),`
`,e.jsx(n.h2,{id:"layout",children:"Layout"}),`
`,e.jsx(n.p,{children:"A typical layout for an internal website:"}),`
...
`]}),`
`,e.jsx(n.p,{children:"Make sure that both menus have the same items."})]})}function u(a={}){const{wrapper:n}={...s(),...a.components};return n?e.jsx(n,{...a,children:e.jsx(o,{...a})}):o(a)}export{u as default};
