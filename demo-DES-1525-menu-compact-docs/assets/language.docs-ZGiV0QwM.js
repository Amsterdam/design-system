import{j as e}from"./iframe-DaawwBLe.js";import{useMDXComponents as a}from"./index-Cbp3tBei.js";import{M as s}from"./blocks-B3P52-Gf.js";import"./preload-helper-PPVm8Dsz.js";import"./index-rbemCgqD.js";/*@license CC0-1.0*/function i(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(s,{title:"Docs/Developer Guide/Language"}),`
...
`,e.jsxs(n.p,{children:["Specify the language on your website’s ",e.jsx(n.code,{children:"<html>"}),` element.
...
`]})]})}function g(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{g as default};
