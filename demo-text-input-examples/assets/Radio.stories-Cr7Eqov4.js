import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{e as p,P as b,E as g,C as h}from"./index.esm-CMapxPh_.js";import{c as x}from"./clsx-B-dksMZM.js";import{r as u}from"./index-G8LIXM5I.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const j=a=>e.jsxs("svg",{"aria-hidden":"true",focusable:"false",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",...a,children:[e.jsx("circle",{className:"ams-radio__circle",cx:12,cy:12,fill:"none",r:10,stroke:"black",strokeWidth:"2px"}),e.jsx("circle",{className:"ams-radio__hover-indicator",cx:12,cy:12,fill:"none",r:9.5,stroke:"black",strokeWidth:"3px"}),e.jsx("circle",{className:"ams-radio__checked-indicator",cx:12,cy:12,r:6})]});try{RadioIcon.displayName="RadioIcon",RadioIcon.__docgenInfo={description:"",displayName:"RadioIcon",props:{}}}catch{}const r=u.forwardRef(({children:a,className:l,icon:n,id:t,invalid:v,..._},f)=>{const m=t||u.useId();return e.jsxs("div",{className:x("ams-radio",l),children:[e.jsx("input",{..._,"aria-invalid":v||void 0,className:"ams-radio__input",id:m,ref:f,type:"radio"}),e.jsxs("label",{className:"ams-radio__label",htmlFor:m,children:[e.jsx("span",{className:"ams-radio__icon-container",children:n??e.jsx(j,{})}),a]})]})});r.displayName="Radio";try{r.displayName="Radio",r.__docgenInfo={description:"",displayName:"Radio",props:{icon:{defaultValue:null,description:"An icon to display instead of the default icon.",name:"icon",required:!1,type:{name:"ReactNode"}},invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}}}}}catch{}/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
