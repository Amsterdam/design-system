import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,d as n,h as r,i,p as a,u as o}from"./blocks-BFa-eblR.js";import{t as s}from"./jsx-runtime-ATHzeHXA.js";import{i as c,r as l}from"./react-Dyi61YEg.js";import{n as u,t as d}from"./DesignTokensTable-CdqILHiR.js";import{n as f,t as p}from"./Spinner.stories-D13BXxpj.js";var m,h;function g(){return(g=e((()=>{m={spinner:{animation:{$value:`ams-spinner-rotate 0.8s linear infinite`,$description:`The loading animation.`},"track-color":{$value:`#D4D4D4`,$description:`The colour of the ring's resting track.`,$extensions:{"nl.amsterdam.type":`color`}},small:{size:{$value:{value:2,unit:`rem`},$type:`dimension`,$description:`The diameter of a small Spinner.`},"border-width":{$value:{value:.25,unit:`rem`},$type:`dimension`,$description:`The border width of a small Spinner.`}},medium:{size:{$value:{value:4,unit:`rem`},$type:`dimension`,$description:`The diameter of a medium Spinner.`},"border-width":{$value:{value:.375,unit:`rem`},$type:`dimension`,$description:`The border width of a medium Spinner.`}},large:{size:{$value:{value:6,unit:`rem`},$type:`dimension`,$description:`The diameter of a large Spinner.`},"border-width":{$value:{value:.5,unit:`rem`},$type:`dimension`,$description:`The border width of a large Spinner.`}}}},h={ams:m}})))()}function _(e){let r={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...c(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[`
`,`
`,`
`,`
`,(0,y.jsx)(o,{of:p}),`
...
`,(0,y.jsx)(r.pre,{children:(0,y.jsx)(r.code,{className:`language-tsx`,children:`<section aria-busy="true">
...
`,(0,y.jsxs)(r.p,{children:[`The animation is set through one custom property, `,(0,y.jsx)(r.code,{children:`--ams-spinner-animation`}),`, which holds a CSS `,(0,y.jsx)(r.code,{children:`animation`}),` shorthand.`]}),`
