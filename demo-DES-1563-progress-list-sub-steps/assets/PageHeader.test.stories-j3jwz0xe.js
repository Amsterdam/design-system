import{j as e}from"./iframe-NTMK3aFY.js";import{r as o}from"./renderComponentVariants-KfuQrKoU.js";import{m as c,P as a}from"./PageHeader.stories-C0MBkwwW.js";import"./preload-helper-PPVm8Dsz.js";import"./useIsAfterBreakpoint-CJoSI3_K.js";import"./Grid-eok_7vQ7.js";import"./gridCellClasses-BgQvftim.js";import"./Icon-BTrGylzy.js";import"./Logo-B1lxI5hi.js";const{expect:d}=__STORYBOOK_MODULE_TEST__,H={...c,title:"Components/Containers/Page Header"},n={args:{brandName:"Data Amsterdam",children:e.jsx("p",{children:"test"}),menuItems:[e.jsx(a.MenuLink,{href:"#",lang:"en",children:"English"},"1"),e.jsx(a.MenuLink,{fixed:!0,href:"#",children:"Zoeken"},"2")]},play:async({canvas:t,userEvent:i})=>{const r=(await t.findByTestId("interaction-test")).querySelector("button"),s=await t.findByTestId("children");r&&(await i.click(r),d(s).toBeVisible(),await i.click(r),d(s).not.toBeVisible())},render:t=>e.jsxs(e.Fragment,{children:[e.jsx(a,{"data-testid":"interaction-test",...t,children:e.jsx("ul",{children:e.jsx("li",{"data-testid":"children",children:"English"})})}),o(a,{args:t})]}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
