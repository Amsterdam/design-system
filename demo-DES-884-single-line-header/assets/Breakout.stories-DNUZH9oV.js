import{j as e}from"./jsx-runtime-BlAj40OV.js";import{S as N,u as k,P as p,i as C,I as b}from"./index.esm-C19DUSQ3.js";import{c as _}from"./clsx-B-dksMZM.js";import{r as B}from"./index-Cs7sjTYM.js";import{a as u,p as T}from"./paddingClasses-C5gheHLv.js";/**
 * @license EUPL-1.2+
 * Copyright Gemeente Amsterdam
 */const q=(a,l,t,o)=>[...u("ams-breakout__cell--col-span-",a),...u("ams-breakout__cell--col-start-",l),...u("ams-breakout__cell--row-span-",t),...u("ams-breakout__cell--row-start-",o)],x=B.forwardRef(({as:a="div",children:l,className:t,colSpan:o,colStart:d,has:i,rowSpan:m,rowStart:c,...j},V)=>e.jsx(a,{...j,ref:V,className:_("ams-breakout__cell",q(o,d,m,c),i&&`ams-breakout__cell--has-${i}`,t),children:l}));x.displayName="Breakout.Cell";try{Breakout.Cell.displayName="Breakout.Cell",Breakout.Cell.__docgenInfo={description:"",displayName:"Breakout.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},colSpan:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
...
}`,...(S=(v=s.parameters)==null?void 0:v.docs)==null?void 0:S.source}}};const z=["Default","VerticalLayout"],G=Object.freeze(Object.defineProperty({__proto__:null,Default:n,VerticalLayout:s,__namedExportsOrder:z,default:R},Symbol.toStringTag,{value:"Module"}));export{G as B,s as V};
