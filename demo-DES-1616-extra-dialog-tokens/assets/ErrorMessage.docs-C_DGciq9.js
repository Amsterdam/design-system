import{j as e}from"./iframe-BbBFboic.js";import{useMDXComponents as r}from"./index-BYPRhWqv.js";import{M as i,e as a,f as m,h,i as t}from"./blocks-DpM5Mw43.js";import{a as c,C as l,W as d}from"./ErrorMessage.stories-DsofepZE.js";import{D as p}from"./DesignTokensTable-BIgdpKYn.js";import"./preload-helper-PPVm8Dsz.js";import"./index-65gl73Su.js";import"./Icon-1oaHOLRi.js";import"./BorderSample-pZblYO5e.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-zeWX6LmZ.js";import"./ColorSample-DgPdLSxM.js";import"./SpaceSample-Y8uPV6fW.js";import"./TypographySample-CSqLye02.js";const f=`<!-- @license CC0-1.0 -->
...
`,u={"error-message":{color:{$value:"{ams.color.feedback.error}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},gap:{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}}}},x={ams:u};function s(o){const n={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...r(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:c}),`
...
`,e.jsx(p,{tokens:x})]})}function W(o={}){const{wrapper:n}={...r(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{W as default};
