import{j as e}from"./iframe-CoWMxKf4.js";import{useMDXComponents as s}from"./index-1SQSUlYL.js";import{M as i,e as r,f as l,h as c,i as a}from"./blocks-BvB5spCY.js";import{a as h,W as d,b as u,P as m}from"./Tabs.stories-gomJRHDH.js";import{D as p}from"./DesignTokensTable-IkcvAA4H.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C4d0SyW2.js";import"./exampleContent-BtVM43j9.js";import"./useKeyboardFocus-CO72QOjh.js";import"./BorderSample-B52mLmiO.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CAMg-Y3D.js";import"./ColorSample-LUOlS_ta.js";import"./SpaceSample-D3cI5Vzs.js";import"./TypographySample-DTS_hmrk.js";const f=`<!-- @license CC0-1.0 -->
...
`,b={tabs:{gap:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},list:{"box-shadow":{$type:"shadow",$value:{inset:!0,offsetX:{value:0,unit:"rem"},offsetY:{value:"calc({ams.border.width.m} * -1)",unit:"rem"},blur:{value:0,unit:"rem"},spread:{value:0,unit:"rem"},color:"{ams.color.separator}"}}},button:{color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"outline-offset":{$value:"calc({ams.focus.outline-offset} * -1)",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{"box-shadow":{$type:"shadow",$value:{inset:!0,offsetX:{value:0,unit:"rem"},offsetY:{value:"calc({ams.border.width.m} * -1)",unit:"rem"},blur:{value:0,unit:"rem"},spread:{value:0,unit:"rem"},color:"currentColor"}},color:{$value:"{ams.color.interactive.hover}",$type:"color"}},selected:{"box-shadow":{$type:"shadow",$value:{inset:!0,offsetX:{value:0,unit:"rem"},offsetY:{value:"calc({ams.border.width.xl} * -1)",unit:"rem"},blur:{value:0,unit:"rem"},spread:{value:0,unit:"rem"},color:"currentColor"}},"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"}},disabled:{color:{$value:"{ams.color.interactive.disabled}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}}}}},v={ams:b};function o(n){const t={code:"code",h2:"h2",h3:"h3",p:"p",pre:"pre",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:h}),`
