import{j as s}from"./jsx-runtime-BlAj40OV.js";import{c as y}from"./clsx-B-dksMZM.js";import{r as L}from"./index-Cs7sjTYM.js";import{H as S}from"./Hint-D4Fy8YuO.js";const a=L.forwardRef(({children:o,className:f,hint:b,optional:g,..._},x)=>s.jsxs("label",{..._,ref:x,className:y("ams-label",f),children:[o," ",s.jsx(S,{hint:b,optional:g})]}));a.displayName="Label";try{a.displayName="Label",a.__docgenInfo={description:"",displayName:"Label",props:{hint:{defaultValue:null,description:"Show a custom hint text.",name:"hint",required:!1,type:{name:"string"}},optional:{defaultValue:null,description:"Appends the text '(niet verplicht)' to the label or legend if no hint is provided. Use when the associated inputs are optional.",name:"optional",required:!1,type:{name:"boolean"}}}}}catch{}/**
 * @license EUPL-1.2+
