...
`,(0,w.jsxs)(r.p,{children:[`If your app uses Date Picker in multiple places with the same language, a small wrapper component avoids repeating these props; the `,(0,w.jsx)(r.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation developer guide`}),` shows an example.`]}),`
...
If the layout truly has no room, placing the Date Picker inside a modal `,(0,w.jsx)(r.a,{href:`/docs/components-dialogs-dialog--docs`,children:`Dialog`}),` is an acceptable last resort.`]}),`
