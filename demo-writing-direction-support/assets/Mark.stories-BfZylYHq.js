import{a as e,n as t,r as n}from"./rolldown-runtime-DaJ6WEGw.js";import{t as r}from"./react-BDsysHVl.js";import{t as i}from"./jsx-runtime-Bq1bXGty.js";import{D as a,E as o,G as s,X as c,dt as l,f as u,ut as d}from"./index.esm-BNvuaS8P.js";import{it as f,t as p}from"./src-BQl4lYG-.js";import{d as m,r as h}from"./argTypes-CQXDxDHP.js";var g=n({Default:()=>b,SearchResults:()=>w,__namedExportsOrder:()=>T,default:()=>y}),_,v,y,b,x,S,C,w,T,E=t((()=>{l(),p(),_=e(r()),m(),v=i(),y={title:`Components/Text/Mark`,component:f},b={args:{children:`Wat vinden Amsterdammers belangrijk?`},argTypes:{children:h(`The text to mark.`)},render:({children:e})=>(0,v.jsxs)(s,{children:[`Daarom organiseren we in 2024 het burgerberaad schone stad, waarin 150 Amsterdammers in gesprek gaan over hoe we de stad beter schoonhouden. `,(0,v.jsx)(f,{children:e}),` Welke oplossingen zien zij? Hier zijn we benieuwd naar. Want elke Amsterdammer heeft afval en moet het kwijt. Wij kunnen als gemeente veel van deze afvalexperts leren.`]})},x=[{category:`Kansspelen`,date:new Date(`2025-10-27`),fragment:`Op dit moment zijn alle vergunning voor speelautomatenhallen verleend. Als u kansspelautomaten wilt plaatsen in uw horecabedrijf dan heeft u de …`,heading:`Vergunning speelautomatenhal of kansspelautomaten aanvragen`},{category:`Veelgevraagd`,date:new Date(`2024-09-15`),fragment:`U heeft een ontheffing nodig als u de geldende geluidsgrenzen van uw horecagelegenheid wil overschrijden. Kijk hier hoe het werkt en hoe u de …`,heading:`Ontheffing geluidsvoorschriften`},{category:`Vergunningen`,date:new Date(`2023-08-03`),fragment:`Voor de organisatie van grootschalige vechtsportgala’s in Amsterdam moet u een vergunning aanvragen bij de gemeente. Vooraf moet u een Bibobformulier …`,heading:`Vergunning vechtsportevenementen`}],S=new Intl.DateTimeFormat(`nl`,{day:`numeric`,month:`long`,year:`numeric`}),C=(e,t,n)=>{if(!t)return e;let r=t.split(/\s+/).filter(Boolean).map(e=>e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`));if(r.length===0)return e;let i=RegExp(`(${r.join(`|`)})`,`gi`);return e.split(i).map(e=>e.match(i)?(0,v.jsx)(f,{...n,children:e},e):e)},w={render:e=>{let[t,n]=(0,_.useState)(`horeca vergunning`),r=x.filter(({fragment:e,heading:n})=>[e,n].some(e=>t.split(/\s+/).filter(Boolean).some(t=>e.toLowerCase().includes(t.toLowerCase()))));return(0,v.jsx)(o,{children:(0,v.jsxs)(o.Cell,{span:{narrow:4,medium:6,wide:7},start:{narrow:1,medium:2,wide:3},children:[(0,v.jsxs)(c,{className:`ams-mb-m`,children:[(0,v.jsx)(c.Input,{label:`Zoeken`,onChange:e=>n(e.target.value),value:t}),(0,v.jsx)(c.Button,{})]}),(0,v.jsxs)(s,{className:`ams-mb-xl`,children:[(0,v.jsx)(`strong`,{children:r.length}),` artikelen gaan over ‘`,t,`’.`]}),(0,v.jsx)(d,{className:`ams-gap-xl`,markers:!1,children:r.map(({category:n,date:r,fragment:i,heading:o})=>(0,v.jsx)(d.Item,{children:(0,v.jsxs)(u,{children:[(0,v.jsx)(u.HeadingGroup,{tagline:n,children:(0,v.jsx)(a,{level:2,size:`level-4`,children:(0,v.jsx)(u.Link,{href:`#`,children:C(o,t,e)})})}),(0,v.jsx)(s,{className:`ams-mb-xs`,children:C(i,t,e)}),(0,v.jsx)(s,{size:`small`,children:(0,v.jsx)(`time`,{dateTime:r.toISOString(),children:S.format(r)})})]})},o))})]})})}},b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  args: {
