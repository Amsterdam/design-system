import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./jsx-runtime-Bq1bXGty.js";import{G as r,dt as i,l as a,n as o}from"./index.esm-CFn1qu0l.js";import{t as s,zt as c}from"./src-CttFLmOq.js";var l=t({Confirmation:()=>m,Default:()=>p,__namedExportsOrder:()=>h,default:()=>f}),u,d,f,p,m,h,g=e((()=>{i(),s(),u=n(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,f={title:`Components/Containers/Dialog`,component:c,argTypes:{footer:{control:!1},id:{description:`The id of the dialog element. Use it to open the dialog.`},open:{description:`Whether the dialog box is active and available for interaction.`}},decorators:[(e,{args:t})=>(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(a,{onClick:()=>{d(`open`)(),c.open(`#${t.id}`)},children:`Open`}),(0,u.jsx)(e,{})]})]},p={args:{children:(0,u.jsx)(r,{children:`U ontvangt een bevestiging per e-mail.`}),footer:(0,u.jsx)(a,{onClick:e=>(d(`close`)(),c.close(e)),children:`Sluiten`}),heading:`De gegevens zijn opgeslagen`,id:`ams-dialog-default`}},m={args:{children:(0,u.jsx)(`form`,{id:`ams-dialog-form`,method:`dialog`,children:(0,u.jsx)(r,{children:`Weet u zeker dat u door wilt gaan met het uitvoeren van deze actie? Gegevens die nog niet opgeslagen zijn gaan dan verloren.`})}),footer:(0,u.jsxs)(o,{children:[(0,u.jsx)(a,{form:`ams-dialog-form`,onClick:d(`continue`),type:`submit`,value:`submit`,children:`Doorgaan`}),(0,u.jsx)(a,{onClick:e=>(d(`cancel`)(),c.close(e)),variant:`secondary`,children:`Stoppen`})]}),heading:`Niet alle gegevens zijn opgeslagen`,id:`ams-dialog-asking-to-confirm`}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
