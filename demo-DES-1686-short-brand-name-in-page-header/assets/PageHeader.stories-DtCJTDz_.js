import{r as k,j as e,c as o,ap as J,ai as j,G as i,x as r,H as _,b as W}from"./iframe-Ba-jUq9E.js";import{L as Q,E as X}from"./ExampleLogo-D6gQ7neN.js";import{u as Y}from"./useIsAfterBreakpoint-B5QlpQWS.js";import{G as ee}from"./Grid-7KSzoN0n.js";import{I as T}from"./Icon-DFnuvW7Q.js";const B=k.forwardRef(({children:a,className:n,...t},l)=>e.jsx(ee.Cell,{...t,className:o("ams-page-header__grid-cell-narrow-window-only",n),hidden:!0,ref:l,children:a}));B.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"div"'},{value:'"section"'},{value:'"aside"'},{value:'"footer"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
