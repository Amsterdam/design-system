import{j as e}from"./jsx-runtime-BlAj40OV.js";import{c as $}from"./clsx-B-dksMZM.js";import{r as z}from"./index-Cs7sjTYM.js";import{g as U,p as W}from"./paddingClasses-C5gheHLv.js";const H=z.forwardRef(({as:a="div",children:r,className:u,span:g,start:v,...y},f)=>e.jsx(a,{...y,ref:f,className:$("ams-grid__cell",U(g,v),u),children:r}));H.displayName="Grid.Cell";try{Grid.Cell.displayName="Grid.Cell",Grid.Cell.__docgenInfo={description:"",displayName:"Grid.Cell",props:{as:{defaultValue:null,description:"The HTML element to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"div"'},{value:'"section"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
