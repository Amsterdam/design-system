...
The browser decides where to split them, so the `,(0,C.jsx)(r.a,{href:`/docs/docs-guidelines-localisation--docs#specify-the-language-for-the-entire-document`,children:`language of the document`}),` must be set correctly.`]}),`
