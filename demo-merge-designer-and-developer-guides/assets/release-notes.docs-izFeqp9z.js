...
`,(0,c.jsxs)(t.p,{children:[`Assets `,(0,c.jsx)(t.strong,{children:`2.6.0`}),`, CSS `,(0,c.jsx)(t.strong,{children:`4.4.0`}),`, React `,(0,c.jsx)(t.strong,{children:`4.4.0`}),`, Tokens `,(0,c.jsx)(t.strong,{children:`4.3.0`}),` (`,(0,c.jsx)(t.a,{href:`https://github.com/Amsterdam/design-system/pull/2926`,rel:`nofollow`,children:`changelogs`}),`).
React Icons did not move this time.
React 4.4.0 asks for React Icons 2.2.0, which arrived on 12 July.`]}),`
`,(0,c.jsx)(t.p,{children:`This release is about pages that list things.
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/components-containers-modal-dialog--docs`,children:`Modal Dialog`})}),` carries a task that deserves the whole screen: a form to fill in, a step to confirm, a document to preview.
...
`,(0,c.jsx)(t.a,{href:`/docs/components-containers-dialog--docs`,children:`Dialog`}),` keeps the short messages: a confirmation, a question, a reminder.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`})}),` renders a line of grey text for data about content: a date, a category, a status.
Its Separator part draws a square between two pieces.
Without our stylesheet it degrades to a dash.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-layout-grid--docs`,children:`Grid`}),` gains a Subgrid.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Lo-fi Mode strips a page down to a wireframe.`}),`
...
Two extra stylesheets switch it on, and it combines freely with Compact Mode; the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-modes--docs`,children:`Modes`}),` guide explains.`]}),`
`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-navigation-card--docs`,children:`Card`}),` taglines are grey now.`]}),`
The Heading Group renders its `,(0,c.jsx)(t.code,{children:`tagline`}),` as a `,(0,c.jsx)(t.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`}),` instead of a small Paragraph, changing the element’s class along with its colour.
The `,(0,c.jsx)(t.code,{children:`tagline`}),` property is deprecated: pass a Metadata as a child instead.
It keeps working until at least 8 February 2027, with a console reminder in the meantime.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Disabled controls look disabled.`}),`
A disabled `,(0,c.jsx)(t.a,{href:`/docs/components-forms-text-input--docs`,children:`Text Input`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-text-area--docs`,children:`Text Area`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-select--docs`,children:`Select`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-date-input--docs`,children:`Date Input`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-time-input--docs`,children:`Time Input`}),` or `,(0,c.jsx)(t.a,{href:`/docs/components-forms-password-input--docs`,children:`Password Input`}),` now has a light grey fill instead of white.
So do a disabled secondary or tertiary `,(0,c.jsx)(t.a,{href:`/docs/components-buttons-button--docs`,children:`Button`}),`, a `,(0,c.jsx)(t.a,{href:`/docs/components-forms-checkbox--docs`,children:`Checkbox`}),`, a `,(0,c.jsx)(t.a,{href:`/docs/components-forms-radio--docs`,children:`Radio`}),` and the button of a `,(0,c.jsx)(t.a,{href:`/docs/components-forms-file-input--docs`,children:`File Input`}),`.
The track of a disabled `,(0,c.jsx)(t.a,{href:`/docs/components-forms-switch--docs`,children:`Switch`}),` is now lighter than an enabled one; the two used to be identical.
A disabled contrast `,(0,c.jsx)(t.a,{href:`/docs/components-buttons-icon-button--docs`,children:`Icon Button`}),` shows a grey chip with a white icon.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-media-image--docs`,children:`Image`}),` reserves a grey box.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` retunes its vertical rhythm.`]}),`
More space below a level 1 heading, none below a level 4 heading, and a step more above a `,(0,c.jsx)(t.a,{href:`/docs/components-text-description-list--docs`,children:`Description List`}),`, Image, `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-link-list--docs`,children:`Link List`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-standalone-link--docs`,children:`Standalone Link`}),` or `,(0,c.jsx)(t.a,{href:`/docs/components-containers-table--docs`,children:`Table`}),` that follows a level 3 or 4 heading.
A Call to Action Link takes more room above and below.
The `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`vertical space`}),` guidelines carry the full tables.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-text-blockquote--docs`,children:`Blockquote`}),` localises its quotation marks.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-navigation-tab-navigation--docs`,children:`Tab Navigation`}),` underlines on hover.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Four components balance their line lengths.`}),`
Blockquote, `,(0,c.jsx)(t.a,{href:`/docs/components-media-figure--docs`,children:`Figure`}),` captions, Link List and `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-table-of-contents--docs`,children:`Table of Contents`}),` now spread wrapped text evenly over the lines it needs.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`Every Table and `,(0,c.jsx)(t.a,{href:`/docs/components-containers-dialog--docs`,children:`Dialog`}),` body can take keyboard focus.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Three design tokens are deprecated`}),`, removable on or after 8 February 2027.
One belongs to `,(0,c.jsx)(t.a,{href:`/docs/components-feedback-avatar--docs`,children:`Avatar`}),`, one to `,(0,c.jsx)(t.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),` and one to `,(0,c.jsx)(t.a,{href:`/docs/components-containers-page-header--docs`,children:`Page Header`}),`.
...
`,(0,c.jsxs)(t.p,{children:[(0,c.jsx)(t.strong,{children:`Right-to-left languages read naturally.`}),`
Pages in Arabic and other right-to-left languages now get the details right.
`,(0,c.jsx)(t.a,{href:`/docs/components-navigation-breadcrumb--docs`,children:`Breadcrumb`}),` separators point the way of the text.
`,(0,c.jsx)(t.a,{href:`/docs/components-navigation-calendar--docs`,children:`Calendar`}),` and `,(0,c.jsx)(t.a,{href:`/docs/components-forms-date-picker--docs`,children:`Date Picker`}),` fit Arabic weekday names in their columns.
The `,(0,c.jsx)(t.a,{href:`/docs/components-media-image-slider--docs`,children:`Image Slider`}),` advances in the writing direction, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-select--docs`,children:`Select`}),` moves its chevron to the other side, `,(0,c.jsx)(t.a,{href:`/docs/components-forms-switch--docs`,children:`Switch`}),` slides its thumb the other way, and an empty `,(0,c.jsx)(t.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),` aligns its placeholder with the page.
`,(0,c.jsx)(t.a,{href:`/docs/components-forms-character-count--docs`,children:`Character Count`}),` can announce its count in six languages through the new `,(0,c.jsx)(t.code,{children:`formatText`}),` property.
The `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`Localisation`}),` guide shows how to serve a page in Arabic.`]}),`
`,(0,c.jsx)(t.p,{children:`Elsewhere:`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Content keeps clear of the notch.`}),`
On phones with a display cutout or a home indicator, `,(0,c.jsx)(t.a,{href:`/docs/components-layout-grid--docs`,children:`Grid`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-layout-breakout--docs`,children:`Breakout`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-containers-page-header--docs`,children:`Page Header`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-containers-page-footer--docs`,children:`Page Footer`}),` and `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-menu--docs`,children:`Menu`}),` keep their content inside the safe area.
Your viewport meta tag must declare `,(0,c.jsx)(t.code,{children:`viewport-fit=cover`}),`; the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-getting-started--docs`,children:`Getting started`}),` guide explains.
On screens without insets nothing changes.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`A `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-card--docs`,children:`Card`}),` can go horizontal.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`A Grid can be a list.`}),`
Grid and Subgrid render as `,(0,c.jsx)(t.code,{children:`ol`}),` or `,(0,c.jsx)(t.code,{children:`ul`}),` with Cells as `,(0,c.jsx)(t.code,{children:`li`}),`, so screen readers announce a set of cards or results as the list it is.
It looks identical.
A Cell or Subgrid can also start at a chosen row with `,(0,c.jsx)(t.code,{children:`rowStart`}),`, for an element that comes first in reading order but sits beside later content.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`Search Field and `,(0,c.jsx)(t.a,{href:`/docs/components-forms-field-set--docs`,children:`Field Set`}),` can be disabled.`]}),`
Search Field takes a `,(0,c.jsx)(t.code,{children:`disabled`}),` property that disables its input and button together.
Field Set accepts the native `,(0,c.jsx)(t.code,{children:`disabled`}),` attribute, disabling every control inside it.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-feedback-avatar--docs`,children:`Avatar`}),` and `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-pagination--docs`,children:`Pagination`}),` let you set their accessible names.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Fourteen missing types are exported.`}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-text-ordered-list--docs`,children:`Ordered List`}),` and `,(0,c.jsx)(t.a,{href:`/docs/components-text-unordered-list--docs`,children:`Unordered List`}),` only style a truly nested list.`]}),`
...
The `,(0,c.jsx)(t.code,{children:`markers={false}`}),` setting reaches a nested list too.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`A tap no longer leaves hover styling behind.`}),`
Hover styles apply only on devices that can hover, so a highlight does not stick to a control after a touch.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Sturdy against long words.`}),`
A long word or URL can no longer push a `,(0,c.jsx)(t.a,{href:`/docs/components-layout-grid--docs`,children:`Grid`}),`, `,(0,c.jsx)(t.a,{href:`/docs/components-text-description-list--docs`,children:`Description List`}),` or another grid-based component out of its container.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`VoiceOver announces our lists again.`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-layout-breakout--docs`,children:`Breakout`}),` aligns its Spotlight cell at every gap size.`]}),`
With a `,(0,c.jsx)(t.code,{children:`gapVertical`}),` of `,(0,c.jsx)(t.code,{children:`none`}),`, `,(0,c.jsx)(t.code,{children:`large`}),` or `,(0,c.jsx)(t.code,{children:`2x-large`}),`, the cell holding a Spotlight was offset by the wrong amount, up to 53 pixels.
The default gap was always right.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-feedback-alert--docs`,children:`Alert`}),` generates a unique heading id.`]}),`
Two Alerts on one page no longer share `,(0,c.jsx)(t.code,{children:`ams-alert-heading`}),`, which made assistive technology name the second after the first.
Pass `,(0,c.jsx)(t.code,{children:`headingId`}),` if you relied on the fixed value.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-forms-switch--docs`,children:`Switch`}),` respects reduced motion.`]}),`
Its thumb no longer slides and its track no longer fades for people who ask their system for less motion.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[`A `,(0,c.jsx)(t.a,{href:`/docs/components-buttons-button--docs`,children:`Button`}),` with `,(0,c.jsx)(t.code,{children:`aria-disabled`}),` looks disabled.`]}),`
...
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Every component page explains its design and its accessibility.`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`The page templates follow one documentation model.`}),`
...
A new `,(0,c.jsx)(t.a,{href:`/docs/pages-guidelines-choosing-a-page-type--docs`,children:`Guidelines`}),` group holds what spans templates: choosing a page type, page structure, layout and spacing, reading the anatomy, and composing your own page.
Component pages gained notes on the choices the templates make with them.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Five new page templates.`}),`
`,(0,c.jsx)(t.a,{href:`/docs/pages-public-information-page--docs`,children:`Information Page`}),` explains a subject, with an Accordion for detail questions.
`,(0,c.jsx)(t.a,{href:`/docs/pages-public-profile-page--docs`,children:`Profile Page`}),` presents a person, group or location, in five variants.
`,(0,c.jsx)(t.a,{href:`/docs/pages-public-news-overview-page--docs`,children:`News Overview Page`}),`, `,(0,c.jsx)(t.a,{href:`/docs/pages-public-search-results-page--docs`,children:`Search Results Page`}),` and `,(0,c.jsx)(t.a,{href:`/docs/pages-public-events-overview-page--docs`,children:`Events Overview Page`}),` are three index pages: filters beside results, pagination below.
The Search Results Page highlights the search term with `,(0,c.jsx)(t.a,{href:`/docs/components-text-mark--docs`,children:`Mark`}),`; the Events Overview Page navigates by date with a `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-calendar--docs`,children:`Calendar`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Two templates gained a variant.`}),`
The `,(0,c.jsx)(t.a,{href:`/docs/pages-public-navigation-page--docs`,children:`Navigation Page`}),` shows a side navigation next to a map.
The `,(0,c.jsx)(t.a,{href:`/docs/pages-public-project-page--docs`,children:`Project Page`}),` shows a Table of Contents beside the text and an image overlapping the Spotlight below it.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`These release notes are themselves new.`}),`
The page arrived with the 12 July release written up, and the Introduction now shows the latest package versions.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Coding assistants see the right components.`}),`
The manifest behind the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-ai-assistance--docs`,children:`AI assistance`}),` MCP server no longer lists internal helpers, exposes far more stories, and names the parts of every compound component.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`A “more” link is not a list item.`}),`
`,(0,c.jsx)(t.a,{href:`/docs/components-navigation-link-list--docs`,children:`Link List`}),` guidance now says a trailing link to all items belongs outside the list, as a `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-standalone-link--docs`,children:`Standalone Link`}),`, and never alone in a list of one.`]}),`
`]}),`
...
`,(0,c.jsx)(t.p,{children:`Four things to know:`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Re-baseline your visual snapshots.`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Migrate Card taglines when it suits.`}),`
Pass a Metadata as a child of the Heading Group instead of the `,(0,c.jsx)(t.code,{children:`tagline`}),` property.
You have until at least 8 February 2027; the console reminds you.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:`Two technical removals, neither of which a working setup can miss.`}),`
...
The Tokens package stops shipping its source files; the compiled `,(0,c.jsx)(t.code,{children:`dist/`}),` files all remain.`]}),`
`]}),`
`,(0,c.jsx)(t.h4,{id:`what-you-could-start-using`,children:`What you could start using`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[`Put a form or another self-contained task in front of the page with `,(0,c.jsx)(t.a,{href:`/docs/components-containers-modal-dialog--docs`,children:`Modal Dialog`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Caption content with a date, category or status through `,(0,c.jsx)(t.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Align nested content with the page columns through `,(0,c.jsx)(t.a,{href:`/docs/components-layout-grid--docs`,children:`Grid`}),` Subgrid, and render an overview as a real list.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Show a page as a wireframe with Lo-fi Mode, per the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-modes--docs`,children:`Modes`}),` guide.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Let a `,(0,c.jsx)(t.a,{href:`/docs/components-navigation-card--docs`,children:`Card`}),` go horizontal where space permits.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Serve pages in right-to-left languages, with the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`Localisation`}),` guide.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Keep content out of the notch by declaring `,(0,c.jsx)(t.code,{children:`viewport-fit=cover`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Disable a whole `,(0,c.jsx)(t.a,{href:`/docs/components-forms-field-set--docs`,children:`Field Set`}),` or a `,(0,c.jsx)(t.a,{href:`/docs/components-forms-search-field--docs`,children:`Search Field`}),`.`]}),`
`,(0,c.jsxs)(t.li,{children:[`Build an index page from the three new overview templates, or an explanatory page from the `,(0,c.jsx)(t.a,{href:`/docs/pages-public-information-page--docs`,children:`Information Page`}),`.`]}),`
`]}),`
`,(0,c.jsx)(t.h4,{id:`bugs-you-may-have-run-into`,children:`Bugs you may have run into`}),`
`,(0,c.jsx)(t.p,{children:`Have you been working around a nested list that styled itself as nested when it was not?
...
Anything spaced with them in `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-modes--docs`,children:`Compact Mode`}),` closes up.
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-ai-assistance--docs`,children:`AI assistance`})}),` is a new guide.
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-responsive-design--docs`,children:`Responsive design`})}),` replaces the Breakpoints guide.
It now covers container queries alongside media queries.
That includes how to make an element a query container.`]}),`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-localisation--docs`,children:`Localisation`})}),` replaces the Language guide.
...
The `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-release-policy--docs`,children:`release policy`}),` explains how.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Let your coding assistant read the design system directly, through the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-ai-assistance--docs`,children:`AI assistance`}),` guide.`]}),`
`]}),`
...
The `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-routing-libraries--docs`,children:`routing libraries`}),` guide was rewritten around the new pattern.`]}),`
`,(0,c.jsxs)(t.ul,{children:[`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.strong,{children:(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-spacing--docs`,children:`Spacing`})}),` is a new guide.
...
`]}),`
`,(0,c.jsx)(t.h3,{id:`fixed-3`,children:`Fixed`}),`
`,(0,c.jsxs)(t.ul,{children:[`
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/components-layout-grid--docs`,children:`Grid`}),` padding in `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-modes--docs`,children:`Compact Mode`}),`.`]}),`
...
`]}),`
`,(0,c.jsx)(t.h4,{id:`bugs-you-may-have-run-into-3`,children:`Bugs you may have run into`}),`
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsxs)(t.strong,{children:[(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-modes--docs`,children:`Compact Mode`}),` looks different.`]}),`
...
`]}),`
`,(0,c.jsx)(t.h3,{id:`added-3`,children:`Added`}),`
`,(0,c.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,c.jsx)(t.h3,{id:`improved-4`,children:`Improved`}),`
`,(0,c.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,c.jsx)(t.h3,{id:`docs-4`,children:`Docs`}),`
`,(0,c.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,c.jsx)(t.h3,{id:`upgrading-4`,children:`Upgrading`}),`
`,(0,c.jsx)(t.h4,{id:`do-you-need-to-change-anything-4`,children:`Do you need to change anything?`}),`
...
`,(0,c.jsx)(t.h4,{id:`what-you-could-start-using-4`,children:`What you could start using`}),`
`,(0,c.jsxs)(t.ul,{children:[`
