import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{c as D,d as L,P as O}from"./index.esm-BpghVcBB.js";import{c as P}from"./clsx-B-dksMZM.js";import{r as R}from"./index-C0MU9AHG.js";const i=R.forwardRef(({className:p,...I},S)=>e.jsx("input",{...I,className:P("ams-file-input",p),ref:S,type:"file"}));i.displayName="FileInput";try{i.displayName="FileInput",i.__docgenInfo={description:"",displayName:"FileInput",props:{}}}catch{}const v={title:"Components/Forms/File Input",component:i,args:{accept:void 0,disabled:!1,multiple:!1},argTypes:{accept:{control:{type:"text"}},disabled:{control:{type:"boolean"}},multiple:{control:{type:"boolean"}}}},r={},a={args:{multiple:!0}},s={args:{accept:"application/pdf"}},t={args:{disabled:!0}},o={render:p=>e.jsxs(D,{children:[e.jsx(L,{htmlFor:"input1",children:"Label"}),e.jsx(O,{id:"description1",size:"small",children:"Omschrijving."}),e.jsx(i,{"aria-describedby":"description1",id:"input1",...p})]})};var c,n,l;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:"{}",...(l=(n=r.parameters)==null?void 0:n.docs)==null?void 0:l.source}}};var d,m,u;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    multiple: true
  }
