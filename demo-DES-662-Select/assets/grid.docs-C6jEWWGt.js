import{j as e}from"./jsx-runtime-CKrituN3.js";import{useMDXComponents as s}from"./index-DSz_1G2r.js";import{M as l}from"./index-CB3NmK61.js";import"./index-CBqU2yxZ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-kF9fjhJr.js";import"../sb-preview/runtime.js";import"./index-BtM5VmRH.js";import"./index-Bw8VTzHM.js";import"./index-k_s-dmML.js";import"./index-DrFu-skq.js";function n(i){const t={a:"a",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Docs/Design Guidelines/Grid"}),`
...
`,e.jsx(t.h3,{id:"four-eight-or-twelve-columns",children:"Four, eight, or twelve columns"}),`
...
`,e.jsx(t.p,{children:"We refer to these three variants as the narrow, medium, and wide grid."}),`
...
`,e.jsx(t.p,{children:`The online corporate identity had been designed for simplicity.
...
`,e.jsx(t.p,{children:`The columns, gaps, and margins have the following widths at the three breakpoints.
...
`,e.jsx(t.p,{children:'For the same reason, we do not refer to the three grid breakpoints as "mobile, tablet, and desktop" but as "for narrow, medium, and wide" screens or windows.'}),`
...
`,e.jsx(t.p,{children:`Therefore, in Figma, we work with three reference widths.
...
`,e.jsx(t.p,{children:"In these three situations, the dimensions are as follows."}),`
...
`,e.jsx(t.p,{children:`On phones and tablets, the two often coincide.
...
`,e.jsxs(t.p,{children:["Like the grid, the ",e.jsx(t.a,{href:"/docs/docs-design-guidelines-typography--docs",children:"text sizes"}),` respond to the window width.
