import{M as h,T as n}from"./index-kl-G6gcu.js";import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{useMDXComponents as l}from"./index-_VGcpBFS.js";import"./iframe-yeiudX6Y.js";import"../sb-preview/runtime.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";function r(t){const i=Object.assign({h1:"h1",h2:"h2",h3:"h3",p:"p",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",a:"a",h4:"h4",ol:"ol",li:"li",code:"code",pre:"pre"},l(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(h,{title:"Docs/Design Guidelines/Typography"}),`
...
This also complements the responsive `,e.jsx(i.a,{href:"?path=/docs/react_layout-grid--docs",children:"grid"}),"."]}),`
...
`,e.jsx(i.p,{children:"Text is bolded in titles and decorative quotes."}),`
...
In the 12-column `,e.jsx(i.a,{href:"?path=/docs/react_layout-grid--docs",children:"grid"}),", paragraphs meet this when they occupy 8 columns or fewer."]}),`
...
`})}),`
`,e.jsxs(i.p,{children:["Further reading: ",e.jsx(i.a,{href:"https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_text/Wrapping_breaking_text",target:"_blank",rel:"nofollow noopener noreferrer",children:"Wrapping and breaking text op MDN"})]})]})}function a(t={}){const{wrapper:i}=Object.assign({},l(),t.components);return i?e.jsx(i,{...t,children:e.jsx(r,{...t})}):r(t)}const d=()=>{throw new Error("Docs-only story")};d.parameters={docsOnly:!0};const s={title:"Docs/Design Guidelines/Typography",tags:["stories-mdx"],includeStories:["__page"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:a};const b=["__page"];export{b as __namedExportsOrder,d as __page,s as default};
