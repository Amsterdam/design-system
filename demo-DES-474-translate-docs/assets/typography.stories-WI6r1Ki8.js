...
`,e.jsx(i.p,{children:`Each level has a minimum text size, active up to a window width of 320 pixels.
...
`,e.jsx(i.h3,{id:"overhang",children:"Overhang"}),`
...
`,e.jsx(i.p,{children:`Most text in the house style is pure black on pure white, meeting the requirement.
