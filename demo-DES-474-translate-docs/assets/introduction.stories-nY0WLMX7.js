...
`,e.jsx(r,{children:d})]})}function m(n={}){const{wrapper:o}=Object.assign({},i(),n.components);return o?e.jsx(o,{...n,children:e.jsx(s,{...n})}):s()}const c=()=>{throw new Error("Docs-only story")};c.parameters={docsOnly:!0};const t={title:"Docs/Introduction",tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:m};const S=["__page"];export{S as __namedExportsOrder,c as __page,t as default};
