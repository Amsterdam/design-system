...
`,(0,x.jsx)(t.h3,{id:`how-to-write`,children:`How to write`}),`
`,(0,x.jsx)(t.p,{children:`Let the Badge contain a short text or a number.`}),`
`,(0,x.jsx)(t.h2,{id:`examples`,children:`Examples`}),`
`,(0,x.jsx)(t.h3,{id:`with-icon`,children:`With icon`}),`
`,(0,x.jsx)(t.p,{children:`Include an icon when it provides meaning that isn’t obvious from the text alone, or when it helps with quick recognition.
This may be helpful for statuses, alerts, or categories that users look over instead of reading.`}),`
`,(0,x.jsx)(c,{of:p}),`
`,(0,x.jsx)(t.h2,{id:`design`,children:`Design`}),`
`,(0,x.jsxs)(t.p,{children:[`Use any of the feedback or highlight `,(0,x.jsx)(t.a,{href:`/docs/brand-design-tokens-colour--docs`,children:`colours`}),` for the background.
