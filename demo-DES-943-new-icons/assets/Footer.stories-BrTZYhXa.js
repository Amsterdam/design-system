    ...
    children: [<Footer.Top key="footer-top">
        ...
        <Grid gapVertical="large" paddingVertical="medium">
          <Grid.Cell span={4}>
            ...
            <LinkList>
              {['Veel gestelde vragen', 'Over ons', 'Werken bij', 'Kalender', 'Uit in Amsterdam', 'Bronnen'].map((label, index) => <LinkList.Link href="#" key={index} inverseColor size="small">
                    {label}
                  </LinkList.Link>)}
            </LinkList>
          </Grid.Cell>
