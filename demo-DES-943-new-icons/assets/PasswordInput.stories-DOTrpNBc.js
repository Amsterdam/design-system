import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{c as j,d as x,P as F,E as P}from"./index.esm-vK_gfqzP.js";import{c as z}from"./clsx-B-dksMZM.js";import{r as S}from"./index-G8LIXM5I.js";const a=S.forwardRef(({className:r,dir:y,invalid:I,..._},w)=>e.jsx("input",{..._,"aria-invalid":I||void 0,autoCorrect:"off",className:z("ams-password-input",r),dir:y??"auto",ref:w,spellCheck:"false",type:"password"}));a.displayName="PasswordInput";try{a.displayName="PasswordInput",a.__docgenInfo={description:"",displayName:"PasswordInput",props:{invalid:{defaultValue:null,description:"Whether the value fails a validation rule.",name:"invalid",required:!1,type:{name:"boolean"}}}}}catch{}const E={title:"Components/Forms/Password Input",component:a,args:{disabled:!1,invalid:!1},argTypes:{disabled:{description:"Prevents interaction. Avoid if possible."},size:{control:{min:0,type:"number"},description:"The width, expressed in the average number of characters."}}},i={},s={args:{size:10}},d={render:r=>e.jsxs(j,{invalid:r.invalid,children:[e.jsx(x,{htmlFor:"input1",children:"Label"}),e.jsx(F,{id:"description1",size:"small",children:"Omschrijving."}),r.invalid&&e.jsx(P,{id:"error1",children:"Foutmelding."}),e.jsx(a,{"aria-describedby":`description1${r.invalid?" error1":""}`,id:"input1",...r})]})},o={args:{invalid:!0},render:r=>e.jsxs(j,{invalid:r.invalid,children:[e.jsx(x,{htmlFor:"input2",children:"Label"}),e.jsx(F,{id:"description2",size:"small",children:"Omschrijving."}),r.invalid&&e.jsx(P,{id:"error2",children:"Foutmelding."}),e.jsx(a,{"aria-describedby":`description2${r.invalid?" error2":""}`,id:"input2",...r})]})};var n,t,l;i.parameters={...i.parameters,docs:{...(n=i.parameters)==null?void 0:n.docs,source:{originalSource:"{}",...(l=(t=i.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};var c,p,m;s.parameters={...s.parameters,docs:{...(c=s.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    size: 10
  }
