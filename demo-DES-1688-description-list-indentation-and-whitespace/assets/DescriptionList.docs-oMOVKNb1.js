import{j as e}from"./iframe-VrVcUjvb.js";import{useMDXComponents as o}from"./index-Cz5ukS70.js";import{M as r,e as a,f as l,h as p,i as s}from"./blocks-I3o-IUOo.js";import{a as m,M as c,b as d,R as h,I as u}from"./DescriptionList.stories-C9EsPpu5.js";import{D as x}from"./DesignTokensTable-C6zIsWL2.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CU6edTxG.js";import"./BorderSample-D34kx2mo.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-SK2-DI5A.js";import"./ColorSample-BxD9KN2L.js";import"./SpaceSample-DmGzG8pr.js";import"./TypographySample-BnRArMuo.js";const f=`<!-- @license CC0-1.0 -->
...
`,y={"description-list":{color:{$value:"{ams.color.text.default}",$type:"color"},"column-gap":{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.body-text.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"line-height":{$value:"{ams.typography.body-text.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"row-gap":{$deprecated:"This token will be removed in release 6.0.0",$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},inverse:{color:{$value:"{ams.color.text.inverse}",$type:"color"}},term:{"font-weight":{$value:"{ams.typography.body-text.bold.font-weight}",$type:"fontWeight"},"last-of-group":{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}},description:{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"},"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline-start":{$deprecated:"This token will be removed in release 6.0.0",$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"last-of-group":{"margin-block-end":{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}},medium:{"margin-block-end":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}},narrow:{"grid-template-columns":{$value:"1fr 4fr"}},medium:{"grid-template-columns":{$value:"1fr 2fr"}},wide:{"grid-template-columns":{$value:"1fr 1fr"}}}},g={ams:y};function i(t){const n={code:"code",h2:"h2",h3:"h3",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:m}),`
