import{j as e}from"./iframe-D4RE-qAq.js";import{useMDXComponents as s}from"./index-BX3OAOn3.js";import{M as a,e as h,f as r,h as l,i}from"./blocks-B3Erv_Pv.js";import{a as d,O as p,W as m,b as c,I as f}from"./Label.stories-B1OXwtsC.js";import{D as x}from"./DesignTokensTable-C-IOYlOq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DVS_pWPj.js";import"./Hint-BN_GwNpj.js";import"./BorderSample-H0IFbXa1.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-DJiVxcPt.js";import"./ColorSample-BdN131i2.js";import"./SpaceSample-DVwEq0G3.js";import"./TypographySample-BQV5bxgs.js";const j=`<!-- @license CC0-1.0 -->
...
`,u={label:{color:{$value:"{ams.color.text.default}",$type:"color"},"font-family":{$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.typography.heading.3.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.typography.heading.3.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"text-wrap":{$value:"{ams.typography.heading.text-wrap}"},"in-fieldset":{"font-weight":{$value:"{ams.typography.body-text.font-weight}",$type:"fontWeight"}}}},g={ams:u};function o(n){const t={a:"a",code:"code",h2:"h2",h3:"h3",p:"p",...s(),...n.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
...
`,e.jsx(x,{tokens:g})]})}function L(n={}){const{wrapper:t}={...s(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(o,{...n})}):o(n)}export{L as default};
