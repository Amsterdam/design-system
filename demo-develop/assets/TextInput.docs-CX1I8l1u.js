import{n as e}from"./chunk-DnJy8xQt.js";import{Ht as t}from"./iframe-sVGWgCr0.js";import{r as n}from"./react-DY-v-PkG.js";import{c as r,f as i,i as a,l as o,n as s,s as c}from"./blocks-CwVrGAjF.js";import{n as l,t as u}from"./DesignTokensTable-DuqwxYCi.js";import{t as d}from"./mdx-react-shim-CAKBIX2J.js";import{DecimalNumber as f,Disabled as p,EmailAddress as m,InAField as h,InAFieldWithValidation as g,Invalid as _,PhoneNumber as v,Size as y,WebAddress as b,WholeNumber as x,n as S,t as C}from"./TextInput.stories-Dnaady1G.js";var w,T=e((()=>{w=`<!-- @license CC0-1.0 -->
...
`,(0,j.jsxs)(t.p,{children:[`Match the width of the input to the expected length of its content.
Use the `,(0,j.jsx)(t.code,{children:`size`}),` attribute for this.
The input won’t grow beyond the width of its container.`]}),`
`,(0,j.jsx)(t.p,{children:`Avoid sizes that feel cramped: the user needs room to type and review comfortably.
Extra space also leaves room for icons or buttons that browsers and extensions may add.`}),`
`,(0,j.jsx)(t.p,{children:`As a rule of thumb: 7 for a postal code, 15 for a phone number, 30 for an email address, and 40 for a web address.`}),`
`,(0,j.jsx)(s,{of:y}),`
