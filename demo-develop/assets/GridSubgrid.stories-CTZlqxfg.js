...
}`,...h.parameters?.docs?.source},description:{story:"A set of Cells that hold the same kind of thing is a list. Render the Subgrid as an `ol` or a `ul` and every\nCell inside it as an `li`. It looks exactly the same, and assistive technology announces the set and its size.",...h.parameters?.docs?.description}}}})))()}export{_ as i,h as n,m as r,d as t};