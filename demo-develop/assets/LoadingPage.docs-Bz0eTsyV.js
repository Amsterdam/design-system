import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-zzQRermb.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./PageAnatomy-nN_uRr7H.js";import{n as u,t as d}from"./LoadingPage.stories-B0qSOMAd.js";var f;function p(){return(p=e((()=>{f=[[{height:`card`,label:`Page title and search`}],[{height:`body`,label:`Search results`}]]})))()}function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsxs)(n.p,{children:[`Where the server renders the results with the page, use the `,(0,g.jsx)(n.a,{href:`/docs/pages-public-search-results-page--docs`,children:`Search Results Page`}),`, which has no loading state to manage.`]}),`
...
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsx)(n.li,{children:`Mark the whole results region busy while it loads, and let it announce once.
...
`,(0,g.jsxs)(n.li,{children:[`Be aware that `,(0,g.jsx)(n.code,{children:`aria-busy="true"`}),` also permits assistive technology to hold back updates from the status message and deliver them as one update once it turns false.
The ARIA specification allows this rather than requiring it, so not every screen reader does it.`]}),`
`,(0,g.jsx)(n.li,{children:`Keep one status message in the DOM at all times and only change its text, from a loading message to the result count.
...
`,(0,g.jsx)(n.li,{children:`No component wraps this pattern yet, so the Grid carries the busy state and the message is a visually hidden paragraph.`}),`
`]}),`
...
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.a,{href:`/docs/pages-public-search-results-page--docs`,children:`Search Results Page`}),` – the same page without a loading state.`]}),`
