...
`,(0,w.jsxs)(r.p,{children:[`The `,(0,w.jsx)(r.code,{children:`Item`}),` subcomponent renders an item in the list.
...
`,(0,w.jsx)(r.h3,{id:`two-levels`,children:`Two levels`}),`
`,(0,w.jsx)(r.p,{children:`A list can have one deeper level.
In this case, an en dash is used as the list item marker.
It is left-aligned with the text of the higher-level item.`}),`
`,(0,w.jsx)(a,{of:h}),`
`,(0,w.jsx)(r.h3,{id:`without-markers`,children:`Without markers`}),`
`,(0,w.jsx)(r.p,{children:`An overview of articles can be seen as an unordered list.
In such cases, apply the list semantics while hiding markers.
This helps screen readers understand and navigate the list.`}),`
`,(0,w.jsxs)(r.p,{children:[`Note: each item typically contains a container with headings and other text components in this variant.
Therefore, it does not define typography for the items and the `,(0,w.jsx)(r.code,{children:`color`}),` prop has no effect.`]}),`
`,(0,w.jsx)(r.p,{children:`For example, here are three news articles:`}),`
`,(0,w.jsx)(a,{of:g}),`
`,(0,w.jsx)(r.h3,{id:`inverse-colour`,children:`Inverse colour`}),`
`,(0,w.jsx)(r.p,{children:`Use the inverse colour if the List sits on a dark background.
...
`,(0,w.jsx)(r.p,{children:`Items of an unordered list have square markers.
...
`,(0,w.jsx)(r.p,{children:`Markers sit outside the text column.
...
`,(0,w.jsx)(r.p,{children:`A nested list is indented less than the top level, which keeps a two-level list from drifting far to the right.`}),`
`,(0,w.jsx)(r.h2,{id:`accessibility`,children:`Accessibility`}),`
`,(0,w.jsxs)(r.p,{children:[`An Unordered List renders `,(0,w.jsx)(r.code,{children:`ul`}),` and `,(0,w.jsx)(r.code,{children:`li`}),` elements.
Screen readers announce it as a list, report how many items it holds, and offer commands to move from one item to the next.`]}),`
`,(0,w.jsxs)(r.p,{children:[`Hiding the markers keeps those semantics intact, so screen readers still announce the items as a list and report how many there are.
That is the point of the variant: the grouping still reaches assistive technology as `,(0,w.jsx)(r.a,{href:`https://www.w3.org/TR/WCAG22/#info-and-relationships`,rel:`nofollow`,children:`WCAG 1.3.1`}),` requires, while the markers stay out of the way visually.`]}),`
