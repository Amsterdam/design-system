import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{h as t,u as n}from"./blocks-zzQRermb.js";import{t as r}from"./jsx-runtime-ATHzeHXA.js";import{i,r as a}from"./react-Dyi61YEg.js";import{n as o,t as s}from"./PageAnatomy-4A5tBZs_.js";import{n as c,t as l}from"./SearchResultsPage.stories-BNHobmAh.js";var u;function d(){return(d=e((()=>{u=[[{height:32,label:`Breadcrumb`}],[{height:120,label:`Page title and search`}],[{height:240,label:`Filters`},{height:32,label:`Result count`},...Array.from({length:6},()=>({height:120,label:`Search result`})),{height:44,label:`Pagination`}]]})))()}function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,...i(),...e.components};return(0,m.jsxs)(m.Fragment,{children:[`
`,`
`,`
`,`
`,(0,m.jsx)(n,{of:l}),`
...
`,(0,m.jsxs)(t.p,{children:[`The breadcrumb sits in its own Grid above `,(0,m.jsx)(t.code,{children:`main`}),`, and the Grid below it carries the page title and the search field.`]}),`
