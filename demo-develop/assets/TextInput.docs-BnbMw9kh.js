import{j as e}from"./iframe-CMZ-AiFT.js";import{useMDXComponents as o}from"./index-DgOphqmf.js";import{M as r,e as l,f as a,h as d,i as s}from"./blocks-B5e7qEoE.js";import{a as h,E as c,W as p,P as u,b as m,D as f,S as x,I as b,c as y,d as j,e as g}from"./TextInput.stories-DQXcJT9_.js";import{D as v}from"./DesignTokensTable-W3CDqc5d.js";import"./preload-helper-PPVm8Dsz.js";import"./index-TV67qQ-D.js";import"./BorderSample-CCh9omXq.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-Cg1a28qm.js";import"./ColorSample-CInKUqta.js";import"./SpaceSample-BbHt-U-v.js";import"./TypographySample-BSHOjY-W.js";const w=`<!-- @license CC0-1.0 -->
...
`,k={"text-input":{"background-color":{$value:"{ams.inputs.background-color}",$type:"color"},"border-color":{$value:"{ams.inputs.border-color}",$type:"color"},"border-style":{$value:"{ams.inputs.border-style}",$extensions:{"nl.amsterdam.type":"borderStyle"}},"border-width":{$value:"{ams.inputs.border-width}",$extensions:{"nl.amsterdam.type":"borderWidth"}},color:{$value:"{ams.inputs.color}",$type:"color"},"font-family":{$value:"{ams.inputs.font-family}",$type:"fontFamily"},"font-size":{$value:"{ams.inputs.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$value:"{ams.inputs.font-weight}",$type:"fontWeight"},"line-height":{$value:"{ams.inputs.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"outline-offset":{$value:"{ams.inputs.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{$value:"{ams.inputs.padding-block}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline":{$value:"{ams.inputs.padding-inline}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},disabled:{color:{$value:"{ams.inputs.disabled.color}",$type:"color"},cursor:{$value:"{ams.cursor.disabled}"}},hover:{"box-shadow":{$value:"{ams.inputs.hover.box-shadow}"}},invalid:{"border-color":{$value:"{ams.inputs.invalid.border-color}",$type:"color"},hover:{"border-color":{$value:"{ams.inputs.invalid.hover.border-color}",$type:"color"},"box-shadow":{$value:"{ams.inputs.invalid.hover.box-shadow}"}}},placeholder:{color:{$value:"{ams.inputs.placeholder.color}",$type:"color"}}}},T={ams:k};function t(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(r,{of:h}),`
...
`,e.jsx(n.p,{children:"The component does apply the correct font and colour for third party websites using placeholders."}),`
...
`,e.jsx(v,{tokens:T})]})}function H(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(t,{...i})}):t(i)}export{H as default};
