import{j as e}from"./iframe-C1GpdmhY.js";import{useMDXComponents as l}from"./index-BUlFJlWY.js";import{M as a,e as o,f as r,h,i as t}from"./blocks-DwUGj7_W.js";import{a as m,A as c,H as d,I as p}from"./Column.stories-DiuMB8gb.js";import{D as x}from"./DesignTokensTable-BXKZCzCq.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B3szGEvX.js";import"./types-CjGn4A4T.js";import"./BorderSample-C1_o7TfS.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-DZyiifgh.js";import"./ColorSample-D4bYisJj.js";import"./SpaceSample-C0ndAQSh.js";import"./TypographySample-CQqd4tKj.js";const u=`<!-- @license CC0-1.0 -->

# Column

Stacks its children vertically with gaps between them and offers alignment options.
`,j={column:{gap:{"x-small":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},small:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},medium:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},large:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"x-large":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}}},g={ams:j};function i(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:m}),`
...
`,e.jsx(x,{tokens:g})]})}function D(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{D as default};
