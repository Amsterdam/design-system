import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{G as l,r,H as x}from"./index.esm-s5yvcob-.js";import{c as d}from"./clsx-B-dksMZM.js";import{r as m}from"./index-G8LIXM5I.js";import{G as ie}from"./Grid-VHIB_U50.js";import{I as se}from"./Icon-BBW_x4VP.js";import{L as le}from"./Logo-BXVw7-MZ.js";const F=m.forwardRef(({children:a,className:n,...s},t)=>e.jsx(ie.Cell,{...s,className:d("ams-page-header__grid-cell-narrow-window-only",n),ref:t,children:a}));F.displayName="PageHeader.GridCellNarrowWindowOnly";try{PageHeader.GridCellNarrowWindowOnly.displayName="PageHeader.GridCellNarrowWindowOnly",PageHeader.GridCellNarrowWindowOnly.__docgenInfo={description:"",displayName:"PageHeader.GridCellNarrowWindowOnly",props:{as:{defaultValue:null,description:"The HTML tag to use.",name:"as",required:!1,type:{name:"enum",value:[{value:'"article"'},{value:'"main"'},{value:'"aside"'},{value:'"div"'},{value:'"footer"'},{value:'"section"'},{value:'"header"'},{value:'"nav"'}]}},span:{defaultValue:null,description:`Lets the cell span the full width of all grid variants.
