...
`,(0,p.jsx)(t.p,{children:`The background colour marks an input as unavailable in Date Input, Password Input, Select, Text Area, Text Input and Time Input.
