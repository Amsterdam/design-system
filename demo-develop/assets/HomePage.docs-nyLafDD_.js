import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{a as t,h as n,p as r,u as i}from"./blocks-CNG2gRRe.js";import{t as a}from"./jsx-runtime-ATHzeHXA.js";import{i as o,r as s}from"./react-Dyi61YEg.js";import{n as c,t as l}from"./anatomyLabels-BcCSOBnI.js";import{n as u,t as d}from"./HomePage.stories-jKx1XTWN.js";import{n as f,t as p}from"./PageAnatomy-CyEbdLca.js";function m(e){let n={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[`
`,`
`,`
`,`
`,(0,g.jsx)(i,{of:d}),`
...
`,(0,g.jsx)(n.p,{children:`Use this page as the entry point of a website, where a visitor arrives without a topic in mind.`}),`
`,(0,g.jsx)(n.h3,{id:`when-not-to-use`,children:`When not to use`}),`
`,(0,g.jsxs)(n.p,{children:[`Use a `,(0,g.jsx)(n.a,{href:`/docs/pages-public-navigation-page--docs`,children:`Navigation Page`}),` for the entry point of one topic within the site.`]}),`
...
`,(0,g.jsxs)(n.p,{children:[`A home page has no single most prominent topic, so it usually has no visible level 1 `,(0,g.jsx)(n.a,{href:`/docs/components-text-heading--docs`,children:`Heading`}),`.`]}),`
...
`,(0,g.jsx)(n.li,{children:`Space a Standalone Link below such a Grid a large from the Cards.
...
`,(0,g.jsxs)(n.p,{children:[`The top tasks and the news previews are each a list in the markup: their Subgrid renders a `,(0,g.jsx)(n.code,{children:`ul`}),` and every Cell in it an `,(0,g.jsx)(n.code,{children:`li`}),`.
...
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.a,{href:`/docs/pages-public-navigation-page--docs`,children:`Navigation Page`}),` – the same job for a single topic.`]}),`
