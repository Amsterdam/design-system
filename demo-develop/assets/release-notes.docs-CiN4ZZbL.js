...
Two extra stylesheets switch it on, and it combines freely with Compact Mode; the `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-modes--docs`,children:`Modes`}),` guide explains.`]}),`
`]}),`
...
The `,(0,c.jsx)(t.a,{href:`/docs/docs-designer-guide-vertical-space--docs`,children:`vertical space`}),` guidelines carry the full tables.`]}),`
...
The `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation`}),` guide shows how to serve a page in Arabic.`]}),`
...
Your viewport meta tag must declare `,(0,c.jsx)(t.code,{children:`viewport-fit=cover`}),`; the `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-getting-started--docs`,children:`Getting started`}),` guide explains.
...
The manifest behind the `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-ai-assistance--docs`,children:`AI assistance`}),` MCP server no longer lists internal helpers, exposes far more stories, and names the parts of every compound component.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Show a page as a wireframe with Lo-fi Mode, per the `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-modes--docs`,children:`Modes`}),` guide.`]}),`
...
`,(0,c.jsxs)(t.li,{children:[`Serve pages in right-to-left languages, with the `,(0,c.jsx)(t.a,{href:`/docs/docs-developer-guide-localisation--docs`,children:`Localisation`}),` guide.`]}),`
