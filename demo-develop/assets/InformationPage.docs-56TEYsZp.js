...
`,(0,u.jsxs)(t.p,{children:[`Write any sources as one sentence, with a `,(0,u.jsx)(t.a,{href:`/docs/components-navigation-link--docs`,children:`Link`}),` for each of them.
The Figure Caption then presents them in the small caption text it is meant for.
Note that the whole caption becomes the accessible name of the Figure, so keep it short.`]})]})}function l(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,u.jsx)(t,{...e,children:(0,u.jsx)(c,{...e})}):c(e)}var u;function d(){return(d=e((()=>{u=r(),a(),t(),o()})))()}d();export{l as default};