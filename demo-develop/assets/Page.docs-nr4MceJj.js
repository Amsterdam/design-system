import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{a as t,d as n,h as r,i,p as a,u as o}from"./blocks-CuAf8lRO.js";import{t as s}from"./jsx-runtime-Bq1bXGty.js";import{i as c}from"./react-BnCtKaSV.js";import{n as l,t as u}from"./DesignTokensTable-DyK92Ilf.js";import{t as d}from"./mdx-react-shim-9RzcSRdq.js";import{n as f,t as p}from"./Page.stories-DlKXD0n7.js";var m,h,g=e((()=>{m={page:{"background-color":{$value:`{ams.color.background.body}`,$extensions:{"nl.amsterdam.type":`color`}},"container-name":{$value:`{ams.query-containers.inline-size.container-name}`},"container-type":{$value:`inline-size`},"max-inline-size":{$value:{value:90,unit:`rem`},$type:`dimension`},"with-menu":{"max-inline-size":{$value:{value:120,unit:`rem`},$type:`dimension`},"area-skip-link":{"margin-inline-end":{$value:`{ams.grid.padding-inline}`,$extensions:{"nl.amsterdam.hint":`Must be the Grid inline padding, to make sure Skip Link and Grid line up.`,"nl.amsterdam.type":`dimension`,"nl.amsterdam.subtype":`space`}}}}}},h={ams:m}}));function _(e){let r={a:`a`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...c(),...e.components};return(0,y.jsxs)(y.Fragment,{children:[`
`,`
`,`
`,`
`,(0,y.jsx)(o,{of:p}),`
...
`,(0,y.jsxs)(r.p,{children:[`See the `,(0,y.jsx)(r.a,{href:`/story/pages-public-home-page--default`,children:`Home Page`}),` template for public websites for a full-page example.`]}),`
`,(0,y.jsx)(r.h3,{id:`with-menu`,children:`With menu`}),`
...
Open the `,(0,y.jsx)(r.a,{href:`/story/components-containers-page--with-menu`,children:`full example page`}),` or see the `,(0,y.jsx)(r.a,{href:`/story/pages-internal-home-page--default`,children:`Home Page`}),` template for internal websites.`]}),`
