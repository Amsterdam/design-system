import{r,j as e,c as S,a3 as H,P as n}from"./iframe-C_BpJfVf.js";import{j as _,b as A}from"./exampleContent-DRope23M.js";import{I as D}from"./Icon-CzO1YZZv.js";import{H as V}from"./Heading-gObjG_RC.js";import{u as q}from"./useKeyboardFocus-BsBpr6qG.js";/**
 * @license EUPL-1.2+
...
Created from {@link createContext}`,displayName:"Context",props:{}}}catch{}const N=r.forwardRef(({children:o,className:h,expanded:g=!1,label:u,...m},c)=>{const{headingLevel:l,sectionAs:E}=r.useContext(L),[x,R]=r.useState(g),T=E||"section",P=r.useId(),w=`heading-${l}`,k=`button-${P}`,C=`panel-${P}`;return e.jsxs("div",{className:S("ams-accordion__section",h),ref:c,...m,children:[e.jsx(V,{className:"ams-accordion__header",level:l,children:e.jsxs("button",{"aria-controls":C,"aria-expanded":x,className:"ams-accordion__button",id:k,onClick:()=>R(!x),type:"button",children:[e.jsx(D,{className:"ams-accordion__icon",size:w,svg:H}),u]})}),e.jsx(T,{"aria-labelledby":k,className:S("ams-accordion__panel",{"ams-accordion__panel--expanded":x}),id:C,children:o})]})});N.displayName="Accordion.Section";try{Accordion.Section.displayName="Accordion.Section",Accordion.Section.__docgenInfo={description:"",displayName:"Accordion.Section",props:{expanded:{defaultValue:{value:"false"},description:"Whether the content is displayed initially.",name:"expanded",required:!1,type:{name:"boolean"}},label:{defaultValue:null,description:"The heading text.",name:"label",required:!0,type:{name:"string"}}}}}catch{}const I=r.forwardRef(({children:o,className:h,headingLevel:g,sectionAs:u="section"},m)=>{const c=r.useRef(null);r.useImperativeHandle(m,()=>c.current);const{keyDown:l}=q(c,{focusableElements:[".ams-accordion__button:not([disabled])"],rotating:!0});return e.jsx(L.Provider,{value:{headingLevel:g,sectionAs:u},children:e.jsx("div",{className:S("ams-accordion",h),onKeyDown:l,ref:c,children:o})})});I.displayName="Accordion";const a=Object.assign(I,{Section:N});try{a.displayName="Accordion",a.__docgenInfo={description:"",displayName:"Accordion",props:{headingLevel:{defaultValue:null,description:`The hierarchical level of this Accordion’s Section Headings within the document.
...
}`,...d.parameters?.docs?.source}}};const z=["Default","Level","ExpandedByDefault","ReduceLandmarks"],G=Object.freeze(Object.defineProperty({__proto__:null,Default:i,ExpandedByDefault:s,Level:t,ReduceLandmarks:d,__namedExportsOrder:z,default:$},Symbol.toStringTag,{value:"Module"}));export{G as A,s as E,t as L,d as R};
