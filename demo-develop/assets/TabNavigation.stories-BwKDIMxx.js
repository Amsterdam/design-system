import{a as e,n as t,r as n}from"./chunk-DnJy8xQt.js";import{Rt as r,St as i,Vt as a,it as o,lt as s,wn as c,wt as l}from"./iframe-CS5CGZam.js";import{s as u,t as d}from"./src-U2q4T6JQ.js";var f=n({Default:()=>v,Vertical:()=>y,WithIcons:()=>x,WithManyLinks:()=>C,__namedExportsOrder:()=>w,default:()=>g}),p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{r(),d(),p=e(c()),m=a(),h=(e,t)=>{let[n,r]=(0,p.useState)(t??e[0]);return{current:n,handleClick:(e,t)=>{e.preventDefault(),r(t)}}},g={title:`Components/Navigation/Tab Navigation`,component:u,argTypes:{orientation:{control:{type:`inline-radio`},options:[`horizontal`,`vertical`]}}},_=[`Gegevens`,`Aanslagen`,`Documenten`,`Acties`],v={parameters:{docs:{source:{code:`<TabNavigation>
  <TabNavigation.List>
