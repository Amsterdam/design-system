...
`,(0,c.jsxs)(t.p,{children:[`The Grid that follows the Breadcrumb holds the Content Header: the page title, an optional `,(0,c.jsx)(t.a,{href:`/docs/components-text-metadata--docs`,children:`Metadata`}),`, and the lead paragraph.
It has no `,(0,c.jsx)(t.code,{children:`paddingTop`}),`, so that the breadcrumb and the page title read as a single block.
Its Cell carries the `,(0,c.jsx)(t.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` utility class, which spaces those three as `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`vertical space`}),` recommends.
...
`,(0,c.jsxs)(t.p,{children:[`The `,(0,c.jsx)(t.a,{href:`/docs/utilities-css-prose--docs`,children:`Prose`}),` utility class sets the space between most types of elements of a Cell, following the `,(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`vertical space`}),` recommendations.
...
`,(0,c.jsxs)(t.p,{children:[`The Content Header contains the page title, an optional Metadata with the publication date or the taxonomy tags, and the lead paragraph.
...
`,(0,c.jsxs)(t.li,{children:[(0,c.jsx)(t.a,{href:`/docs/docs-guidelines-vertical-space--docs`,children:`Vertical space`}),` – the space between any two components.`]}),`
