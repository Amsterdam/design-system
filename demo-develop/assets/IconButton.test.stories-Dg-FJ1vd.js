import{j as e,e as d}from"./iframe-YwOhrd5l.js";import{i as c}from"./Icon-BgD_ukhj.js";import{i as r,I as l}from"./IconButton-BU3Uh1GB.js";import{m as u}from"./IconButton.stories-C3tmrk_Z.js";import"./preload-helper-PPVm8Dsz.js";const I={...u,title:"Components/Buttons/Icon Button"},m=["default","disabled","hovered",...r],n={parameters:{pseudo:{hover:".hover"}},render:s=>e.jsx("table",{children:e.jsx("tbody",{children:c.map(t=>e.jsx("tr",{children:m.map(o=>{const a=i=>r.includes(i);return e.jsx("td",{children:e.jsx(l,{...s,className:o==="hovered"?"hover":void 0,color:a(o)?o:void 0,disabled:o==="disabled",size:t,svg:d})},`${o}-${t}`)})},t))})}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      hover: '.hover'
    }
