import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{$ as r,J as i,L as a,O as o,S as s,o as c,t as l,v as u,w as d,x as f}from"./index.esm-DPbJc1Ha.js";import{n as p,r as m,t as h}from"./commonMeta-CSzf7AJR.js";var g=t({Default:()=>y,WithTable:()=>b,__namedExportsOrder:()=>x,default:()=>v}),_,v,y,b,x;function S(){return(S=e((()=>{r(),p(),_=n(),v={...h,title:`Pages/Public/Information Page`,parameters:m(`Explains a subject that is neither a product nor a news article: its background, the rules, and what they mean for a reader who wants to understand something rather than arrange it.`)},y={parameters:{docs:{source:{code:`<>
