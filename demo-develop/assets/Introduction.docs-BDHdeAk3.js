...
`,(0,c.jsxs)(t.p,{children:[`Below the page title, a `,(0,c.jsx)(t.a,{href:`/docs/components-text-heading--docs#sections-and-blocks`,children:`Heading`}),` keeps the size of its level where it introduces a content body, and takes a `,(0,c.jsx)(t.code,{children:`size`}),` one step smaller where it introduces a block or a group of blocks.
