import{n as e,r as t}from"./chunk-DnJy8xQt.js";import{Ht as n,I as r,Rt as i,X as a,ct as o,x as s,zt as c}from"./iframe-sVGWgCr0.js";import{d as l,t as u}from"./src-CIE9Makr.js";var d=t({ContrastColour:()=>h,Default:()=>m,InverseColour:()=>g,WithCustomIcon:()=>v,WithHeadingAndParagraph:()=>_,__namedExportsOrder:()=>y,default:()=>p}),f,p,m,h,g,_,v,y,b=e((()=>{a(),c(),u(),f=n(),p={title:`Components/Navigation/Standalone Link`,component:l,args:{children:`Bekijk alle onderwerpen`,href:`#`},argTypes:{children:{description:`The link text.`,table:{disable:!1}},color:{control:{labels:{undefined:`default`},type:`radio`},options:[void 0,`contrast`,`inverse`]},href:{description:`The url for the link.`,name:`href`,type:{name:`string`,required:!1}},icon:{control:{labels:{undefined:`none`},type:`select`},mapping:i,options:[void 0,...Object.keys(i)],table:{defaultValue:{summary:`ChevronForwardIcon`}}}}},m={},h={args:{color:`contrast`}},g={args:{color:`inverse`}},_={args:{children:`Bekijk alle werkzaamheden`},decorators:[e=>(0,f.jsx)(`article`,{style:{maxInlineSize:`32rem`},children:(0,f.jsx)(e,{})})],render:({children:e,...t})=>(0,f.jsxs)(`article`,{children:[(0,f.jsx)(s,{className:`ams-mb-s`,level:2,size:`level-3`,children:`Werkzaamheden`}),(0,f.jsx)(r,{className:`ams-mb-m`,children:`Lees waar en wanneer we werken aan nieuwbouw, groot onderhoud, herinrichting van straten en wegen, aanpak van parken of ontwikkeling van hele gebieden.`}),(0,f.jsx)(l,{...t,children:e})]})},v={args:{children:`Downloaden`,icon:(0,f.jsx)(o,{})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{}`,...m.parameters?.docs?.source}}},h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    color: 'contrast'
  }
