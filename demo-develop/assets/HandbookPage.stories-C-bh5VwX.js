...
</Grid>`,language:`tsx`}}},render:()=>{let[e,t]=(0,_.useState)(b),[n,r]=(0,_.useState)(()=>x(b)),c=(e,n)=>{e.preventDefault(),t(n),r(e=>new Set([...e,...x(n)]))},l=(e,t)=>{r(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),r})},u=m(e)??f[0];return(0,v.jsxs)(s,{paddingBottom:`2x-large`,paddingTop:`large`,children:[(0,v.jsx)(s.Cell,{span:{narrow:4,medium:3,wide:4},children:(0,v.jsx)(o,{collapsible:!0,heading:`Inhoudsopgave`,id:`inhoudsopgave`,children:S(f,{currentSlug:e,expandedSlugs:n,onSelect:c,onToggle:l})})}),(0,v.jsx)(s.Cell,{span:{narrow:4,medium:5,wide:7},children:(0,v.jsxs)(`main`,{className:`ams-prose`,id:`inhoud`,children:[(0,v.jsx)(a,{level:1,children:u.heading}),(0,v.jsx)(i,{size:`large`,children:u.lead}),(0,v.jsx)(i,{children:u.body})]})})]})}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
