import{j as e}from"./iframe-BlTSEvLE.js";import{useMDXComponents as s}from"./index-C8fBMEu3.js";import{M as r}from"./blocks-Db3mX6pe.js";import"./index-BwmE4Tmo.js";/*@license CC0-1.0*/function i(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...s(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(r,{title:"Docs/Developer Guide/Interactivity"}),`
`,e.jsx(n.h1,{id:"interactivity",children:"Interactivity"}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://www.w3.org/TR/WCAG22/#use-of-color",rel:"nofollow",children:"WCAG 1.4.1"}),": colour should not be the only way to indicate that something is interactive"]}),`
