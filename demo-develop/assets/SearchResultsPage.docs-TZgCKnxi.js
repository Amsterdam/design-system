...
Suggest what to change — a shorter term, a different word, or fewer filters — and give a way to clear the filters in one action.`})]})}function l(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,u.jsx)(t,{...e,children:(0,u.jsx)(c,{...e})}):c(e)}var u;function d(){return(d=e((()=>{u=r(),a(),t(),o()})))()}d();export{l as default};