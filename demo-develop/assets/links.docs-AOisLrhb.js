...
`,(0,p.jsx)(s,{exclude:[`subtle`,`contrast`,`inverse`],path:`ams.links`,showDescriptions:!0,tokens:l}),`
...
`,(0,p.jsx)(s,{hideExamples:!0,path:`ams.links.subtle`,tokens:l}),`
...
`,(0,p.jsx)(s,{path:`ams.links.contrast`,tokens:l}),`
`,(0,p.jsx)(t.h2,{id:`inverse`,children:`Inverse`}),`
`,(0,p.jsx)(t.p,{children:`On dark backgrounds, links have the inverse colour.`}),`
`,(0,p.jsx)(s,{path:`ams.links.inverse`,tokens:l}),`
`,(0,p.jsx)(t.h2,{id:`how-to-use`,children:`How to use`}),`
`,(0,p.jsx)(t.p,{children:`Use these tokens if you recreate our React components with different technology, or if you create a new link component.`})]})}function f(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(d,{...e})}):d(e)}var p;function m(){return(m=e((()=>{p=r(),a(),t(),o(),u()})))()}m();export{f as default};