import{j as e}from"./iframe-JKNgUUaB.js";import{useMDXComponents as a}from"./index-NucKPaLH.js";import{M as i,e as r,f as c,h as d,i as o}from"./blocks-JUShT5hE.js";import{a as l,L as h,E as m,R as p}from"./Accordion.stories-bUkoQThG.js";import{D as u}from"./DesignTokensTable-Bs-ukdyX.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DUn2DcO_.js";import"./exampleContent-D2tKGi5u.js";import"./useKeyboardFocus-CO72QOjh.js";import"./Icon-ihs-AqtW.js";import"./Heading-DuOhfKMh.js";import"./getHeadingTag-Dv1eMqvl.js";import"./BorderSample-DJFhSP8P.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-Bm-hZEWW.js";import"./ColorSample-BmFVskFR.js";import"./SpaceSample-QFcWlo4a.js";import"./TypographySample-BCo9KYeL.js";const g=`<!-- @license CC0-1.0 -->
...
`,f={accordion:{gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},button:{"font-family":{$deprecated:"The Accordion section button now uses a Heading component. Use the Heading component tokens instead. Will be removed in release 4.0.0.",$value:"{ams.typography.font-family}",$type:"fontFamily"},"font-size":{$deprecated:"The Accordion section button now uses a Heading component. Use the Heading component tokens instead. Will be removed in release 4.0.0.",$value:"{ams.typography.heading.3.font-size}",$extensions:{"nl.amsterdam.type":"fontSize"}},"font-weight":{$deprecated:"The Accordion section button now uses a Heading component. Use the Heading component tokens instead. Will be removed in release 4.0.0.",$value:"{ams.typography.heading.font-weight}",$type:"fontWeight"},"line-height":{$deprecated:"The Accordion section button now uses a Heading component. Use the Heading component tokens instead. Will be removed in release 4.0.0.",$value:"{ams.typography.heading.3.line-height}",$extensions:{"nl.amsterdam.type":"lineHeight"}},"text-wrap":{$deprecated:"The Accordion section button now uses a Heading component. Use the Heading component tokens instead. Will be removed in release 4.0.0.",$value:"{ams.typography.heading.text-wrap}"},color:{$value:"{ams.color.interactive.default}",$type:"color"},cursor:{$value:"{ams.cursor.interactive}"},gap:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"outline-offset":{$value:"{ams.focus.outline-offset}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-block":{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"padding-inline":{$value:"0",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},hover:{color:{$value:"{ams.color.interactive.hover}",$type:"color"}}},panel:{"padding-block":{$deprecated:"Will be removed in release 4.0.0.",$value:"0"},"padding-inline":{$deprecated:"Will be removed in release 4.0.0.",$value:"0"}}}},y={ams:f};function s(t){const n={a:"a",code:"code",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(i,{of:l}),`
...
`,e.jsx(n.p,{children:`There are 3 hierarchical levels of headings possible.
...
`,e.jsx(u,{tokens:y})]})}function M(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{M as default};
