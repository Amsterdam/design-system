import{r as g,j as e,c as m,P as d,C as x,G as l}from"./iframe-YwOhrd5l.js";import{f as _}from"./common-DrnyCu3t.js";import{k as w}from"./exampleContent-DRope23M.js";import{H as y}from"./Heading-DlMmD_Mw.js";import{P as H}from"./Paragraph-CboTQWXU.js";import{I as b}from"./Image-BARYUaHR.js";const C=g.forwardRef(({children:r,className:n,size:i="level-3",...s},u)=>e.jsx(y,{...s,className:m("ams-card__heading",n),ref:u,size:i,children:r}));C.displayName="Card.Heading";try{Card.Heading.displayName="Card.Heading",Card.Heading.__docgenInfo={description:"",displayName:"Card.Heading",props:{color:{defaultValue:null,description:"Changes the text colour for readability on a dark background.",name:"color",required:!1,type:{name:"enum",value:[{value:'"inverse"'}]}},level:{defaultValue:null,description:"The hierarchical level within the document.",name:"level",required:!0,type:{name:"enum",value:[{value:"1"},{value:"3"},{value:"2"},{value:"4"}]}},size:{defaultValue:{value:"level-3"},description:`Uses larger or smaller text without changing its position in the heading hierarchy.
