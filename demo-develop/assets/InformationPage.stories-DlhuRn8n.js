import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{t as n}from"./jsx-runtime-ATHzeHXA.js";import{E as r,F as i,K as a,S as o,Z as s,b as c,g as l,o as u,t as d,y as f}from"./index.esm-uYrK_Rjm.js";import{n as p,t as m}from"./commonMeta-BFmSZdoe.js";var h=t({Default:()=>v,WithTable:()=>y,__namedExportsOrder:()=>b,default:()=>_}),g,_,v,y,b;function x(){return(x=e((()=>{s(),p(),g=n(),_={...m,title:`Pages/Public/Information Page`},v={parameters:{docs:{source:{code:`<>
...
</>`,language:`tsx`}}},render:()=>(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(f,{paddingTop:`large`,children:(0,g.jsx)(f.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:(0,g.jsxs)(u,{children:[(0,g.jsx)(u.Link,{href:`#`,children:`Home`}),(0,g.jsx)(u.Link,{href:`#`,children:`Parken en groen`}),(0,g.jsx)(u.Link,{href:`#`,children:`Evenementen in parken`})]})})}),(0,g.jsxs)(`main`,{id:`inhoud`,children:[(0,g.jsxs)(f,{paddingBottom:`x-large`,children:[(0,g.jsxs)(f.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:[(0,g.jsx)(c,{className:`ams-mb-xs`,level:1,children:`Natuurbescherming bij evenementen in parken en groengebieden`}),(0,g.jsx)(i,{children:`Evenementen, Natuur en groen, Vergunningen`})]}),(0,g.jsx)(f.Cell,{span:{narrow:4,medium:4,wide:5},start:{narrow:1,medium:1,wide:2},children:(0,g.jsx)(i,{size:`large`,children:`De Wet Natuurbescherming verbiedt festivals in het broedseizoen niet. Festivalorganisatoren moeten wel extra maatregelen nemen om de planten en dieren in het park te beschermen. Volgens een natuurtoets door een adviesbureau voldoet de festivalorganisator aan de eisen van de natuurbeschermingswet. Het stadsdeel verleent de vergunning.`})}),(0,g.jsx)(f.Cell,{span:{narrow:4,medium:4,wide:5},start:{narrow:1,medium:5,wide:7},children:(0,g.jsx)(o,{alt:``,aspectRatio:`4:3`,src:`https://picsum.photos/id/1015/640/480`})})]}),(0,g.jsx)(f,{paddingBottom:`2x-large`,children:(0,g.jsxs)(f.Cell,{span:{narrow:4,medium:6,wide:7},start:{narrow:1,medium:2,wide:3},children:[(0,g.jsx)(c,{className:`ams-mb-s`,level:2,children:`Regels tijdens het broedseizoen`}),(0,g.jsx)(i,{className:`ams-mb-l`,children:`Van half maart tot half juli broeden veel vogels in de parken. In die periode gelden extra regels voor geluid, verlichting en de opbouw van podia.`}),(0,g.jsxs)(d,{className:`ams-mb-xl`,headingLevel:3,children:[(0,g.jsx)(d.Section,{label:`Wanneer is het broedseizoen?`,children:(0,g.jsx)(i,{children:`Het broedseizoen loopt globaal van 15 maart tot 15 juli. De precieze periode verschilt per vogelsoort en per jaar. Een ecoloog bepaalt bij elk evenement of er op dat moment nesten in gebruik zijn.`})}),(0,g.jsx)(d.Section,{label:`Welke maatregelen neemt een organisator?`,children:(0,g.jsx)(i,{children:`Denk aan het weren van geluid richting bosschages, het uitschakelen van schijnwerpers na zonsondergang, en het vrijhouden van een zone rond nestbomen. De maatregelen staan in het ecologisch werkprotocol bij de vergunning.`})}),(0,g.jsx)(d.Section,{label:`Wat staat er in een natuurtoets?`,children:(0,g.jsx)(i,{children:`Een adviesbureau onderzoekt welke beschermde planten en dieren in het gebied voorkomen. De natuurtoets beschrijft de verwachte effecten van het evenement en de maatregelen die nodig zijn om schade te voorkomen.`})}),(0,g.jsx)(d.Section,{label:`Wie controleert de afspraken?`,children:(0,g.jsx)(i,{children:`Toezichthouders van de gemeente controleren voor, tijdens en na het evenement. Bij overtredingen kan het stadsdeel het evenement stilleggen of de vergunning voor een volgend jaar weigeren.`})}),(0,g.jsx)(d.Section,{label:`Waar meldt u schade aan groen?`,children:(0,g.jsx)(i,{children:`Ziet u schade aan bomen, struiken of oevers? Meld dit via het formulier Melding openbare ruimte. Vermeld de locatie en voeg zo mogelijk een foto toe.`})})]}),(0,g.jsx)(c,{className:`ams-mb-s`,level:2,children:`Onderzoek naar planten en dieren`}),(0,g.jsx)(i,{className:`ams-mb-l`,children:`Voor elk groot evenement in een park laat de organisator een natuurtoets uitvoeren. Het onderzoek brengt in kaart welke soorten er leven en hoe kwetsbaar zij zijn. De uitkomsten bepalen waar podia, hekken en horeca mogen staan.`}),(0,g.jsx)(o,{alt:``,className:`ams-mb-xl`,loading:`lazy`,src:`https://picsum.photos/id/1016/1280/720`}),(0,g.jsx)(c,{className:`ams-mb-s`,level:2,children:`Bezwaar maken tegen een vergunning`}),(0,g.jsx)(i,{className:`ams-mb-m`,children:`Bent u het niet eens met een verleende vergunning? Dan kunt u binnen 6 weken na de bekendmaking bezwaar maken. De termijn begint op de dag na de publicatie in het Gemeenteblad.`}),(0,g.jsx)(i,{className:`ams-mb-l`,children:`Een bezwaar schorst de vergunning niet. Wilt u dat het evenement voorlopig niet doorgaat, dan vraagt u de rechtbank daarnaast om een voorlopige voorziening.`}),(0,g.jsx)(c,{className:`ams-mb-xs`,level:3,children:`Wat zet u in uw bezwaarschrift?`}),(0,g.jsx)(i,{className:`ams-mb-m`,children:`Beschrijf om welke vergunning het gaat, waarom u het er niet mee eens bent, en wat u anders zou willen zien. Vermeld ook uw naam, adres en de datum.`}),(0,g.jsx)(i,{children:`U ontvangt een bevestiging van ontvangst. Daarna nodigt de bezwaarcommissie u uit voor een hoorzitting. Binnen 12 weken volgt een beslissing op uw bezwaar.`})]})})]})]})},y={parameters:{docs:{source:{code:`<>
  {/* Keep the breadcrumb in its own Grid above <main>, so it sits outside the main content region. */}
  <Grid paddingTop="large">
    <Grid.Cell span={{ narrow: 4, medium: 7, wide: 9 }} start={{ narrow: 1, medium: 1, wide: 2 }}>
      <Breadcrumb>
...
</>`,language:`tsx`}}},render:()=>(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(f,{paddingTop:`large`,children:(0,g.jsx)(f.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:(0,g.jsxs)(u,{children:[(0,g.jsx)(u.Link,{href:`#`,children:`Home`}),(0,g.jsx)(u.Link,{href:`#`,children:`Belastingen`}),(0,g.jsx)(u.Link,{href:`#`,children:`WOZ-waarde`})]})})}),(0,g.jsxs)(`main`,{id:`inhoud`,children:[(0,g.jsx)(f,{paddingBottom:`x-large`,children:(0,g.jsxs)(f.Cell,{span:{narrow:4,medium:7,wide:9},start:{narrow:1,medium:1,wide:2},children:[(0,g.jsx)(c,{className:`ams-mb-xs`,level:1,children:`Landelijk vastgestelde gegevens voor de WOZ-waarde van uw woning`}),(0,g.jsxs)(i,{className:`ams-mb-xl`,children:[(0,g.jsx)(`time`,{dateTime:`2026-01-01`,children:`1 januari 2026`}),` – Belastingen, Wonen, WOZ`]}),(0,g.jsx)(i,{size:`large`,children:`De gemeente stelt elk jaar de WOZ-waarde van uw woning vast. Welke gegevens daarbij horen en hoe zij worden vastgelegd, is landelijk bepaald. Zo betekent een gegeven in Amsterdam hetzelfde als in elke andere gemeente.`})]})}),(0,g.jsx)(f,{paddingBottom:`x-large`,children:(0,g.jsxs)(f.Cell,{span:{narrow:4,medium:6,wide:7},start:{narrow:1,medium:2,wide:3},children:[(0,g.jsx)(c,{className:`ams-mb-s`,level:2,children:`Hoe de WOZ-waarde tot stand komt`}),(0,g.jsx)(i,{className:`ams-mb-m`,children:`De WOZ-waarde is de waarde die uw woning op de peildatum zou opbrengen bij verkoop. De peildatum ligt altijd een jaar voor het belastingjaar, zodat de gemeente verkoopcijfers van een heel jaar kan gebruiken.`}),(0,g.jsx)(i,{className:`ams-mb-l`,children:`Voor de vergelijking gebruikt de gemeente woningen die in dezelfde periode zijn verkocht en die op uw woning lijken in type, grootte, bouwjaar en ligging. Verschillen tussen die woningen en de uwe worden verrekend.`}),(0,g.jsx)(c,{className:`ams-mb-xs`,level:3,children:`Niet eens met de waarde`}),(0,g.jsx)(i,{className:`ams-mb-m`,children:`Bekijk eerst het taxatieverslag. Daarin staat welke woningen zijn vergeleken en welke kenmerken zijn gebruikt. Klopt een kenmerk niet, geef dat dan aan ons door.`}),(0,g.jsx)(i,{children:`Bent u het daarna nog niet eens met de waarde? Maak dan binnen 6 weken na de dagtekening van de aanslag bezwaar. U hoeft daar geen bureau voor in te schakelen.`})]})}),(0,g.jsx)(f,{paddingBottom:`2x-large`,children:(0,g.jsx)(f.Cell,{span:{narrow:4,medium:8,wide:10},start:{narrow:1,medium:1,wide:2},children:(0,g.jsxs)(l,{children:[(0,g.jsxs)(a,{children:[(0,g.jsx)(a.Caption,{children:(0,g.jsx)(c,{level:2,children:`Landelijk vastgestelde gegevens WOZ`})}),(0,g.jsx)(a.Header,{children:(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{children:`Gegeven`}),(0,g.jsx)(a.HeaderCell,{children:`Omschrijving`}),(0,g.jsx)(a.HeaderCell,{children:`Eenheid`}),(0,g.jsx)(a.HeaderCell,{children:`Verplicht`})]})}),(0,g.jsxs)(a.Body,{children:[(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`WOZ-waarde`}),(0,g.jsx)(a.Cell,{children:`Vastgestelde waarde van de woning`}),(0,g.jsx)(a.Cell,{children:`Euro`}),(0,g.jsx)(a.Cell,{children:`Ja`})]}),(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`Objectnummer`}),(0,g.jsx)(a.Cell,{children:`Uniek nummer van het WOZ-object`}),(0,g.jsx)(a.Cell,{children:`Tekst`}),(0,g.jsx)(a.Cell,{children:`Ja`})]}),(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`Grondoppervlakte`}),(0,g.jsx)(a.Cell,{children:`Oppervlakte van het perceel`}),(0,g.jsx)(a.Cell,{children:`m²`}),(0,g.jsx)(a.Cell,{children:`Ja`})]}),(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`Woonoppervlakte`}),(0,g.jsx)(a.Cell,{children:`Gebruiksoppervlakte volgens de BAG`}),(0,g.jsx)(a.Cell,{children:`m²`}),(0,g.jsx)(a.Cell,{children:`Nee`})]}),(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`Bouwjaar`}),(0,g.jsx)(a.Cell,{children:`Jaar waarin het object is gebouwd`}),(0,g.jsx)(a.Cell,{children:`Jaartal`}),(0,g.jsx)(a.Cell,{children:`Nee`})]}),(0,g.jsxs)(a.Row,{children:[(0,g.jsx)(a.HeaderCell,{scope:`row`,children:`Gebruiksdoel`}),(0,g.jsx)(a.Cell,{children:`Functie van het object volgens de BAG`}),(0,g.jsx)(a.Cell,{children:`Tekst`}),(0,g.jsx)(a.Cell,{children:`Ja`})]})]})]}),(0,g.jsxs)(l.Caption,{children:[`Bronnen: `,(0,g.jsx)(r,{href:`#`,children:`Catalogus Basisregistratie WOZ`}),` en`,` `,(0,g.jsx)(r,{href:`#`,children:`Gegevenswoordenboek WOZ`}),`.`]})]})})})]})]})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...y.parameters?.docs?.source}}},b=[`Default`,`WithTable`]})))()}export{x as n,h as t};