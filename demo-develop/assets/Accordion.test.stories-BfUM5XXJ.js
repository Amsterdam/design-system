import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-ATHzeHXA.js";import{n,t as r}from"./renderComponentVariants-CTso6ycW.js";import{n as i,t as a}from"./Accordion-C7DA5PMz.js";import{a as o,i as s}from"./Accordion.stories-DfX8WSeJ.js";var c,l,u,d,f;function p(){return(p=e((()=>{i(),r(),s(),c=t(),{expect:l}=__STORYBOOK_MODULE_TEST__,u={...o,title:`Components/Containers/Accordion`},d={args:{children:[(0,c.jsx)(a.Section,{label:`Verhuizing doorgeven bij stadsloket`,children:(0,c.jsx)(`p`,{children:`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 7 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`})},1),(0,c.jsx)(a.Section,{label:`Dit grof afval halen we niet op`,children:(0,c.jsx)(`p`,{children:`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 7 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`})},2),(0,c.jsx)(a.Section,{label:`Verhuizing doorgeven per post`,children:(0,c.jsx)(`p`,{children:`Vertel ons in het evenementenformulier wat u wilt gaan doen. U checkt daarmee of u een vergunning nodig hebt. Daarna vraagt u de vergunning aan in hetzelfde formulier. Of doet u een gratis melding of vooraankondiging.`})},3)]},parameters:{a11y:{config:{rules:[{enabled:!1,id:`heading-order`}]}}},play:async({canvas:e,userEvent:t})=>{let n=e.getByTestId(`test-label`),r=e.getByTestId(`test-paragraph`),i=n.querySelector(`button`);i&&(await l(e.getByTestId(`expanded-paragraph`)).toBeVisible(),await l(r).not.toBeVisible(),await t.click(i),await l(r).toBeVisible(),await t.click(i),await l(r).not.toBeVisible())},render:(e,t)=>(0,c.jsxs)(c.Fragment,{children:[n(a,{args:e},t),(0,c.jsx)(a.Section,{defaultExpanded:!0,label:`Verhuizing doorgeven bij stadsloket`,children:(0,c.jsx)(`p`,{"data-testid":`expanded-paragraph`,children:`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 7 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`})}),(0,c.jsx)(a.Section,{"data-testid":`test-label`,label:`Dit grof afval halen we niet op`,children:(0,c.jsx)(`p`,{"data-testid":`test-paragraph`,children:`Veel Amsterdammers in de bijstand zijn huiverig om te gaan werken. Ze denken dat ze dan minder geld krijgen, bijvoorbeeld omdat ze hun toeslagen verliezen. Voor deze mensen ontwikkelen we de ‘garantieknop’. Als mensen in de bijstand beginnen met werken en binnen 7 maanden hun baan verliezen, kunnen zij met de ‘garantieknop’ meteen weer bijstand krijgen als dat nodig is. Dit zorgt ervoor dat zij minder stress hebben. Het wordt zo makkelijker om weer een nieuwe baan te zoeken.`})}),(0,c.jsx)(a.Section,{label:`Verhuizing doorgeven per post`,children:(0,c.jsx)(`p`,{children:`Vertel ons in het evenementenformulier wat u wilt gaan doen. U checkt daarmee of u een vergunning nodig hebt. Daarna vraagt u de vergunning aan in hetzelfde formulier. Of doet u een gratis melding of vooraankondiging.`})})]}),tags:[`!dev`,`!autodocs`,`!manifest`]},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...d.parameters?.docs?.source}}},f=[`Test`]})))()}p();export{d as Test,f as __namedExportsOrder,u as default};