import{j as e,e as d}from"./iframe-kL5mGIV0.js";import{i as c}from"./Icon-CwyWOQeL.js";import{i as r,I as l}from"./IconButton-CM4uy8CT.js";import{m as u}from"./IconButton.stories-BeDauM9Q.js";import"./preload-helper-PPVm8Dsz.js";const I={...u,title:"Components/Buttons/Icon Button"},m=["default","disabled","hovered",...r],n={parameters:{pseudo:{hover:".hover"}},render:s=>e.jsx("table",{children:e.jsx("tbody",{children:c.map(t=>e.jsx("tr",{children:m.map(o=>{const a=i=>r.includes(i);return e.jsx("td",{children:e.jsx(l,{...s,className:o==="hovered"?"hover":void 0,color:a(o)?o:void 0,disabled:o==="disabled",size:t,svg:d})},`${o}-${t}`)})},t))})}),tags:["!dev","!autodocs"]};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      hover: '.hover'
    }
