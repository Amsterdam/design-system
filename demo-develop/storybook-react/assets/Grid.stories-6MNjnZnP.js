...
}`,...(f=(j=o.parameters)==null?void 0:j.docs)==null?void 0:f.source}}};var N,v,V;t.parameters={...t.parameters,docs:{...(N=t.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...GridStoryTemplate,
  args: {
    children: Array.from(Array(6).keys()).map(i => <Grid.Cell className="amsterdam-docs-pink-box" span={4} key={i} />),
    gapVertical: 'small'
  }
}`,...(V=(v=t.parameters)==null?void 0:v.docs)==null?void 0:V.source}}};var D,z,A;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...GridCellStoryTemplate,
  args: {
    children: <p className="amsterdam-docs-paragraph amsterdam-docs-pink-box">Deze cel beslaat 4 kolommen.</p>,
    span: 4
  }
}`,...(A=(z=l.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var w,_,M;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...GridCellStoryTemplate,
  args: {
...
}`,...(O=(L=d.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};var E,H,q;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
  ...GridCellStoryTemplate,
  args: {
...
}`,...(q=(H=m.parameters)==null?void 0:H.docs)==null?void 0:q.source}}};var B,R,F;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  ...GridCellStoryTemplate,
  args: {
    as: 'section'
  },
...
}`,...(F=(R=p.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};const W=["Default","Compact","VerticalSpace","VerticalGap","SpanMultipleColumns","ConfigureGridVariants","SpanAllColumns","StartPosition","CustomTagName"],Y=Object.freeze(Object.defineProperty({__proto__:null,Compact:n,ConfigureGridVariants:c,CustomTagName:p,Default:s,SpanAllColumns:d,SpanMultipleColumns:l,StartPosition:m,VerticalGap:t,VerticalSpace:o,__namedExportsOrder:W,default:h},Symbol.toStringTag,{value:"Module"}));export{n as C,Y as G,l as S,o as V,t as a,c as b,d as c,m as d,p as e};
