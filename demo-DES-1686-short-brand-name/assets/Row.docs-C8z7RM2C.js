import{j as e}from"./iframe-hU1eIJel.js";import{useMDXComponents as l}from"./index-CaFIx-qR.js";import{M as o,e as a,f as r,h,i}from"./blocks-BZjk459y.js";import{R as d,A as c,E as m,a as p,b as x,V as g,W as j}from"./Row.stories-COfgnHhz.js";import{D as u}from"./DesignTokensTable-CcrPpYSE.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C9Js6yfY.js";import"./types-CjGn4A4T.js";import"./Row-QYpL6q-3.js";import"./BorderSample-BLFwcs7A.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-Cgc8wuK4.js";import"./ColorSample-BnWBKYfM.js";import"./SpaceSample-D_6KBsql.js";import"./TypographySample-Cfn8XbjN.js";const f=`<!-- @license CC0-1.0 -->

# Row

Stacks its children horizontally with gaps between them and offers alignment options.
`,w={row:{gap:{"x-small":{$value:"{ams.space.xs}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},small:{$value:"{ams.space.s}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},medium:{$value:"{ams.space.m}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},large:{$value:"{ams.space.l}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}},"x-large":{$value:"{ams.space.xl}",$type:"dimension",$extensions:{"nl.amsterdam.subtype":"space"}}}}},y={ams:w};function t(s){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(o,{of:d}),`
