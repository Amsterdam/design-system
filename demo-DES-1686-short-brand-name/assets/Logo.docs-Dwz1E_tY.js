import{j as e}from"./iframe-CyXdCwPa.js";import{useMDXComponents as i}from"./index-DZ9hxeqU.js";import{M as a,e as r,f as l,h,i as s}from"./blocks-BMcgK4hh.js";import{L as d,G as m,S as g,a as c,V as p,M as u,A as f,C as x}from"./Logo.stories-CbLDTgiF.js";import{D as b}from"./DesignTokensTable-DvYxuuFa.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BeglOs_C.js";import"./ExampleLogo-B2cRmbaA.js";import"./BorderSample-j8ApnBK6.js";import"./formatTokenValue-BYjgZrXg.js";import"./Code-CaI_O-CP.js";import"./ColorSample-O3RQxofG.js";import"./SpaceSample-BodV1QlZ.js";import"./TypographySample-CCCb7Fnl.js";const j=`<!-- @license CC0-1.0 -->
...
`,w={logo:{"block-size":{$value:"{ams.space.xl}",$type:"dimension"},"min-block-size":{$value:{value:2.5,unit:"rem"},$type:"dimension"},emblem:{color:{$value:"#ec0000",$type:"color"}},subsite:{color:{$value:"{ams.color.text.default}",$type:"color"}},title:{color:{$value:"#ec0000",$type:"color"}}}},k={ams:w};function t(o){const n={h2:"h2",h3:"h3",p:"p",strong:"strong",...i(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,`
`,`
`,e.jsx(a,{of:d}),`
...
`,e.jsx(b,{tokens:k})]})}function _(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(t,{...o})}):t(o)}export{_ as default};
