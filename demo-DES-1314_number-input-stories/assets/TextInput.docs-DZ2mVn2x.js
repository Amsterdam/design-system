import{j as e}from"./jsx-runtime-Cf8x2fCZ.js";import{useMDXComponents as o}from"./index-CxbY7dAs.js";import{M as r,e as l,P as d,f as a,h as s}from"./index-DMjyuNSj.js";import{T as h,E as c,W as p,P as m,a as u,D as x,S as f,b,I as j,c as y,d as g,e as w}from"./TextInput.stories-BDcXJD4k.js";import"./index-yBjzXJbu.js";import"./index-G8LIXM5I.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-Gu4sTDL-.js";import"./index-fNjTmf9T.js";import"./index-CXQShRbs.js";import"./index-DrFu-skq.js";import"./index.esm-C4Aaqgc8.js";import"./clsx-B-dksMZM.js";import"./index.esm-jhuYF6FN.js";const v=`<!-- @license CC0-1.0 -->
...
`,e.jsxs(n.p,{children:["This field helps the user enter a whole number, we recommend using the ",e.jsx(n.code,{children:"text"}),` type for whole numbers.
You then need to add the `,e.jsx(n.code,{children:'inputMode="numeric"'}),` attribute and a pattern to validate the input.
Do not rely only on the browser’s validation. The `,e.jsx(n.code,{children:"text"}),` input field looks like a standard text input.
...
`,e.jsxs(n.p,{children:["This field helps the user enter a decimal number. Use the ",e.jsx(n.code,{children:"text"}),` type for decimal numbers. We do not recommend
using `,e.jsx(n.code,{children:'inputMode="decimal"'}),` as it may not work consistently across all browsers and devices. The language
